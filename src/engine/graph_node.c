...
struct GraphNodeScale *init_graph_node_scale(struct AllocOnlyPool *pool,
                                             struct GraphNodeScale *graphNode, DrawingLayer drawingLayer,
...
struct GraphNodeBone *init_graph_node_bone(struct AllocOnlyPool *pool,
                                           ...
                                           Vec3s translation, Vec3a rotation) {
    if (pool != NULL) graphNode = alloc_only_pool_alloc(pool, sizeof(struct GraphNodeBone));
    if (graphNode != NULL) {
