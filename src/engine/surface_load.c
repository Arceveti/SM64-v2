...
void load_object_collision_model(void) {
    ...
    if (o->oCollisionDistance > o->oDrawingDistance) o->oDrawingDistance = o->oCollisionDistance;// Update if no Time Stop, in range, and in the current room.
