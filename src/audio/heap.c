...
//     }
//     for (i = 0; i < 16; i++) arg2[i] = tmp[i];
// #ifdef VERSION_EU
//     for (i = 0; i < 8; i++) eu_stubbed_printf_1("%d ", arg2[i]);
//     eu_stubbed_printf_0("\n");
//     for (i = 8; i < 16; i++) eu_stubbed_printf_1("%d ", arg2[i]);
//     eu_stubbed_printf_0("\n");
// #endif
// }
// #endif
...
// UNUSED void func_sh_802F0E40(s16 filter[8], s32 arg1) { // Unused
//     s32 i;
...
void audio_reset_session(void) {
    ...
    if (gAudioLoadLock != AUDIO_LOCK_UNINITIALIZED) {
        ...
        while (remainingDmas > 0) {
            for (i = 0; i < gCurrAudioFrameDmaCount; i++) {
                if (osRecvMesg(&gCurrAudioFrameDmaQueue, NULL, OS_MESG_NOBLOCK) == 0) remainingDmas--;
            }
        }
    ...
    //     case  1: sReverbDownsampleRateLog = 0; break;
    //     case  2: sReverbDownsampleRateLog = 1; break;
    //     case  4: sReverbDownsampleRateLog = 2; break;
    //     case  8: sReverbDownsampleRateLog = 3; break;
    //     case 16: sReverbDownsampleRateLog = 4; break;
    //     default: sReverbDownsampleRateLog = 0;
    // }
    gVolume = preset->volume;
...
void func_sh_802f2158(struct UnkEntry *entry) {
    ...
    for (idx = 0; idx < seqCount; idx++) {
        ...
        if ((((bankId1 != 0xff) && (entry->bankId == bankId1)) || ((bankId2 != 0xff) && (entry->bankId == bankId2)) || (entry->bankId == 0))
            ...
            && (IS_BANK_LOAD_COMPLETE(idx) != FALSE)) {
