...
struct Object *spawn_object_rel_with_rot(                  struct Object *parent,                       u32 model, const BehaviorScript *behavior, s16 xOff, s16 yOff, s16 zOff, s16 rx, s16 ry, UNUSED s16 rz);
...
struct Object *find_closest_obj_with_behavior_from_yaw(     const BehaviorScript *behavior, Vec3f pos, s16 lookingAngle, s16 yawRange, s16 *yaw);
