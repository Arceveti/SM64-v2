...
// 23: end
Bool32 act_reading_npc_dialog(struct MarioState *m) {
...
Bool32 act_reading_automatic_dialog(struct MarioState *m) {
    u32 actionArg;
    m->actionState++;
...
static Bool32 act_credits_cutscene(struct MarioState *m) {
    s32 width, height;
