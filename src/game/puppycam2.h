...
#define PUPPYSPLINE_NONE                    0x1 // Will not write to focus at all.
#define PUPPYSPLINE_FOLLOW                  0x2 // Focus will follow a separate spline, but will mirror the speed and progress of the pos.
...
struct gPuppyStruct
{
    ...
    Bool8 cutscene;                 // A boolean that decides whether a cutscene is active
    s32 (*sceneFunc)();
    Bool8 sceneInput;               // A boolean that decides whether the controller updates during the scene.
