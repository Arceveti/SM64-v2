...
s32 trigger_obj_dialog_when_facing(s32 *inDialog, DialogID dialogID, f32 dist, s32 actionArg) {
    ...
    if ((is_point_within_radius_of_mario(o->oPosX, o->oPosY, o->oPosZ, (s32) dist)
      && obj_check_if_facing_toward_angle(o->oFaceAngleYaw, (gMarioObject->header.gfx.angle[1] + DEG(180)), DEG(22.5))
      && obj_check_if_facing_toward_angle(o->oMoveAngleYaw, o->oAngleToMario, DEG(22.5))) || (*inDialog)) {
        *inDialog = TRUE;
