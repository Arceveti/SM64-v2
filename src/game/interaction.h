...
#define INTERACT_NONE                   /* 0x00000000 */ 0
...
#define INTERACT_MASK_NO_OBJ_COLLISIONS (INTERACT_COIN | INTERACT_CAP | INTERACT_STRONG_WIND | INTERACT_STAR_OR_KEY | INTERACT_WARP | INTERACT_WATER_RING | INTERACT_FLAME) // 0x00053430
...
#define INT_STATUS_NONE                 0x00       /* 0x00000000 */
