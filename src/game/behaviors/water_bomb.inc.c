...
void bhv_water_bomb_spawner_update(void) {
    ...
    if (!o->oWaterBombSpawnerBombActive && (lateral_dist_between_objects_squared(o, gMarioObject) < sqr((50 * (u16)(o->oBehParams >> 16)) + 200.0f)) && ((gMarioObject->oPosY - o->oPosY) < 1000.0f)) {
