...
struct ExclamationBoxContents sExclamationBoxContents[] = { { EXCLAMATION_BOX_BP_WING_CAP        , 0, 0, MODEL_MARIOS_WING_CAP,  bhvWingCap               },
                                                            ...
                                                            { EXCLAMATION_BOX_BP_NULL            , 0, 0, 0,                      NULL                     } };
...
void exclamation_box_act_init(void) {
    if (o->oBehParams2ndByte < EXCLAMATION_BOX_BP_KOOPA_SHELL) {
        ...
        if ((save_file_get_flags() & sCapSaveFlags[o->oBehParams2ndByte]) || ((o->oBehParams >> 24) & 0xFF) != 0) {
...
void (*sExclamationBoxActions[])(void) = { exclamation_box_act_init,
