    ...
    if (o->oEyerokBossNumHands == 2) {
        if (o->oTimer > 5) {
            ...
            if (o->oEyerokBossUnk110 == 0.0f && mario_ready_to_speak()) {
                ...
                if (approach_f32_ptr(&o->oEyerokBossUnk110, 0.0f, 10.0f)) o->oTimer = 0;
            } else if (o->oTimer >  90) {
...
static void eyerok_hand_act_sleep(void) {
    if ((o->parentObj->oAction != EYEROK_BOSS_ACT_SLEEP) && ((++o->oEyerokHandWakeUpTimer) > (-3 * o->oBehParams2ndByte))) {
        ...
        o->collisionData = segmented_to_virtual((o->oBehParams2ndByte < 0) ? &ssl_seg7_collision_left_hand : &ssl_seg7_collision_right_hand);
...
static void eyerok_hand_act_retreat(void) {
    ...
    if (approach_f32_ptr(&o->oPosY, o->oHomeY, 20.0f) && distToHome == 0.0f && o->oFaceAngleYaw == 0) {
        ...
        if (o->parentObj->oEyerokBossUnk1AC == o->oBehParams2ndByte) o->parentObj->oEyerokBossUnk1AC = 0;
    }
}
...
static void eyerok_hand_act_begin_double_pound(void) {
    ...
    if ((o->parentObj->oEyerokBossUnk104 < 0) || (o->parentObj->oEyerokBossActiveHand == o->oBehParams2ndByte)) {
        ...
        sp4 = o->parentObj->oPosX + (400.0f * o->parentObj->oEyerokBossFightSideZ) - (180.0f * o->oBehParams2ndByte);

        o->oPosX = o->oHomeX + (sp4 - o->oHomeX) * o->parentObj->oEyerokBossUnk110;
        o->oPosY = o->oHomeY + (300.0f * o->parentObj->oEyerokBossUnk110);
        o->oPosZ = o->oHomeZ + (o->parentObj->oEyerokBossClampedMarioPosZ - o->oHomeZ) * o->parentObj->oEyerokBossUnk110;
    }
}

static void eyerok_hand_act_double_pound(void) {
    if (o->parentObj->oEyerokBossNumHands != 2) o->parentObj->oEyerokBossActiveHand = o->oBehParams2ndByte;
