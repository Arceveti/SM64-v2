...
static void eyerok_spawn_hand(s16 side, ModelID32 model, const BehaviorScript *behavior) {
    ...
    if (hand != NULL) hand->oFaceAngleYaw -= (DEG(90) * side);
}
...
static Bool32 eyerok_hand_check_attacked(void) {
    if ((o->oEyerokReceivedAttack != 0) && (abs_angle_diff(o->oAngleToMario, o->oFaceAngleYaw) < 0x3000)) {
        ...
        o->oForwardVel  *= 0.2f;
        o->oMoveAngleYaw = (o->oFaceAngleYaw + DEG(180));
    ...
    if (o->oTimer > 20) {
        if (o->oMoveFlags & OBJ_MOVE_MASK_ON_GROUND) {
            if (o->oGravity < -4.0f) {
                ...
                if ((o->oDistanceToMario < 300.0f) && (dYawToMario > DEG(45)) && (dYawToMario < DEG(135))) {
                    o->oAction = EYEROK_HAND_ACT_FIST_SWEEP;
                    o->oMoveAngleYaw = (((Angle)(o->oFaceAngleYaw - o->oAngleToMario) < 0) ? DEG(90) : -DEG(90));
                } else {
                    o->oAction = EYEROK_HAND_ACT_RETREAT;
                }
            }
