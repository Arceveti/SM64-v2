...
void cap_switch_act_being_pressed(void) {
    if (o->oTimer < 5) {
        ...
        if (cur_obj_update_dialog_with_cutscene(MARIO_DIALOG_LOOK_FRONT, (DIALOG_FLAG_TEXT_RESPONSE | DIALOG_FLAG_UNK_CAPSWITCH), CUTSCENE_CAP_SWITCH_PRESS, 0)) o->oAction = CAP_SWITCH_ACT_DONE;
    }
}
