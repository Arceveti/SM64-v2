...
void bhv_treasure_chest_top_loop(void) {
    ...
    switch (o->oAction) {
        case 0:
            if (o->parentObj->oAction == 1) o->oAction = 1;
            break;
        ...
        case 1:
            ...
            if (o->oFaceAnglePitch < -0x4000) {
                ...
                o->oAction++;
                if (o->parentObj->oBehParams2ndByte != 4) spawn_orange_number(o->parentObj->oBehParams2ndByte, 0, -40, 0);
            }
            break;

        case 2:
            if (o->parentObj->oAction == 0) o->oAction = 3;
            break;
...
void bhv_treasure_chest_bottom_loop(void) {
    switch (o->oAction) {
        ...
        case 1:
            if (o->parentObj->oTreasureChestDoCloseChests) o->oAction = 0;
            break;
