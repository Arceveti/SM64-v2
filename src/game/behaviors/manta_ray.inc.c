...
static void manta_ray_move(void) {
    ...
    if ((Angle) o->oMantaTargetYaw != (Angle) o->oMoveAngleYaw) {
        ...
        if (o->oMoveAngleRoll < -DEG(30)) o->oMoveAngleRoll = (-DEG(90) / 3);
    } else {
        o->oMoveAngleRoll += 0x5B;
        if (o->oMoveAngleRoll >  DEG(30)) o->oMoveAngleRoll = ( DEG(90) / 3);
    }
...
static void manta_ray_act_spawn_ring(void) {
    ...
    if (o->oTimer == 100) {
        ...
        ring->oFaceAnglePitch = (o->oMoveAnglePitch + DEG(90));
        ring->oPosX           = (o->oPosX + (200.0f * sins(o->oMoveAngleYaw + DEG(180))));
        ring->oPosY           = (o->oPosY + 10.0f + (200.0f * sins(o->oMoveAnglePitch)));
        ring->oPosZ           = (o->oPosZ + (200.0f * coss(o->oMoveAngleYaw + DEG(180))));
