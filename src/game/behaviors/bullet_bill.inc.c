...
void bullet_bill_act_idle(void) {
    if ((abs_angle_diff(o->oAngleToMario, o->oMoveAngleYaw) < DEG(45)) && (400.0f < o->oDistanceToMario) && (o->oDistanceToMario < 1500.0f)) o->oAction = BULLET_BILL_ACT_CHASING_MARIO;
}
...
void (*sBulletBillActions[])(void) = { bullet_bill_act_reset,
...
void bhv_bullet_bill_loop(void) {
    ...
    if (cur_obj_check_interacted()) o->oAction = BULLET_BILL_ACT_HIT;
}
