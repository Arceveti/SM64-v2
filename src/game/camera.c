...
extern Angle sAvoidYawVel;
extern Angle sCameraYawAfterDoorCutscene;
...
extern DialogID16 sCutsceneDialogID;
extern struct LakituState gLakituState;
extern Angle sAreaYaw;
extern Angle sAreaYawChange;
extern s16   sLakituDist;
extern Angle sLakituPitch;
extern f32   sZoomAmount;
extern Angle sCSideButtonYaw;
extern s16   sBehindMarioSoundTimer;
extern f32   sZeroZoomDist;
extern Angle sCUpCameraPitch;
extern Angle sModeOffsetYaw;
extern Angle sSpiralStairsYawOffset;
extern Angle s8DirModeBaseYaw;
extern Angle s8DirModeYawOffset;
...
void set_camera_shake_from_hit(s16 shake) {
    switch (shake) {
        ...
        case SHAKE_FALL_DAMAGE:
            set_camera_pitch_shake(0x60, 0x3, DEG(180));
            set_camera_roll_shake( 0x60, 0x3, DEG(180));
            break;
        case SHAKE_GROUND_POUND:
            set_camera_pitch_shake(0x60, 0xC, DEG(180));
            break;
        case SHAKE_SMALL_DAMAGE:
            if (sMarioCamState->action & (ACT_FLAG_SWIMMING | ACT_FLAG_METAL_WATER)) {
                set_camera_yaw_shake( 0x200, 0x10, DEG(22.5));
                set_camera_roll_shake(0x400, 0x20, DEG(22.5));
                set_fov_shake(        0x100, 0x30, DEG( 180));
            } else {
                set_camera_yaw_shake(  0x80,  0x8, DEG(  90));
                set_camera_roll_shake( 0x80,  0x8, DEG(  90));
                set_fov_shake(        0x100, 0x30, DEG( 180));
            }
            gLakituState.focHSpeed = 0.0f;
            gLakituState.posHSpeed = 0.0f;
        ...
        case SHAKE_MED_DAMAGE:
            if (sMarioCamState->action & (ACT_FLAG_SWIMMING | ACT_FLAG_METAL_WATER)) {
                set_camera_yaw_shake( 0x400, 0x20, DEG(22.5));
                set_camera_roll_shake(0x600, 0x30, DEG(22.5));
                set_fov_shake(        0x180, 0x40, DEG( 180));
            } else {
                set_camera_yaw_shake( 0x100, 0x10, DEG(  90));
                set_camera_roll_shake(0x100, 0x10, DEG(  90));
                set_fov_shake(        0x180, 0x40, DEG( 180));
            }
            gLakituState.focHSpeed = 0.0f;
            gLakituState.posHSpeed = 0.0f;
        ...
        case SHAKE_LARGE_DAMAGE:
            if (sMarioCamState->action & (ACT_FLAG_SWIMMING | ACT_FLAG_METAL_WATER)) {
                set_camera_yaw_shake( 0x600, 0x30, DEG(22.5));
                set_camera_roll_shake(0x800, 0x40, DEG(22.5));
                set_fov_shake(        0x200, 0x50, DEG( 180));
            } else {
                set_camera_yaw_shake( 0x180, 0x20, DEG(  90));
                set_camera_roll_shake(0x200, 0x20, DEG(  90));
                set_fov_shake(        0x200, 0x50, DEG( 180));
            }
            gLakituState.focHSpeed = 0.0f;
            gLakituState.posHSpeed = 0.0f;
...
void set_environmental_camera_shake(s16 shake) {
    switch (shake) {
        ...
        case SHAKE_ENV_UNUSED_6:            set_camera_roll_shake(  0x80, 0x10, 0x3000); break;
        case SHAKE_ENV_UNUSED_7:            set_camera_pitch_shake( 0x20,  0x8, 0x8000); break;
        case SHAKE_ENV_PYRAMID_EXPLODE:     set_camera_pitch_shake( 0x40,  0x8, 0x8000); break;
        case SHAKE_ENV_JRB_SHIP_DRAIN:      set_camera_pitch_shake( 0x20,  0x8, 0x8000);
                                            set_camera_roll_shake( 0x400, 0x10,  0x100); break;
        case SHAKE_ENV_FALLING_BITS_PLAT:   set_camera_pitch_shake( 0x40,  0x2, 0x8000); break;
        case SHAKE_ENV_UNUSED_5:            set_camera_yaw_shake( -0x200, 0x80,  0x200); break;
    }
}
...
void set_camera_shake_from_point(s16 shake, Vec3f pos) {
    switch (shake) {
        case SHAKE_POS_BOWLING_BALL: set_pitch_shake_from_point(0x028, 0x8, 0x4000, 2000.0f, pos); break;
        case SHAKE_POS_SMALL:        set_pitch_shake_from_point(0x080, 0x8, 0x4000, 4000.0f, pos);
                                     set_fov_shake_from_point_preset(SHAKE_FOV_SMALL,        pos); break;
        case SHAKE_POS_MEDIUM:       set_pitch_shake_from_point(0x0C0, 0x8, 0x4000, 6000.0f, pos);
                                     set_fov_shake_from_point_preset(SHAKE_FOV_MEDIUM,       pos); break;
        case SHAKE_POS_LARGE:        set_pitch_shake_from_point(0x100, 0x8, 0x3000, 8000.0f, pos);
                                     set_fov_shake_from_point_preset(SHAKE_FOV_LARGE,        pos); break;
    }
}
 ...
 */
Angle look_down_slopes(Angle camYaw) {
...
void pan_ahead_of_player(struct Camera *c) {
    ...
    vec3f_get_dist_and_yaw(c->pos, sMarioCamState->pos, &dist, &yaw);
    ...
    yaw    = -yaw;
    rotate_in_xz(pan, pan, yaw);
    vec3_add(c->focus, pan);
}

Angle find_in_bounds_yaw_wdw_bob_thi(UNUSED Vec3f pos, UNUSED Vec3f origin, Angle yaw) {
...
CameraTransitionAngle update_8_directions_camera(struct Camera *c, Vec3f focus, Vec3f pos) {
    ...
    if (gCurrLevelArea == AREA_DDD_SUB) camYaw = clamp_positions_and_find_yaw(pos, focus, 6839.0f, 995.0f, 5994.0f, -3945.0f);
    return camYaw;
}
...
void radial_camera_move(struct Camera *c) {
    ...
    if (!(gCameraMovementFlags & CAM_MOVE_ROTATE)) {
        if ((sMarioGeometry.currFloorType == SURFACE_CAMERA_MIDDLE      ) && (sMarioGeometry.prevFloorType != SURFACE_CAMERA_MIDDLE      )) gCameraMovementFlags |= (CAM_MOVE_RETURN_TO_MIDDLE | CAM_MOVE_ENTERED_ROTATE_SURFACE);
        if ((sMarioGeometry.currFloorType == SURFACE_CAMERA_ROTATE_RIGHT) && (sMarioGeometry.prevFloorType != SURFACE_CAMERA_ROTATE_RIGHT)) gCameraMovementFlags |= (CAM_MOVE_ROTATE_RIGHT     | CAM_MOVE_ENTERED_ROTATE_SURFACE);
        if ((sMarioGeometry.currFloorType == SURFACE_CAMERA_ROTATE_LEFT ) && (sMarioGeometry.prevFloorType != SURFACE_CAMERA_ROTATE_LEFT )) gCameraMovementFlags |= (CAM_MOVE_ROTATE_LEFT      | CAM_MOVE_ENTERED_ROTATE_SURFACE);
    }
    if (gCameraMovementFlags & CAM_MOVE_ENTERED_ROTATE_SURFACE) rotateSpeed = 0x200;
    ...
    //! negative and/or off by 1?
    if (sModeOffsetYaw >  0x5554) sModeOffsetYaw =  0x5554;
    if (sModeOffsetYaw < -0x5554) sModeOffsetYaw = -0x5554;
}
...
void lakitu_zoom(f32 rangeDist, Angle rangePitch) {
    if (sLakituDist < 0) {
        ...
        if ((sLakituDist -= 30) < rangeDist) sLakituDist = rangeDist;
    } else if (gCameraMovementFlags & CAM_MOVE_ZOOMED_OUT) {
        if ((sLakituDist += 30) > rangeDist) sLakituDist = rangeDist;
    } else {
        if ((sLakituDist -= 30) <         0) sLakituDist = 0;
    }
    if (gCurrLevelArea == AREA_SSL_PYRAMID && gCamera->mode == CAMERA_MODE_OUTWARD_RADIAL) rangePitch /= 2;
    if (gCameraMovementFlags & CAM_MOVE_ZOOMED_OUT) {
        if ((sLakituPitch += rangePitch / 13) > rangePitch) sLakituPitch = rangePitch;
    } else {
        if ((sLakituPitch -= rangePitch / 13) <        0x0) sLakituPitch = 0x0;
    }
}
...
void mode_radial_camera(struct Camera *c) {
    ...
    if (c->mode == CAMERA_MODE_RADIAL) lakitu_zoom(400.0f, 0x900);
    c->nextYaw     = update_radial_camera(c, c->focus, pos);
    c->pos[0]      = pos[0];
    c->pos[2]      = pos[2];
    sAreaYawChange = sAreaYaw - oldAreaYaw;
    if (sMarioCamState->action == ACT_RIDING_HOOT) pos[1] += 500.0f;
...
void mode_8_directions_camera(struct Camera *c) {
    ...
    if ((gPlayer1Controller->buttonPressed & L_CBUTTONS) && !(gPlayer1Controller->buttonDown & R_TRIG)) {
        ...
        s8DirModeBaseYaw += DEG((gPlayer2Controller->rawStickX * 4) / 64); // Analog camera support (Use the "Dual Analog" input mode in Parallel Launcher)
    }
    if (gPlayer1Controller->buttonDown & R_TRIG) {
        if (gPlayer1Controller->buttonDown & L_CBUTTONS) {
            s8DirModeBaseYaw -= DEG(cameraSpeed);
        ...
        if ((rButtonCounter > 0) && (rButtonCounter <= 5) && !((gPlayer1Controller->buttonDown & L_CBUTTONS) || (gPlayer1Controller->buttonDown & R_CBUTTONS) || (gMarioState->action & ACT_FLAG_SWIMMING_OR_FLYING))) {
            ...
            s8DirModeBaseYaw = (gMarioState->faceAngle[1] - DEG(180));
    ...
    // extra functionality
        ...
        s8DirModeYawOffset -= DEG(2);
    } else if (gPlayer1Controller->buttonDown & R_JPAD) {
        s8DirModeYawOffset += DEG(2);
    } else if (gPlayer1Controller->buttonPressed & D_JPAD) {
        s8DirModeYawOffset = (s8DirModeYawOffset & DEG(-45));
    }
#endif
    lakitu_zoom(400.0f, 0x900);
    c->nextYaw     = update_8_directions_camera(c, c->focus, pos);
...
CameraTransitionAngle update_parallel_tracking_camera(struct Camera *c, Vec3f focus, Vec3f pos) {
    ...
    f32 distToNext, distToPrev; //! switch these names?
    Angle prevPitch, nextPitch, prevYaw, nextYaw;
    // Store camera pos, for changing between paths
    vec3_copy(oldPos, pos);
    vec3_copy(path[0], sParTrackPath[sParTrackIndex].pos);
    vec3_copy(path[1], sParTrackPath[sParTrackIndex + 1].pos);
    ...
    marioPos[1] = sMarioCamState->pos[1] + 150.0f + marioFloorDist;
    ...
    //     if (marioOffset[2] - camOffset[2] >  0.0f) camOffset[2] = marioOffset[2] - 0.0f;
    // } else {
    //     if (marioOffset[2] - camOffset[2] < -0.0f) camOffset[2] = marioOffset[2] + 0.0f;
    // }
    camOffset[2] = marioOffset[2];
    ...
    focOffset[2] = ((pathLength / 2.0f) - focOffset[2]);
    ...
    vec3_add(c->pos, sParTrackTransOff.pos);
    ...
    vec3_copy(focus, marioPos);
    return vec3_yaw(focus, pos);
}
...
CameraTransitionAngle update_fixed_camera(struct Camera *c, Vec3f focus, UNUSED Vec3f pos) {
    ...
    switch (gCurrLevelArea) {
        case AREA_RR:           scaleToMario = 0.0f; heightOffset = 0.0f; break;
        case AREA_CASTLE_LOBBY: scaleToMario = 0.3f; heightOffset = 0.0f; break;
        case AREA_BBH:          scaleToMario = 0.0f; heightOffset = 0.0f; break;
    }
    handle_c_button_movement(c);
    play_camera_buzz_if_cdown();
    calc_y_to_curr_floor(&focusFloorOff, 1.0f, 200.0f, &focusFloorOff, 0.9f, 200.0f);
    vec3_copy(focus, sMarioCamState->pos);
    focus[1] += (focusFloorOff + CAMERA_Y_OFFSET);
    vec3f_get_dist_and_angle(focus, c->pos, &distCamToFocus, &faceAngle[0], &faceAngle[1]);
    faceAngle[2] = 0x0;
    vec3_copy(basePos, sFixedModeBasePosition);
    vec3_add( basePos, sCastleEntranceOffset );
...
CameraTransitionAngle update_boss_fight_camera(struct Camera *c, Vec3f focus, Vec3f pos) {
    ...
    yaw = (sModeOffsetYaw + DEG(45));
    // Get boss's position and whether Mario is holding it.
    if ((bossObj = gSecondCameraFocus) != NULL) {
        vec3_copy(secondFocus, &bossObj->oPosVec);
        heldState = bossObj->oHeldState;
    } else {
    ...
    focusDistance *= 1.6f;
    if (focusDistance <  800.0f) focusDistance =  800.0f;
    if (focusDistance > 5000.0f) focusDistance = 5000.0f;
    ...
    if (gCurrLevelNum == LEVEL_BBH) pos[1] = 2048.0f;
    ...
    lakitu_zoom(focusDistance, DEG(33.75));
    ...
    vec3f_set_dist_and_angle(pos, pos, sLakituDist, (sLakituPitch + DEG(22.5)), yaw);
    return yaw;
}
...
CameraTransitionAngle update_behind_mario_camera(struct Camera *c, Vec3f focus, Vec3f pos) {
    ...
    if (!(sMarioCamState->action & (ACT_FLAG_SWIMMING | ACT_FLAG_METAL_WATER))) pitchInc = 128;
    // Focus on Mario
    vec3_copy(focus, sMarioCamState->pos);
    c->focus[1] += focYOff;
    vec3f_get_dist_and_angle(focus, pos, &dist, &pitch, &yaw);
    if (dist > maxDist) dist = maxDist;
    if ((absPitch = pitch) < 0x0) absPitch = -absPitch;
    ...
    if (sCSideButtonYaw != 0x0) {
        approach_s16_symmetric_bool(&sCSideButtonYaw, 0x0, 0x1);
        yawSpeed = 0x8;
    }
    ...
    if (sCButtonsPressed & L_CBUTTONS) {
        if (gPlayer1Controller->buttonPressed & L_CBUTTONS) play_sound_cbutton_side();
        if (dist < maxDist) approach_f32_symmetric_bool(&dist, maxDist, 5.0f);
        goalYawOff      = -0x3FF8; // near 90 degrees
        sCSideButtonYaw =    0x1E;
        yawSpeed        =     0x2;
    // Rotate left
    } else if (sCButtonsPressed & R_CBUTTONS) {
        if (gPlayer1Controller->buttonPressed & R_CBUTTONS) play_sound_cbutton_side();
        if (dist < maxDist) approach_f32_symmetric_bool(&dist, maxDist, 5.0f);
        goalYawOff      = 0x3FF8; // near 90 degrees
        sCSideButtonYaw =   0x1E;
        yawSpeed        =    0x2;
 ...
 */
Angle update_slide_camera(struct Camera *c) {
    struct Surface *floor;
    f32 floorHeight;
    Vec3f pos;
    f32   distCamToFocus;
    ...
    Angle goalYaw   = (sMarioCamState->faceAngle[1] + DEG(180));
    ...
    if ((sMarioCamState->action != ACT_RIDING_HOOT) && (sMarioGeometry.currFloorType == SURFACE_DEATH_PLANE)) {
        ...
        c->pos[0] = pos[0];
        c->pos[2] = pos[2];
        approach_f32_symmetric_bool(&c->pos[1], c->focus[1], 30.0f);
 ...
 */
Angle update_default_camera(struct Camera *c) {
    Vec3f tempPos, cPos;
    ...
    Angle avoidYaw, pitch, yaw;
    Angle yawGoal = (sMarioCamState->faceAngle[1] + DEG(180));
    f32   posHeight, focHeight;
    f32   distFromWater;
    Angle tempPitch, tempYaw;
    f32   xzDist;
    Angle nextYawVel, yawVel = 0x0;
    f32   scale;
    s32   avoidStatus  = 0;
    ...
    if (gCameraMovementFlags & CAM_MOVE_ZOOMED_OUT) {
        ...
        zoomDist = (gCameraZoomDist + ((set_cam_angle(0) == CAM_ANGLE_MARIO) ? 1050 : 400));
    } else {
    ...
    if (sZoomAmount == 0.0f) {
        if ((dist > zoomDist) && (dist -= 50.0f) < zoomDist) dist = zoomDist;
    } else {
        if ((sZoomAmount -= 30.0f) < 0.0f) sZoomAmount = 0.0f;
        if ((dist > zoomDist) && (dist -= 30.0f) < zoomDist) dist = zoomDist;
        if ((dist < zoomDist) && (dist += 30.0f) > zoomDist) dist = zoomDist;
    }
    // Determine how fast to rotate the camera
    if (sCSideButtonYaw == 0x0) {
        nextYawVel = ((c->mode == CAMERA_MODE_FREE_ROAM) ? 0xC0 : 0x100);
        if ((gPlayer1Controller->stickX != 0.0f) || (gPlayer1Controller->stickY != 0.0f)) nextYawVel = 0x20;
    } else {
        if (sCSideButtonYaw < 0x0) yaw += 0x200;
        if (sCSideButtonYaw > 0x0) yaw -= 0x200;
    ...
    if (-16 < gPlayer1Controller->stickY) c->yaw = yaw;
    calc_y_to_curr_floor(&posHeight, 1, 200, &focHeight, 0.9f, 200);
    vec3_copy(cPos, c->pos);
    ...
    if (avoidStatus == 3) {
        ...
        approach_s16_asymptotic_bool(&yaw, avoidYaw, 0xA);
    ...
    vec3_copy_y_off(c->focus, sMarioCamState->pos, (CAMERA_Y_OFFSET + focHeight));
    ...
    if (waterHeight != FLOOR_LOWER_LIMIT) {
        ...
        if (!(gCameraMovementFlags & CAM_MOVE_METAL_BELOW_WATER) && (camFloorHeight < waterHeight)) camFloorHeight = waterHeight;
    } else {
        gCameraMovementFlags &= ~CAM_MOVE_METAL_BELOW_WATER;
    }
    cPos[1] = camFloorHeight;
    vec3_copy(tempPos, cPos);
    ...
    if (c->mode == CAMERA_MODE_FREE_ROAM) {
        if (gCameraMovementFlags & CAM_MOVE_ZOOMED_OUT) {
            posHeight = 375.0f;
            if (gCurrLevelArea == AREA_SSL_PYRAMID) posHeight /= 2;
        } else {
            posHeight = 100.0f;
        }
    }
    ...
    if ((ceilHeight != CELL_HEIGHT_LIMIT) && c->pos[1] > (ceilHeight -= 150.0f) && (avoidStatus = is_range_behind_surface(c->pos, sMarioCamState->pos, ceil, 0, -1)) == 1) c->pos[1] = ceilHeight;
    if (gCurrLevelArea == AREA_WDW_TOWN) yaw = clamp_positions_and_find_yaw(c->pos, c->focus, 2254.0f, -3789.0f, 3790.0f, -2253.0f);
    return yaw;
}
...
CameraTransitionAngle update_spiral_stairs_camera(struct Camera *c, Vec3f focus, Vec3f pos) {
    Vec3f cPos, checkPos;
    struct Surface *floor;
    f32 focusHeight, floorHeight, focY;
    handle_c_button_movement(c);
    // Set base pos to the center of the staircase
    vec3_set(sFixedModeBasePosition, -1280.0f, 614.0f, 1740.0f);
    ...
    Angle focYaw = vec3_yaw(sFixedModeBasePosition, focus);
    /// The camera's yaw around the stairs
    Angle posYaw = vec3_yaw(sFixedModeBasePosition, cPos );
    ...
    if (sSpiralStairsYawOffset < DEG(-90)) sSpiralStairsYawOffset = DEG(-90);
    if (sSpiralStairsYawOffset > DEG( 90)) sSpiralStairsYawOffset = DEG( 90);
    focYaw += sSpiralStairsYawOffset;
    posYaw = focYaw;
    vec3f_set_dist_and_angle(sFixedModeBasePosition, cPos, 300.0f, 0x0, posYaw);
...
void mode_slide_camera(struct Camera *c) {
    if (sMarioGeometry.currFloorType == SURFACE_CLOSE_CAMERA ||
        ...
        if (gPlayer1Controller->buttonPressed & U_CBUTTONS) gCameraMovementFlags |= CAM_MOVE_C_UP_MODE;
        c->nextYaw = update_slide_camera(c);
    }
}

void store_lakitu_cam_info_for_c_up(struct Camera *c) {
    vec3_copy(sCameraStoreCUp.pos, c->pos);
    vec3_sub(sCameraStoreCUp.pos, sMarioCamState->pos);
    // Only store the y value, and as an offset from Mario, for some reason
    vec3_set(sCameraStoreCUp.focus, 0.0f, (c->focus[1] - sMarioCamState->pos[1]), 0.0f);
}
 ...
 */
Bool32 set_mode_c_up(struct Camera *c) {
    ...
    if ((gCameraMovementFlags & CAM_MOVE_C_UP_MODE) && !(gCameraMovementFlags & CAM_MOVE_STARTED_EXITING_C_UP)) {
        ...
        if ((sModeInfo.lastMode == CAMERA_MODE_SPIRAL_STAIRS) || (sModeInfo.lastMode == CAMERA_MODE_CLOSE) || (sModeInfo.lastMode == CAMERA_MODE_FREE_ROAM)) {
            ...
            if (searching == 0) {
                ...
                vec3_copy(sCameraStoreCUp.focus, checkFoc);
                vec3_sub(sCameraStoreCUp.pos,   sMarioCamState->pos);
                vec3_sub(sCameraStoreCUp.focus, sMarioCamState->pos);
            }
...
void move_mario_head_c_up(UNUSED struct Camera *c) {
    ...
    if (sCUpCameraPitch >  DEG( 80)) sCUpCameraPitch =  DEG( 80);
    // Bound looking down to -45 degrees
    if (sCUpCameraPitch < -DEG( 45)) sCUpCameraPitch = -DEG( 45);
...
void move_into_c_up(struct Camera *c) {
    ...
    Angle pitch = (end->pitch - start->pitch);
    Angle yaw   = (end->yaw   - start->yaw);
    ...
    // Finished zooming in
    if (++sModeInfo.frame == sModeInfo.max) gCameraMovementFlags &= ~CAM_MOVING_INTO_MODE;
}

/**
 * The main update function for C-Up mode
 */
Bool32 mode_c_up_camera(struct Camera *c) {
    ...
    if (!(gCameraMovementFlags & CAM_MOVE_STARTED_EXITING_C_UP)) {
        ...
        if (sStatusFlags & CAM_FLAG_TRANSITION_OUT_OF_C_UP) {
            ...
            vec3_copy(c->pos,   sCameraStoreCUp.pos  );
            vec3_add( c->pos,   sMarioCamState->pos  );
    ...
    sPanDistance = 0.0f;
    // Exit C-Up mode
    if (gPlayer1Controller->buttonPressed & (A_BUTTON | B_BUTTON | D_CBUTTONS | L_CBUTTONS | R_CBUTTONS)) exit_c_up(c);
    return FALSE;
}
...
void set_camera_mode(struct Camera *c, s16 mode, s16 frames) {
    ...
    if (mode != CAMERA_MODE_WATER_SURFACE || gCurrLevelArea != AREA_TTM_OUTSIDE) {
        ...
        gCameraMovementFlags &= (u16)~(CAM_MOVE_RESTRICT | CAM_MOVE_ROTATE);
        gCameraMovementFlags |= CAM_MOVING_INTO_MODE;
        if (mode == CAMERA_MODE_NONE) mode = CAMERA_MODE_CLOSE;
        sCUpCameraPitch    = 0x0;
        sModeOffsetYaw     = 0x0;
        sLakituDist        = 0x0;
        sLakituPitch       = 0x0;
        ...
        vec3_copy(end->focus, c->focus);
        vec3_sub( end->focus, sMarioCamState->pos);
        vec3_copy(end->pos, c->pos);
        vec3_sub( end->pos,   sMarioCamState->pos);
        sAreaYaw = sModeTransitions[sModeInfo.newMode](c, end->focus, end->pos);
        // End was updated by sModeTransitions
        vec3_sub(   end->focus, sMarioCamState->pos  );
        vec3_sub(   end->pos,   sMarioCamState->pos  );
        vec3_copy(start->focus, gLakituState.curFocus);
        vec3_sub( start->focus, sMarioCamState->pos  );
        vec3_copy(start->pos,   gLakituState.curPos  );
        vec3_sub( start->pos,   sMarioCamState->pos  );
...
void update_lakitu(struct Camera *c) {
    ...
    if (!(gCameraMovementFlags & CAM_MOVE_PAUSE_SCREEN)) {
        ...
        // Update old state
        vec3_copy(sOldPosition, newPos);
        vec3_copy(sOldFocus,    newFoc);
        gLakituState.yaw                 = c->yaw;
        gLakituState.nextYaw             = c->nextYaw;
        vec3_copy(gLakituState.goalPos,   c->pos  );
        vec3_copy(gLakituState.goalFocus, c->focus);
        // Simulate Lakitu flying to the new position and turning towards the new focus
        set_or_approach_vec3f_asymptotic(gLakituState.curPos,   newPos, gLakituState.posHSpeed, gLakituState.posVSpeed, gLakituState.posHSpeed);
        set_or_approach_vec3f_asymptotic(gLakituState.curFocus, newFoc, gLakituState.focHSpeed, gLakituState.focVSpeed, gLakituState.focHSpeed);
        ...
        vec3_copy(gLakituState.pos, gLakituState.curPos);
        vec3_copy(gLakituState.focus, gLakituState.curFocus);
        if (c->cutscene) {
            vec3_add(gLakituState.focus, sPlayer2FocusOffset);
        ...
        if ((sMarioCamState->action == ACT_DIVE) && (gLakituState.lastFrameAction != ACT_DIVE)) set_camera_shake_from_hit(SHAKE_HIT_FROM_BELOW);
        ...
        vec3_copy(sModeTransition.marioPos, sMarioCamState->pos);
    }
...
void update_camera(struct Camera *c) {
    ...
    if (!gPuppyCam.enabled || (c->cutscene != 0) || gCurrentArea->camera->mode == CAMERA_MODE_INSIDE_CANNON) {
        ...
        gCheckingSurfaceCollisionsForCamera = TRUE;
        vec3_copy(c->pos  , gLakituState.goalPos);
        vec3_copy(c->focus, gLakituState.goalFocus);
        ...
        } else if ((gRecentCutscene != CUTSCENE_NONE) && (sFramesSinceCutsceneEnded < 8)) {
    ...
    if (!gPuppyCam.enabled || (c->cutscene != CUTSCENE_NONE) || (gCurrentArea->camera->mode == CAMERA_MODE_INSIDE_CANNON)) {
        ...
        if (gCurrLevelNum != LEVEL_CASTLE) {
            ...
            // trigger is held
            if (((c->cutscene == CUTSCENE_NONE) && (gPlayer1Controller->buttonDown & R_TRIG) && (cam_select_alt_mode(0) == CAM_SELECTION_FIXED))
                || (gCameraMovementFlags & CAM_MOVE_FIX_IN_PLACE)
                || (sMarioCamState->action == ACT_GETTING_BLOWN)) {
                // If this is the first frame that R_TRIG is held, play the "click" sound
                if (c->cutscene == CUTSCENE_NONE && (gPlayer1Controller->buttonPressed & R_TRIG) && (cam_select_alt_mode(0) == CAM_SELECTION_FIXED)) {
                ...
                c->yaw = c->nextYaw = vec3_yaw(gLakituState.focus, gLakituState.pos);
                gCameraMovementFlags &= ~CAM_MOVE_FIX_IN_PLACE;
            } else if (sCameraSoundFlags & CAM_SOUND_FIXED_ACTIVE) {
                // Play the "click" sound when fixed mode is released
                play_sound_rbutton_changed();
                sCameraSoundFlags &= ~CAM_SOUND_FIXED_ACTIVE;
            }
        } else if ((gPlayer1Controller->buttonPressed & R_TRIG) && (cam_select_alt_mode(0) == CAM_SELECTION_FIXED)) {
    ...
    if (c->cutscene != CUTSCENE_NONE) {
        ...
        if (gMarioState->action == ACT_ENTERING_STAR_DOOR) { //! god this is stupid and the fact I have to continue doing this is testament to the idiocy of the star door cutscene >:(
            gPuppyCam.yawTarget = (gMarioState->faceAngle[1] + DEG(180));
            gPuppyCam.yaw       = (gMarioState->faceAngle[1] + DEG(180));
        }
    }
...
void reset_camera(struct Camera *c) {
    ...
    sMarioCamState->headRotation[0] = 0x0;
    sMarioCamState->headRotation[1] = 0x0;
    sLuigiCamState->headRotation[0] = 0x0;
    sLuigiCamState->headRotation[1] = 0x0;
    sMarioCamState->cameraEvent     = 0;
...
void init_camera(struct Camera *c) {
    ...
    vec3_set(marioOffset, 0.0f, CAMERA_Y_OFFSET, 400.0f);
    ...
    switch (gCurrLevelNum) {
        ...
        case LEVEL_CASTLE_GROUNDS:
            if (!is_point_within_radius_of_mario_cam_state(-1328.0f, 260.0f, 4664.0f, 100.0f)) {
                marioOffset[0] = -400.0f;
                marioOffset[2] = -800.0f;
            }
            if (is_point_within_radius_of_mario_cam_state(-6901.0f, 2376.0f, -6509.0f, 100.0f)) start_cutscene(c, CUTSCENE_EXIT_WATERFALL);
            if (is_point_within_radius_of_mario_cam_state( 5408.0f, 4500.0f,  3637.0f, 100.0f)) start_cutscene(c, CUTSCENE_EXIT_FALL_WMOTR);
        ...
        case LEVEL_RR: vec3_set(sFixedModeBasePosition, -2985.0f, 478.0f, -5568.0f); break;
    }
    if (c->mode == CAMERA_MODE_8_DIRECTIONS) gCameraMovementFlags |= CAM_MOVE_ZOOMED_OUT;
    switch (gCurrLevelArea) {
        case AREA_SSL_EYEROK:  vec3_set(marioOffset, 0.0f, 500.0f, -100.0f);                                         break;
        case AREA_CCM_SLIDE:   // fall through
        case AREA_THI_WIGGLER: // fall through
        case AREA_SL_IGLOO:    marioOffset[2] = -300.0f;                                                             break;
        case AREA_SL_OUTSIDE:  if (is_point_within_radius_of_mario_cam_state(256.0f, 2150.0f, 1400.0f, 100.0f)) marioOffset[2] = -300.0f; break;
        case AREA_CCM_OUTSIDE: gCameraMovementFlags |= CAM_MOVE_ZOOMED_OUT;                                          break;
        case AREA_TTM_OUTSIDE: gLakituState.mode     = CAMERA_MODE_RADIAL;                                           break;
    }
    ...
    vec3_copy(c->focus, sMarioCamState->pos   );
    vec3_copy(gLakituState.curPos,    c->pos  );
    vec3_copy(gLakituState.curFocus,  c->focus);
    vec3_copy(gLakituState.goalPos,   c->pos  );
    vec3_copy(gLakituState.goalFocus, c->focus);
    vec3_copy(gLakituState.pos,       c->pos  );
    vec3_copy(gLakituState.focus,     c->focus);
    if (c->mode == CAMERA_MODE_FIXED) set_fixed_cam_axis_sa_lobby(c->mode);
    store_lakitu_cam_info_for_c_up(c);
    gLakituState.yaw     = vec3_yaw(c->focus, c->pos);
...
void zoom_out_if_paused_and_outside(struct GraphNodeCamera *camera) {
    ...
    s32 areaBit       = (0x1 << (((gCurrLevelArea & 0x10) / 4) + (((gCurrLevelArea & 0xF) - 1) & 0x3)));
...
void create_camera(struct GraphNodeCamera *gc, struct AllocOnlyPool *pool) {
    ...
    vec3_copy(gc->lerpPos[0],   gc->pos);
    vec3_copy(gc->lerpPos[1],   gc->pos);
    vec3_copy(gc->lerpPos[2],   gc->pos);
    vec3_copy(c->focus,         gc->focus);
    vec3_copy(gc->lerpFocus[0], gc->focus);
    vec3_copy(gc->lerpFocus[1], gc->focus);
    vec3_copy(gc->lerpFocus[2], gc->focus);
#else
    vec3_copy(c->pos  , gc->pos  );
    vec3_copy(c->focus, gc->focus);
#endif
...
void update_graph_node_camera(struct GraphNodeCamera *gc) {
    ...
    vec3_copy(gc->pos,   gLakituState.pos);
    vec3_copy(gc->focus, gLakituState.focus);
...
Bool32 move_point_along_spline(Vec3f p, struct CutsceneSplinePoint spline[], s16 *splineSegment, f32 *progress) {
    ...
    f32 u           = *progress;
    f32 progressChange;
    f32 firstSpeed  = 0, secondSpeed = 0;
    ...
    for ((i = 0); (i < 4); (i++)) vec3_copy(controlPoints[i], spline[segment + i].point);
...
#ifdef VERSION_EU
    if (gCamera->cutscene == CUTSCENE_INTRO_PEACH) progressChange += (progressChange * 0.19f);
    if (gCamera->cutscene == CUTSCENE_CREDITS    ) progressChange += (progressChange * 0.15f);
    if (gCamera->cutscene == CUTSCENE_ENDING     ) progressChange += (progressChange * 0.1f );
#endif
...
s32 cam_select_alt_mode(s32 selection) {
    if (selection == CAM_SELECTION_MARIO) {
        if (!(sSelectionFlags & CAM_MODE_MARIO_SELECTED)) sSelectionFlags |= CAM_MODE_MARIO_SELECTED;
    ...
    return ((sSelectionFlags & CAM_MODE_MARIO_SELECTED) ? CAM_SELECTION_MARIO : CAM_SELECTION_FIXED);
}
...
s32 set_cam_angle(s32 mode) {
    ...
    return ((sSelectionFlags & CAM_MODE_MARIO_ACTIVE) ? CAM_ANGLE_MARIO : CAM_ANGLE_LAKITU);
}
...
void set_handheld_shake(u8 mode) {
    switch (mode) {
        ...
        case HAND_CAM_SHAKE_STAR_DANCE: sHandheldShakeMag =  0x400; sHandheldShakeInc = 0.07f; break;
        default:                        sHandheldShakeMag =    0x0; sHandheldShakeInc = 0.0f;         // Slightly steadier than HANG_OWL and UNUSED
    }
}
...
void shake_camera_handheld(Vec3f pos, Vec3f focus) {
    ...
    if (sHandheldShakeMag == 0) {
        ...
        for ((i = 0); (i < 4); (i++)) vec3_copy(shakeSpline[i], sHandheldShakeSpline[i].point);
        ...
        if (1.0f <= (sHandheldShakeTimer += sHandheldShakeInc)) {
            ...
            // straight line
            for ((i = 0); (i < 3); (i++)) vec3_copy(sHandheldShakeSpline[i].point, sHandheldShakeSpline[i + 1].point);
            ...
            if (sHandheldShakeInc < 0.02f) sHandheldShakeInc = 0.02f;
        }
    }
...
s32 find_c_buttons_pressed(u16 currentState, u16 buttonsPressed, u16 buttonsDown) {
    ...
    if (buttonsPressed & L_CBUTTONS) { currentState |=  L_CBUTTONS; currentState &= ~R_CBUTTONS; }
    if (!(buttonsDown  & L_CBUTTONS))  currentState &= ~L_CBUTTONS;
    if (buttonsPressed & R_CBUTTONS) { currentState |=  R_CBUTTONS; currentState &= ~L_CBUTTONS; }
    if (!(buttonsDown  & R_CBUTTONS))  currentState &= ~R_CBUTTONS;
    if (buttonsPressed & U_CBUTTONS) { currentState |=  U_CBUTTONS; currentState &= ~D_CBUTTONS; }
    if (!(buttonsDown  & U_CBUTTONS))  currentState &= ~U_CBUTTONS;
    if (buttonsPressed & D_CBUTTONS) { currentState |=  D_CBUTTONS; currentState &= ~U_CBUTTONS; }
    if (!(buttonsDown  & D_CBUTTONS))  currentState &= ~D_CBUTTONS;
    return currentState;
}
...
s32 update_camera_hud_status(struct Camera *c) {
    ...
    if (gCameraMovementFlags & CAM_MOVE_ZOOMED_OUT) status |= CAM_STATUS_C_DOWN;
    if (gCameraMovementFlags & CAM_MOVE_C_UP_MODE ) status |= CAM_STATUS_C_UP;
...
Bool32 is_point_within_radius_of_mario_cam_state(f32 x, f32 y, f32 z, f32 maxDist) {
    ...
    register f32 dz = (z - sMarioCamState->pos[2]);
    return ((sqr(dx) + sqr(dy) + sqr(dz)) < (f32)sqr(maxDist));
}
...
Bool32 set_or_approach_s16_symmetric(s16 *current, s16 target, s16 increment) {
    if (sStatusFlags & CAM_FLAG_SMOOTH_MOVEMENT) {
        approach_s16_symmetric_bool(current, target, increment);
    } else {
        *current = target;
    }
...
s32 reduce_by_dist_from_camera(s16 value, f32 maxDist, Vec3f pos) {
    ...
    Vec3f goalD;
    vec3_diff(goalD, gLakituState.goalPos, pos);
...
void set_pitch_shake_from_point(s16 mag, s16 decay, s16 inc, f32 maxDist, Vec3f pos) {
    f32 dist;
    vec3f_get_dist(gLakituState.goalPos, pos, &dist);
    mag = reduce_by_dist_from_camera(mag, maxDist, pos);
 ...
 */
UNUSED void set_yaw_shake_from_point(s16 mag, s16 decay, s16 inc, f32 maxDist, Vec3f pos) {
    f32 dist;
    vec3f_get_dist(gLakituState.goalPos, pos, &dist);
    mag = reduce_by_dist_from_camera(mag, maxDist, pos);
...
/**
 * Add an offset to the camera's yaw, used in levels that are inside a vertical building, like the
 * pyramid or TTC.
 */
s32 offset_yaw_outward_radial(struct Camera *c, Angle areaYaw) {
    Angle yawGoal = DEG(60);
    ...
    switch (gCurrLevelArea) {
        ...
        case AREA_SSL_PYRAMID:
            ...
            yawGoal = (((areaYaw & DEG(-90)) - areaYaw) + DEG(45));
...
void play_camera_buzz_if_cdown(void) {
    if (gPlayer1Controller->buttonPressed & D_CBUTTONS) play_sound_button_change_blocked();
}

void play_camera_buzz_if_cbutton(void) {
    if (gPlayer1Controller->buttonPressed & CBUTTON_MASK) play_sound_button_change_blocked();
}

void play_camera_buzz_if_c_sideways(void) {
    if ((gPlayer1Controller->buttonPressed & L_CBUTTONS) || (gPlayer1Controller->buttonPressed & R_CBUTTONS)) play_sound_button_change_blocked();
}
...
void play_sound_if_cam_switched_to_lakitu_or_mario(void) {
    if (sCameraSoundFlags & CAM_SOUND_MARIO_ACTIVE ) play_sound_rbutton_changed();
    if (sCameraSoundFlags & CAM_SOUND_NORMAL_ACTIVE) play_sound_rbutton_changed();
    ...
    if ((gCameraMovementFlags & CAM_MOVE_ENTERED_ROTATE_SURFACE) || !(gCameraMovementFlags & CAM_MOVE_ROTATE)) {
        ...
        if (gPlayer1Controller->buttonPressed & R_CBUTTONS) {
            if (sModeOffsetYaw > -0x800) {
                ...
                if (c->mode == CAMERA_MODE_RADIAL) {
                    ...
                    if (sModeOffsetYaw > 0x22AA) s2ndRotateFlags |= CAM_MOVE_ROTATE_RIGHT;
                    if (sModeOffsetYaw == DEG(105)) {
                        play_sound_button_change_blocked();
                    } else {
                        play_sound_cbutton_side();
                    }
                } else {
                    if (sModeOffsetYaw == DEG(60)) {
                        play_sound_button_change_blocked();
                    } else {
                        play_sound_cbutton_side();
                    }
        ...
        if (gPlayer1Controller->buttonPressed & L_CBUTTONS) {
            if (sModeOffsetYaw < 0x800) {
                ...
                if (c->mode == CAMERA_MODE_RADIAL) {
                    // if < ~48.7 degrees, we're rotating for the second time.
                    if (sModeOffsetYaw < -0x22AA) s2ndRotateFlags |= CAM_MOVE_ROTATE_LEFT;
                    if (sModeOffsetYaw == DEG(-105)) {
                        play_sound_button_change_blocked();
                    } else {
                        play_sound_cbutton_side();
...
void handle_c_button_movement(struct Camera *c) {
    ...
    if (gPlayer1Controller->buttonPressed & U_CBUTTONS) {
        if ((c->mode != CAMERA_MODE_FIXED) && (gCameraMovementFlags & CAM_MOVE_ZOOMED_OUT)) {
            ...
            set_mode_c_up(c);
            sZoomAmount = (sZeroZoomDist > gCameraZoomDist) ? -gCameraZoomDist : gCameraZoomDist;
        }
    }
    if (c->mode != CAMERA_MODE_FIXED) {
        ...
        if (gPlayer1Controller->buttonPressed & R_CBUTTONS) {
            if (gCameraMovementFlags &   CAM_MOVE_ROTATE_LEFT) {
                ...
                if (sCSideButtonYaw == 0x0) play_sound_cbutton_side();
...
s32 determine_dance_cutscene(UNUSED struct Camera *c) {
    u8 cutscene      = 0;
    u8 cutsceneIndex = 0;
    u8 starIndex     = ((gLastCompletedStarNum - 1) >> 1);
    u8 courseIndex   = gCurrCourseNum;
    if (starIndex > 3) starIndex = 0;
    if (courseIndex > COURSE_MAX) courseIndex = COURSE_NONE;
...
u8 get_cutscene_from_mario_status(struct Camera *c) {
    ...
    if (cutscene == CUTSCENE_NONE) {
        ...
        if (sMarioCamState->cameraEvent == CAM_EVENT_DOOR_WARP)     cutscene = CUTSCENE_DOOR_WARP;
        if (sMarioCamState->cameraEvent == CAM_EVENT_CANNON)        cutscene = CUTSCENE_ENTER_CANNON;
        if (SURFACE_IS_PAINTING_WARP(sMarioGeometry.currFloorType)) cutscene = CUTSCENE_ENTER_PAINTING;
...
void warp_camera(Vec3f displacement) {
    ...
    struct LinearTransitionPoint *end   = &sModeInfo.transitionEnd;
    gCurrLevelArea                      = ((gCurrLevelNum * 16) + gCurrentArea->index);
    vec3_add(gLakituState.curPos,    displacement);
    vec3_add(gLakituState.curFocus,  displacement);
    vec3_add(gLakituState.goalPos,   displacement);
    vec3_add(gLakituState.goalFocus, displacement);
    marioStates->waterLevel       += displacement[1];
    vec3_add(start->focus,           displacement);
    vec3_add(start->pos,             displacement);
    vec3_add(end->focus,             displacement);
    vec3_add(end->pos,               displacement);
}
...
void approach_camera_height(struct Camera *c, f32 goal, f32 inc) {
    if (sStatusFlags & CAM_FLAG_SMOOTH_MOVEMENT) {
        if (c->pos[1] < goal) {
            if ((c->pos[1] += inc) > goal) c->pos[1] = goal;
        } else {
            if ((c->pos[1] -= inc) < goal) c->pos[1] = goal;
        }
    } else {
 ...
 */
void set_focus_rel_mario(struct Camera *c, f32 leftRight, f32 yOff, f32 forwBack, Angle yawOff) {
    Angle yaw;
    f32 focFloorYOff;
...
Angle next_lakitu_state(Vec3f newPos, Vec3f newFoc, Vec3f curPos, Vec3f curFoc, Vec3f oldPos, Vec3f oldFoc, Angle yaw) {
    Angle yawVelocity, pitchVelocity;
    f32 distVelocity;
    f32 goalDist;
    ...
    vec3_copy(newPos, curPos);
    vec3_copy(newFoc, curFoc);
 ...
 */
Bool32 set_camera_mode_fixed(struct Camera *c, s16 x, s16 y, s16 z) {
    Bool32 basePosSet = FALSE;
    // Convert to f32
    Vec3f pos;
    vec3_set(pos, x, y, z);
    ...
    if (c->mode      !=  CAMERA_MODE_FIXED) {
        ...
        vec3_set(c->pos, sFixedModeBasePosition[0], sMarioCamState->pos[1], sFixedModeBasePosition[2]);
    }
    return basePosSet;
}
...
void set_camera_mode_boss_fight(struct Camera *c) {
    if (c->mode != CAMERA_MODE_BOSS_FIGHT) {
        ...
        sModeOffsetYaw = (c->nextYaw - DEG(45));
    }
}
...
void set_camera_mode_radial(struct Camera *c, s16 transitionTime) {
    ...
    if (c->mode != CAMERA_MODE_RADIAL) {
        ...
        if (((yawToMario - yawToCam) + DEG(90)) > 0) {
...
void parallel_tracking_init(struct Camera *c, struct ParallelTrackingPoint *path) {
    if (c->mode != CAMERA_MODE_PARALLEL_TRACKING) {
        sParTrackPath            = path;
        sParTrackIndex           = 0;
        sParTrackTransOff.pos[0] = 0.0f;
        sParTrackTransOff.pos[1] = 0.0f;
        sParTrackTransOff.pos[2] = 0.0f;
...
void set_fixed_cam_axis_sa_lobby(UNUSED s16 preset) {
    switch (gCurrLevelArea) {
        case AREA_SA:           vec3_set(sFixedModeBasePosition,  646.0f, 143.0f, -1513.0f); break;
        case AREA_CASTLE_LOBBY: vec3_set(sFixedModeBasePosition, -577.0f, 143.0f,  1443.0f); break;
    }
}
...
void check_blocking_area_processing(const u8 *mode) {
    if ((sMarioCamState->action & ACT_FLAG_METAL_WATER)
     ...
     || (*mode == CAMERA_MODE_WATER_SURFACE)) sStatusFlags |= CAM_FLAG_BLOCK_AREA_PROCESSING;
    if ((gCurrLevelNum == LEVEL_DDD)
     || (gCurrLevelNum == LEVEL_WDW)
     || (gCurrLevelNum == LEVEL_COTMC)) sStatusFlags &= ~CAM_FLAG_BLOCK_AREA_PROCESSING;
    if ((*mode == CAMERA_MODE_BEHIND_MARIO && !(sMarioCamState->action & (ACT_FLAG_SWIMMING | ACT_FLAG_METAL_WATER))) || *mode == CAMERA_MODE_INSIDE_CANNON) sStatusFlags |= CAM_FLAG_BLOCK_AREA_PROCESSING;
}

void cam_rr_exit_building_side(struct Camera *c) {
    set_camera_mode_8_directions(c);
    s8DirModeBaseYaw = DEG(90);
}
...
void cam_rr_enter_building_window(struct Camera *c) {
    if (c->mode != CAMERA_MODE_FIXED) set_camera_mode_fixed(c, -2974, 478, -3975);
}

void cam_rr_enter_building(struct Camera *c) {
    if (c->mode != CAMERA_MODE_FIXED) set_camera_mode_fixed(c, -2953, 798, -3943);
    // Prevent the camera from being above the roof
    if (c->pos[1] > 6043.0f) c->pos[1] = 6043.0f;
}
...
void cam_thi_move_cam_through_tunnel(UNUSED struct Camera *c) {
    if (sModeOffsetYaw < DEG(60)) sModeOffsetYaw = DEG(60);
}
...
void cam_thi_look_through_tunnel(UNUSED struct Camera *c) {
    if (sModeOffsetYaw > DEG(82.5)) sModeOffsetYaw = DEG(82.5);
}
...
void cam_castle_lobby_entrance(UNUSED struct Camera *c) {
    vec3_set(sCastleEntranceOffset, (-813.0f - sFixedModeBasePosition[0]),
                                    ( 378.0f - sFixedModeBasePosition[1]),
                                    (1103.0f - sFixedModeBasePosition[2]));
}
...
void cam_castle_look_upstairs(struct Camera *c) {
    ...
    if ((sMarioGeometry.currFloorHeight > 1229.0f) && (sCSideButtonYaw == 0) && (find_floor(c->pos[0], c->pos[1], c->pos[2], &floor) < 1229.0f)) vec3_set(c->pos, -227.0f, 1425.0f, 1533.0f);
}
...
void cam_castle_basement_look_downstairs(struct Camera *c) {
    ...
    if ((sCSideButtonYaw == 0x0) && (find_floor(c->pos[0], c->pos[1], c->pos[2], &floor) > -110.0f)) vec3_set(c->pos, -980.0f, 249.0f, -1398.0f);
}
...
void cam_bbh_room_5_library_to_hidden_transition(struct Camera *c) {
    if (set_camera_mode_fixed(c, -2172, 200, 675)) transition_next_state(c, 20);
}

void cam_bbh_room_5_hidden_to_library_transition(struct Camera *c) {
    if (set_camera_mode_fixed(c, -1542, 320, -307)) transition_next_state(c, 20);
}
...
void cam_bbh_room_7_mr_i_to_coffins_transition(struct Camera *c) {
    if (set_camera_mode_fixed(c, 1371, 360, -1302)) transition_next_state(c, 20);
}

void cam_bbh_room_7_coffins_to_mr_i_transition(struct Camera *c) {
    if (set_camera_mode_fixed(c, 2115, 260, -772)) transition_next_state(c, 20);
}
...
void cam_bbh_room_2_library_to_trapdoor_transition(struct Camera *c) {
    if (set_camera_mode_fixed(c, 3493, 440, 617)) transition_next_state(c, 20);
}
...
void cam_bbh_room_2_trapdoor_transition(struct Camera *c) {
    if (set_camera_mode_fixed(c, 3502, 440, 1217)) transition_next_state(c, 20);
}
...
void cam_bbh_room_9_attic_transition(struct Camera *c) {
    if (set_camera_mode_fixed(c, -670, 460, 372)) transition_next_state(c, 20);
}

void cam_bbh_room_9_mr_i_transition(struct Camera *c) {
    if (set_camera_mode_fixed(c, 131, 380, -263)) transition_next_state(c, 20);
}
...
u32 surface_type_modes(struct Camera *c) {
    ...
    switch (sMarioGeometry.currFloorType) {
        case SURFACE_CLOSE_CAMERA:        transition_to_camera_mode(c, CAMERA_MODE_CLOSE,     90); modeChanged++; break;
        case SURFACE_CAMERA_FREE_ROAM:    transition_to_camera_mode(c, CAMERA_MODE_FREE_ROAM, 90); modeChanged++; break;
        case SURFACE_NO_CAM_COL_SLIPPERY: transition_to_camera_mode(c, CAMERA_MODE_CLOSE,     90); modeChanged++; break;
    }
    return modeChanged;
}
...
u32 set_mode_if_not_set_by_surface(struct Camera *c, u8 mode) {
    ...
    if ((modeChanged == 0) && (mode != 0)) transition_to_camera_mode(c, mode, 90);
    return modeChanged;
}
...
void surface_type_modes_thi(struct Camera *c) {
    switch (sMarioGeometry.currFloorType) {
        case SURFACE_CLOSE_CAMERA:     // fall through
        case SURFACE_CAMERA_FREE_ROAM: // fall through
        case SURFACE_NO_CAM_COL_SLIPPERY: if (c->mode != CAMERA_MODE_CLOSE) transition_to_camera_mode(c, CAMERA_MODE_FREE_ROAM,    90); break;
        case SURFACE_CAMERA_8_DIR:                                          transition_to_camera_mode(c, CAMERA_MODE_8_DIRECTIONS, 90); break;
        default:                                                            transition_to_camera_mode(c, CAMERA_MODE_RADIAL,       90);
    }
}
...
s32 camera_course_processing(struct Camera *c) {
    ...
    if (sCameraTriggers[level] != NULL) {
        ...
        while (sCameraTriggers[level][b].event != NULL) {
            ...
            if (sCameraTriggers[level][b].area == area) {
                ...
                vec3_copy(center, sCameraTriggers[level][b].center);
                vec3_copy(bounds, sCameraTriggers[level][b].bounds);
            ...
            if (((sCameraTriggers[level])[b].area == -1) && !insideBounds && !(sStatusFlags & CAM_FLAG_BLOCK_AREA_PROCESSING)) sCameraTriggers[level][b].event(c);
            b++;
        }
    }
    ...
    if (!(sStatusFlags & CAM_FLAG_BLOCK_AREA_PROCESSING)) {
        switch (gCurrLevelArea) {
                ...
                if (sMarioCamState->action == ACT_RIDING_HOOT) {
                    ...
                    switch (sMarioGeometry.currFloorType) {
                        ...
                        case SURFACE_BOSS_FIGHT_CAMERA:
                            ...
                            break;
                        default: set_camera_mode_radial(c, 60);
                    }
                }
                break;
            case AREA_BBH:
            ...
            case AREA_THI_HUGE:                                                                   break;
            case AREA_THI_TINY:    surface_type_modes_thi(        c                            ); break;
            case AREA_TTC:         set_mode_if_not_set_by_surface(c, CAMERA_MODE_OUTWARD_RADIAL); break;
            case AREA_BOB:
                ...
                break;
            case AREA_WDW_MAIN: if (sMarioGeometry.currFloorType == SURFACE_INSTANT_WARP_1B) c->defMode = CAMERA_MODE_RADIAL; break;
            case AREA_WDW_TOWN: if (sMarioGeometry.currFloorType == SURFACE_INSTANT_WARP_1C) c->defMode = CAMERA_MODE_CLOSE;  break;
            case AREA_DDD_WHIRLPOOL: break;
            case AREA_DDD_SUB:
                if ((c->mode != CAMERA_MODE_BEHIND_MARIO) && (c->mode != CAMERA_MODE_WATER_SURFACE)) {
                    if (((sMarioCamState->action & ACT_FLAG_ON_POLE) != 0) || (sMarioGeometry.currFloorHeight > 800.0f)) {
                        transition_to_camera_mode(c, CAMERA_MODE_8_DIRECTIONS, 60);
                    } else {
                        if (sMarioCamState->pos[1] < 800.0f) transition_to_camera_mode(c, CAMERA_MODE_FREE_ROAM, 60);
                    }
                }
                break;
        }
...
s32 cutscene_object_with_dialog(u8 cutscene, struct Object *obj, DialogID dialogID) {
    ...
    if ((gCamera->cutscene == CUTSCENE_NONE) && (sObjectCutscene == CUTSCENE_NONE)) {
        if (gRecentCutscene != cutscene) {
            ...
            sCutsceneDialogID = ((dialogID != DIALOG_NONE) ? dialogID : DIALOG_001);
        } else {
...
void update_camera_yaw(struct Camera *c) {
    c->yaw = c->nextYaw = vec3_yaw(c->focus, c->pos);
}
...
void stop_cutscene_and_retrieve_stored_info(struct Camera *c) {
    ...
    c->cutscene    = CUTSCENE_NONE;
    vec3_copy(c->focus, sCameraStoreCutscene.focus);
    vec3_copy(c->pos,   sCameraStoreCutscene.pos  );
}
...
void init_spline_point(struct CutsceneSplinePoint *splinePoint, s8 index, u8 speed, Vec3s point) {
    ...
    vec3_copy(splinePoint->point, point);
}
 ...
 */
void player2_rotate_cam(struct Camera *c, Angle minPitch, Angle maxPitch, Angle minYaw, Angle maxYaw) {
    f32 distCamToFocus;
    Angle pitch, yaw, pitchCap;
    // Change the camera rotation to match the 2nd player's stick
    approach_s16_asymptotic_bool(&sCreditsPlayer2Yaw,   -(Angle)(gPlayer2Controller->stickX * 250.0f), 0x4);
    approach_s16_asymptotic_bool(&sCreditsPlayer2Pitch, -(Angle)(gPlayer2Controller->stickY * 265.0f), 0x4);
    vec3f_get_dist_and_angle(c->pos, c->focus, &distCamToFocus, &pitch, &yaw);
    pitchCap = ( 0x3800 - pitch); if (pitchCap < 0x0) pitchCap = 0x0;
    if (maxPitch > pitchCap) maxPitch = pitchCap;
    pitchCap = (-0x3800 - pitch);
    if (pitchCap >      0x0) pitchCap = 0x0;
    if (minPitch < pitchCap) minPitch = pitchCap;
    if (sCreditsPlayer2Pitch > maxPitch) sCreditsPlayer2Pitch = maxPitch;
    if (sCreditsPlayer2Pitch < minPitch) sCreditsPlayer2Pitch = minPitch;
    if (sCreditsPlayer2Yaw   > maxYaw  ) sCreditsPlayer2Yaw   = maxYaw;
    if (sCreditsPlayer2Yaw   < minYaw  ) sCreditsPlayer2Yaw   = minYaw;
...
void store_info_cannon(struct Camera *c) {
    vec3_copy(sCameraStoreCutscene.pos,   c->pos  );
    vec3_copy(sCameraStoreCutscene.focus, c->focus);
 ...
 */
void pan_camera(struct Camera *c, Angle incPitch, Angle incYaw) {
    f32 distCamToFocus;
    Angle pitch, yaw;
    vec3f_get_dist_and_angle(c->pos, c->focus, &distCamToFocus, &pitch, &yaw);
    pitch += incPitch;
 ...
 */
void rotate_and_move_vec3f(Vec3f to, Vec3f from, f32 incDist, Angle incPitch, Angle incYaw) {
    f32 dist;
    Angle pitch, yaw;
...
void set_flag_post_door(struct Camera *c) {
    sStatusFlags |= CAM_FLAG_BEHIND_MARIO_POST_DOOR;
    sCameraYawAfterDoorCutscene = vec3_yaw(c->focus, c->pos);
}
...
void cutscene_ending_mario_fall_start(struct Camera *c) {
    vec3_set(c->focus, -26.0f,    0.0f, -137.0f);
    vec3_set(c->pos,   165.0f, 4725.0f,  324.0f);
}
...
void cutscene_ending_mario_fall_focus_mario(struct Camera *c) {
    Vec3f offset = { 0.0f, 80.0f, (absf(sMarioCamState->pos[1] - c->pos[1]) * -0.1f) };
...
void cutscene_ending_mario_land_closeup(struct Camera *c) {
    vec3_set(c->focus, 85.0f, 826.0f,  250.0f);
    vec3_set(c->pos,  -51.0f, 988.0f, -202.0f);
    player2_rotate_cam(c, -0x2000, 0x2000, -0x2000, 0x2000);
}
...
void cutscene_ending_mario_land(struct Camera *c) {
    vec3_set(c->focus, sEndingFlyToWindowFocus[0].point[0], (sEndingFlyToWindowFocus[0].point[1] + 80.0f), sEndingFlyToWindowFocus[0].point[2]);
    vec3_set(c->pos,     sEndingFlyToWindowPos[0].point[0],    sEndingFlyToWindowPos[0].point[1],           (sEndingFlyToWindowPos[0].point[2] + 150.0f));
...
void cutscene_ending_peach_appear_closeup(struct Camera *c) {
    vec3_set(c->pos, 179.0f, 2463.0f, -1216.0f);
    c->pos[1] = (gCutsceneFocus->oPosY + 35.0f);
    vec3_copy_y_off(c->focus, &gCutsceneFocus->oPosVec, CAMERA_Y_OFFSET);
}
...
void cutscene_ending_peach_descent_lower_focus(UNUSED struct Camera *c) {
    approach_f32_symmetric_bool(&(sCutsceneVars[2].point[1]), 90.0f, 0.5f);
}
...
void cutscene_ending_peach_descends(struct Camera *c) {
    ...
    vec3_copy_y_off(c->focus, &gCutsceneFocus->oPosVec, sCutsceneVars[2].point[1]);
    player2_rotate_cam(c, -DEG(45), DEG(45), -DEG(45), DEG(45));
}
...
#endif
    vec3_set(c->pos, -163.0f, 978.0f, -1082.0f);
    player2_rotate_cam(c, -0x800, 0x2000, -0x2000, 0x2000);
}
...
void cutscene_ending_dialog(struct Camera *c) {
    vec3_set(c->focus, 11.0f, 983.0f, -1273.0f);
    vec3_set(c->pos, -473.0f, 970.0f, -1152.0f);
    player2_rotate_cam(c, -0x800, 0x2000, -0x2000, 0x2000);
}
...
void cutscene_ending_kiss_closeup(struct Camera *c) {
    ...
    vec3_set(c->focus, 350.0f, 1034.0f, -1216.0f);
    vec3_set(c->pos,  -149.0f, 1021.0f, -1216.0f);
}
...
void cutscene_ending_kiss_here_we_go(struct Camera *c) {
    Vec3f pos = { -250.0f,  966.0f, -1111.0f };
    Vec3f foc = {  233.0f, 1068.0f, -1298.0f };
    set_fov_function(CAM_FOV_DEFAULT);
...
void cutscene_ending_look_at_sky(struct Camera *c) {
    ...
    vec3_set(c->pos, 699.0f, 1680.0f, -703.0f);
}
...
void cutscene_grand_star_start(UNUSED struct Camera *c) {
    vec3_set(sCutsceneVars[0].point, 0.0f, 150.0f, -600.0f);
...
void cutscene_grand_star_front_of_mario(struct Camera *c) {
    f32 goalDist, dist;
    Angle goalPitch, goalYaw, pitch, yaw;
...
void cutscene_grand_star_accel_cvar2(UNUSED struct Camera *c) {
    approach_f32_symmetric_bool(&sCutsceneVars[2].point[2], -40.0f, 2.0f);
...
void cutscene_grand_star_approach_mario(struct Camera *c) {
    approach_f32_symmetric_bool(&sCutsceneVars[2].point[2], 0.0f, 2.0f);
...
void cutscene_grand_star_focus_mario(struct Camera *c) {
    Vec3f foc = { sMarioCamState->pos[0], (((sMarioCamState->pos[1] - 307.0f) * 0.5f) + 407.0f), sMarioCamState->pos[2] };
...
void cutscene_grand_star_fly_start(struct Camera *c) {
    vec3_zero(sCutsceneVars[4].point);
    vec3_set(sCutsceneVars[5].point, 0.0f, (c->focus[1] - sMarioCamState->pos[1]), 0.0f);
...
void cutscene_grand_star_fly_move_to_mario(UNUSED struct Camera *c) {
    Vec3f posOff = { -600.0f, 0.0f, -400.0f };
    approach_vec3f_asymptotic(sCutsceneVars[4].point, posOff, 0.05f, 0.05f, 0.05f);
    approach_f32_symmetric_bool(&sCutsceneVars[5].point[1],    0.0f, 2.0f);
    approach_f32_symmetric_bool(&sCutsceneVars[5].point[2], -200.0f, 6.0f);
}
...
void cutscene_grand_star_fly_app_cvars(struct Camera *c) {
    ...
    f32 dist;
    Angle pitch, yaw;
    approach_f32_symmetric_bool(&sCutsceneVars[8].point[2], 90.0f, 2.5f);
    ...
    approach_f32_symmetric_bool(&dist, 0, sCutsceneVars[8].point[2]);
...
void focus_in_front_of_mario(struct Camera *c, f32 dist, f32 speed) {
    ...
    vec3_set(offset, 0.0f, 100.0f, dist);
 ...
 */
void star_dance_bound_yaw(struct Camera *c, Angle absYaw, Angle yawMax) {
    Angle yaw = (vec3_yaw(sMarioCamState->pos, c->pos) - absYaw);
    // Because angles are s16, this checks if yaw is negative
    if (yaw & 0x8000) yaw = -yaw;
    if (yaw > yawMax) {
        c->nextYaw = absYaw;
        c->yaw     = absYaw;
    }
...
void cutscene_dance_closeup_start(struct Camera *c) {
    if ((gLastCompletedStarNum == 4) && (gCurrCourseNum == COURSE_JRB)) star_dance_bound_yaw(c,    0x0, 0x4000);
    if ((gLastCompletedStarNum == 1) && (gCurrCourseNum == COURSE_DDD)) star_dance_bound_yaw(c, 0x8000, 0x5000);
    if ((gLastCompletedStarNum == 5) && (gCurrCourseNum == COURSE_WDW)) star_dance_bound_yaw(c, 0x8000,  0x800);
...
void cutscene_dance_closeup_focus_mario(struct Camera *c) {
    Vec3f marioPos;
    vec3_copy_y_off(marioPos, sMarioCamState->pos, CAMERA_Y_OFFSET);
    approach_vec3f_asymptotic(sCutsceneVars[9].point, marioPos, 0.2f, 0.2f, 0.2f);
    vec3_copy(c->focus, sCutsceneVars[9].point);
}
...
void cutscene_dance_closeup_fly_above(struct Camera *c) {
    ...
    approach_s16_asymptotic_bool(&pitch, goalPitch, 0x10);
...
void cutscene_key_dance_jump_closeup(UNUSED struct Camera *c) {
    vec3_set(sCutsceneVars[8].point,  38.0f, 171.0f, -248.0f);
    vec3_set(sCutsceneVars[7].point, -57.0f,  51.0f,  187.0f);
}
...
void cutscene_key_dance_jump_lower_left(UNUSED struct Camera *c) {
    vec3_set(sCutsceneVars[8].point, -178.0f, 62.0f, -132.0f);
    vec3_set(sCutsceneVars[7].point,  299.0f, 91.0f,   58.0f);
}
...
void cutscene_key_dance_jump_above(UNUSED struct Camera *c) {
    ...
    vec3_set(sCutsceneVars[8].point, 89.0f, 373.0f, -304.0f);
    vec3_set(sCutsceneVars[7].point,  0.0f, 127.0f,    0.0f);
}
...
void cutscene_key_dance_jump_last(UNUSED struct Camera *c) {
    ...
    vec3_set(sCutsceneVars[8].point, 135.0f, 158.0f, -673.0f);
    vec3_set(sCutsceneVars[7].point, -20.0f, 135.0f, -198.0f);
}
...
void cutscene_bowser_arena_set_pos(struct Camera *c) {
    vec3f_set_dist_and_angle(sCutsceneVars[2].point, c->pos,
                             sCutsceneVars[3].point[2],
                             sCutsceneVars[3].angle[0],
                             sCutsceneVars[3].angle[1]);
    vec3_copy(sCutsceneVars[2].point, &gSecondCameraFocus->oPosVec);
}
...
void cutscene_bowser_arena_start(struct Camera *c) {
    ...
    sCutsceneVars[3].angle[1] = (gSecondCameraFocus->oMoveAngleYaw - DEG(45));
    sCutsceneVars[3].angle[0] = 0xD90;
#ifdef FIX_CAMERA_OFFSET_ROTATED
    vec3_set(sCutsceneVars[0].point, 0.0f, 120.0f, 600.0f);
#else
    ...
    vec3_set(sCutsceneVars[0].point, 0.0f, 120.0f, -800.0f);
#endif
    vec3_set(sCutsceneVars[2].angle, gSecondCameraFocus->oMoveAnglePitch, gSecondCameraFocus->oMoveAngleYaw, gSecondCameraFocus->oMoveAngleRoll);
...
void cutscene_bowser_arena_dialog(struct Camera *c) {
    ...
    if (get_dialog_id() == DIALOG_NONE) gCutsceneTimer = CUTSCENE_LOOP;
}
...
void cutscene_bowser_arena_end(struct Camera *c) {
    ...
    transition_next_state(c, 20);
    sStatusFlags                     |= CAM_FLAG_UNUSED_CUTSCENE_ACTIVE;
    sModeOffsetYaw                    = sMarioCamState->faceAngle[1] + DEG(90);
    gSecondCameraFocus->oBowserCamAct = BOWSER_CAM_ACT_END;
}
...
void cutscene_star_spawn_focus_star(struct Camera *c) {
    ...
    if (gCutsceneFocus != NULL) {
        vec3_copy(starPos, &gCutsceneFocus->oPosVec);
...
void cutscene_star_spawn(struct Camera *c) {
    ...
    sStatusFlags |= CAM_FLAG_SMOOTH_MOVEMENT;
    if (gObjCutsceneDone) gCutsceneTimer = CUTSCENE_LOOP; // Set the timer to CUTSCENE_LOOP, which starts the next shot.
}
...
void cutscene_exit_fall_to_castle_grounds_warp(struct Camera *c) {
    //! hardcoded position
    vec3_set(c->pos, 5830.0f, 32.0f, 3985.0f);
}
...
void cutscene_red_coin_star_start(struct Camera *c) {
    vec3_copy(sCutsceneVars[1].point, &gCutsceneFocus->oPosVec);
    store_info_star(c);
...
void cutscene_red_coin_star_warp(struct Camera *c) {
    Angle yaw, posYaw;
    struct Object *focusObj = gCutsceneFocus;
    vec3_copy(sCutsceneVars[1].point, &focusObj->oHomeVec);
    posYaw = vec3_yaw(sCutsceneVars[1].point, c->pos);
    yaw    = vec3_yaw(sCutsceneVars[1].point, sMarioCamState->pos);
    if (abss((yaw - posYaw) + DEG(90)) < abss((yaw - posYaw) - DEG(90))) {
        yaw += DEG(90);
    } else {
        yaw -= DEG(90);
    }
 ...
 */
void cutscene_goto_cvar_pos(struct Camera *c, f32 goalDist, Angle goalPitch, Angle rotPitch, Angle rotYaw) {
    f32 nextDist;
    Angle nextPitch, nextYaw;
    // The next 2 polar coord points are only used in CUTSCENE_PREPARE_CANNON
    f32 cannonDist;
    Angle cannonPitch, cannonYaw;
    f32 curDist;
    Angle curPitch, curYaw;
    ...
    vec3_copy(c->focus,      sCutsceneVars[0].point);
    ...
    if (nextPitch < -0x3000) nextPitch = -0x3000;
    if (nextPitch >  0x3000) nextPitch =  0x3000;
...
void cutscene_prepare_cannon_start(struct Camera *c) {
    ...
    vec3_copy(sCutsceneVars[3].point, &gCutsceneFocus->oPosVec);
...
void cannon_approach_prev(f32 *value, f32 target) {
    f32 inc = (target - *value);
    inc = (ABSF(inc) / sCutsceneVars[2].point[0]);
    approach_f32_symmetric_bool(value, target, inc);
}
...
void cutscene_prepare_cannon_fly_back(struct Camera *c) {
    ...
    if (sCutsceneVars[2].point[0] > 1.0f) sCutsceneVars[2].point[0] -= 1.0f;
}
...
void cutscene_death_standing_start(struct Camera *c) {
    vec3_copy(sCutsceneVars[0].point, c->focus);
    vec3_copy(sCutsceneVars[3].point, sMarioCamState->pos);
...
void cutscene_quicksand_death_goto_mario(struct Camera *c) {
    ...
    if (c->cutscene == CUTSCENE_WATER_DEATH) water_death_move_to_mario_side(c);
}
...
void cutscene_enter_pool_start(struct Camera *c) {
    vec3_copy(sCutsceneVars[3].point, sMarioCamState->pos);
    if (gCurrLevelNum == LEVEL_CASTLE) vec3_set(sCutsceneVars[3].point, 2485.0f, -1589.0f, -2659.0f); // entering HMC
    if (gCurrLevelNum == LEVEL_HMC   ) vec3_set(sCutsceneVars[3].point, 3350.0f, -4589.0f,  4800.0f); // entering CotMC
    vec3_copy(sCutsceneVars[0].point, c->focus);
}
...
void cutscene_pyramid_top_explode_warp(struct Camera *c) {
    ...
    set_fov_function(CAM_FOV_DEFAULT);
    sFOVState.fov = 45.0f;
    vec3_copy(               sCutsceneVars[4].point, c->pos);
    vec3_copy(               sCutsceneVars[5].point, c->focus);
    vec3_copy(c->focus,      sCutsceneVars[3].point);
...
void cutscene_pyramid_top_explode_warp_back(struct Camera *c) {
    vec3_copy(c->pos,   sCutsceneVars[4].point);
    vec3_copy(c->focus, sCutsceneVars[5].point);
    set_environmental_camera_shake(SHAKE_ENV_BOWSER_JUMP);
}
...
void cutscene_enter_pyramid_top(struct Camera *c) {
    ...
    if (sMarioCamState->pos[1] > 1250.0f) cutscene_exit_to_castle_grounds_end(c);
}
...
void cutscene_dialog_start(struct Camera *c) {
    ...
    vec3_copy(sCutsceneVars[8].point, sMarioCamState->pos);
    sCutsceneVars[8].point[1] += CAMERA_Y_OFFSET;
    // Store gCutsceneFocus's position and yaw
    vec3_copy(sCutsceneVars[9].point, &gCutsceneFocus->oPosVec);
    sCutsceneVars[9].point[1] += (gCutsceneFocus->hitboxHeight + 200.0f);
    sCutsceneVars[9].angle[1] = vec3_yaw(sCutsceneVars[8].point, sCutsceneVars[9].point);
    if ((vec3_yaw(sMarioCamState->pos, gLakituState.curPos) - sCutsceneVars[9].angle[1]) & DEG(180)) {
        sCutsceneVars[9].angle[1] -= DEG(135);
    } else {
        sCutsceneVars[9].angle[1] += DEG(135);
    }
}
...
void cutscene_dialog_move_mario_shoulder(struct Camera *c) {
    ...
    focus[1] += ((sCutsceneVars[9].point[1] - focus[1]) * 0.1f);
    approach_vec3f_asymptotic(c->focus, focus, 0.2f, 0.2f, 0.2f);
    vec3_copy(pos, c->pos);
    ...
    pos[1] = (sCutsceneVars[8].point[1] + (sins(pitch) * 100.0f));
...
void cutscene_dialog(struct Camera *c) {
    ...
    sStatusFlags |= CAM_FLAG_SMOOTH_MOVEMENT;
    if (gDialogResponse != DIALOG_RESPONSE_NONE) sCutsceneDialogResponse = gDialogResponse;
    if ((get_dialog_id() == DIALOG_NONE) && (sCutsceneDialogResponse != 0)) {
        if (c->cutscene != CUTSCENE_RACE_DIALOG) sCutsceneDialogResponse = DIALOG_RESPONSE_NOT_DEFINED;
...
void cutscene_exit_succ_start(UNUSED struct Camera *c) {
    vec3_copy(sCutsceneVars[7].point, sMarioCamState->pos);
    vec3_copy(sCutsceneVars[7].angle, sMarioCamState->faceAngle);
    vec3_set(sCutsceneVars[6].point,   6.0f, 363.0f, 543.0f);
    vec3_set(sCutsceneVars[5].point, 137.0f, 226.0f, 995.0f);
}
...
void cutscene_non_painting_set_cam_pos(struct Camera *c) {
    struct Surface *floor;
    switch (gPrevLevel) {
        case LEVEL_HMC:   vec3_set(c->pos,  3465.0f, -1008.0f, -2961.0f); break;
        case LEVEL_COTMC: vec3_set(c->pos,  3465.0f, -1008.0f, -2961.0f); break;
        case LEVEL_RR:    vec3_set(c->pos, -3741.0f,  3151.0f,  6065.0f); break;
        case LEVEL_WMOTR: vec3_set(c->pos,  1972.0f,  3230.0f,  5891.0f); break;
        default:
...
void cutscene_non_painting_end(struct Camera *c) {
    c->cutscene   = CUTSCENE_NONE;
    c->mode       = ((c->defMode == CAMERA_MODE_CLOSE) ? CAMERA_MODE_CLOSE : CAMERA_MODE_FREE_ROAM);
    sStatusFlags |= CAM_FLAG_UNUSED_CUTSCENE_ACTIVE;
    sStatusFlags |= CAM_FLAG_SMOOTH_MOVEMENT;
...
void cutscene_exit_non_painting_succ_override_cvar(UNUSED struct Camera *c) {
    vec3_set(sCutsceneVars[5].point, 137.0f, 246.0f, 1115.0f);
}
...
void cutscene_non_painting_death_start(UNUSED struct Camera *c) {
    vec3_copy(sCutsceneVars[7].point, sMarioCamState->pos);
    vec3_copy(sCutsceneVars[7].angle, sMarioCamState->faceAngle);
    vec3_set( sCutsceneVars[6].point, -42.0f, 350.0f,  727.0f);
    // This is always overwritten, except in the unused cutscene_exit_bowser_death()
    vec3_set( sCutsceneVars[5].point, 107.0f, 226.0f, 1187.0f);
}
...
void cutscene_non_painting_death_override_offset(UNUSED struct Camera *c) {
    switch (gPrevLevel) {
        case LEVEL_HMC:   vec3_set(sCutsceneVars[5].point, 187.0f, 369.0f, -197.0f); break;
        case LEVEL_COTMC: vec3_set(sCutsceneVars[5].point, 187.0f, 369.0f, -197.0f); break;
        default:          vec3_set(sCutsceneVars[5].point, 107.0f, 246.0f, 1307.0f); break;
    }
}
...
void cutscene_cap_switch_press_start(struct Camera *c) {
    store_info_star(c);
    Angle yaw = vec3_yaw(sMarioCamState->pos, c->pos);
...
void cutscene_cap_switch_press_lower_cam(struct Camera *c) {
    rotate_and_move_vec3f(c->pos, sMarioCamState->pos, 0x0, -0x20, 0x0);
}
...
#ifdef FIX_CAMERA_OFFSET_ROTATED
    Vec3f   posOff = { -206.0f, 108.0f, -234.0f};
    Vec3f focusOff = {   48.0f, 104.0f,  193.0f};
#else
    Vec3f   posOff = { -206.0f, 108.0f,  234.0f};
    Vec3f focusOff = {   48.0f, 104.0f, -193.0f};
#endif
    vec3_copy(    sCutsceneVars[0].point, c->pos  );
    vec3_copy(    sCutsceneVars[1].point, c->focus);
...
s32 intro_peach_move_camera_start_to_pipe(struct Camera *c, struct CutsceneSplinePoint positionSpline[], struct CutsceneSplinePoint focusSpline[]) {
    ...
    vec3_set(     offset, -1328.0f, 260.0f, 4664.0f);
    vec3_add(c->focus, offset);
    vec3_add(c->pos,   offset);
...
void cutscene_intro_peach_mario_appears(struct Camera *c) {
    ...
    approach_f32_asymptotic_bool(&sCutsceneVars[1].point[1], (80.0f + sMarioGeometry.currFloorHeight + ((sMarioCamState->pos[1] - sMarioGeometry.currFloorHeight) * 1.1f)), 0.4f);
    // Make the camera look up as Mario jumps out of the pipe
    if (c->focus[1] < sCutsceneVars[1].point[1]) c->focus[1] = sCutsceneVars[1].point[1];
    sStatusFlags |= CAM_FLAG_UNUSED_CUTSCENE_ACTIVE;
}
...
void cutscene_intro_peach_letter(struct Camera *c) {
    ...
    if ((gCutsceneTimer > 120) && (get_dialog_id() == DIALOG_NONE)) gCutsceneTimer = CUTSCENE_LOOP;
    clamp_pitch(c->pos, c->focus, 0x3B00, -0x3B00);
}
...
void cutscene_credits(struct Camera *c) {
    ...
    player2_rotate_cam(c, -DEG(45), DEG(45), -DEG(90), DEG(90));
}
...
void cutscene_sliding_doors_open_set_cvars(UNUSED struct Camera *c) {
    vec3_copy(sCutsceneVars[1].point, sMarioCamState->pos);
    vec3_copy(sCutsceneVars[0].angle, sMarioCamState->faceAngle);
#ifdef FIX_CAMERA_OFFSET_ROTATED
    vec3_set( sCutsceneVars[0].point, 80.0f, 325.0f, -200.0f);
#else
    vec3_set( sCutsceneVars[0].point, 80.0f, 325.0f, 200.0f);
#endif
}
...
void cutscene_sliding_doors_go_under_doorway(UNUSED struct Camera *c) {
    approach_f32_symmetric_bool(&sCutsceneVars[0].point[1], 75.0f, 10.0f);
}
...
void cutscene_enter_painting(struct Camera *c) {
    ...
    if (gRipplingPainting != NULL) {
        vec3_set(paintingAngle, 0x0, (s32)((gRipplingPainting->yaw / 360.0f) * 65536.0f), 0x0); // convert degrees to IAU
        vec3_set(focusOffset, (gRipplingPainting->size / 2), focusOffset[0], 0.0f);
        vec3_copy(paintingPos, gRipplingPainting->pos);
...
void cutscene_exit_painting_start(struct Camera *c) {
    ...
    f32 floorHeight;
#ifdef FIX_CAMERA_OFFSET_ROTATED
    vec3_set(sCutsceneVars[2].point, 258.0f, -352.0f, -1189.0f);
    vec3_set(sCutsceneVars[1].point,  65.0f, -155.0f,  -444.0f);
#else
    vec3_set(sCutsceneVars[2].point, 258.0f, -352.0f, 1189.0f);
    vec3_set(sCutsceneVars[1].point,  65.0f, -155.0f,  444.0f);
#endif
    ...
    if ((floorHeight != FLOOR_LOWER_LIMIT) && (c->pos[1] < (floorHeight += 60.0f))) c->pos[1] = floorHeight;
}
...
void cutscene_exit_painting_move_to_floor(struct Camera *c) {
    struct Surface *floor;
    Vec3f floorHeight;
    vec3_copy(floorHeight, sMarioCamState->pos);
...
void cutscene_exit_painting(struct Camera *c) {
    ...
    if (gPrevLevel == LEVEL_TTM) vec3_set(c->pos, -296.0f, 1261.0f, 3521.0f);
    update_camera_yaw(c);
}
...
void cutscene_unused_exit_start(struct Camera *c) {
    Vec3f offset;
    Vec3s marioAngle;
    vec3_set(offset, 200.0f, 300.0f, 200.0f);
    vec3_set(marioAngle, 0x0, sMarioCamState->faceAngle[1], 0x0);
...
void cutscene_unused_exit_focus_mario(struct Camera *c) {
    Vec3f focus;
    vec3_copy_y_off(focus, sMarioCamState->pos, CAMERA_Y_OFFSET);
    set_focus_rel_mario(c, 0.0f, CAMERA_Y_OFFSET, 0.0f, 0);
...
void cutscene_enter_cannon_raise(struct Camera *c) {
    ...
    if ((cannonObj = sMarioCamState->usedObj) != NULL) {
        sCutsceneVars[0].point[1] = cannonObj->oPosY;
        vec3_copy(cannonAngle, &cannonObj->oMoveAngleVec);
        vec3_copy(c->focus, &cannonObj->oPosVec);
        vec3_set(cannonFocus, 0.0f, 100.0f, 0.0f);
        offset_rotated(c->focus, c->focus, cannonFocus, cannonAngle);
    }
    floorHeight = (find_floor(c->pos[0], (c->pos[1] + 500.0f), c->pos[2], &floor) + 100.0f);
    if (c->pos[1] < floorHeight) c->pos[1] = floorHeight;
}
...
void cutscene_enter_cannon_start(struct Camera *c) {
    ...
    if ((cannonObj = sMarioCamState->usedObj) != NULL) {
        vec3_copy(sCutsceneVars[0].point, &cannonObj->oPosVec      );
        vec3_copy(sCutsceneVars[0].angle, &cannonObj->oMoveAngleVec);
    }
    // Store the camera's polar offset from the cannon in cvar1
    vec3f_get_dist_and_angle(sCutsceneVars[0].point, c->pos,
                             &sCutsceneVars[1].point[2],
...
void cutscene_door_fix_cam(struct Camera *c) {
    vec3_copy(c->pos,   sCutsceneVars[0].point);
    vec3_copy(c->focus, sCutsceneVars[1].point);
}
...
void cutscene_door_move_behind_mario(struct Camera *c) {
    ...
    set_focus_rel_mario(c, 0.0f, CAMERA_Y_OFFSET, 0.0f, 0);
    vec3_set(sCutsceneVars[0].angle, 0x0, (sMarioCamState->faceAngle[1] + doorRotation), 0x0);
#ifdef FIX_CAMERA_OFFSET_ROTATED
    vec3_set(camOffset, 0.0f, CAMERA_Y_OFFSET, -250.0f);
#else
    vec3_set(camOffset, 0.0f, CAMERA_Y_OFFSET, 250.0f);
#endif
...
void cutscene_door_mode(struct Camera *c) {
    reset_pan_distance(c);
    camera_course_processing(c);
    if (c->mode == CAMERA_MODE_FIXED            ) c->nextYaw = update_fixed_camera(            c, c->focus, c->pos);
    if (c->mode == CAMERA_MODE_PARALLEL_TRACKING) c->nextYaw = update_parallel_tracking_camera(c, c->focus, c->pos);
    c->yaw = c->nextYaw;
    // Loop until Mario is no longer using the door
...
#undef CUTSCENE
    if ((cutsceneDuration != 0) && !(gCutsceneTimer & CUTSCENE_STOP)) {
        if (gCutsceneTimer < CUTSCENE_LOOP) gCutsceneTimer++;
    ...
    if ((c->cutscene == CUTSCENE_NONE) && (oldCutscene != CUTSCENE_NONE)) gRecentCutscene = oldCutscene;
}
...
void cutscene_event(CameraEvent event, struct Camera *c, s16 start, s16 end) {
    if ((start <= gCutsceneTimer) && ((end == -1) || (end >= gCutsceneTimer))) event(c);
}
...
void cutscene_spawn_obj(u32 obj, s16 frame) {
    if (frame == gCutsceneTimer) gCutsceneObjSpawn = obj;
}
 ...
 */
void set_fov_shake_from_point(s16 amplitude, s16 decay, s16 shakeSpeed, f32 maxDist, Vec3f pos) {
    amplitude = reduce_by_dist_from_camera(amplitude, maxDist, pos);
    if (amplitude != 0) {
...
void shake_camera_fov(struct GraphNodePerspective *perspective) {
    if (sFOVState.shakeAmplitude != 0.0f) {
        ...
        approach_f32_symmetric_bool(&sFOVState.shakeAmplitude, 0.0f, sFOVState.decay);
...
void approach_fov_20(UNUSED struct MarioState *m) {
    approach_f32_symmetric_bool(&sFOVState.fov, 20.0f, 0.3f);
}
...
void zoom_fov_30(UNUSED struct MarioState *m) {
    approach_f32_asymptotic_bool(&sFOVState.fov, 30.0f, (30.0f - sFOVState.fov) / 60.0f);
}
...
void approach_fov_30(UNUSED struct MarioState *m) {
    approach_f32_symmetric_bool(&sFOVState.fov, 30.0f, 1.0f);
}

void approach_fov_60(UNUSED struct MarioState *m) {
    approach_f32_symmetric_bool(&sFOVState.fov, 60.0f, 1.0f);
}

void approach_fov_45(UNUSED struct MarioState *m) {
    approach_f32_symmetric_bool(&sFOVState.fov, 45.0f, 2.0f);
}

void approach_fov_80(UNUSED struct MarioState *m) {
    approach_f32_symmetric_bool(&sFOVState.fov, 80.0f, 3.5f);
}
...
void cutscene_set_fov_shake_preset(u8 preset) {
    switch (preset) {
        case 1: set_fov_shake(0x100, 0x30, DEG(180)); break;
        case 2: set_fov_shake(0x400, 0x20, DEG( 90)); break;
    }
}
...
void set_fov_shake_from_point_preset(u8 preset, Vec3f pos) {
    switch (preset) {
        case SHAKE_FOV_SMALL:  set_fov_shake_from_point(0x100, 0x30, DEG(180), 3000.0f, pos); break;
        case SHAKE_FOV_MEDIUM: set_fov_shake_from_point(0x200, 0x30, DEG(180), 4000.0f, pos); break;
        case SHAKE_FOV_LARGE:  set_fov_shake_from_point(0x300, 0x30, DEG(180), 6000.0f, pos); break;
        case SHAKE_FOV_UNUSED: set_fov_shake_from_point(0x800, 0x20, DEG( 90), 3000.0f, pos); break;
    }
}
...
void obj_rotate_towards_point(struct Object *obj, Vec3f point, Angle pitchOff, Angle yawOff, Angle pitchDiv, Angle yawDiv) {
    Angle pitch, yaw;
    vec3f_get_angle(&obj->oPosVec, point, &pitch, &yaw);
