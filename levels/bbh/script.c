...
static const LevelScript script_func_local_bbh_flames[] = {
    OBJECT(/*model*/ MODEL_RED_FLAME,                  /*pos*/  2089,  1331, -1126, /*angle*/ 0, 270, 0, /*behParam*/ 0x00000000, /*beh*/ bhvFlame),
    OBJECT(/*model*/ MODEL_RED_FLAME,                  /*pos*/  1331,  1075, -1331, /*angle*/ 0,  90, 0, /*behParam*/ 0x00000000, /*beh*/ bhvFlame),
    OBJECT(/*model*/ MODEL_RED_FLAME,                  /*pos*/  2089,  1331,  -512, /*angle*/ 0, 270, 0, /*behParam*/ 0x00000000, /*beh*/ bhvFlame),
    OBJECT(/*model*/ MODEL_RED_FLAME,                  /*pos*/  -512,   358, -1331, /*angle*/ 0,  90, 0, /*behParam*/ 0x00000000, /*beh*/ bhvFlame),
...
static const LevelScript script_func_local_bbh_platforms[] = {
    ...
    OBJECT(/*model*/ MODEL_BBH_MESH_ELEVATOR,          /*pos*/ -2985,  -205,  5400, /*angle*/ 0, -45, 0, /*behParam*/ 0x00000000, /*beh*/ bhvBbhMeshElevator),
...
static const LevelScript script_func_local_bbh_enemies[] = {
    ...
    OBJECT_WITH_ACTS(/*model*/ MODEL_BOO,                        /*pos*/  3150,   100,   400, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvGhostHuntBoo,           /*acts*/ ACT_1),
    ...
    OBJECT_WITH_ACTS(/*model*/ MODEL_BBH_STAIRCASE_STEP,         /*pos*/   973,  -205,   717, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvHiddenStaircaseStep,    /*acts*/ ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
    OBJECT_WITH_ACTS(/*model*/ MODEL_BBH_STAIRCASE_STEP,         /*pos*/   973,  -410,   917, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvHiddenStaircaseStep,    /*acts*/ ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
    ...
    OBJECT_WITH_ACTS(/*model*/ MODEL_BOO,                        /*pos*/  3150,   100,   400, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvBoo,                    /*acts*/ ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
    ...
    OBJECT_WITH_ACTS(/*model*/ MODEL_NONE,                       /*pos*/   992, -2146,  -908, /*angle*/ 0, -45, 0, /*behParam*/ 0x00030000, /*beh*/ bhvFlamethrower,           /*acts*/ ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
    ...
    OBJECT(          /*model*/ MODEL_NONE,                       /*pos*/ -1331,   890,   200, /*angle*/ 0,  90, 0, /*behParam*/ 0x00000000, /*beh*/ bhvBookendSpawn),
    OBJECT(          /*model*/ MODEL_NONE,                       /*pos*/  -819,   890,  -200, /*angle*/ 0, 270, 0, /*behParam*/ 0x00000000, /*beh*/ bhvBookendSpawn),
    OBJECT(          /*model*/ MODEL_NONE,                       /*pos*/ -1331,   890,  -622, /*angle*/ 0,  90, 0, /*behParam*/ 0x00000000, /*beh*/ bhvBookendSpawn),
    OBJECT(          /*model*/ MODEL_NONE,                       /*pos*/  -819,   890,  -686, /*angle*/ 0, 270, 0, /*behParam*/ 0x00000000, /*beh*/ bhvBookendSpawn),
    ...
    OBJECT(          /*model*/ MODEL_BOOKEND,                    /*pos*/  3072,  1045,   992, /*angle*/ 0, 166, 0, /*behParam*/ 0x00000000, /*beh*/ bhvFlyingBookend),
    OBJECT(          /*model*/ MODEL_BOOKEND,                    /*pos*/ -1411,   218,   922, /*angle*/ 0, 180, 0, /*behParam*/ 0x00000000, /*beh*/ bhvFlyingBookend),
    RETURN(),
};

static const LevelScript script_func_local_bbh_stars[] = {
    OBJECT_WITH_ACTS(/*model*/ MODEL_STAR, /*pos*/ -2030, 1350,  1940, /*angle*/ 0,  0, 0, /*behParam*/ 0x02000000, /*beh*/ bhvStar,              /*acts*/ ALL_ACTS),
    OBJECT_WITH_ACTS(/*model*/ MODEL_NONE, /*pos*/  -205, 1100,  1576, /*angle*/ 0,  0, 0, /*behParam*/ 0x03000000, /*beh*/ bhvHiddenRedCoinStar, /*acts*/ ALL_ACTS),
    OBJECT_WITH_ACTS(/*model*/ MODEL_NONE, /*pos*/   922, 1741,  -332, /*angle*/ 0, 18, 0, /*behParam*/ 0x05010000, /*beh*/ bhvMrI,               /*acts*/ ALL_ACTS),
    RETURN(),
};
...
const LevelScript level_bbh_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_BBH_STAIRCASE_STEP,         geo_bbh_staircase_step),
    LOAD_MODEL_FROM_GEO(MODEL_BBH_TILTING_FLOOR_PLATFORM, geo_bbh_tilting_trap_platform),
    LOAD_MODEL_FROM_GEO(MODEL_BBH_TUMBLING_PLATFORM,      geo_bbh_tumbling_platform_far),
    LOAD_MODEL_FROM_GEO(MODEL_BBH_TUMBLING_PLATFORM_PART, geo_bbh_tumbling_platform_near),
    LOAD_MODEL_FROM_GEO(MODEL_BBH_MOVING_BOOKSHELF,       geo_bbh_moving_bookshelf),
    LOAD_MODEL_FROM_GEO(MODEL_BBH_MESH_ELEVATOR,          geo_bbh_mesh_elevator),
    LOAD_MODEL_FROM_GEO(MODEL_BBH_MERRY_GO_ROUND,         geo_bbh_merry_go_round),
    LOAD_MODEL_FROM_GEO(MODEL_BBH_WOODEN_TOMB,            geo_bbh_coffin),

    AREA(/*index*/ 1, geo_bbh_area_1),
        JUMP_LINK(script_func_local_bbh_flames),
        JUMP_LINK(script_func_local_bbh_platforms),
        JUMP_LINK(script_func_local_bbh_enemies),
        JUMP_LINK(script_func_local_bbh_stars),
    ...
    FREE_LEVEL_POOL(),
    MARIO_POS(/*area*/ 1, /*yaw*/ 180, /*pos*/ 666, -205, 5350),
