...
static const Vtx bbh_seg7_vertex_0701F390[] = {
    {{{   307,   -102,    256}, 0, { 22<<5,   8<<5}, {0x00, 0x81, 0x00, 0xff}}},
    {{{  -307,   -102,    256}, 0, {  8<<5,   8<<5}, {0x00, 0x81, 0x00, 0xff}}},
    {{{  -307,   -102,   -256}, 0, {  8<<5,    624}, {0x00, 0x81, 0x00, 0xff}}},
    {{{   307,   -102,   -256}, 0, { 22<<5,    624}, {0x00, 0x81, 0x00, 0xff}}},
};

// 0x0701F3D0 - 0x0701F4D0
static const Vtx bbh_seg7_vertex_0701F3D0[] = {
    {{{   307,      0,    256}, 0, { 79<<5,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   307,   -102,   -256}, 0, {     0,  31<<5}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   307,      0,   -256}, 0, {     0,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   307,      0,   -256}, 0, {     0,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -307,   -102,   -256}, 0, { 95<<5,  31<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -307,      0,   -256}, 0, { 95<<5,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   307,   -102,   -256}, 0, {     0,  31<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -307,      0,   -256}, 0, {     0,      0}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  -307,   -102,   -256}, 0, {     0,  31<<5}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  -307,   -102,    256}, 0, { 79<<5,  31<<5}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  -307,      0,    256}, 0, { 79<<5,      0}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  -307,      0,    256}, 0, { 95<<5,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -307,   -102,    256}, 0, { 95<<5,  31<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   307,   -102,    256}, 0, {     0,  31<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   307,      0,    256}, 0, {     0,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   307,   -102,    256}, 0, { 79<<5,  31<<5}, {0x7f, 0x00, 0x00, 0xff}}},
};

// 0x0701F4D0 - 0x0701F510
static const Vtx bbh_seg7_vertex_0701F4D0[] = {
    {{{   307,      0,   -256}, 0, {159<<5,  31<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  -307,      0,    256}, 0, {     0,  -5136}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   307,      0,    256}, 0, {     0,  31<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  -307,      0,   -256}, 0, {159<<5,  -5136}, {0x00, 0x7f, 0x00, 0xff}}},
};
