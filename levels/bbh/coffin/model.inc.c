...
static const Vtx bbh_seg7_vertex_07020380[] = {
    {{{    58,      0,      0}, 0, { 31<<5,  15<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   -58,     77,      0}, 0, {     0,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   -58,      0,      0}, 0, {     0,  15<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{    58,     77,      0}, 0, { 31<<5,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   115,      0,   -307}, 0, { 63<<5,  15<<5}, {0x7c, 0x00, 0x17, 0xff}}},
    {{{    58,     77,      0}, 0, {     0,      0}, {0x7c, 0x00, 0x17, 0xff}}},
    {{{    58,      0,      0}, 0, {     0,  15<<5}, {0x7c, 0x00, 0x17, 0xff}}},
    {{{   115,     77,   -307}, 0, { 63<<5,      0}, {0x7c, 0x00, 0x17, 0xff}}},
    {{{    58,      0,   -461}, 0, { 31<<5,  15<<5}, {0x77, 0x00, 0xd4, 0xff}}},
    {{{   115,     77,   -307}, 0, {     0,      0}, {0x77, 0x00, 0xd4, 0xff}}},
    {{{   115,      0,   -307}, 0, {     0,  15<<5}, {0x77, 0x00, 0xd4, 0xff}}},
    {{{    58,     77,   -461}, 0, { 31<<5,      0}, {0x77, 0x00, 0xd4, 0xff}}},
    {{{   -58,      0,   -461}, 0, {     0,  15<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{    58,     77,   -461}, 0, { 31<<5,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{    58,      0,   -461}, 0, { 31<<5,  15<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   -58,     77,   -461}, 0, {     0,      0}, {0x00, 0x00, 0x81, 0xff}}},
};

// 0x07020480 - 0x07020500
static const Vtx bbh_seg7_vertex_07020480[] = {
    {{{  -115,      0,   -307}, 0, {     0,  15<<5}, {0x89, 0x00, 0xd4, 0xff}}},
    {{{  -115,     77,   -307}, 0, {     0,      0}, {0x89, 0x00, 0xd4, 0xff}}},
    {{{   -58,     77,   -461}, 0, { 31<<5,      0}, {0x89, 0x00, 0xd4, 0xff}}},
    {{{   -58,      0,   -461}, 0, { 31<<5,  15<<5}, {0x89, 0x00, 0xd4, 0xff}}},
    {{{   -58,      0,      0}, 0, {     0,  15<<5}, {0x84, 0x00, 0x17, 0xff}}},
    {{{  -115,     77,   -307}, 0, { 63<<5,      0}, {0x84, 0x00, 0x17, 0xff}}},
    {{{  -115,      0,   -307}, 0, { 63<<5,  15<<5}, {0x84, 0x00, 0x17, 0xff}}},
    {{{   -58,     77,      0}, 0, {     0,      0}, {0x84, 0x00, 0x17, 0xff}}},
};

// 0x07020500 - 0x07020560
static const Vtx bbh_seg7_vertex_07020500[] = {
    {{{   -58,      0,   -461}, 0, { 95<<5,  35<<5}, {0x00, 0x81, 0x00, 0xff}}},
    {{{    58,      0,   -461}, 0, { 95<<5,  11<<5}, {0x00, 0x81, 0x00, 0xff}}},
    {{{   115,      0,   -307}, 0, { 63<<5,      0}, {0x00, 0x81, 0x00, 0xff}}},
    {{{  -115,      0,   -307}, 0, { 63<<5,  47<<5}, {0x00, 0x81, 0x00, 0xff}}},
    {{{   -58,      0,      0}, 0, {     0,  35<<5}, {0x00, 0x81, 0x00, 0xff}}},
    {{{    58,      0,      0}, 0, {     0,  11<<5}, {0x00, 0x81, 0x00, 0xff}}},
};

// 0x07020560 - 0x070205C0
static const Vtx bbh_seg7_vertex_07020560[] = {
    {{{   -58,     77,      0}, 0, {  7<<5,  63<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   115,     77,   -307}, 0, { 31<<5,    656}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  -115,     77,   -307}, 0, {     0,    656}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{    58,     77,      0}, 0, { 23<<5,  63<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{    58,     77,   -461}, 0, { 23<<5,      0}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   -58,     77,   -461}, 0, {  7<<5,      0}, {0x00, 0x7f, 0x00, 0xff}}},
};
