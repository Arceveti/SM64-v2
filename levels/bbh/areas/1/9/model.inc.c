...
static const Vtx bbh_seg7_vertex_0700B238[] = {
    {{{  2161,    819,   1638}, 0, {     0,  63<<5}, {0xff, 0x57, 0x00, 0x9a}}},
    {{{  2161,   1485,   1638}, 0, {     0,      0}, {0xff, 0x57, 0x00, 0x9a}}},
    {{{  2161,   1485,   1997}, 0, { 31<<5,      0}, {0xff, 0x57, 0x00, 0x9a}}},
    {{{  2161,   1741,    307}, 0, {     0,  63<<5}, {0xff, 0x57, 0x00, 0x9a}}},
    {{{  2161,   2406,    307}, 0, {     0,      0}, {0xff, 0x57, 0x00, 0x9a}}},
    {{{  2161,   2406,    666}, 0, { 31<<5,      0}, {0xff, 0x57, 0x00, 0x9a}}},
    {{{  2161,   1741,    666}, 0, { 31<<5,  63<<5}, {0xff, 0x57, 0x00, 0x9a}}},
    {{{  2161,    819,    307}, 0, {     0,  63<<5}, {0xff, 0x57, 0x00, 0x9a}}},
    {{{  2161,   1485,    307}, 0, {     0,      0}, {0xff, 0x57, 0x00, 0x9a}}},
    {{{  2161,   1485,    666}, 0, { 31<<5,      0}, {0xff, 0x57, 0x00, 0x9a}}},
    {{{  2161,    819,    666}, 0, { 31<<5,  63<<5}, {0xff, 0x57, 0x00, 0x9a}}},
    {{{  3533,    614,   1137}, 0, { 31<<5,      0}, {0xff, 0x57, 0x00, 0x9a}}},
    {{{  3174,      0,   1137}, 0, {     0,  63<<5}, {0xff, 0x57, 0x00, 0x9a}}},
    {{{  3533,      0,   1137}, 0, { 31<<5,  63<<5}, {0xff, 0x57, 0x00, 0x9a}}},
    {{{  3174,    614,   1137}, 0, {     0,      0}, {0xff, 0x57, 0x00, 0x9a}}},
};

// 0x0700B328 - 0x0700B398
static const Vtx bbh_seg7_vertex_0700B328[] = {
    {{{  2161,      0,   1280}, 0, {     0,  63<<5}, {0xff, 0x57, 0x00, 0x9a}}},
    {{{  2161,    666,   1638}, 0, { 31<<5,      0}, {0xff, 0x57, 0x00, 0x9a}}},
    {{{  2161,      0,   1638}, 0, { 31<<5,  63<<5}, {0xff, 0x57, 0x00, 0x9a}}},
    {{{  2161,    819,   1638}, 0, {     0,  63<<5}, {0xff, 0x57, 0x00, 0x9a}}},
    {{{  2161,   1485,   1997}, 0, { 31<<5,      0}, {0xff, 0x57, 0x00, 0x9a}}},
    {{{  2161,    819,   1997}, 0, { 31<<5,  63<<5}, {0xff, 0x57, 0x00, 0x9a}}},
