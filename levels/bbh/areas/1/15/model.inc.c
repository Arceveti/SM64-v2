...
static const Gfx bbh_seg7_sub_dl_piano_room_window_light[] = {
...
const Gfx bbh_seg7_dl_piano_room_window_light[] = {
    gsDPPipeSync(),
    ...
    gsSPDisplayList(bbh_seg7_sub_dl_piano_room_window_light),
