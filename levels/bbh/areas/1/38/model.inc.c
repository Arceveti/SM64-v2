...
static const Vtx bbh_seg7_vertex_0701ED88[] = {
    {{{  1331,    563,   2161}, 0, { 31<<5,      0}, {0xff, 0x00, 0x00, 0x9a}}},
    {{{   922,    154,   2161}, 0, {     0,  31<<5}, {0xff, 0x00, 0x00, 0x9a}}},
    {{{  1331,    154,   2161}, 0, { 31<<5,  31<<5}, {0xff, 0x00, 0x00, 0x9a}}},
    {{{   922,    563,   2161}, 0, {     0,      0}, {0xff, 0x00, 0x00, 0x9a}}},
    {{{     0,    154,   2161}, 0, {     0,  31<<5}, {0xff, 0x00, 0x00, 0x9a}}},
    {{{   410,    154,   2161}, 0, { 31<<5,  31<<5}, {0xff, 0x00, 0x00, 0x9a}}},
    {{{   410,    563,   2161}, 0, { 31<<5,      0}, {0xff, 0x00, 0x00, 0x9a}}},
    {{{     0,    563,   2161}, 0, {     0,      0}, {0xff, 0x00, 0x00, 0x9a}}},
};

// 0x0701EE08 - 0x0701EE48
static const Vtx bbh_seg7_vertex_0701EE08[] = {
    {{{ -1741,    717,  -1649}, 0, { 31<<5,      0}, {0xff, 0x57, 0x00, 0x9a}}},
    {{{ -1382,    717,  -1649}, 0, {     0,      0}, {0xff, 0x57, 0x00, 0x9a}}},
    {{{ -1382,      0,  -1649}, 0, {     0,  63<<5}, {0xff, 0x57, 0x00, 0x9a}}},
    {{{ -1741,      0,  -1649}, 0, { 31<<5,  63<<5}, {0xff, 0x57, 0x00, 0x9a}}},
};
