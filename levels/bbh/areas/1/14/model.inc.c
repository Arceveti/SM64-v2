...
static const Vtx bbh_seg7_vertex_0700D368[] = {
    {{{ -1741,   1536,   2550}, 0, { 31<<5,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{ -1331,   1536,   2550}, 0, {     0,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{ -1331,   1126,   2550}, 0, {     0,  31<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{ -1741,   1126,   2550}, 0, { 31<<5,  31<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{ -1741,    614,   2550}, 0, { 31<<5,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{ -1331,    614,   2550}, 0, {     0,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{ -1331,    205,   2550}, 0, {     0,  31<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{ -1741,    205,   2550}, 0, { 31<<5,  31<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -614,    614,   2038}, 0, { 31<<5,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -205,    614,   2038}, 0, {     0,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -205,    205,   2038}, 0, {     0,  31<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -614,    205,   2038}, 0, { 31<<5,  31<<5}, {0x00, 0x00, 0x81, 0xff}}},
};
