...
static const Vtx wf_seg7_vertex_sliding_platform_sides[] = {
    ...
    {{{   256,    -51,    256}, 0, {     0,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   256,    -51,   -256}, 0, { 63<<5,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   256,      0,   -256}, 0, { 63<<5,   -236}, {0x7f, 0x00, 0x00, 0xff}}},
};

// 0x0700EA80 - 0x0700EAC0
static const Vtx wf_seg7_vertex_sliding_platform_top[] = {
    {{{   256,      0,    256}, 0, {     0,  31<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  -256,      0,   -256}, 0, { 63<<5,  -1056}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  -256,      0,    256}, 0, {     0,  -1056}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   256,      0,   -256}, 0, { 63<<5,  31<<5}, {0x00, 0x7f, 0x00, 0xff}}},
};
