...
const Collision wf_seg7_collision_070102D8[] = {
    ...
    COL_VERTEX( 3584,  2304,  -512),
    COL_VERTEX( 3226,  2304,     0),
    COL_VERTEX( 3584,  2304,     0),
    COL_VERTEX( 3226,  2304,  -512),
    COL_VERTEX( 4096,  1075, -4096),
    COL_VERTEX( 3226,  1075, -3072),
    COL_VERTEX( 4096,  1075, -3072),
    COL_VERTEX( 2458,  1075, -4096),
    COL_VERTEX( 2458,  1075, -3072),
    COL_VERTEX( 1536,  3584, -1024),
    COL_VERTEX( 1024,  3584,  -512),
    COL_VERTEX( 1536,  3584,  1024),
    COL_VERTEX( -423,  3584, -1960),
    ...
    COL_VERTEX(-2048,  2432, -1024),
    COL_VERTEX(-1946,  1024,  3994),
    COL_VERTEX(-1946,   512,  3994),
    COL_VERTEX(-1741,  1024,  3994),
    COL_VERTEX(-1741,  1024,  3789),
    COL_VERTEX(-1946,  1024,  3789),
    COL_VERTEX(-1536,  2560,  1536),
    COL_VERTEX(-2048,  2560,   512),
    COL_VERTEX(-2048,  2662, -2409),
    COL_VERTEX(-3277,   384, -1536),
    COL_VERTEX(-2509,  1024,  4096),
    COL_VERTEX(-3277,   384,   640),
    COL_VERTEX( 5120,   384,  2816),
    COL_VERTEX( -273,  2560, -2833),
    COL_VERTEX(-2048,  2560, -2409),
    COL_VERTEX(-2509,   384,   640),
    COL_VERTEX(-2509,  1152,  3072),
    COL_VERTEX(-2252,  1792,  -736),
    COL_VERTEX(-2252,  1792,  -832),
    COL_VERTEX(-2380,  1792,  -736),
    COL_VERTEX(-2380,  1792,  -832),
    COL_VERTEX(-2687,  1792,  -832),
    COL_VERTEX(-2687,  1792,  -736),
    COL_VERTEX(-2815,  1792,  -736),
    COL_VERTEX(-2815,  1792,  -832),
    COL_VERTEX(-2687,  1792,   224),
    COL_VERTEX(-2687,  1792,   320),
    COL_VERTEX(-2815,  1792,   320),
    COL_VERTEX(-2815,  1792,   224),
    COL_VERTEX(-2252,  1792,   320),
    COL_VERTEX(-2252,  1792,   224),
    COL_VERTEX(-2380,  1792,   320),
    COL_VERTEX(-2380,  1792,   224),
    COL_VERTEX(-2073,  2662,   512),
    COL_VERTEX(-2073,  2662, -1024),
    ...
    COL_VERTEX( 2881,  4096,   -64),
    COL_VERTEX( 2659,  4352,   320),
    COL_VERTEX( 3138,  4352,   340),
    COL_VERTEX( 3103,  4352,    64),
    COL_VERTEX( 3138,  4352,    44),
    COL_VERTEX( 2881,  4352,   -64),
    COL_VERTEX( 2881,  4352,  -102),
    COL_VERTEX( 2659,  4352,    64),
    COL_VERTEX( 2048,  2688,   -40),
    COL_VERTEX( 2007,  2560,     0),
    COL_VERTEX(-2048,  1792,  -832),
    COL_VERTEX(-2048,  1792,   320),
    COL_VERTEX(-2048,  2432,   512),
    COL_VERTEX(-1946,   512,  3789),
    COL_VERTEX(-1741,   512,  3994),
    COL_VERTEX(-1741,   512,  3789),
    COL_VERTEX(-2048,  2662,   512),
    COL_VERTEX(-2048,  2560, -1024),
    COL_VERTEX(-2048,  2662, -1024),
    COL_VERTEX(-1536,  2662,  1536),
    COL_VERTEX(-2048,   384, -1536),
    COL_VERTEX(-2048,   512, -1536),
    COL_VERTEX(-3277,   512, -1536),
    COL_VERTEX(-2509,  1152,  4096),
    COL_VERTEX(-1024,  1152,  4096),
    COL_VERTEX(-1024,  1024,  4096),
    COL_VERTEX(-3277,   512,   640),
    COL_VERTEX(-2509,   512,   640),
    ...
    COL_VERTEX( 4096,  1203, -3072),
    COL_VERTEX( 4096,  1203, -4096),
    COL_VERTEX( 2458,  1203, -4096),
    COL_VERTEX( 1536,  2560, -1024),
    COL_VERTEX( 1536,  2662, -1024),
    COL_VERTEX( -273,  2662, -2833),
    COL_VERTEX(-2509,  1024,  3072),
    COL_VERTEX(-2252,  2432,  -736),
    COL_VERTEX(-2380,  2432,  -736),
    COL_VERTEX(-2380,  2432,  -832),
    COL_VERTEX(-2252,  2432,  -832),
    COL_VERTEX(-2687,  2432,  -736),
    COL_VERTEX(-2815,  2432,  -736),
    COL_VERTEX(-2687,  2432,  -832),
    COL_VERTEX(-2815,  2432,  -832),
    COL_VERTEX(-2687,  2432,   320),
    COL_VERTEX(-2815,  2432,   320),
    COL_VERTEX(-2815,  2432,   224),
    COL_VERTEX(-2687,  2432,   224),
    COL_VERTEX(-2252,  2432,   320),
    COL_VERTEX(-2380,  2432,   320),
    COL_VERTEX(-2380,  2432,   224),
    COL_VERTEX(-2252,  2432,   224),
    COL_VERTEX(-2073,  2560,   512),
    COL_VERTEX(-2073,  2560, -1024),
    COL_VERTEX( 2881,  4055,   489),
    COL_VERTEX( 3138,  4055,   340),
    COL_VERTEX( 2624,  4055,    44),
    COL_VERTEX( 2881,  4055,  -102),
    ...
    COL_VERTEX( 2560,  2304,  -512),
    COL_VERTEX( 2048,  2560, -1024),
    COL_VERTEX( 2048,  2560,  -512),
    COL_VERTEX(-2690,  1203,   -32),
    COL_VERTEX(-2690,  1203,  -783),
    COL_VERTEX(-2048,  1203,  -783),
    COL_VERTEX(-2738,  1331,    13),
    COL_VERTEX(-2048,  1203,   -32),
    COL_VERTEX(-2738,  1331,  -832),
    COL_VERTEX(-2048,  1331,  -832),
    COL_VERTEX(-2048,  1331,    13),
    ...
    COL_VERTEX( 3021,   922,  3840), // unused
    ...
    COL_VERTEX( 3226,  1075, -3072),
    COL_VERTEX( 3226,  2304, -1024),
    COL_VERTEX(-2048,  1024,  3072),
    COL_VERTEX(-1024,  1024,  3072),
    COL_VERTEX(-1024,  2025,  1536),
    COL_VERTEX(-1024,  1024,  4045),
    COL_VERTEX(-1192,  2560,  2565),
    COL_VERTEX(-1024,  2560,  1536),
    COL_VERTEX(-1024,  2560,  2565),
    COL_VERTEX(  512,  2025,  1536),
    COL_VERTEX( 3584,   512,  3840),
    COL_VERTEX( 3584,  1024,  3840),
    COL_VERTEX( -423,  2560, -1960),
    COL_VERTEX(-1024,  2560,  -512),
    COL_VERTEX( 1024,  2560,  -512),
    COL_VERTEX( 2509,  2304,     0),
    COL_VERTEX( 2509,  2304,  -512),
    COL_VERTEX( 2048,  2534,     0),
    COL_VERTEX( 2048,  2534,  -512),
    COL_VERTEX( 1536,  2560,  1024),
    COL_VERTEX( 1536,  2560,  -512),
    COL_VERTEX( 3584,  1075, -3072),
    ...
    COL_VERTEX(-3072,  2432, -1024),
    COL_VERTEX(-3072,  2560,   512),
    COL_VERTEX(-2048,     0, -4096),
    COL_VERTEX( 3226,  1024,  4096),
    COL_VERTEX( 4096,     0, -4096),
    COL_VERTEX(-2048,  1664,   320),
    COL_VERTEX( -256,  2816,  1536),
    COL_VERTEX( -128,  2560,  2099),
    COL_VERTEX( -128,  2560,  1536),
    COL_VERTEX( -384,  2560,  1536),
    COL_VERTEX(  512,  1792,  3072),
    COL_VERTEX(-2509,     0,   640),
    COL_VERTEX(-2509,     0,  3072),
    COL_VERTEX(  800,  3584,  -736),
    COL_VERTEX(  800,  2791,  -736),
    ...
    COL_VERTEX( 2099,  2534,  -512),
    COL_VERTEX( 2150,  2509,  -512),
    COL_VERTEX( 2150,  2483,     0),
    COL_VERTEX( 2150,  2509,     0),
    COL_VERTEX( 2150,  2483,  -512),
    COL_VERTEX( 2202,  2458,     0),
    COL_VERTEX( 2202,  2458,  -512),
    COL_VERTEX( 2253,  2432,  -512),
    COL_VERTEX( 2253,  2432,     0),
    COL_VERTEX( 2304,  2406,     0),
    COL_VERTEX( 2304,  2406,  -512),
    COL_VERTEX( 2304,  2432,     0),
    COL_VERTEX( 2355,  2381,  -512),
    COL_VERTEX( 2355,  2381,     0),
    COL_VERTEX( 2406,  2355,     0),
    COL_VERTEX( 2406,  2355,  -512),
    COL_VERTEX( 2406,  2381,  -512),
    COL_VERTEX( 2458,  2330,     0),
    COL_VERTEX( 2458,  2330,  -512),
    ...
    COL_VERTEX( 2048,     0,  4096),
    COL_VERTEX(-2509, -3072,  4096),
    COL_VERTEX( 4096,   256,  4096),
    COL_VERTEX( 4096,     0,  -512),
    COL_VERTEX( 4608,     0,  -512),
    COL_VERTEX( 3712,   599,  3525),
    COL_VERTEX( 3968,   599,  3401),
    COL_VERTEX( 3712,   802,  2779),
    COL_VERTEX( 3840,   893,  2282),
    COL_VERTEX( 3840,   751,  2779),
    COL_VERTEX( 4096,  1075, -2560),
    COL_VERTEX( 3584,  1075, -2048),
    COL_VERTEX( 4096,  1075, -2048),
    COL_VERTEX( 4096,  1075, -1536),
    COL_VERTEX( 4096,  1075, -1024),
    COL_VERTEX( 3584,  1075, -1024),
    COL_VERTEX( 3584,  1757, -2032),
    COL_VERTEX( 3584,  1584, -2412),
    COL_VERTEX( 3584,  1575, -2032),
    ...
    COL_VERTEX(-2048,  1664,  -832),
    COL_VERTEX(-2430,  1664,  -320),
    COL_VERTEX(-2943,  1664,   320),
    COL_VERTEX(-2560,  1664,  -190),
    COL_VERTEX(-2943,  1792,   320),
    COL_VERTEX(-2943,  1792,  -832),
    COL_VERTEX(-2560,  1664,  -320),
    COL_VERTEX(-2943,  1664,  -832),
    COL_VERTEX(-3277,     0,   640),
    COL_VERTEX( 1925,  2560,  -205),
    COL_VERTEX( 1280,  2560, -1024),
    COL_VERTEX( 1373,  3456, -2767),
    COL_VERTEX(  864,  3456, -2127),
    ...
    COL_VERTEX(  512,     0, -4096),
    COL_VERTEX(-2509,     0,  4096),
    COL_VERTEX( 3226,     0,  4096),
    COL_VERTEX(-2048,   384,   640),
    COL_VERTEX( -256,  2816,  2099),
    COL_VERTEX( -384,  2560,  2099),
    ...
    COL_VERTEX( 2099,  2509,  -512),
    COL_VERTEX( 2202,  2483,     0),
    COL_VERTEX( 2253,  2458,     0),
    COL_VERTEX( 2202,  2483,  -512),
    COL_VERTEX( 2253,  2458,  -512),
    COL_VERTEX( 2355,  2406,     0),
    COL_VERTEX( 2355,  2406,  -512),
    COL_VERTEX( 2304,  2432,  -512),
    COL_VERTEX( 2406,  2381,     0),
    COL_VERTEX( 2458,  2355,  -512),
    COL_VERTEX( 5120,     0,  4096),
    COL_VERTEX( 2048, -3072,  4096),
    COL_VERTEX( 3584,  1075, -2560),
    COL_VERTEX( 4096,     0, -2048),
    COL_VERTEX( 4096,     0, -2560),
    COL_VERTEX( 3584,     0, -2560),
    COL_VERTEX( 3584,     0, -2048),
    COL_VERTEX( 3584,  1075, -1536),
    COL_VERTEX( 4096,     0, -1536),
    COL_VERTEX( 4096,     0, -1024),
    COL_VERTEX( 3584,     0, -1536),
    COL_VERTEX( 3584,     0, -1024),
    COL_VERTEX( 3226,  1575, -2032),
    COL_VERTEX( 3226,  1757, -2032),
    ...
    COL_VERTEX(-2560,  1792,  -190),
    COL_VERTEX(-2560,  1792,  -320),
    COL_VERTEX(-2430,  1792,  -320),
    COL_VERTEX(-3277,     0, -1536),
    COL_VERTEX( 1720,  2560,  -205),
    COL_VERTEX( 1720,  2560,     0),
    COL_VERTEX( 1925,  2560,     0),
    COL_VERTEX(  973,  2560, -1024),
    COL_VERTEX( 1126,  2560,  -870),
    COL_VERTEX( 1126,  2560, -1177),
    COL_VERTEX(-2060,  2688,   512),
    COL_VERTEX(-2060,  2688, -1024),
    ...
    COL_TRI( 11,  10,  13),
    COL_TRI( 12,  14,  13),
    COL_TRI_INIT(SURFACE_CAMERA_MIDDLE, 4),
    COL_TRI(  0,   1,   2),
    COL_TRI(  0,   3,   1),
    COL_TRI(  4,   8,   6),
    COL_TRI(  4,   7,   8),
    ...
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_level_geo_11, /*pos*/ -2500, 1792,  -262, /*yaw*/ 0), // platforms with pole
    SPECIAL_OBJECT(         /*preset*/ special_bubble_tree,  /*pos*/  2560,  256,  4608),
    COL_WATER_BOX_INIT(1),
    COL_WATER_BOX(0, -1024, 1024, 3226, 4096, 973),
    COL_END(),
};
