...
static const Vtx wf_seg7_vertex_tree_shadow[] = {
    {{{  -819,    102,   -461}, 0, ST_B(    32,      0), {0xff, 0xff, 0xff, 0xff}}},
    {{{ -1229,    102,   -461}, 0, ST_B(     0,      0), {0xff, 0xff, 0xff, 0xff}}},
    {{{ -1229,    102,    -51}, 0, ST_B(     0,     32), {0xff, 0xff, 0xff, 0xff}}},
    {{{  -819,    102,    -51}, 0, ST_B(    32,     32), {0xff, 0xff, 0xff, 0xff}}},
};
