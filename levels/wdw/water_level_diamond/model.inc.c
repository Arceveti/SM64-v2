...
static const Vtx wdw_seg7_vertex_water_level_diamond_yellow[] = {
    {{{   -51,     51,    -51}, 0, ST_B(    32,      0), {0xa6, 0x58, 0x00, 0xff}}},
    {{{   -51,     51,     51}, 0, ST_B(     0,      0), {0xa6, 0x58, 0x00, 0xff}}},
    {{{     0,    102,      0}, 0, ST_B(    16,     30), {0xa6, 0x58, 0x00, 0xff}}},
    {{{    51,     51,    -51}, 0, ST_B(    32,      0), {0x59, 0xa7, 0x00, 0xff}}},
    {{{    51,     51,     51}, 0, ST_B(     0,      0), {0x59, 0xa7, 0x00, 0xff}}},
    {{{     0,      0,      0}, 0, ST_B(    16,     30), {0x59, 0xa7, 0x00, 0xff}}},
};

// 0x07012FD8 - 0x07013038
static const Vtx wdw_seg7_vertex_water_level_diamond_blue[] = {
    {{{    51,     51,     51}, 0, ST_B(    32,      0), {0x59, 0x59, 0x00, 0xff}}},
    {{{    51,     51,    -51}, 0, ST_B(     0,      0), {0x59, 0x59, 0x00, 0xff}}},
    {{{     0,    102,      0}, 0, ST_B(    16,     30), {0x59, 0x59, 0x00, 0xff}}},
    {{{   -51,     51,     51}, 0, ST_B(    32,      0), {0xa6, 0xa8, 0x00, 0xff}}},
    {{{   -51,     51,    -51}, 0, ST_B(     0,      0), {0xa6, 0xa8, 0x00, 0xff}}},
    {{{     0,      0,      0}, 0, ST_B(    16,     30), {0xa6, 0xa8, 0x00, 0xff}}},
};

// 0x07013038 - 0x07013098
static const Vtx wdw_seg7_vertex_water_level_diamond_green[] = {
    {{{   -51,     51,     51}, 0, ST_B(    32,      0), {0x00, 0x59, 0x59, 0xff}}},
    {{{    51,     51,     51}, 0, ST_B(     0,      0), {0x00, 0x59, 0x59, 0xff}}},
    {{{     0,    102,      0}, 0, ST_B(    16,     30), {0x00, 0x59, 0x59, 0xff}}},
    {{{   -51,     51,    -51}, 0, ST_B(    32,      0), {0x00, 0xa8, 0xa6, 0xff}}},
    {{{    51,     51,    -51}, 0, ST_B(     0,      0), {0x00, 0xa8, 0xa6, 0xff}}},
    {{{     0,      0,      0}, 0, ST_B(    16,     30), {0x00, 0xa8, 0xa6, 0xff}}},
};

// 0x07013098 - 0x070130F8
static const Vtx wdw_seg7_vertex_water_level_diamond_red[] = {
    {{{    51,     51,     51}, 0, ST_B(    32,      0), {0x00, 0xa7, 0x59, 0xff}}},
    {{{   -51,     51,     51}, 0, ST_B(     0,      0), {0x00, 0xa7, 0x59, 0xff}}},
    {{{     0,      0,      0}, 0, ST_B(    16,     30), {0x00, 0xa7, 0x59, 0xff}}},
    {{{    51,     51,    -51}, 0, ST_B(    32,      0), {0x00, 0x58, 0xa6, 0xff}}},
    {{{   -51,     51,    -51}, 0, ST_B(     0,      0), {0x00, 0x58, 0xa6, 0xff}}},
    {{{     0,    102,      0}, 0, ST_B(    16,     30), {0x00, 0x58, 0xa6, 0xff}}},
};
