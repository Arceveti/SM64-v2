...
static const LevelScript script_func_local_wdw_area_1_objects[] = {
    ...
    OBJECT(/*model*/ MODEL_PURPLE_SWITCH,                     /*pos*/  3400, 1280,  3440, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvFloorSwitchHiddenObjects),
...
static const LevelScript script_func_local_wdw_area_2_objects[] = {
    OBJECT(/*model*/ MODEL_NONE,                    /*pos*/     0,     0,     0, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvInitializeChangingWaterLevel),
...
static const LevelScript script_func_local_wdw_area_1_stars[] = {
...
static const LevelScript script_func_local_wdw_area_2_stars[] = {
...
const LevelScript level_wdw_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_WDW_SQUARE_FLOATING_PLATFORM,      wdw_geo_square_floating_platform),
    LOAD_MODEL_FROM_GEO(MODEL_WDW_ARROW_LIFT,                    wdw_geo_arrow_lift),
    LOAD_MODEL_FROM_GEO(MODEL_WDW_WATER_LEVEL_DIAMOND,           wdw_geo_water_level_diamond),
    LOAD_MODEL_FROM_GEO(MODEL_WDW_HIDDEN_PLATFORM,               wdw_geo_hidden_platform),
    LOAD_MODEL_FROM_GEO(MODEL_WDW_EXPRESS_ELEVATOR,              wdw_geo_express_elevator),
    LOAD_MODEL_FROM_GEO(MODEL_WDW_RECTANGULAR_FLOATING_PLATFORM, wdw_geo_rectangular_floating_platform),
    LOAD_MODEL_FROM_GEO(MODEL_WDW_ROTATING_PLATFORM,             wdw_geo_rotating_platform),

    AREA(/*index*/ 1, wdw_geo_area_1),
        ...
        JUMP_LINK(script_func_local_wdw_area_1_stars),
        JUMP_LINK(script_func_local_wdw_area_1_objects),
    ...
    AREA(/*index*/ 2, wdw_geo_area_2),
        JUMP_LINK(script_func_local_wdw_area_2_stars),
        JUMP_LINK(script_func_local_wdw_area_2_objects),
        WARP_NODE(/*id*/ 0xF0, /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 0x02, /*destNode*/ 0x32, /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ 0xF1, /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 0x02, /*destNode*/ 0x64, /*flags*/ WARP_NO_CHECKPOINT),
