...
static const Vtx wdw_seg7_vertex_070137F8[] = {
    {{{   195,     38,     65}, 0, {   224,    992}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   256,     38,     65}, 0, {   224,     32}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   256,     13,     65}, 0, {     0,     32}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   195,     13,    109}, 0, {   736,    992}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   256,     38,    109}, 0, {   480,     32}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   195,     38,    109}, 0, {   480,    992}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   256,     13,    109}, 0, {   736,     32}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   195,      0,     87}, 0, {   992,    992}, {0x00, 0x93, 0x40, 0xff}}},
    {{{   256,      0,     87}, 0, {   992,     32}, {0x00, 0x93, 0x40, 0xff}}},
    {{{   256,     13,    109}, 0, {   736,     32}, {0x00, 0x93, 0x40, 0xff}}},
    {{{   195,     13,    109}, 0, {   736,    992}, {0x00, 0x93, 0x40, 0xff}}},
    {{{   195,     13,     65}, 0, {   480,    992}, {0x00, 0x93, 0xc0, 0xff}}},
    {{{   256,      0,     87}, 0, {   224,     32}, {0x00, 0x93, 0xc0, 0xff}}},
    {{{   195,      0,     87}, 0, {   224,    992}, {0x00, 0x93, 0xc0, 0xff}}},
    {{{   256,     13,     65}, 0, {   480,     32}, {0x00, 0x93, 0xc0, 0xff}}},
};

// 0x070138E8 - 0x070139D8
static const Vtx wdw_seg7_vertex_070138E8[] = {
    {{{   195,      0,    -64}, 0, {   224,    992}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -357,      0,    -64}, 0, {   224,    -80}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -357,     51,    -64}, 0, {     0,    -80}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   195,     38,     65}, 0, {   224,    992}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   256,     13,     65}, 0, {     0,     32}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   195,     13,     65}, 0, {     0,    992}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   195,     51,     87}, 0, {   736,    992}, {0x00, 0x6d, 0xc0, 0xff}}},
    {{{   256,     38,     65}, 0, {   480,     32}, {0x00, 0x6d, 0xc0, 0xff}}},
    {{{   195,     38,     65}, 0, {   480,    992}, {0x00, 0x6d, 0xc0, 0xff}}},
    {{{   256,     51,     87}, 0, {   736,     32}, {0x00, 0x6d, 0xc0, 0xff}}},
    {{{  -357,      0,    384}, 0, {   224,    -80}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   195,     51,    384}, 0, {     0,    992}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -357,     51,    384}, 0, {     0,    -80}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   195,      0,    384}, 0, {   224,    992}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   195,     51,    -64}, 0, {     0,    992}, {0x00, 0x00, 0x81, 0xff}}},
};
