...
static const Vtx wdw_seg7_vertex_0700F130[] = {
    {{{ -2805,  -2149,   3000}, 0, ST_B(     0,      0), {0x7f, 0x00, 0x00, 0xff}}},
    {{{ -2805,  -2242,   3000}, 0, ST_B(     0,     32), {0x7f, 0x00, 0x00, 0xff}}},
    {{{ -2805,  -2242,   2724}, 0, ST_B(    32,     32), {0x7f, 0x00, 0x00, 0xff}}},
    {{{ -2805,  -2149,   2427}, 0, ST_B(     0,      0), {0x7f, 0x00, 0x00, 0xff}}},
    {{{ -2805,  -2242,   2427}, 0, ST_B(     0,     32), {0x7f, 0x00, 0x00, 0xff}}},
    {{{ -2805,  -2242,   2150}, 0, ST_B(    32,     32), {0x7f, 0x00, 0x00, 0xff}}},
    {{{ -2805,  -2149,   2150}, 0, ST_B(    32,      0), {0x7f, 0x00, 0x00, 0xff}}},
    {{{ -2805,  -1576,   2427}, 0, ST_B(     0,      0), {0x7f, 0x00, 0x00, 0xff}}},
    {{{ -2805,  -1668,   2150}, 0, ST_B(    32,     32), {0x7f, 0x00, 0x00, 0xff}}},
    {{{ -2805,  -1576,   2150}, 0, ST_B(    32,      0), {0x7f, 0x00, 0x00, 0xff}}},
    {{{ -2805,  -1668,   2427}, 0, ST_B(     0,     32), {0x7f, 0x00, 0x00, 0xff}}},
    {{{ -2805,  -1576,   3000}, 0, ST_B(     0,      0), {0x7f, 0x00, 0x00, 0xff}}},
    {{{ -2805,  -1668,   2724}, 0, ST_B(    32,     32), {0x7f, 0x00, 0x00, 0xff}}},
    {{{ -2805,  -1576,   2724}, 0, ST_B(    32,      0), {0x7f, 0x00, 0x00, 0xff}}},
    {{{ -2805,  -1668,   3000}, 0, ST_B(     0,     32), {0x7f, 0x00, 0x00, 0xff}}},
};
...
static const Vtx wdw_seg7_vertex_0700FE80[] = {
    {{{    51,  -2559,   -777}, 0, ST_B(     0,     32), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   205,  -2303,   -777}, 0, ST_B(    32,      0), {0x00, 0x00, 0x7f, 0xff}}},
    {{{    51,  -2303,   -777}, 0, ST_B(     0,      0), {0x00, 0x00, 0x7f, 0xff}}},
    {{{ -2895,  -2303,   3137}, 0, ST_B(    32,      0), {0x5a, 0x00, 0x59, 0xff}}},
    {{{ -3003,  -2303,   3246}, 0, ST_B(     0,      0), {0x5a, 0x00, 0x59, 0xff}}},
    {{{ -3003,  -2559,   3246}, 0, ST_B(     0,     32), {0x5a, 0x00, 0x59, 0xff}}},
    {{{ -2895,  -2559,   3137}, 0, ST_B(    32,     32), {0x5a, 0x00, 0x59, 0xff}}},
    {{{ -3506,  -2559,     10}, 0, ST_B(     0,     32), {0x00, 0x00, 0x81, 0xff}}},
    {{{ -3660,  -2303,     10}, 0, ST_B(    32,      0), {0x00, 0x00, 0x81, 0xff}}},
    {{{ -3506,  -2303,     10}, 0, ST_B(     0,      0), {0x00, 0x00, 0x81, 0xff}}},
    {{{ -3660,  -2559,     10}, 0, ST_B(    32,     32), {0x00, 0x00, 0x81, 0xff}}},
    {{{ -2805,  -2559,  -1689}, 0, ST_B(     0,     32), {0x81, 0x00, 0x00, 0xff}}},
    {{{ -2805,  -2303,  -1535}, 0, ST_B(    32,      0), {0x81, 0x00, 0x00, 0xff}}},
    {{{ -2805,  -2303,  -1689}, 0, ST_B(     0,      0), {0x81, 0x00, 0x00, 0xff}}},
    {{{ -2805,  -2559,  -1535}, 0, ST_B(    32,     32), {0x81, 0x00, 0x00, 0xff}}},
};

// 0x0700FF70 - 0x0700FFE0
static const Vtx wdw_seg7_vertex_0700FF70[] = {
    {{{  1034,  -2303,    947}, 0, ST_B(     0,      0), {0x81, 0x00, 0x00, 0xff}}},
    {{{  1034,  -2559,    947}, 0, ST_B(     0,     32), {0x81, 0x00, 0x00, 0xff}}},
    {{{  1034,  -2559,   1101}, 0, ST_B(    32,     32), {0x81, 0x00, 0x00, 0xff}}},
    {{{    51,  -2559,   -777}, 0, ST_B(     0,     32), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   205,  -2559,   -777}, 0, ST_B(    32,     32), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   205,  -2303,   -777}, 0, ST_B(    32,      0), {0x00, 0x00, 0x7f, 0xff}}},
    {{{  1034,  -2303,   1101}, 0, ST_B(    32,      0), {0x81, 0x00, 0x00, 0xff}}},
};
