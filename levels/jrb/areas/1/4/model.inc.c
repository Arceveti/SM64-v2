...
static const Vtx jrb_seg7_vertex_07004D70[] = {
    {{{  8048,  -2866,   1727}, 0, {  2048,    150}, {0x8f, 0xde, 0x2d, 0xff}}},
    {{{  8008,  -3020,   1579}, 0, {  2048,    426}, {0xfe, 0xd1, 0x75, 0xff}}},
    {{{  8008,  -3327,   1579}, 0, {  2048,    790}, {0xd0, 0x34, 0x69, 0xff}}},
    {{{  8048,  -3481,   1727}, 0, {  2048,    882}, {0xc0, 0x64, 0x2c, 0xff}}},
    {{{  8127,  -3481,   2024}, 0, {  2048,    700}, {0x9e, 0x4f, 0xf8, 0xff}}},
    {{{  8166,  -3327,   2173}, 0, {  2048,    426}, {0xac, 0x2a, 0xac, 0xff}}},
    {{{  8166,  -3020,   2173}, 0, {  2048,     64}, {0xa2, 0xcc, 0xbd, 0xff}}},
    {{{  8127,  -2866,   2024}, 0, {  2048,      0}, {0xd0, 0x8d, 0xee, 0xff}}},
};
...
static const Vtx jrb_seg7_vertex_07004DF0[] = {
    ...
    {{{  8166,  -3020,   2173}, 0, {  2048,     64}, {0xa2, 0xcc, 0xbd, 0xff}}},
    {{{  7249,  -3022,   2416}, 0, {   128,     64}, {0xe1, 0xe0, 0x8a, 0xff}}},
    {{{  8166,  -3327,   2173}, 0, {  2048,    426}, {0xac, 0x2a, 0xac, 0xff}}},
    {{{  7187,  -3325,   2432}, 0, {    48,    426}, {0xe3, 0x31, 0x8f, 0xff}}},
    {{{  8127,  -2866,   2024}, 0, {  2048,      0}, {0xd0, 0x8d, 0xee, 0xff}}},
    {{{  7117,  -3476,   2292}, 0, {     0,    700}, {0xf5, 0x75, 0xd2, 0xff}}},
    {{{  8127,  -3481,   2024}, 0, {  2048,    700}, {0x9e, 0x4f, 0xf8, 0xff}}},
    {{{  7168,  -2871,   1962}, 0, {   172,    150}, {0x0c, 0x8b, 0x2e, 0xff}}},
    {{{  8048,  -2866,   1727}, 0, {  2048,    150}, {0x8f, 0xde, 0x2d, 0xff}}},
    {{{  7092,  -3022,   1822}, 0, {   128,    426}, {0x1e, 0xcf, 0x71, 0xff}}},
    {{{  8008,  -3020,   1579}, 0, {  2048,    426}, {0xfe, 0xd1, 0x75, 0xff}}},
    {{{  7030,  -3325,   1838}, 0, {    44,    790}, {0x1f, 0x20, 0x76, 0xff}}},
    {{{  8008,  -3327,   1579}, 0, {  2048,    790}, {0xd0, 0x34, 0x69, 0xff}}},
    {{{  7038,  -3476,   1995}, 0, {     0,    880}, {0x10, 0x6d, 0x3d, 0xff}}},
    {{{  8048,  -3481,   1727}, 0, {  2048,    880}, {0xc0, 0x64, 0x2c, 0xff}}},
};

// 0x07004EF0 - 0x07004FF0
static const Vtx jrb_seg7_vertex_07004EF0[] = {
    {{{  5662,  -4096,   -653}, 0, {  1436,  -2854}, {0x8b, 0xd5, 0xed, 0xff}}},
    ...
    {{{  5662,  -4096,   -653}, 0, {  1340,   1376}, {0x8b, 0xd5, 0xed, 0xff}}},
    {{{  5662,  -4096,    533}, 0, {  1340,  -1582}, {0x8b, 0xcf, 0x00, 0xff}}},
    ...
    {{{  5152,  -4914,    427}, 0, {127<<5,  -1318}, {0x00, 0x7e, 0x00, 0xff}}},
};
...
static const Vtx jrb_seg7_vertex_07004FF0[] = {
    ...
    {{{  5457,  -3900,   -590}, 0, {  1652,   1218}, {0xcf, 0x8e, 0xe9, 0xff}}},
    {{{  5167,  -3890,    198}, 0, {  1992,   -748}, {0x00, 0x82, 0x01, 0xff}}},
    {{{  4842,  -3890,    284}, 0, {  2364,   -960}, {0x31, 0x8b, 0x01, 0xff}}},
    {{{  4638,  -4096,    384}, 0, {  2684,  -1210}, {0x6d, 0xc0, 0x00, 0xff}}},
    {{{  4638,  -4096,   -653}, 0, {  2684,   1376}, {0x75, 0xd5, 0xed, 0xff}}},
    ...
    {{{  5152,  -4914,    427}, 0, {127<<5,  -1318}, {0x00, 0x7e, 0x00, 0xff}}},
    {{{  5457,  -4914,    603}, 0, {   320,  -1758}, {0xd0, 0x75, 0x00, 0xff}}},
    {{{  5457,  -4904,   -913}, 0, {   320,   2026}, {0xd6, 0x73, 0x20, 0xff}}},
    {{{  5152,  -4914,    427}, 0, {   -32,  -1318}, {0x00, 0x7e, 0x00, 0xff}}},
    {{{  5662,  -4709,    675}, 0, {   640,  -1938}, {0x93, 0x41, 0x00, 0xff}}},
    {{{  5662,  -4709,   -850}, 0, {   640,   1868}, {0x8b, 0x2b, 0x13, 0xff}}},
};
...
static const Vtx jrb_seg7_vertex_070050F0[] = {
    ...
    {{{  4638,  -4096,   -653}, 0, {  2588,  -2854}, {0x75, 0xd5, 0xed, 0xff}}},
    {{{  4842,  -2401,  -2665}, 0, {  2336,   2386}, {0x37, 0x9b, 0xcc, 0xff}}},
};
...
static const Vtx jrb_seg7_vertex_070051F0[] = {
    ...
    {{{  5457,  -3279,  -3193}, 0, {   356,   2178}, {0xc9, 0x65, 0x34, 0xff}}},
    {{{  5662,  -4709,   -850}, 0, {   756,  -3274}, {0x8b, 0x2b, 0x13, 0xff}}},
    {{{  5662,  -2577,  -2771}, 0, {  1128,  -1328}, {0x88, 0xdf, 0xee, 0xff}}},
    ...
    {{{  4638,  -2577,  -2771}, 0, {  2896,  -1328}, {0x79, 0xdf, 0xee, 0xff}}},
...
static const Vtx jrb_seg7_vertex_070052F0[] = {
    ...
    {{{  5457,  -2401,  -2665}, 0, { 47<<5,  -1454}, {0xc9, 0x9d, 0xc7, 0xff}}},
    {{{  5662,  -2167,  -3795}, 0, {  1376,    438}, {0x8e, 0xca, 0xf6, 0xff}}},
    {{{  5662,  -2577,  -2771}, 0, {  1128,  -1328}, {0x88, 0xdf, 0xee, 0xff}}},
    {{{  5662,  -2766,  -3933}, 0, {   676,    500}, {0x8e, 0x36, 0x0a, 0xff}}},
