...
static const Vtx jrb_seg7_vertex_070059D8[] = {
    ...
    {{{  2980,   1485,   5431}, 0, {     0,  31<<5}, {0x00, 0x81, 0x00, 0xff}}},
    {{{  5084,   1536,   6377}, 0, { 10734,      0}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  3392,   1536,   5018}, 0, {     0,  31<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  4909,   1536,   6535}, 0, { 10670,  31<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  3559,   1536,   4852}, 0, {     0,      0}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  4909,   1485,   6535}, 0, { 10670,  31<<5}, {0x00, 0x81, 0x00, 0xff}}},
    {{{  3392,   1485,   5018}, 0, {     0,  31<<5}, {0x00, 0x81, 0x00, 0xff}}},
    ...
    {{{  2813,   1536,   5598}, 0, {     0,  31<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  4284,   1536,   7069}, 0, { 10352,  31<<5}, {0x00, 0x7f, 0x00, 0xff}}},
...
static const Vtx jrb_seg7_vertex_07005AC8[] = {
    ...
    {{{  2835,   1485,   6155}, 0, { 63<<5,  -2080}, {0x00, 0x81, 0x00, 0xff}}},
    {{{  3861,   1485,   7182}, 0, {  9258,  -2080}, {0x00, 0x81, 0x00, 0xff}}},
    {{{  4284,   1485,   7069}, 0, { 10352,      0}, {0x00, 0x81, 0x00, 0xff}}},
    {{{  2980,   1485,   5431}, 0, {     0,  31<<5}, {0x00, 0x81, 0x00, 0xff}}},
    {{{  4460,   1485,   6912}, 0, { 10416,  31<<5}, {0x00, 0x81, 0x00, 0xff}}},
    {{{  3861,   1536,   7182}, 0, {  9258,  95<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  2668,   1536,   6322}, 0, { 63<<5, 127<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  3611,   1536,   7264}, 0, {  8664, 127<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  2835,   1536,   6155}, 0, { 63<<5,  95<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  2668,   1485,   6322}, 0, { 63<<5,  -3098}, {0x00, 0x81, 0x00, 0xff}}},
};

// 0x07005B78 - 0x07005BF8
static const Vtx jrb_seg7_vertex_07005B78[] = {
    {{{ -4338,   1249,   2034}, 0, { 95<<5,      0}, {0x21, 0x65, 0x43, 0xff}}},
    {{{ -4133,    736,   2034}, 0, {  1588,   2520}, {0xd6, 0x54, 0x54, 0xff}}},
    {{{ -4133,   1249,   2034}, 0, {  1588,      0}, {0xbd, 0x65, 0x21, 0xff}}},
    {{{ -4133,    736,   2239}, 0, {   144,   2520}, {0x99, 0x33, 0xcd, 0xff}}},
    {{{ -4133,   1249,   2239}, 0, {   144,      0}, {0xdf, 0x65, 0xbd, 0xff}}},
    {{{ -4338,    736,   2034}, 0, { 95<<5,   2520}, {0x67, 0x33, 0x33, 0xff}}},
    {{{ -4338,    736,   2239}, 0, {  1588,   2520}, {0x2a, 0x54, 0xac, 0xff}}},
...
static const Vtx jrb_seg7_vertex_07005BF8[] = {
    ...
    {{{ -4082,   1249,   1983}, 0, { 15<<5,  -5244}, {0x18, 0x72, 0xd0, 0xff}}},
    {{{ -4082,   1249,   2290}, 0, { 47<<5,  -5244}, {0x2a, 0x6f, 0x2b, 0xff}}},
    ...
    {{{ -4389,   1249,   2290}, 0, { 47<<5,  -5244}, {0xd0, 0x72, 0x18, 0xff}}},
    {{{ -4495,   1024,   1877}, 0, {   128,  -4120}, {0xb6, 0x46, 0xb6, 0xff}}},
    {{{ -4495,   1024,   2395}, 0, {  1852,  -4120}, {0xd0, 0x43, 0x60, 0xff}}},
    {{{ -4389,   1249,   1983}, 0, { 15<<5,  -5244}, {0xe4, 0x78, 0xe4, 0xff}}},
};

// 0x07005CE8 - 0x07005DD8
static const Vtx jrb_seg7_vertex_07005CE8[] = {
    {{{  1762,   1843,   1734}, 0, {  2580,  -3810}, {0x58, 0xa7, 0xef, 0xff}}},
    {{{  1853,   1843,   2191}, 0, { 95<<5,  -1534}, {0x72, 0xd6, 0x23, 0xff}}},
    {{{  1546,   1843,   2703}, 0, { 47<<5,  32<<5}, {0x04, 0xaf, 0x60, 0xff}}},
    {{{ -4082,   1249,   1983}, 0, {  1244,  -5244}, {0x18, 0x72, 0xd0, 0xff}}},
    {{{ -3976,   1024,   1877}, 0, {  1772,  -4120}, {0x60, 0x43, 0xd0, 0xff}}},
    {{{ -4495,   1024,   1877}, 0, {  -812,  -4120}, {0xb6, 0x46, 0xb6, 0xff}}},
    {{{ -4082,   1249,   1983}, 0, { 63<<5,  31<<5}, {0x18, 0x72, 0xd0, 0xff}}},
    {{{ -4133,   1249,   2034}, 0, {  1672,    816}, {0xbd, 0x65, 0x21, 0xff}}},
    {{{ -4133,   1249,   2239}, 0, {   304,    816}, {0xdf, 0x65, 0xbd, 0xff}}},
    {{{ -4082,   1249,   2290}, 0, {     0,  31<<5}, {0x2a, 0x6f, 0x2b, 0xff}}},
    {{{ -4389,   1249,   1983}, 0, { 63<<5,      0}, {0xe4, 0x78, 0xe4, 0xff}}},
    {{{ -4338,   1249,   2034}, 0, {  1672,    138}, {0x21, 0x65, 0x43, 0xff}}},
    {{{ -4338,   1249,   2239}, 0, {   304,    138}, {0x43, 0x65, 0xdf, 0xff}}},
    {{{ -4389,   1249,   2290}, 0, {     0,      0}, {0xd0, 0x72, 0x18, 0xff}}},
    {{{   522,   1843,   2287}, 0, { -3604,  -1056}, {0xdf, 0xa7, 0x53, 0xff}}},
};

// 0x07005DD8 - 0x07005EC8
static const Vtx jrb_seg7_vertex_07005DD8[] = {
    {{{  1480,   1536,   7814}, 0, {     0,  31<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  1098,   1536,   6104}, 0, {  -980,  -3276}, {0xf8, 0x46, 0x97, 0xff}}},
    {{{   532,   1536,   6198}, 0, { -2392,  -3042}, {0xab, 0x4f, 0xcf, 0xff}}},
    {{{   522,   1946,   2287}, 0, { -3604,  -1056}, {0xdf, 0x59, 0x53, 0xff}}},
    {{{  1546,   1946,   2703}, 0, { 47<<5,   1020}, {0x42, 0x31, 0x60, 0xff}}},
    {{{  1853,   1946,   2191}, 0, { 95<<5,  -1534}, {0x67, 0x49, 0x04, 0xff}}},
    {{{  1762,   1946,   1734}, 0, {  2580,  -3810}, {0x58, 0x59, 0xef, 0xff}}},
    {{{   532,   1536,   6198}, 0, {     0,  31<<5}, {0xab, 0x4f, 0xcf, 0xff}}},
    {{{   532,   1024,   6198}, 0, {     0,   3542}, {0xc2, 0x2e, 0x9c, 0xff}}},
    {{{   386,   1075,   7315}, 0, {  5540,   3288}, {0xae, 0x5f, 0xf0, 0xff}}},
    {{{   330,   1536,   7742}, 0, {  7672,  31<<5}, {0x90, 0x38, 0xf2, 0xff}}},
...
static const Vtx jrb_seg7_vertex_07005FB8[] = {
    ...
    {{{  1853,   1843,   2191}, 0, {  2796,  15<<5}, {0x72, 0xd6, 0x23, 0xff}}},
    {{{  1853,   1946,   2191}, 0, {  2796,      0}, {0x67, 0x49, 0x04, 0xff}}},
    {{{  1762,   1843,   1734}, 0, {  4920,  15<<5}, {0x58, 0xa7, 0xef, 0xff}}},
    {{{  1762,   1946,   1734}, 0, {  4920,      0}, {0x58, 0x59, 0xef, 0xff}}},
    {{{  1546,   1843,   2703}, 0, {     0,  15<<5}, {0x04, 0xaf, 0x60, 0xff}}},
    {{{   522,   1946,   2287}, 0, { -3604,      0}, {0xdf, 0x59, 0x53, 0xff}}},
    {{{  1546,   1843,   2703}, 0, {  1908,  15<<5}, {0x04, 0xaf, 0x60, 0xff}}},
    {{{  1546,   1946,   2703}, 0, {  1908,      0}, {0x42, 0x31, 0x60, 0xff}}},
    {{{   522,   1843,   2287}, 0, { -3604,  15<<5}, {0xdf, 0xa7, 0x53, 0xff}}},
    {{{ -1675,   1331,   6547}, 0, { 15876, 127<<5}, {0x6b, 0x2e, 0xcf, 0xff}}},
    {{{ -2073,   1024,   6165}, 0, { 12960,   2522}, {0x2b, 0x00, 0x89, 0xff}}},
    {{{ -2073,   1331,   6165}, 0, { 12960, 127<<5}, {0xf0, 0x50, 0xa0, 0xff}}},
    {{{ -1675,   1024,   6547}, 0, { 15876,   2522}, {0x7e, 0x00, 0x01, 0xff}}},
    {{{ -1944,   1331,   7211}, 0, { 19276, 127<<5}, {0x53, 0x59, 0x21, 0xff}}},
...
static const Vtx jrb_seg7_vertex_070060B8[] = {
    ...
    {{{ -3017,   1331,   6778}, 0, {  7700, 127<<5}, {0xd0, 0x59, 0xb5, 0xff}}},
...
static const Vtx jrb_seg7_vertex_07006138[] = {
    ...
    {{{ -2534,   2048,   6112}, 0, {  1804,   -440}, {0x00, 0x7f, 0x00, 0xff}}},
    ...
    {{{   112,   1024,   6993}, 0, {  3508,    664}, {0xf0, 0x7d, 0xfb, 0xff}}},
    ...
    {{{   800,   1024,   3275}, 0, {  1628,   8204}, {0x7a, 0x09, 0xe0, 0xff}}},
...
static const Vtx jrb_seg7_vertex_07006318[] = {
    ...
    {{{ -5647,   1126,    717}, 0, { -3700,  -5170}, {0x0e, 0x7d, 0x0d, 0xff}}},
    {{{ -5756,   1024,   1719}, 0, { -1468,  -3782}, {0x19, 0x7b, 0x11, 0xff}}},
    {{{ -7494,   1126,    173}, 0, { -9664,  -3544}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{ -5762,   1126,  -1126}, 0, { -8580,  -7324}, {0x00, 0x7f, 0x00, 0xff}}},
    ...
    {{{ -3747,   1024,    256}, 0, {  -104,  -8114}, {0x02, 0x7a, 0x21, 0xff}}},
};
...
static const Vtx jrb_seg7_vertex_07006418[] = {
    ...
    {{{ -4690,   1126,     88}, 0, { -2880,  -7148}, {0x07, 0x7d, 0x12, 0xff}}},
    {{{ -3443,   1024,    320}, 0, {   804,  -8416}, {0xf8, 0x78, 0x28, 0xff}}},
    {{{ -5762,   1126,  -1126}, 0, { -8580,  -7324}, {0x00, 0x7f, 0x00, 0xff}}},
...
static const Vtx jrb_seg7_vertex_070064C8[] = {
    {{{ -4133,    736,   2034}, 0, {     0,      0}, {0xd6, 0x54, 0x54, 0xff}}},
    {{{ -4338,    736,   2239}, 0, {     0,      0}, {0x2a, 0x54, 0xac, 0xff}}},
    {{{ -4133,    736,   2239}, 0, {     0,      0}, {0x99, 0x33, 0xcd, 0xff}}},
    {{{ -4338,    736,   2034}, 0, {     0,      0}, {0x67, 0x33, 0x33, 0xff}}},
};
