...
const Collision jrb_seg7_area_1_collision[] = {
    ...
    COL_VERTEX(-1805, -1024, 5315),
    COL_VERTEX(-1105, -1024, 5129),
    COL_VERTEX(-4161, 512, 6315),
    COL_VERTEX(-4161, 4096, 6315),
    COL_VERTEX(-5256, 512, 4733),
    COL_VERTEX(-3762, 0, 3587),
    COL_VERTEX(-2876, -1024, 4101),
    COL_VERTEX(-2690, -1024, 4801),
    COL_VERTEX(-805, 4096, 7672),
    COL_VERTEX(-805, 1024, 7672),
    COL_VERTEX(3093, -5120, 4015),
    COL_VERTEX(2722, -5120, 2615),
    COL_VERTEX(4279, -1536, 7071),
    COL_VERTEX(1136, -1024, 2287),
    COL_VERTEX(5821, -5120, 4414),
    COL_VERTEX(5183, -5120, 2892),
    COL_VERTEX(3750, -5120, 844),
    COL_VERTEX(2350, 0, 1215),
    COL_VERTEX(5150, -5120, 472),
    COL_VERTEX(6478, -5120, 1243),
    COL_VERTEX(5457, -4914, 603),
    COL_VERTEX(7117, -3476, 2292),
    COL_VERTEX(7435, 0, 614),
    COL_VERTEX(6849, -5120, 2643),
    ...
    COL_VERTEX(-1662, -1024, 3030),
    COL_VERTEX(294, -512, 4758),
    COL_VERTEX(-1848, 0, 2330),
    COL_VERTEX(-777, -1024, 3544),
    COL_VERTEX(-705, 0, 2401),
    COL_VERTEX(-105, -376, 2631),
    COL_VERTEX(4569, -5120, 2687),
    COL_VERTEX(4774, -5120, 2892),
    COL_VERTEX(4815, -5221, 2154),
    COL_VERTEX(4569, -5120, 2277),
    COL_VERTEX(4774, -5120, 2073),
    COL_VERTEX(5306, -5221, 2318),
    COL_VERTEX(5388, -5120, 2277),
    COL_VERTEX(5388, -5120, 2687),
    ...
    COL_VERTEX(-2362, -1024, 3215),
    COL_VERTEX(4422, -5120, 4786),
    COL_VERTEX(6707, -1024, 4928),
    COL_VERTEX(1185, -712, 3631),
    COL_VERTEX(589, -726, 3046),
    COL_VERTEX(3121, 0, -112),
    COL_VERTEX(5183, -5120, 2073),
    ...
    COL_WATER_BOX(51, -7818, -1126, 9055, 7814,  1229),
    COL_END(),
};
