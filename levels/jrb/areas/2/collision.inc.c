...
const Collision jrb_seg7_area_2_collision[] = {
    ...
    COL_VERTEX(514, 22, 1331),
    COL_VERTEX(-463, -351, 265),
    COL_VERTEX(-631, -307, 265),
    ...
    COL_WATER_BOX(0, -4096, -4096,  4096,  4096,  2765),
    COL_END(),
};
