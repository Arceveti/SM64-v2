...
static const LevelScript script_func_local_jrb_1[] = {
    OBJECT_WITH_ACTS(/*model*/ MODEL_JRB_SHIP_LEFT_HALF_PART,  /*pos*/  5385, -5520,  2428, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvSunkenShipPart,           /*acts*/ ACT_1                                        ),
    OBJECT_WITH_ACTS(/*model*/ MODEL_JRB_SHIP_RIGHT_HALF_PART, /*pos*/  5385, -5520,  2428, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvSunkenShipPart,           /*acts*/ ACT_1                                        ),
...
static const LevelScript script_func_local_jrb_rocks[] = {
    ...
    OBJECT(/*model*/ MODEL_JRB_ROCK,                 /*pos*/  -815,  -614,  3556, /*angle*/ 0, 315, 0, /*behParam*/ 0x00000000, /*beh*/ bhvRockSolid),
    ...
    OBJECT(/*model*/ MODEL_JRB_ROCK,                 /*pos*/ -1798,  -717,  4330, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvRockSolid),
    ...
    OBJECT(/*model*/ MODEL_JRB_ROCK,                 /*pos*/   256,  -102,  4719, /*angle*/ 0,  45, 0, /*behParam*/ 0x00000000, /*beh*/ bhvRockSolid),
    OBJECT(/*model*/ MODEL_JRB_ROCK,                 /*pos*/  1787,  -307,  5133, /*angle*/ 0, 315, 0, /*behParam*/ 0x00000000, /*beh*/ bhvRockSolid),
    OBJECT(/*model*/ MODEL_JRB_ROCK,                 /*pos*/  1080,  -614,  2299, /*angle*/ 0,  75, 0, /*behParam*/ 0x00000000, /*beh*/ bhvRockSolid),
    ...
    OBJECT(/*model*/ MODEL_JRB_ROCK,                 /*pos*/  4222, -1126,  7083, /*angle*/ 0, 104, 0, /*behParam*/ 0x00000000, /*beh*/ bhvRockSolid),
    OBJECT(/*model*/ MODEL_JRB_ROCK,                 /*pos*/  6650,  -614,  4941, /*angle*/ 0, 315, 0, /*behParam*/ 0x00000000, /*beh*/ bhvRockSolid),
    ...
    OBJECT(/*model*/ MODEL_NONE,                     /*pos*/ -2535,  1075,  6112, /*angle*/ 0,   0, 0, /*behParam*/ 0x00610000, /*beh*/ bhvPoleGrabbing),
    ...
    OBJECT(/*model*/ MODEL_JRB_FLOATING_PLATFORM,    /*pos*/ -1059,  1024,  7072, /*angle*/ 0, 247, 0, /*behParam*/ 0x00000000, /*beh*/ bhvJrbFloatingPlatform),
    RETURN(),
};

static const LevelScript script_func_local_jrb_stars[] = {
...
static const LevelScript script_func_local_jrb_treasure_chests_in_ship[] = {
    OBJECT(/*model*/ MODEL_NONE,            /*pos*/  400,  -350, -2700, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvTreasureChestsShip),
    RETURN(),
};

// static const LevelScript script_func_local_jrb_area_2_stub[] = {
//     RETURN(),
// };
...
const LevelScript level_jrb_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_JRB_SHIP_LEFT_HALF_PART,  jrb_geo_ship_left_half_part),
    LOAD_MODEL_FROM_GEO(MODEL_JRB_SHIP_BACK_LEFT_PART,  jrb_geo_ship_back_left_part),
    LOAD_MODEL_FROM_GEO(MODEL_JRB_SHIP_RIGHT_HALF_PART, jrb_geo_ship_right_half_part),
    LOAD_MODEL_FROM_GEO(MODEL_JRB_SHIP_BACK_RIGHT_PART, jrb_geo_ship_back_right_part),
    LOAD_MODEL_FROM_GEO(MODEL_JRB_SUNKEN_SHIP,          jrb_geo_sunken_ship),
    LOAD_MODEL_FROM_GEO(MODEL_JRB_SUNKEN_SHIP_BACK,     jrb_geo_sunken_ship_back),
    LOAD_MODEL_FROM_GEO(MODEL_JRB_ROCK,                 jrb_geo_rock),
    LOAD_MODEL_FROM_GEO(MODEL_JRB_SLIDING_BOX,          jrb_geo_sliding_box),
    LOAD_MODEL_FROM_GEO(MODEL_JRB_FALLING_PILLAR,       jrb_geo_falling_pillar),
    LOAD_MODEL_FROM_GEO(MODEL_JRB_FALLING_PILLAR_BASE,  jrb_geo_falling_pillar_base),
    LOAD_MODEL_FROM_GEO(MODEL_JRB_FLOATING_PLATFORM,    jrb_geo_floating_platform),

    AREA(/*index*/ 1, jrb_geo_area_1),
        ...
        JUMP_LINK(script_func_local_jrb_1),
        JUMP_LINK(script_func_local_jrb_rocks),
        JUMP_LINK(script_func_local_jrb_stars),
    ...
    AREA(/*index*/ 2, jrb_geo_area_2),
        ...
        WARP_NODE(/*id*/ 0xF0, /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 0x01, /*destNode*/ 0x35, /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ 0xF1, /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 0x01, /*destNode*/ 0x67, /*flags*/ WARP_NO_CHECKPOINT),
        JUMP_LINK(script_func_local_jrb_treasure_chests_in_ship),
        // JUMP_LINK(script_func_local_jrb_area_2_stub),
