...
static const Lights1 ccm_seg7_lights_snowman_base = gdSPDefLights1(
    0xcc, 0xcc, 0xcc,
...
static const Gfx ccm_seg7_sub_dl_snowman_base[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, ccm_seg7_texture_snowman_snow),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPLight(&ccm_seg7_lights_snowman_base.l, 1),
    gsSPLight(&ccm_seg7_lights_snowman_base.a, 2),
...
const Gfx ccm_seg7_dl_snowman_base[] = {
    gsDPPipeSync(),
    ...
    gsSPDisplayList(ccm_seg7_sub_dl_snowman_base),
