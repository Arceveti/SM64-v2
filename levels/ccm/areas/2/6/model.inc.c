...
static const Vtx ccm_seg7_vertex_0701FDE8[] = {
    {{{ -7592,  -5703,  -6819}, 0, ST_B(    32,     32), {0xff, 0xff, 0xff, 0xff}}},
    {{{ -7592,  -5600,  -6716}, 0, ST_B(     0,      0), {0xff, 0xff, 0xff, 0xff}}},
    {{{ -7592,  -5703,  -6716}, 0, ST_B(     0,     32), {0xff, 0xff, 0xff, 0xff}}},
    {{{ -7592,  -5600,  -6819}, 0, ST_B(    32,      0), {0xff, 0xff, 0xff, 0xff}}},
};
