...
const Collision ccm_seg7_area_1_collision[] = {
    ...
    COL_VERTEX(-4382, -1946, 5414),
    COL_VERTEX(-3892, -1946, 6246),
    COL_VERTEX(-3268, -1741, 6246),
    COL_VERTEX(4077, -4608, -1403),
    ...
    COL_VERTEX(4790, -4608, 5511),
    COL_VERTEX(4790, -5120, 5511),
    COL_VERTEX(5989, -5120, -3076),
    COL_VERTEX(5989, -4608, -3076),
    COL_VERTEX(5990, -4608, -3076),
    COL_VERTEX(5490, -5120, -3189),
    COL_VERTEX(5490, -4608, -3189),
    COL_VERTEX(4240, -4608, -1490),
    COL_VERTEX(4350, 41, -2633),
    COL_VERTEX(4096, -819, 0),
    COL_VERTEX(4413, -577, -4089),
    COL_VERTEX(4525, 144, -3360),
    COL_VERTEX(-1329, -4889, -4308),
    COL_VERTEX(4551, -3072, 228),
    COL_VERTEX(3004, -4608, 4617),
    COL_VERTEX(3268, -4812, 5055),
    COL_VERTEX(3268, -4608, 5055),
    COL_VERTEX(3251, -4608, 4168),
    COL_VERTEX(4027, -4608, 4596),
    COL_VERTEX(3780, -4608, 5045),
    COL_VERTEX(3763, -4608, 4158),
    COL_VERTEX(1792, -5120, 6654),
    COL_VERTEX(768, -5120, 6654),
    COL_VERTEX(2450, -1536, 2332),
    COL_VERTEX(2579, -2304, 3259),
    COL_VERTEX(4096, -3072, 0),
    COL_VERTEX(3707, -1227, 552),
    COL_VERTEX(4096, -1229, 0),
    COL_VERTEX(768, -4608, 5118),
    COL_VERTEX(-1414, -3072, 3522),
    COL_VERTEX(4262, -1229, 975),
    COL_VERTEX(3553, -1607, 768),
    COL_VERTEX(4075, -1607, 1104),
    COL_VERTEX(768, -972, -3327),
    COL_VERTEX(3072, -410, -3020),
    ...
    COL_VERTEX(-3892, -1946, 6605),
    COL_VERTEX(-3268, -1920, 6246),
    COL_VERTEX(-3268, -3327, 6246),
    COL_VERTEX(-3327, -3584, 3840),
    COL_VERTEX(-4360, -1946, 6000),
    COL_VERTEX(-4360, -2149, 6000),
    COL_VERTEX(-6398, -3327, 3943),
    COL_VERTEX(-6398, -1741, 3943),
    COL_VERTEX(-4914, -4096, 0),
    ...
    COL_VERTEX(23, 2560, -3072),
    COL_VERTEX(3072, 2304, -3327),
    COL_VERTEX(23, 1741, -3072),
    COL_VERTEX(768, 819, -2610),
    COL_VERTEX(638, 2765, -2152),
    COL_VERTEX(23, 3471, -2048),
    COL_VERTEX(3072, 1022, -2560),
    COL_VERTEX(4096, 1792, -2560),
    COL_VERTEX(4096, 1327, 1843),
    COL_VERTEX(3072, 807, -512),
    COL_VERTEX(3072, -205, -2560),
    COL_VERTEX(768, 154, -2610),
    COL_VERTEX(-2024, 2662, -3072),
    COL_VERTEX(-3045, 1842, -1970),
    COL_VERTEX(3072, -410, -2560),
    COL_VERTEX(-1005, 410, -2562),
    COL_VERTEX(3072, -819, -512),
    COL_VERTEX(2048, -819, 1024),
    COL_VERTEX(-51, -512, 2048),
    COL_VERTEX(-1000, 3471, -512),
    ...
    COL_VERTEX(-4490, -1229, -3765),
    COL_VERTEX(-5632, -1331, 0),
    COL_VERTEX(-3839, -1229, -4351),
    COL_VERTEX(-4402, -1536, 3789),
    COL_VERTEX(-3327, -1536, 3840),
    COL_VERTEX(-4096, -1331, -1024),
    COL_VERTEX(-3327, -4608, 3840),
    ...
    COL_VERTEX(1751, -4608, 4096),
    COL_VERTEX(1751, -3788, 4096),
    COL_VERTEX(2914, -3994, 3996),
    COL_VERTEX(2927, -4608, 3634),
    ...
    COL_VERTEX(4240, -5120, -1490),
    COL_VERTEX(4606, -1229, 67),
    COL_VERTEX(1380, -5164, -3729),
    COL_VERTEX(1380, -4908, -3729),
    COL_VERTEX(3068, -4694, 1181),
    COL_VERTEX(2745, -4898, 858),
    COL_VERTEX(6537, -5120, -852),
    COL_VERTEX(6537, -4608, -852),
    COL_VERTEX(1792, -4608, 6654),
    COL_VERTEX(3682, -5120, 2895),
    COL_VERTEX(4413, -65, -4089),
    COL_VERTEX(-1329, -5146, -4308),
    ...
    COL_VERTEX(-2776, -1536, 1910),
    COL_VERTEX(-3072, -1126, -3072),
    COL_VERTEX(-3072, -512, -2048),
    ...
    COL_VERTEX(768, -5120, 5118),
    COL_VERTEX(-5387, -1741, 4976),
    COL_VERTEX(-6423, -3839, 102),
    COL_VERTEX(2617, 2703, -2483),
    COL_VERTEX(3072, 2201, -1914),
    COL_VERTEX(3072, 1685, 1331),
    COL_VERTEX(2662, 2304, -512),
    COL_VERTEX(23, 2560, -2048),
    COL_VERTEX(-2024, 2150, -3072),
    COL_VERTEX(945, 2560, -3072),
    COL_VERTEX(3072, 1894, -3327),
    COL_VERTEX(638, 2765, -3072),
    COL_VERTEX(-1005, 1638, -2562),
    COL_VERTEX(4096, 2304, -2560),
    COL_VERTEX(-3045, 768, -1970),
    COL_VERTEX(-3608, 819, -864),
    COL_VERTEX(-1020, 2048, 3),
    COL_VERTEX(-2429, 2867, -636),
    COL_VERTEX(-51, 5632, -154),
    COL_VERTEX(2048, 840, 1024),
    COL_VERTEX(-1000, 3471, -1281),
    COL_VERTEX(-2024, 2560, -1536),
    COL_VERTEX(-4874, -1741, -2465),
    COL_VERTEX(-5632, -1741, 0),
    COL_VERTEX(-4490, -1741, -3765),
    COL_VERTEX(-4402, -1741, 3789),
    COL_VERTEX(-3268, -1536, 5668),
    COL_VERTEX(-3327, -5120, 3840),
    COL_VERTEX(-2230, -5139, -4501),
    COL_VERTEX(-2230, -4883, -4501),
    COL_VERTEX(-4905, -4499, -4234),
    COL_VERTEX(1394, -4908, -2624),
    COL_VERTEX(-5120, -4863, -5120),
    COL_VERTEX(-3203, 1095, 1412),
    COL_VERTEX(23, 3471, -768),
    COL_VERTEX(-1983, -3966, -2478),
    COL_VERTEX(-6423, -1741, 102),
    COL_VERTEX(-3292, -5120, 5501),
    COL_VERTEX(-4608, -4608, 4608),
    COL_VERTEX(-2776, -512, 1910),
    COL_VERTEX(-5120, -5120, 0),
    COL_VERTEX(121, -2573, -2548),
    COL_VERTEX(-355, -2764, -2548),
    COL_VERTEX(-355, -2531, -2548),
    COL_VERTEX(-1229, -3584, 5734),
    COL_VERTEX(-1331, -3584, 5837),
    COL_VERTEX(-1331, -3584, 6144),
    COL_VERTEX(-1229, -3584, 6246),
    COL_VERTEX(-1024, -3584, 6246),
    COL_VERTEX(-922, -3584, 6144),
    COL_VERTEX(-1126, -4044, 5990),
    COL_VERTEX(-1024, -3584, 5734),
    COL_VERTEX(-922, -3584, 5837),
    COL_VERTEX(1192, -4608, 5626),
    COL_VERTEX(2953, -2621, 2700),
    COL_VERTEX(3162, -2627, 2924),
    COL_VERTEX(3098, -2822, 1860),
    COL_VERTEX(524, 3134, -717),
    COL_VERTEX(73, 3457, -1739),
    COL_VERTEX(590, 3222, -1106),
    COL_VERTEX(949, 3072, -1271),
    COL_VERTEX(128, 3442, -1811),
    COL_VERTEX(774, 3072, -72),
    COL_VERTEX(970, 3072, 59),
    COL_VERTEX(837, 3072, -1),
    COL_VERTEX(1379, 3072, 53),
    COL_VERTEX(834, 3072, -145),
    COL_VERTEX(922, -4608, 6603),
    COL_VERTEX(1177, -4608, 6244),
    COL_VERTEX(1192, -4608, 5831),
    COL_VERTEX(922, -4608, 6224),
    COL_VERTEX(988, -4608, 5831),
    COL_VERTEX(988, -4608, 5626),
    COL_VERTEX(1775, -4608, 4425),
    COL_VERTEX(1786, -4608, 4136),
    COL_VERTEX(-5144, -1741, 4720),
    COL_VERTEX(-4940, -1741, 4714),
    COL_VERTEX(-4947, -1741, 4509),
    COL_VERTEX(-5151, -1741, 4516),
    COL_VERTEX(-2024, 2560, -2766),
    COL_VERTEX(4199, -4608, 1340),
    COL_VERTEX(4328, -4608, 952),
    ...
    COL_VERTEX(3132, -4796, -307),
    COL_VERTEX(3132, -4591, -307),
    ...
    COL_VERTEX(-5387, -1638, 4976),
    COL_VERTEX(-4360, -1842, 6000),
    ...
    COL_VERTEX(2852, -1536, 2490),
    COL_VERTEX(3002, -1331, 2631),
    ...
    COL_VERTEX(-3072, 1142, 1024),
    COL_VERTEX(-51, 1382, 2048),
    COL_VERTEX(-3298, -4608, 5194),
    COL_VERTEX(-3314, -4608, 4454),
    COL_VERTEX(-3314, -4505, 4454),
    COL_VERTEX(-4720, -4608, 3590),
    COL_VERTEX(-4720, -4505, 3590),
    COL_VERTEX(192, -3078, -3762),
    ...
    COL_VERTEX(805, -1638, 5320),
    COL_VERTEX(-1386, -1741, 4683),
    COL_VERTEX(805, -1433, 5320),
    COL_VERTEX(-3323, -1638, 4045),
    COL_VERTEX(-3323, -1433, 4045),
    COL_VERTEX(-1407, -1536, 4480),
    COL_VERTEX(-3327, -1638, 3840),
    COL_VERTEX(768, -1433, 5118),
    COL_VERTEX(768, -1638, 5118),
    ...
    COL_VERTEX(160, 3479, -1743),
    COL_VERTEX(574, 3243, -793),
    COL_VERTEX(846, 3195, -77),
    COL_VERTEX(922, -4608, 6603),
    COL_VERTEX(4099, -1229, 851),
    COL_VERTEX(3605, -1229, 1500),
    COL_VERTEX(3768, -1229, 1624),
    COL_VERTEX(-2024, 2560, -1536),
    ...
    COL_VERTEX(3072, 2560, -768),
    COL_VERTEX(3516, -4709, 4608),
    COL_VERTEX(3500, -1337, 1638),
    COL_VERTEX(3663, -1337, 1762),
    COL_VERTEX(-717, -8089, 5837),
    COL_VERTEX(-717, -8089, 6246),
    ...
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_level_geo_03,     /*pos*/  -410,  2765, -1638, /*yaw*/   0),
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_level_geo_04,     /*pos*/  2355, -4096,  4096, /*yaw*/   0),
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_level_geo_05,     /*pos*/ -4210, -1446,  1874, /*yaw*/   0),
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_level_geo_05,     /*pos*/  2560,  2560, -1024, /*yaw*/   0),
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_level_geo_06,     /*pos*/  -819,   102,  2048, /*yaw*/   0),
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_level_geo_07,     /*pos*/  -512, -3072, -3584, /*yaw*/   0),
    SPECIAL_OBJECT(         /*preset*/ special_snow_tree,        /*pos*/ -5201, -1741,  2994),
    SPECIAL_OBJECT(         /*preset*/ special_snow_tree,        /*pos*/  1989, -4608,  4949),
    SPECIAL_OBJECT(         /*preset*/ special_snow_tree,        /*pos*/  1248, -4608,  5474),
    SPECIAL_OBJECT(         /*preset*/ special_snow_tree,        /*pos*/ -5508, -1741,  4148),
    SPECIAL_OBJECT(         /*preset*/ special_snow_tree,        /*pos*/ -4576, -1741,  4814),
    SPECIAL_OBJECT(         /*preset*/ special_snow_tree,        /*pos*/  -488,  2560, -2305),
    SPECIAL_OBJECT(         /*preset*/ special_snow_tree,        /*pos*/ -5892, -1741,   811),
    SPECIAL_OBJECT(         /*preset*/ special_snow_tree,        /*pos*/ -3748, -4608,  4464),
    SPECIAL_OBJECT(         /*preset*/ special_snow_tree,        /*pos*/  2237,  2560, -1630),
    SPECIAL_OBJECT(         /*preset*/ special_snow_tree,        /*pos*/  2885,  2560, -1638),
    SPECIAL_OBJECT(         /*preset*/ special_snow_tree,        /*pos*/ -1146, -3584,  5919),
    SPECIAL_OBJECT(         /*preset*/ special_snow_tree,        /*pos*/ -1768,  2560, -1793),
    SPECIAL_OBJECT(         /*preset*/ special_snow_tree,        /*pos*/ -3443,   807, -2713),
    SPECIAL_OBJECT_WITH_YAW_AND_PARAM(/*preset*/ special_wooden_door_warp, /*pos*/  2464, -4608,  4302, /*yaw*/ 158, /*behParam2*/ 20),
