...
const MacroObject ccm_seg7_area_1_macro_objs[] = {
    ...
    MACRO_OBJECT_WITH_BEH_PARAM(/*preset*/ macro_wooden_signpost,           /*yaw*/   0, /*pos*/ -1037, -3584,  5872, /*behParam*/ DIALOG_091),
    MACRO_OBJECT_WITH_BEH_PARAM(/*preset*/ macro_wooden_signpost,           /*yaw*/ 180, /*pos*/  -309, -4890, -3690, /*behParam*/ DIALOG_049),
    MACRO_OBJECT_WITH_BEH_PARAM(/*preset*/ macro_wooden_signpost,           /*yaw*/   0, /*pos*/  1900, -1536,  3500, /*behParam*/ DIALOG_040),
    MACRO_OBJECT_WITH_BEH_PARAM(/*preset*/ macro_cannon_closed,             /*yaw*/   0, /*pos*/ -3615, -4608,  4790, /*behParam*/       0x00),
    MACRO_OBJECT_WITH_BEH_PARAM(/*preset*/ macro_cannon_closed,             /*yaw*/   0, /*pos*/ -5045, -1741,  4615, /*behParam*/       0x00),
    MACRO_OBJECT_WITH_BEH_PARAM(/*preset*/ macro_cannon_closed,             /*yaw*/   0, /*pos*/  1090, -4608,  5729, /*behParam*/       0x80),
...
#ifdef BONUS_OBJECTS
    MACRO_OBJECT(               /*preset*/ macro_hidden_blue_coin,          /*yaw*/   0, /*pos*/  3072,  -752,   512                         ),
    MACRO_OBJECT(               /*preset*/ macro_hidden_blue_coin,          /*yaw*/   0, /*pos*/  2500,  -680,  1280                         ),
    MACRO_OBJECT(               /*preset*/ macro_recovery_heart,            /*yaw*/   0, /*pos*/  1160,  3122,  -600                         ),
    MACRO_OBJECT(               /*preset*/ macro_recovery_heart,            /*yaw*/   0, /*pos*/  1780, -4558,  4280                         ),
#endif
