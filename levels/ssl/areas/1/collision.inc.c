...
const Collision ssl_seg7_area_1_collision[] = {
    ...
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_level_geo_03, /*pos*/ -3584,  0,  2935, /*yaw*/  0),
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_level_geo_03, /*pos*/  -512,  0,  2935, /*yaw*/  0),
    ...
    COL_WATER_BOX(51,  1024, -7066,  7578,  -717,  -51),
    COL_WATER_BOX(52, -3994, -7066,  1024, -4198,  -51),
    COL_WATER_BOX (0, -6912, -7168, -4224, -4608, -128),
    COL_END(),
};
