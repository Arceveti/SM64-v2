...
static const Gfx bowser_1_seg7_dl_07002578[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_1_seg7_texture_arena_inner_circle),
    gsDPLoadSync(),
...
static const Gfx bowser_1_seg7_dl_070025F8[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_1_seg7_texture_arena_outer_circle),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
static const Gfx bowser_1_seg7_dl_070026B0[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_1_seg7_texture_arena_sides),
    gsDPLoadSync(),
