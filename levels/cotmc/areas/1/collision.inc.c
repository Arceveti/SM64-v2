...
const Collision cotmc_seg7_collision_level[] = {
    ...
    COL_TRI_STOP(),
    COL_SPECIAL_INIT(1),
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_null_start, /*pos*/ -4186, 20, -48, /*yaw*/ 64), // unused, probably an early way to set initial position
    COL_WATER_BOX_INIT(1),
    COL_WATER_BOX(0, -1536, -7680, 1536, 3389, 0),
    COL_END(),
};
