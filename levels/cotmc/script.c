...
static const LevelScript script_func_local_cotmc_1[] = {
...
static const LevelScript script_func_local_cotmc_stars[] = {
...
const LevelScript level_cotmc_entry[] = {
    ...
    AREA(/*index*/ 1, cotmc_geo_area_1),
        ...
        JUMP_LINK(script_func_local_cotmc_stars),
        JUMP_LINK(script_func_local_cotmc_1),
