...
static const LevelScript script_func_local_bob_1[] = {
    OBJECT(/*model*/ MODEL_BOB_CHAIN_CHOMP_GATE,  /*pos*/  1456,   768,   446, /*angle*/ 0, 326, 0, /*behParam*/ 0x00000000, /*beh*/ bhvChainChompGate),
    OBJECT(/*model*/ MODEL_BOB_SEESAW_PLATFORM,   /*pos*/ -2304,   717,  1024, /*angle*/ 0,  45, 0, /*behParam*/ 0x00030000, /*beh*/ bhvSeesawPlatform),
    OBJECT(/*model*/ MODEL_NONE,                  /*pos*/ -2048,     0, -3072, /*angle*/ 0,  25, 0, /*behParam*/ 0x00000000, /*beh*/ bhvOpenableGrill),
...
static const LevelScript script_func_local_bob_2[] = {
    OBJECT_WITH_ACTS(/*model*/ MODEL_NONE,                  /*pos*/  1536, 3840, -5561, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000,         /*beh*/ bhvBobBowlingBallSpawner,  /*acts*/ ACT_1 | ACT_2                                ),
    OBJECT_WITH_ACTS(/*model*/ MODEL_NONE,                  /*pos*/  1536, 3840, -5561, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000,         /*beh*/ bhvTtmBowlingBallSpawner,  /*acts*/                 ACT_3 | ACT_4 | ACT_5 | ACT_6),
    ...
    OBJECT          (/*model*/ MODEL_BOWLING_BALL,          /*pos*/  -992,  886, -3565, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000,         /*beh*/ bhvPitBowlingBall),
    ...
    OBJECT_WITH_ACTS(/*model*/ MODEL_CANNON_BASE,           /*pos*/ -5696,  128,  5600, /*angle*/ 0, 135, 0, /*behParam*/ 0x00010000,         /*beh*/ bhvWaterBombCannon,        /*acts*/ ACT_1                                        ),
    OBJECT_WITH_ACTS(/*model*/ MODEL_DL_CANNON_LID,         /*pos*/ -5696,  128,  5600, /*angle*/ 0, 180, 0, /*behParam*/ 0x00000000,         /*beh*/ bhvCannonClosed,           /*acts*/         ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
...
static const LevelScript script_func_local_bob_stars[] = {
    ...
    OBJECT_WITH_ACTS(/*model*/ MODEL_KOOPA_WITH_SHELL,      /*pos*/ -4004,    0,  5221, /*angle*/ 0,    0, 0, /*behParam*/ 0x01020000, /*beh*/ bhvKoopa,                 /*acts*/ ACT_2), // Koopa the Quick
...
const LevelScript level_bob_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_BOB_CHAIN_CHOMP_GATE, bob_geo_chain_chomp_gate),
    LOAD_MODEL_FROM_GEO(MODEL_BOB_SEESAW_PLATFORM,  bob_geo_seesaw_platform),
    LOAD_MODEL_FROM_GEO(MODEL_BOB_BARS_GRILLS,      bob_geo_grate_door),

    AREA(/*index*/ 1, bob_geo_area_1),
        JUMP_LINK(script_func_local_bob_1),
        JUMP_LINK(script_func_local_bob_2),
        JUMP_LINK(script_func_local_bob_stars),
