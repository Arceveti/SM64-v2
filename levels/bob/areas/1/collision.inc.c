...
const Collision bob_seg7_collision_level[] = {
    ...
    COL_VERTEX(-3477,   944, -4251),
    COL_VERTEX(-3556,   944, -4215),
    COL_VERTEX(-3536,   823, -4169),
    COL_VERTEX(-3538,   944, -4176),
    COL_VERTEX(-3460,   823, -4204),
    COL_VERTEX(-3554,   823, -4208),
    COL_VERTEX(-3477,   823, -4243),
    COL_VERTEX(-4454,  1138, -1962),
    COL_VERTEX(-4453,  1018, -1962),
    COL_VERTEX(-4389,  1018, -2020),
    COL_VERTEX(-4390,  1138, -2020),
    COL_VERTEX(-4482,  1138, -1994),
    COL_VERTEX(-4418,  1138, -2048),
    COL_VERTEX(-4270,  1144,  -785),
    COL_VERTEX(-4208,  1144,  -846),
    COL_VERTEX(-4238,  1144,  -754),
    COL_VERTEX(-4178,  1144,  -819),
    COL_VERTEX( 6215,   992, -1513),
    COL_VERTEX( 6185,   992, -1544),
    COL_VERTEX( 6277,   992, -1573),
    COL_VERTEX( 6247,   992, -1604),
    COL_VERTEX(-2304,     0,   896),
    COL_VERTEX(-2175,     0,  1024),
    COL_VERTEX(-2304,   358,  1152),
    COL_VERTEX(-2175,   358,  1024),
    COL_VERTEX(-2304,   358,   896),
    COL_VERTEX(-2432,     0,  1024),
    COL_VERTEX(-2432,   358,  1024),
    COL_VERTEX(-2304,     0,  1152),
    ...
    COL_VERTEX( 6289,   912, -2654),
    COL_VERTEX( 6289,  1936, -2654),
    COL_VERTEX( 3096,  1741,  -736),
    COL_VERTEX( -870,  1024, -5528),
    COL_VERTEX(-6144,  2560, -8192),
    COL_VERTEX(-8192,  2048,     0),
    ...
    COL_VERTEX( 3584,   656,  -768),
    COL_VERTEX( 3072,  2513, -7680),
    COL_VERTEX( 7029,   912, -4000),
    COL_VERTEX( 3072,  4293, -6656),
    COL_VERTEX( 4402,  4294, -3840),
    COL_VERTEX( 4402,  4294, -5376),
    COL_VERTEX( 1298,  4293, -3584),
    COL_VERTEX( 3072,  4293, -3072),
    COL_VERTEX( 1298,  4293, -5632),
    COL_VERTEX( 4846,  4294, -5632),
    COL_VERTEX( 5097,   823, -1387),
    COL_VERTEX( 5452,   857, -1485),
    COL_VERTEX( 5842,   832, -1155),
    COL_VERTEX(-5577,   963, -5517),
    COL_VERTEX(-5518,   848, -6024),
    COL_VERTEX(-5198,   896, -5376),
    COL_VERTEX(-6015,  1024, -3840),
    COL_VERTEX(-3339,  1024,  -563),
    COL_VERTEX(-3448,  1015,  -908),
    COL_VERTEX(-4991,  1024, -2432),
    COL_VERTEX(-2816,  1024,   256),
    COL_VERTEX(-1792,   973,  -768),
    COL_VERTEX(-1872,   768, -1441),
    COL_VERTEX(-7168,  1024,   512),
    COL_VERTEX(-2123,   173,  6244),
    COL_VERTEX(-2386,   187,  5931),
    COL_VERTEX(-2242,   197,  5944),
    COL_VERTEX(-2560,   179,  5888),
    COL_VERTEX(-1536,   256,  5888),
    COL_VERTEX( -922,     0,  6400),
    COL_VERTEX(-2644,   112,  6413),
    COL_VERTEX(-5376,     0,  6464),
    COL_VERTEX(-2632,   132,  6269),
    COL_VERTEX(-2542,   160,  6061),
    COL_VERTEX(-3232,  1024,  -160),
    COL_VERTEX( 5070,   717,    32),
    COL_VERTEX( 5471,   717,   -24),
    COL_VERTEX( 5314,   717,  -540),
    COL_VERTEX( 5812,   760,  -649),
    COL_VERTEX( 5777,   743,   424),
    COL_VERTEX( 5360,   763,  1257),
    COL_VERTEX( 5683,   760,   922),
    COL_VERTEX( 5856,   754,   700),
    COL_VERTEX( 4864,  1024,  4096),
    COL_VERTEX( 5888,  1024,  4096),
    COL_VERTEX( 3840,   768,  2304),
    COL_VERTEX( 4299,   720,   668),
    COL_VERTEX( 4496,   713,   314),
    COL_VERTEX( 4845,   748,  -936),
    COL_VERTEX( 4378,   732,   944),
    COL_VERTEX( 4582,   747,  1241),
    COL_VERTEX( 4810,   757,  1414),
    COL_VERTEX( 4250,  3072,  1126),
    COL_VERTEX( 4250,  3072,  1331),
    COL_VERTEX( 4454,  3072,  1126),
    ...
    COL_VERTEX(-5120,  1331, -3634),
    COL_VERTEX(-4914,  1331, -3634),
    COL_VERTEX(-4914,   819, -3634),
    COL_VERTEX(-4914,  1331, -3429),
    COL_VERTEX(-5120,  1331, -3429),
    COL_VERTEX( 6246,  1568, -7168),
    COL_VERTEX( 4352,  2560, -2560),
    COL_VERTEX( 4352,  3072, -2560),
    COL_VERTEX( 4147,  3072, -2560),
    ...
    COL_VERTEX( 4454,  2560,  1126),
    COL_VERTEX(-3504,   960,   112),
    COL_VERTEX(-3232,   960,  -160),
    COL_VERTEX(-3460,   896,   156),
    COL_VERTEX(-3187,   896,  -112),
    COL_VERTEX(-3142,   832,   -69),
    COL_VERTEX(-3414,   832,   201),
    COL_VERTEX(-3096,   768,   -24),
    COL_VERTEX(  768,     0,  5376),
    COL_VERTEX( 3279,  2944, -1718),
    COL_VERTEX( 3319,  2944, -1866),
    COL_VERTEX( 3319,  2970, -1866),
    COL_VERTEX( 2407,  2918, -1925),
    COL_VERTEX( 2447,  2918, -2073),
    COL_VERTEX( -922,     0,  5376),
    COL_VERTEX(-1008,   819, -5170),
    ...
    COL_VERTEX( -354,  2606, -5360),
    COL_VERTEX( 3072,  2513, -7168),
    ...
    COL_VERTEX(  800,  2683, -5393),
    COL_VERTEX(  507,  3042, -5697),
    COL_VERTEX(  329,  3042, -5595),
    COL_VERTEX( 5289,  2493, -3329),
    COL_VERTEX( 5289,  1936, -3329),
    COL_VERTEX( 2851,  1613, -1920),
    COL_VERTEX( 2560,  1613, -2737),
    COL_VERTEX( 3072,  2944, -2048),
    COL_VERTEX( 3328,  2944, -1604),
    COL_VERTEX(  168,  2709, -3757),
    COL_VERTEX(  168,  1024, -3471),
    COL_VERTEX(   56,  1024, -3700),
    COL_VERTEX( 2560,  2862, -2613),
    COL_VERTEX( 2560,  2864, -2367),
    COL_VERTEX( 3072,  2894, -2432),
    COL_VERTEX( 3072,  2944, -2560),
    COL_VERTEX( 4846,  3089, -3584),
    COL_VERTEX( 2560,  2912, -2736),
    COL_VERTEX( 3072,  4096, -3072),
    COL_VERTEX( 1298,  3954, -3584),
    COL_VERTEX( 1298,  3810, -5632),
    COL_VERTEX( 1609,  4192, -5810),
    COL_VERTEX( 3072,  4294, -6656),
    COL_VERTEX( 3072,  3666, -6656),
    COL_VERTEX( 4846,  3233, -5632),
    COL_VERTEX( 5543,  2637, -2883),
    COL_VERTEX( 5543,  3089, -2883),
    COL_VERTEX( 5400,  1885, -3263),
    COL_VERTEX( 3072,  3521, -7680),
    COL_VERTEX( 3072,  3521, -7168),
    COL_VERTEX( 5733,  3089, -6144),
    COL_VERTEX( 5289,  3088, -5887),
    COL_VERTEX( 3072,  4096, -2560),
    ...
    COL_VERTEX(-5146,   128,  5816),
    COL_VERTEX(-5146,   128,  5384),
    COL_VERTEX(-5548,   128,  4952),
    COL_VERTEX( 1452,  2918, -2259),
    COL_VERTEX( 1521,  2918, -2452),
    COL_VERTEX( 1328,  2918, -2520),
    COL_VERTEX( 4250,  2560,  1126),
    COL_VERTEX( 4250,  2560,  1331),
    COL_VERTEX( 4454,  2560,  1331),
    COL_VERTEX(-3460,   960,   156),
    COL_VERTEX(-3187,   960,  -112),
    COL_VERTEX(-3414,   896,   201),
    COL_VERTEX(-3142,   896,   -69),
    COL_VERTEX(-3096,   832,   -24),
    COL_VERTEX(-3368,   832,   246),
    COL_VERTEX(  768,   768,  5376),
    COL_VERTEX( 3279,  2970, -1718),
    COL_VERTEX( 2407,  2944, -1925),
    COL_VERTEX( 2447,  2944, -2073),
    COL_VERTEX( -286,   717, -3096),
    COL_VERTEX(   28,   819, -3113),
    COL_VERTEX( -629,   717, -2924),
    COL_VERTEX( -828,   819, -2680),
    COL_VERTEX(-3232,   768,  -160),
    ...
    COL_VERTEX( 2560,  1613, -2244),
    COL_VERTEX( 2488,  1369, -2138),
    COL_VERTEX( 2874,  1576, -1794),
    COL_VERTEX( -870,  2657, -5528),
    COL_VERTEX(  803,  2940, -5394),
    COL_VERTEX(  712,  3042, -5342),
    COL_VERTEX( 5289,  3089, -3329),
    COL_VERTEX(  534,  3042, -5240),
    COL_VERTEX( 3072,  2349, -2048),
    COL_VERTEX( 3072,  2894, -2175),
    COL_VERTEX( 2802,  1613, -2654),
    COL_VERTEX( 3328,  2493, -1604),
    COL_VERTEX(   56,  2762, -3700),
    COL_VERTEX( -697,  2606, -5472),
    COL_VERTEX(  168,  2775, -3471),
    COL_VERTEX(  286,  2723, -3530),
    COL_VERTEX( 4846,  4242, -3584),
    COL_VERTEX( 4402,  4293, -3840),
    COL_VERTEX( 1902,  4088, -5506),
    COL_VERTEX( 1548,  3835, -5302),
    COL_VERTEX( 1636,  4192, -5353),
    COL_VERTEX( 1814,  4192, -5455),
    COL_VERTEX( 1548,  4088, -5302),
    COL_VERTEX( 2388,  2918, -1762),
    COL_VERTEX(  228,  2802, -2532),
    COL_VERTEX( 2560,  2662, -2244),
    ...
    COL_VERTEX( 1212,  1408,  -128),
    COL_VERTEX( 1888,  1408,   720),
    COL_VERTEX( 1186,   768,  -149),
    COL_VERTEX(-7168,  1044,  4076),
    COL_VERTEX(-4115,  1044,  4076),
    COL_VERTEX(-3092,  1044,  3052),
    COL_VERTEX(-3092,  1044,  1536),
    COL_VERTEX( 2076,  1408,   425),
    COL_VERTEX( 1186,  1408,  -149),
    COL_VERTEX( 6271,  2084, -2676),
    COL_VERTEX( 5669,   922,  -780),
    COL_VERTEX( 5146,   922,  -960),
    COL_VERTEX( 5345,   966, -1188),
    COL_VERTEX(-5070,  1081, -5738),
    COL_VERTEX(-5322,  1136, -5756),
    COL_VERTEX(-5235,  1075, -5842),
    COL_VERTEX(-5018,  1331, -3020),
    COL_VERTEX(-5460,  1331, -3788),
    COL_VERTEX(-4573,  1331, -3788),
    COL_VERTEX(-2816,  1207,  -537),
    COL_VERTEX(-2816,  1207,  -844),
    COL_VERTEX(-3045,  1207,  -896),
    COL_VERTEX(-3200,  1207,  -563),
    ...
    COL_VERTEX( -896,   922, -5370),
    COL_VERTEX(-2096,   922, -4764),
    COL_VERTEX( -944,   922, -2479),
    COL_VERTEX(  256,   922, -3085),
    ...
    SPECIAL_OBJECT(/*preset*/ special_bubble_tree, /*pos*/ -1504,  144,  5094),
    SPECIAL_OBJECT(/*preset*/ special_bubble_tree, /*pos*/ -4096,  768,  3072),
    SPECIAL_OBJECT(/*preset*/ special_bubble_tree, /*pos*/ -5120,  768,  2048),
    SPECIAL_OBJECT(/*preset*/ special_bubble_tree, /*pos*/  5444,  864,  6016),
    SPECIAL_OBJECT(/*preset*/ special_bubble_tree, /*pos*/ -6656,  768,  3584),
    SPECIAL_OBJECT(/*preset*/ special_bubble_tree, /*pos*/ -6130,  900, -6508),
    SPECIAL_OBJECT(/*preset*/ special_bubble_tree, /*pos*/ -6804, 1024, -4866),
    SPECIAL_OBJECT(/*preset*/ special_bubble_tree, /*pos*/  6033, 2194, -7660),
    SPECIAL_OBJECT(/*preset*/ special_bubble_tree, /*pos*/ -4096,  768,  1536),
    SPECIAL_OBJECT(/*preset*/ special_bubble_tree, /*pos*/ -4268,    0,  4768),
    SPECIAL_OBJECT(/*preset*/ special_bubble_tree, /*pos*/ -3584,  768,  2560),
    SPECIAL_OBJECT(/*preset*/ special_bubble_tree, /*pos*/ -6172, 1024,  -432),
    SPECIAL_OBJECT(/*preset*/ special_bubble_tree, /*pos*/  4096, 3072,  1638),
    SPECIAL_OBJECT(/*preset*/ special_bubble_tree, /*pos*/  6800, 2008, -5587),
    SPECIAL_OBJECT(/*preset*/ special_bubble_tree, /*pos*/  2911,  768,  5917),
    SPECIAL_OBJECT(/*preset*/ special_bubble_tree, /*pos*/  4208,  922,  3772),
    COL_END(),
};
