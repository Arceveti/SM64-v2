...
static const Vtx lll_seg7_vertex_07018D08[] = {
    {{{   768,      0,    384}, 0, { 10188,  31<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   768,    154,    384}, 0, { 10188,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -768,    154,    384}, 0, {     0,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -768,      0,    384}, 0, {     0,  31<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -768,      0,   -384}, 0, { 31<<5,  31<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   768,    154,   -384}, 0, { -9228,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   768,      0,   -384}, 0, { -9228,  31<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -768,    154,   -384}, 0, { 31<<5,      0}, {0x00, 0x00, 0x81, 0xff}}},
};

// 0x07018D88 - 0x07018E48
static const Vtx lll_seg7_vertex_07018D88[] = {
    {{{   768,    154,   -384}, 0, {     0,  -9230}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  -768,    154,   -384}, 0, {     0,  31<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  -768,    154,    384}, 0, { 31<<5,  31<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   768,    154,    384}, 0, { 31<<5,  -9230}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   768,      0,   -384}, 0, { 31<<5,  31<<5}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   768,    154,   -384}, 0, { 31<<5,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   768,    154,    384}, 0, { -4118,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   768,      0,    384}, 0, { -4118,  31<<5}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{  -768,      0,    384}, 0, { 31<<5,  31<<5}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  -768,    154,   -384}, 0, { -4118,      0}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  -768,      0,   -384}, 0, { -4118,  31<<5}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  -768,    154,    384}, 0, { 31<<5,      0}, {0x81, 0x00, 0x00, 0xff}}},
};
...
const Gfx lll_seg7_dl_wooden_float_large[] = {
    gsDPPipeSync(),
