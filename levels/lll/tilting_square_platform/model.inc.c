...
static const Vtx lll_seg7_vertex_tilting_square_platform_sides[] = {
    {{{     0,      0,      0}, 0, { 15<<5,  15<<5}, {0xff, 0x00, 0x00, 0xff}}},
    {{{  -307,    307,   -307}, 0, {     0,  31<<5}, {0xff, 0x00, 0x00, 0xff}}},
    {{{   307,    307,   -307}, 0, { 31<<5,  31<<5}, {0xff, 0x00, 0x00, 0xff}}},
    {{{   307,    307,    307}, 0, { 31<<5,      0}, {0xff, 0x00, 0x00, 0xff}}},
    {{{  -307,    307,    307}, 0, {     0,      0}, {0xff, 0x00, 0x00, 0xff}}},
    {{{     0,      0,      0}, 0, { 15<<5,  15<<5}, {0xc8, 0x00, 0x00, 0xff}}},
    {{{  -307,    307,    307}, 0, {     0,      0}, {0xc8, 0x00, 0x00, 0xff}}},
    {{{  -307,    307,   -307}, 0, {     0,  31<<5}, {0xc8, 0x00, 0x00, 0xff}}},
    {{{   307,    307,   -307}, 0, { 31<<5,  31<<5}, {0xc8, 0x00, 0x00, 0xff}}},
    {{{   307,    307,    307}, 0, { 31<<5,      0}, {0xc8, 0x00, 0x00, 0xff}}},
};

// 0x0701A120 - 0x0701A160
static const Vtx lll_seg7_vertex_tilting_square_platform_top[] = {
    {{{   307,    307,    307}, 0, { 31<<5,  31<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  -307,    307,   -307}, 0, {     0,      0}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  -307,    307,    307}, 0, {     0,  31<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   307,    307,   -307}, 0, { 31<<5,      0}, {0x00, 0x7f, 0x00, 0xff}}},
};
