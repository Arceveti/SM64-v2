...
const Collision lll_seg7_area_1_collision[] = {
    ...
    COL_VERTEX(-3072,   10,  3584),
    COL_VERTEX(-3072,   10,  3328),
    ...
    COL_VERTEX(  186,  102,   108),
    COL_VERTEX(  186,  102,  -108),
    COL_VERTEX(-3072,  307,  3584),
    COL_VERTEX(-3072,  307,  3328),
    ...
    COL_VERTEX( -128,    0, -1920),
    COL_VERTEX( -128,  307, -2175),
    COL_VERTEX( -128,    0, -2175),
    COL_VERTEX(  128,  307, -2175),
    COL_VERTEX(  128,    0, -2175),
    COL_VERTEX(  128,  307, -1920),
    COL_VERTEX(  128,    0, -1920),
    COL_VERTEX( -128,  307, -1920),
    COL_VERTEX(-4608,    0, -1024),
    COL_VERTEX(-4608,  154,  -384),
    COL_VERTEX(-4608,    0,     0),
    COL_VERTEX(-4608,  307, -1024),
    COL_VERTEX(-4608,  307,  -640),
    COL_VERTEX(-5632,    0, -1024),
    COL_VERTEX(-5632,  307,  -640),
    COL_VERTEX(-5632,  307, -1024),
    COL_VERTEX(-5632,  154,  -384),
    COL_VERTEX(-4608,  154,     0),
    COL_VERTEX(-5632,    0,     0),
    COL_VERTEX(-5632,  154,     0),
    COL_VERTEX(-4096,    0,  3968),
    COL_VERTEX(-4096,    0,  2944),
    COL_VERTEX(-4096,  307,  2944),
    COL_VERTEX(-4480,  307,  2944),
    COL_VERTEX(-4735,  154,  3968),
    COL_VERTEX(-4735,  154,  2944),
    COL_VERTEX(-5120,    0,  2944),
    COL_VERTEX(-5120,    0,  3968),
    ...
    COL_VERTEX( -256,    0,  6528),
    COL_VERTEX(-1152,  154,  6528),
    COL_VERTEX(-1152,    0,  6528),
    COL_VERTEX(  640,    0,  6400),
    COL_VERTEX(-5376,  307, -3072),
    COL_VERTEX(-5376,    0, -3072),
    COL_VERTEX(-5503,    0, -2943),
    COL_VERTEX(-4863,    0, -3072),
    COL_VERTEX(-4735,    0, -2943),
    COL_VERTEX(-4735,    0, -1152),
    COL_VERTEX(-5376,    0, -1024),
    COL_VERTEX(-5503,    0, -1152),
    COL_VERTEX(-2560,    0,  4224),
    COL_VERTEX(-3840,    0,  2688),
    COL_VERTEX(-2560,    0,  2688),
    COL_VERTEX(-3072,  307,  2688),
    COL_VERTEX(-3840,    0,  4224),
    COL_VERTEX(-3840,  307,  4224),
    COL_VERTEX(-3327,  307,  4224),
    COL_VERTEX(-2560,    0,  3840),
    COL_VERTEX(-2380,  410,  3840),
    COL_VERTEX(-2304,    0,  3840),
    COL_VERTEX(-2304,  307,  3840),
    COL_VERTEX(-2560,  307,  3968),
    COL_VERTEX(-2304,  307,  3328),
    COL_VERTEX(-2380,  410,  3328),
    COL_VERTEX(-2304,    0,  3328),
    COL_VERTEX(-2560,    0,  3328),
    COL_VERTEX(-2560,  307,  3456),
    COL_VERTEX(-1280,  307,  3840),
    COL_VERTEX(-1458,  410,  3840),
    COL_VERTEX(-1536,    0,  3840),
    COL_VERTEX(-1536,    0,  3968),
    COL_VERTEX(-1536,    0,  3456),
    COL_VERTEX(-1536,  307,  3456),
    COL_VERTEX(-1458,  410,  3328),
    COL_VERTEX(-1280,    0,  3456),
    COL_VERTEX(-1024,  307,  3328),
    COL_VERTEX(-1280,  307,  3328),
    COL_VERTEX(-1280,    0,  3968),
    COL_VERTEX(-1536,  307,  3968),
    COL_VERTEX(-1024,    0,  4096),
    COL_VERTEX(-1280,    0,  3328),
    ...
    COL_VERTEX(-4096,  154,  6528),
    COL_VERTEX(-3584,  154,  6528),
    COL_VERTEX(-3584,    0,  6528),
    COL_VERTEX(-2304,    0,  6528),
    COL_VERTEX(-2304,  154,  6016),
    COL_VERTEX(-3584,    0,  6016),
    COL_VERTEX(-4096,    0,  6016),
    COL_VERTEX(-4096,    0,  6528),
    COL_VERTEX(  256,  154,  4096),
    COL_VERTEX( -256,  230,  4224),
    COL_VERTEX(  256,  154,  4224),
    COL_VERTEX( -256,  154,  4224),
    COL_VERTEX(-1664,    0,  6016),
    COL_VERTEX(-1664,  154,  6528),
    COL_VERTEX(-4608,  154,   512),
    COL_VERTEX(-4096,  154,   512),
    COL_VERTEX(-4096,  154,     0),
    ...
    COL_VERTEX( 6656,  154, -3504),
    COL_VERTEX( 7030,  154, -2855),
    COL_VERTEX( 6282,  154, -3287),
    COL_VERTEX(-2759,  166,   435),
    COL_VERTEX(-2722,  403,   550),
    COL_VERTEX(-2667,  554,   718),
    COL_VERTEX(-2568,  640,  1024),
    COL_VERTEX(-2469,  554,  1327),
    COL_VERTEX(-2408,  376,  1515),
    COL_VERTEX(-2377,  166,  1611),
    COL_VERTEX(-2080,  640,   864),
    COL_VERTEX(-7179,  128,  4096),
    COL_VERTEX(-6665,  256,  4982),
    COL_VERTEX(-7042,  256,  4606),
    COL_VERTEX(-6151,  128,  5120),
    COL_VERTEX(-6151,  128, -7175),
    COL_VERTEX(-7042,  256, -6661),
    COL_VERTEX(-6665,  256, -7037),
    COL_VERTEX(-7179,  128, -6147),
    COL_VERTEX(-2567,  128, -2567),
    COL_VERTEX(-3458,  256, -2053),
    COL_VERTEX(-3081,  256, -2429),
    COL_VERTEX(-3595,  128, -1539),
    ...
    COL_VERTEX( 6572,  166, -5960),
    COL_VERTEX( 6497,  640, -6758),
    COL_VERTEX(-4096,  307,  3968),
    COL_VERTEX(-4480,  307,  3968),
    COL_VERTEX(-5120,  154,  3968),
    COL_VERTEX(-5120,  154,  2944),
    COL_VERTEX( 1536,  307,  3968),
    ...
    COL_VERTEX( -256,  154,  6528),
    COL_VERTEX( -384,  154,  6400),
    COL_VERTEX(-1152,  154,  6016),
    COL_VERTEX(-1152,    0,  6016),
    COL_VERTEX( -256,    0,  4224),
    COL_VERTEX(  256,  230,  4224),
    COL_VERTEX( -256,  230,  4096),
    COL_VERTEX( -384,    0,  6400),
    COL_VERTEX(  640,  154,  6016),
    COL_VERTEX(-5503,  307, -1152),
    COL_VERTEX(-5376,  307, -1024),
    COL_VERTEX(-5503,  307, -2943),
    COL_VERTEX(-4863,  307, -1024),
    COL_VERTEX(-4735,  307, -2943),
    COL_VERTEX(-4863,  307, -3072),
    COL_VERTEX(-4735,  307, -1152),
    COL_VERTEX(  640,  154,  6400),
    COL_VERTEX(-4863,    0, -1024),
    COL_VERTEX(-2560,  307,  4224),
    COL_VERTEX(-2560,  307,  2688),
    COL_VERTEX(-3840,  307,  2688),
    COL_VERTEX(-3072,  307,  4224),
    COL_VERTEX(-3327,  307,  2688),
    COL_VERTEX(-2560,  307,  3840),
    COL_VERTEX(-2304,  307,  3968),
    COL_VERTEX(-2380,  410,  3968),
    COL_VERTEX(-2304,    0,  3968),
    COL_VERTEX(-2560,    0,  3968),
    COL_VERTEX(-2380,  410,  3456),
    COL_VERTEX(-2304,  307,  3456),
    COL_VERTEX(-2560,  307,  3328),
    COL_VERTEX(-2304,    0,  3456),
    COL_VERTEX(-2560,    0,  3456),
    COL_VERTEX(-1458,  410,  3968),
    COL_VERTEX(-1536,  307,  3840),
    COL_VERTEX(-1280,    0,  3840),
    COL_VERTEX(-1280,  307,  3968),
    COL_VERTEX(-1536,  307,  3328),
    COL_VERTEX(-1280,  307,  3456),
    COL_VERTEX(-1458,  410,  3456),
    COL_VERTEX(-1536,    0,  3328),
    ...
    COL_VERTEX( 4608,  154, -1152),
    COL_VERTEX( 5248,  154,     0),
    COL_VERTEX( 5120,  154,  -384),
    COL_VERTEX( 4992,  154,  -768),
    COL_VERTEX( 5632,  154, -1152),
    COL_VERTEX( 5504,  154,  -384),
    COL_VERTEX( 5248,  154, -1536),
    COL_VERTEX( 5504,  154,   640),
    COL_VERTEX( 4096,  154,   384),
    COL_VERTEX( 4096,  154,   768),
    COL_VERTEX( 4480,  154, -1664),
    COL_VERTEX( 4096,  154, -1664),
    COL_VERTEX( 4096,  154, -2048),
    COL_VERTEX( 2688,  307, -6015),
    COL_VERTEX( 4608,  307, -6400),
    COL_VERTEX( 2688,  307, -5247),
    COL_VERTEX( 3072,  307, -4863),
    COL_VERTEX( 4992,  307, -6015),
    COL_VERTEX( 4992,  307, -5247),
    COL_VERTEX( 4608,  307, -4863),
    COL_VERTEX(-4096,  307,  3584),
    COL_VERTEX(-3840,  307,  3584),
    COL_VERTEX(-4096,  307,  3328),
    ...
    COL_VERTEX(  384,  768, -7231),
    COL_VERTEX(  384,    0, -7231),
    COL_VERTEX(-3584,  154,  6016),
    COL_VERTEX(-2304,  154,  6528),
    COL_VERTEX(-2304,    0,  6016),
    COL_VERTEX(-4096,  154,  6016),
    COL_VERTEX(  256,  230,  4096),
    COL_VERTEX( -256,  154,  4096),
    COL_VERTEX(-1664,  154,  6016),
    COL_VERTEX(-1664,    0,  6528),
    ...
    COL_VERTEX(-5320,  320, -3400),
    COL_VERTEX(-4920,  320, -3400),
    COL_VERTEX(-4920,  320, -3000),
    COL_VERTEX(-5320,  320, -3000),
    ...
    COL_TRI_STOP(),
    COL_SPECIAL_INIT(1),
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_null_start, /*pos*/ -3840, 154, 6272, /*yaw*/ 64), // unused, probably an early way to set initial position
    COL_END(),
};
