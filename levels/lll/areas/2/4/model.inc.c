...
static const Vtx lll_seg7_vertex_07025648[] = {
    ...
    {{{     0,   7373,    496}, 0, {   376,    868}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -245,   7373,    426}, 0, {   132,    802}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   426,   7373,    246}, 0, {   802,    622}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   496,   7373,      0}, 0, {   868,    376}, {0xff, 0xff, 0xff, 0xff}}},
};

// 0x07025708 - 0x07025808
static const Vtx lll_seg7_vertex_volcano_exit_hole_1[] = {
...
static const Vtx lll_seg7_vertex_volcano_exit_hole_2[] = {
    {{{   532,   7168,    307}, 0, {     0,      0}, {0x00, 0x00, 0x00, 0xff}}},
    {{{   102,   7168,    177}, 0, {     0,      0}, {0x00, 0x00, 0x00, 0xff}}},
...
static const Gfx lll_seg7_vertex_volcano_exit_sky[] = {
...
static const Gfx lll_seg7_sub_dl_volcano_exit_hole[] = {
    gsSPVertex(lll_seg7_vertex_volcano_exit_hole_1, 16, 0),
    ...
    gsSPVertex(lll_seg7_vertex_volcano_exit_hole_2, 15, 0),
...
const Gfx lll_seg7_dl_volcano_exit[] = {
    gsDPPipeSync(),
    ...
    gsSPDisplayList(lll_seg7_vertex_volcano_exit_sky),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_OFF),
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADE, G_CC_SHADE),
    gsSPDisplayList(lll_seg7_sub_dl_volcano_exit_hole),
