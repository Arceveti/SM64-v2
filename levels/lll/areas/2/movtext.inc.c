...
Movtex lll_movtex_tris_lava_floor[] = {
    MOV_TEX_SPD(     1),
    MOV_TEX_TRIS( 8192, 0,  8192, 0, 0),
    MOV_TEX_TRIS(    0, 0,  8192, 0, 2),
    MOV_TEX_TRIS(-8192, 0,  8192, 0, 4),
    MOV_TEX_TRIS( 8192, 0,     0, 2, 0),
    MOV_TEX_TRIS(    0, 0,     0, 2, 2),
    MOV_TEX_TRIS(-8192, 0,     0, 2, 4),
    MOV_TEX_TRIS( 8192, 0, -8192, 4, 0),
    MOV_TEX_TRIS(    0, 0, -8192, 4, 2),
    MOV_TEX_TRIS(-8192, 0, -8192, 4, 4),
};
