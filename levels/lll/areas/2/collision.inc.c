...
const Collision lll_seg7_area_2_collision[] = {
    ...
    COL_VERTEX( -788, 1562,  2943),
    COL_VERTEX(-1720, 1613,  1720),
    COL_VERTEX(-2942, 2268,  -788),
    COL_VERTEX(-2348, 2268,  -628),
    COL_VERTEX(-2154, 2391, -2154),
    COL_VERTEX(-2154, 2442, -2154),
    COL_VERTEX(-1720, 2442, -1720),
    COL_VERTEX( 2411, 3539,  -480),
    COL_VERTEX( 2943, 3539,  -788),
    COL_VERTEX( 1831,  978,  1831),
    COL_VERTEX(  645,  978,  2328),
    COL_VERTEX( -788, 1152,  2328),
    COL_VERTEX(-1720, 2391, -1720),
    COL_VERTEX(-2942, 2217,  -788),
    ...
    COL_VERTEX( 2154, 3463, -2154),
    COL_VERTEX( 2154,  179, -2154),
    ...
    COL_VERTEX(-1940, 1905,   -26),
    COL_VERTEX(-2321, 1905,  -173),
    COL_VERTEX(-2086, 1591,  -224),
    COL_VERTEX(-1940, 1853,   -26),
    COL_VERTEX(-2321, 1853,  -173),
    COL_VERTEX(-2295, 1853,  -410),
    COL_VERTEX(-2275, 1981,    64),
    COL_VERTEX(-2046, 1981,   475),
    COL_VERTEX(-2275, 1930,    64),
    COL_VERTEX(-2219, 1981,   666),
    COL_VERTEX(-2621, 1981,   551),
    COL_VERTEX(-2659, 1981,    96),
    COL_VERTEX(-2046, 1930,   475),
    COL_VERTEX(-2363, 1799,   402),
    COL_VERTEX(-2659, 1930,    96),
    COL_VERTEX(-2621, 1930,   551),
    COL_VERTEX(-2457, 2089,  -488),
    COL_VERTEX(-2389, 2089,  -205),
    COL_VERTEX(-2837, 2038,  -256),
    COL_VERTEX(-2644, 2089,   -36),
    COL_VERTEX(-2879, 2089,  -512),
    COL_VERTEX(-2644, 2038,   -36),
    COL_VERTEX(-2389, 2038,  -205),
    COL_VERTEX(-2572, 1792,  -256),
    COL_VERTEX(-2457, 2038,  -488),
    COL_VERTEX(-2879, 2038,  -512),
    ...
    COL_VERTEX(  992,   82, -1725),
    COL_VERTEX( 1075,   82, -2032),
    COL_VERTEX( 1211,   82, -2222),
    COL_VERTEX( 1610,   82, -2166),
    COL_VERTEX(-1246,    0,  -700),
    COL_VERTEX( -984,    0,  -614),
    COL_VERTEX(-1386,    0, -1060),
    COL_VERTEX( -776,    0,  -614),
    COL_VERTEX( -544,    0,  -786),
    COL_VERTEX( -666,  102,  -865),
    COL_VERTEX( -656,  102, -1042),
    COL_VERTEX( -536,    0, -1039),
    COL_VERTEX( -488,    0, -1178),
    COL_VERTEX( -623,  102, -1140),
    COL_VERTEX(-1008,    0, -1482),
    COL_VERTEX(-1313,    0, -1368),
    COL_VERTEX( -986,  102, -1352),
    COL_VERTEX( -800,    0, -1409),
    COL_VERTEX( -604,    0, -1392),
    COL_VERTEX( -704,  102, -1289),
    COL_VERTEX( -842,  102, -1301),
    COL_VERTEX(-1201,  102, -1273),
    COL_VERTEX( 1507,   48, -1190),
    ...
    COL_VERTEX( 2076, 3621, -1331),
    COL_VERTEX( 2007, 3621, -1454),
    COL_VERTEX( 2187, 3539,  -992),
    ...
    COL_VERTEX( -788, 1203,  2328),
    COL_VERTEX(  788, 1203,  2943),
    COL_VERTEX( -788, 1562,  2328),
    COL_VERTEX(-2154, 1613,  2154),
    COL_VERTEX( -788, 1613,  2943),
    COL_VERTEX( -788, 1613,  2328),
    COL_VERTEX(-2154, 2268, -2154),
    COL_VERTEX(-1720, 2268, -1720),
    COL_VERTEX( -669, 2442, -2500),
    COL_VERTEX( 1704, 3539, -1703),
    COL_VERTEX( 2154, 3539, -2154),
    COL_VERTEX(-1720, 2217, -1720),
    COL_VERTEX(-1720, 1562,  1720),
    COL_VERTEX(-2348, 2217,  -628),
    COL_VERTEX(-2154,  128, -2154),
    COL_VERTEX( 2154,  128,  2154),
    COL_VERTEX(-2154, 1562,  2154),
    COL_VERTEX( -788, 2391, -2942),
    COL_VERTEX( 2302,  640,  1342),
    COL_VERTEX( 2697,  349,   224),
    COL_VERTEX( 2601,  167,  -533),
    COL_VERTEX( 2154, 2121, -2154),
    COL_VERTEX( 2943, 2121,  -788),
    COL_VERTEX( 2411, 3463,  -480),
    COL_VERTEX(-1874, 1628,  1252),
    COL_VERTEX(-2102, 1341,  1520),
    COL_VERTEX(-1972, 1669,   614),
    ...
    COL_VERTEX( -205,    0, -1241),
    COL_VERTEX(  205,    0, -1250),
    ...
    COL_VERTEX(  154,   56, -2784),
    COL_VERTEX(  179,   22, -2717),
    COL_VERTEX(  188,   32, -2720),
    COL_VERTEX(  228,  102, -2759),
    COL_VERTEX(  230,  192, -2785),
    COL_VERTEX(  205,  231, -2809),
    ...
    COL_TRI_STOP(),
    COL_SPECIAL_INIT(1),
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_null_start, /*pos*/ -960, 102, -1024, /*yaw*/ 84), // unused, probably an early way to set initial position
    COL_WATER_BOX_INIT(1),
    COL_WATER_BOX(10, -3072, -3072,  3072,  3072, 20),
    COL_END(),
};
