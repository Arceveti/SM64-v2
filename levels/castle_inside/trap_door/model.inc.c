...
static const Vtx inside_castle_seg7_vertex_0703BAC8[] = {
    ...
    {{{   358,   -102,    307}, 0, {     0,  15<<5}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   358,   -102,   -307}, 0, { 95<<5,  15<<5}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   358,      0,   -307}, 0, {  1756,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   358,   -102,   -307}, 0, {  1756,  15<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{     0,   -102,   -307}, 0, {     0,  15<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{     0,      0,   -307}, 0, {     0,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{     0,      0,   -307}, 0, { 95<<5,      0}, {0x81, 0x00, 0x00, 0xff}}},
    {{{     0,   -102,   -307}, 0, { 95<<5,  15<<5}, {0x81, 0x00, 0x00, 0xff}}},
    {{{     0,   -102,    307}, 0, {     0,  15<<5}, {0x81, 0x00, 0x00, 0xff}}},
    {{{     0,      0,    307}, 0, {     0,      0}, {0x81, 0x00, 0x00, 0xff}}},
    {{{     0,      0,    307}, 0, {     0,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   358,   -102,    307}, 0, {  1756,  15<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   358,      0,    307}, 0, {  1756,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{     0,   -102,    307}, 0, {     0,  15<<5}, {0x00, 0x00, 0x7f, 0xff}}},
};

// 0x0703BBB8 - 0x0703BC28
static const Vtx inside_castle_seg7_vertex_0703BBB8[] = {
    {{{   358,      0,   -307}, 0, {  1756,  -2080}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{     0,      0,    307}, 0, {     0,  31<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   358,      0,    307}, 0, {  1756,  31<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   358,      0,    307}, 0, {     0,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   358,   -102,   -307}, 0, { 95<<5,  15<<5}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   358,      0,   -307}, 0, { 95<<5,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{     0,      0,   -307}, 0, {     0,  -2080}, {0x00, 0x7f, 0x00, 0xff}}},
};
...
const Gfx inside_castle_seg7_dl_bowser_trap_door[] = {
    gsDPPipeSync(),
