...
static const Vtx inside_castle_seg7_vertex_painting_textured[] = {
    ...
    {{{   614,    614,      0}, 0, { 63<<5,    -32}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{     0,    614,      0}, 0, {   -32,    -32}, {0x00, 0x00, 0x7f, 0xff}}},
};

// 0x07021898 - 0x07021918
static const Vtx inside_castle_seg7_vertex_painting_sl[] = {
    {{{     0,      0,      0}, 0, {   -32,  31<<5}, {0xdd, 0xdd, 0xdd, 0xff}}},
    {{{   614,      0,      0}, 0, { 63<<5,  31<<5}, {0xdd, 0xdd, 0xdd, 0xff}}},
    {{{   614,    307,      0}, 0, { 63<<5,      0}, {0xdd, 0xdd, 0xdd, 0xff}}},
    {{{     0,    307,      0}, 0, {   -32,      0}, {0xdd, 0xdd, 0xdd, 0xff}}},
    {{{     0,    307,      0}, 0, {   -32,  31<<5}, {0xdd, 0xdd, 0xdd, 0xff}}},
    {{{   614,    307,      0}, 0, { 63<<5,  31<<5}, {0xdd, 0xdd, 0xdd, 0xff}}},
    {{{   614,    614,      0}, 0, { 63<<5,    -32}, {0xdd, 0xdd, 0xdd, 0xff}}},
    {{{     0,    614,      0}, 0, {   -32,    -32}, {0xdd, 0xdd, 0xdd, 0xff}}},
};

// 0x07021918 - 0x07021998
static const Vtx inside_castle_seg7_vertex_painting_ccm_fake_1[] = {
    {{{ -3046,   -307,  -3724}, 0, {   -32,  31<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{ -2742,   -307,  -4258}, 0, { 63<<5,  31<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{ -2742,      0,  -4258}, 0, { 63<<5,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{ -3046,      0,  -3724}, 0, {   -32,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{ -3046,      0,  -3724}, 0, {   -32,  31<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{ -2742,      0,  -4258}, 0, { 63<<5,  31<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{ -2742,    307,  -4258}, 0, { 63<<5,      0}, {0x00, 0x00, 0x7f, 0xff}}},
...
static const Vtx inside_castle_seg7_vertex_painting_ccm_fake_2[] = {
    {{{ -1866,   -307,  -4258}, 0, {   -32,  31<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{ -1562,   -307,  -3724}, 0, { 63<<5,  31<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{ -1562,      0,  -3724}, 0, { 63<<5,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{ -1866,      0,  -4258}, 0, {   -32,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{ -1866,      0,  -4258}, 0, {   -32,  31<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{ -1562,      0,  -3724}, 0, { 63<<5,  31<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{ -1562,    307,  -3724}, 0, { 63<<5,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{ -1866,    307,  -4258}, 0, {   -32,      0}, {0x00, 0x00, 0x7f, 0xff}}},
};

// 0x07021A18 - 0x07021A30
static const Gfx inside_castle_seg7_dl_painting_bottom_model[] = {
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSPEndDisplayList(),
};

// 0x07021A30 - 0x07021A48
static const Gfx inside_castle_seg7_dl_painting_top_model[] = {
...
static const Gfx inside_castle_seg7_painting_dl_bob[] = {
    ...
    gsSPDisplayList(inside_castle_seg7_dl_painting_bottom_model),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, inside_castle_seg7_texture_bob_top),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
    gsSPDisplayList(inside_castle_seg7_dl_painting_top_model),
...
#ifdef PSS_PAINTING
static const Gfx inside_castle_seg7_painting_dl_pss[] = {
    gsSPDisplayList(inside_castle_seg7_dl_painting_texture_begin),
    gsSPVertex(inside_castle_seg7_vertex_painting_textured, 8, 0),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, inside_castle_seg7_texture_pss_bottom),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
    gsSPDisplayList(inside_castle_seg7_dl_painting_bottom_model),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, inside_castle_seg7_texture_pss_top),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
    gsSPDisplayList(inside_castle_seg7_dl_painting_top_model),
    gsSPDisplayList(inside_castle_seg7_dl_painting_texture_end),
...
static const Gfx inside_castle_seg7_painting_dl_lll[] = {
    gsSPDisplayList(inside_castle_seg7_dl_painting_texture_begin),
    gsSPVertex(inside_castle_seg7_vertex_painting_textured, 8, 0),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, inside_castle_seg7_texture_lll_bottom),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
    gsSPDisplayList(inside_castle_seg7_dl_painting_bottom_model),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, inside_castle_seg7_texture_lll_top),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
    gsSPDisplayList(inside_castle_seg7_dl_painting_top_model),
    gsSPDisplayList(inside_castle_seg7_dl_painting_texture_end),
...
static const Gfx inside_castle_seg7_painting_dl_ssl[] = {
    gsSPDisplayList(inside_castle_seg7_dl_painting_texture_begin),
    gsSPVertex(inside_castle_seg7_vertex_painting_textured, 8, 0),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, inside_castle_seg7_texture_ssl_bottom),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
    gsSPDisplayList(inside_castle_seg7_dl_painting_bottom_model),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, inside_castle_seg7_texture_ssl_top),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
    gsSPDisplayList(inside_castle_seg7_dl_painting_top_model),
    gsSPDisplayList(inside_castle_seg7_dl_painting_texture_end),
...
static const Gfx inside_castle_seg7_painting_dl_wdw[] = {
    gsSPDisplayList(inside_castle_seg7_dl_painting_texture_begin),
    gsSPVertex(inside_castle_seg7_vertex_painting_textured, 8, 0),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, inside_castle_seg7_texture_wdw_bottom),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
    gsSPDisplayList(inside_castle_seg7_dl_painting_bottom_model),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, inside_castle_seg7_texture_wdw_top),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
    gsSPDisplayList(inside_castle_seg7_dl_painting_top_model),
    gsSPDisplayList(inside_castle_seg7_dl_painting_texture_end),
...
static const Gfx inside_castle_seg7_painting_dl_ttm[] = {
    gsSPDisplayList(inside_castle_seg7_dl_painting_texture_begin),
    gsSPVertex(inside_castle_seg7_vertex_painting_textured, 8, 0),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, inside_castle_seg7_texture_ttm_bottom),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
    gsSPDisplayList(inside_castle_seg7_dl_painting_bottom_model),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, inside_castle_seg7_texture_ttm_top),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
    gsSPDisplayList(inside_castle_seg7_dl_painting_top_model),
    gsSPDisplayList(inside_castle_seg7_dl_painting_texture_end),
...
static const Gfx inside_castle_seg7_painting_dl_ttc[] = {
    gsSPDisplayList(inside_castle_seg7_dl_painting_texture_begin),
    gsSPVertex(inside_castle_seg7_vertex_painting_textured, 8, 0),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, inside_castle_seg7_texture_ttc_bottom),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
    gsSPDisplayList(inside_castle_seg7_dl_painting_bottom_model),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, inside_castle_seg7_texture_ttc_top),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
    gsSPDisplayList(inside_castle_seg7_dl_painting_top_model),
    gsSPDisplayList(inside_castle_seg7_dl_painting_texture_end),
...
static const Gfx inside_castle_seg7_painting_dl_sl[] = {
    ...
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, inside_castle_seg7_texture_sl_bottom),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
    gsSPDisplayList(inside_castle_seg7_dl_painting_bottom_model),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, inside_castle_seg7_texture_sl_top),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
    gsSPDisplayList(inside_castle_seg7_dl_painting_top_model),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_OFF),
...
ALIGNED8 static const Texture *const inside_castle_seg7_painting_textures_bob[] = {
    inside_castle_seg7_texture_bob_bottom, inside_castle_seg7_texture_bob_top,
};

ALIGNED8 static const Texture *const inside_castle_seg7_painting_textures_ccm[] = {
    inside_castle_seg7_texture_ccm_bottom, inside_castle_seg7_texture_ccm_top,
};

ALIGNED8 static const Texture *const inside_castle_seg7_painting_textures_wf[] = {
    inside_castle_seg7_texture_wf_bottom, inside_castle_seg7_texture_wf_top,
};

ALIGNED8 static const Texture *const inside_castle_seg7_painting_textures_jrb[] = {
    inside_castle_seg7_texture_jrb_bottom, inside_castle_seg7_texture_jrb_top,
};

ALIGNED8 static const Texture *const inside_castle_seg7_painting_textures_lll[] = {
    inside_castle_seg7_texture_lll_bottom, inside_castle_seg7_texture_lll_top,
};

ALIGNED8 static const Texture *const inside_castle_seg7_painting_textures_ssl[] = {
    inside_castle_seg7_texture_ssl_bottom, inside_castle_seg7_texture_ssl_top,
};

ALIGNED8 static const Texture *const inside_castle_seg7_painting_textures_hmc_env[] = {
    inside_castle_seg7_texture_hmc_env,
};

ALIGNED8 static const Texture *const inside_castle_seg7_painting_textures_ddd_env[] = {
    inside_castle_seg7_texture_ddd_env,
};

ALIGNED8 static const Texture *const inside_castle_seg7_painting_textures_wdw[] = {
    inside_castle_seg7_texture_wdw_bottom, inside_castle_seg7_texture_wdw_top,
};

ALIGNED8 static const Texture *const inside_castle_seg7_painting_textures_thi[] = {
    inside_castle_seg7_texture_thi_bottom, inside_castle_seg7_texture_thi_top,
};

ALIGNED8 static const Texture *const inside_castle_seg7_painting_textures_ttm[] = {
    inside_castle_seg7_texture_ttm_bottom, inside_castle_seg7_texture_ttm_top,
};

ALIGNED8 static const Texture *const inside_castle_seg7_painting_textures_ttc[] = {
    inside_castle_seg7_texture_ttc_bottom, inside_castle_seg7_texture_ttc_top,
};

ALIGNED8 static const Texture *const inside_castle_seg7_painting_textures_sl[] = {
    inside_castle_seg7_texture_sl_bottom, inside_castle_seg7_texture_sl_top,
};

#ifdef PSS_PAINTING
ALIGNED8 static const Texture *const inside_castle_seg7_painting_textures_pss[] = {
    inside_castle_seg7_texture_pss_bottom, inside_castle_seg7_texture_pss_top,
};
#endif
...
struct Painting pss_painting = {
    ...
    /* Position */   2041.6f,   716.8f,  -2222.4f,
    /*                         curr   passive     entry */
    /* Ripple Magnitude */     0.0f,    20.0f,    80.0f,
    /* Ripple Decay */         1.0f,  0.9608f,  0.9524f,
    /* Ripple Rate */          0.0f,    0.24f,    0.14f,
    ...
    /* Curr Ripple Timer */    0.0f,
    /* Curr Ripple x, y */     0.0f,     0.0f,
    /* Normal DList */ inside_castle_seg7_painting_dl_pss,
    /* Texture Maps */ inside_castle_seg7_painting_texture_maps_07022518,
    /* Textures */     inside_castle_seg7_painting_textures_pss,
    /* Texture w, h */ 64, 32,
    /* Ripple DList */ inside_castle_seg7_painting_dl_image_ripple,
    /* Ripple Trigger */ RIPPLE_TRIGGER_PROXIMITY,
    /* Alpha */ 0xFF,
