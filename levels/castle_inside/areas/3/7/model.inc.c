...
static const Vtx inside_castle_seg7_vertex_07064C40[] = {
    ...
    {{{  1669,  -1075,  -3475}, 0, {  8654,  31<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  1669,   -972,  -3475}, 0, {  8654,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  1669,  -1075,  -1847}, 0, { -7184,  31<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  1669,   -972,  -1847}, 0, {  8144,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3277,  -1075,  -1847}, 0, { -7694,  31<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  1669,  -1075,  -1847}, 0, {  8144,  31<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3277,   -972,  -1847}, 0, { -7694,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3277,   -972,  -3475}, 0, {  8654,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  1669,  -1075,  -3475}, 0, { -7184,  31<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3277,  -1075,  -3475}, 0, {  8654,  31<<5}, {0xff, 0xff, 0xff, 0xff}}},
