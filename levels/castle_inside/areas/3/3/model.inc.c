...
static const Vtx inside_castle_seg7_vertex_0705E328[] = {
    {{{  -102,   -429,   1075}, 0, { 31<<5,   -102}, {0x00, 0x00, 0x81, 0x60}}},
    {{{  -563,   -858,   1075}, 0, {     0,  31<<5}, {0x00, 0x00, 0x81, 0x60}}},
    {{{  -563,   -429,   1075}, 0, {     0,   -102}, {0x00, 0x00, 0x81, 0x60}}},
    {{{  -102,   -858,   1075}, 0, { 31<<5,  31<<5}, {0x00, 0x00, 0x81, 0x60}}},
    {{{  -563,   -858,   1075}, 0, {     0,  31<<5}, {0x00, 0x81, 0x00, 0x60}}},
    {{{  -102,   -858,   1075}, 0, { 31<<5,  31<<5}, {0x00, 0x81, 0x00, 0x60}}},
    {{{  -102,   -858,   1178}, 0, { 31<<5,  31<<5}, {0x00, 0x81, 0x00, 0x60}}},
    {{{  -563,   -858,   1178}, 0, {     0,  31<<5}, {0x00, 0x81, 0x00, 0x60}}},
    {{{  -563,   -460,   1178}, 0, {     0,      0}, {0x00, 0x00, 0x7f, 0x60}}},
    {{{  -102,   -858,   1178}, 0, { 31<<5,  31<<5}, {0x00, 0x00, 0x7f, 0x60}}},
    {{{  -102,   -460,   1178}, 0, { 31<<5,      0}, {0x00, 0x00, 0x7f, 0x60}}},
    {{{  -563,   -858,   1178}, 0, {     0,  31<<5}, {0x00, 0x00, 0x7f, 0x60}}},
};
