...
static Movtex inside_castle_movtex_green_room_water_data[] = {
    ...
    MOV_TEX_4_BOX_TRIS(-3225,  -256),
    MOV_TEX_4_BOX_TRIS(  870,  -256),
...
static Movtex inside_castle_movtex_moat_leftover_water_data[] = {
    ...
    MOV_TEX_ROT_SPEED(    5),
    MOV_TEX_ROT_SCALE(    7),
    MOV_TEX_4_BOX_TRIS(  973, -1280),
    MOV_TEX_4_BOX_TRIS(  973,   256),
    MOV_TEX_4_BOX_TRIS( 5786,   256),
    MOV_TEX_4_BOX_TRIS( 5786, -1280),
    MOV_TEX_ROT(     ROTATE_COUNTER_CLOCKWISE),
    MOV_TEX_ALPHA(    0x96),
...
static Movtex inside_castle_movtex_moat_water_data[] = {
    ...
    MOV_TEX_ROT_SPEED(    3),
    MOV_TEX_ROT_SCALE(    5),
    MOV_TEX_4_BOX_TRIS( 5786, -1331),
    MOV_TEX_4_BOX_TRIS( 5786,   410),
    MOV_TEX_4_BOX_TRIS( 8038,   410),
    MOV_TEX_4_BOX_TRIS( 8038, -1331),
    MOV_TEX_ROT(     ROTATE_COUNTER_CLOCKWISE),
    MOV_TEX_ALPHA(    0x96),
    MOV_TEX_DEFINE(  TEXTURE_WATER),
    MOV_TEX_END(),
