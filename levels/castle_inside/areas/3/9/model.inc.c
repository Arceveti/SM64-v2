...
static const Vtx inside_castle_seg7_vertex_07066D88[] = {
    {{{  3731,  -2421,   -666}, 0, { -9300,  -2080}, {0xff, 0xff, 0x00, 0x80}}},
    {{{  3731,  -2421,   -357}, 0, { -9300,   -544}, {0xff, 0xff, 0x00, 0x80}}},
    {{{  3894,  -2297,   -512}, 0, { -8278,  -1310}, {0xff, 0xff, 0x00, 0x80}}},
    {{{  4179,  -2079,   -512}, 0, { -6490,  -1310}, {0xff, 0xff, 0x00, 0x80}}},
    {{{  4016,  -2204,   -666}, 0, { -7512,  -2080}, {0xff, 0xff, 0x00, 0x80}}},
    {{{  4016,  -2204,   -357}, 0, { -7512,   -544}, {0xff, 0xff, 0x00, 0x80}}},
    {{{  2011,  -2405,   -357}, 0, {   318,   -544}, {0xff, 0xff, 0x00, 0x80}}},
    {{{  2011,  -2405,   -666}, 0, {   318,  -2080}, {0xff, 0xff, 0x00, 0x80}}},
    {{{  1867,  -2261,   -512}, 0, {  -702,  -1310}, {0xff, 0xff, 0x00, 0x80}}},
    {{{  1722,  -2116,   -357}, 0, { -1724,   -544}, {0xff, 0xff, 0x00, 0x80}}},
    {{{  1722,  -2116,   -666}, 0, { -1724,  -2080}, {0xff, 0xff, 0x00, 0x80}}},
    {{{  1577,  -1971,   -512}, 0, { -2746,  -1310}, {0xff, 0xff, 0x00, 0x80}}},
};
