...
static const Vtx inside_castle_seg7_vertex_07051A50[] = {
    ...
    {{{   -51,   2253,   7027}, 0, {     0,      0}, {0x72, 0x00, 0xc9, 0x80}}},
    {{{   -51,   2611,   7027}, 0, {     0,      0}, {0x72, 0x00, 0xc9, 0x80}}},
    {{{   -51,   2611,   7027}, 0, {     0,      0}, {0x00, 0x00, 0x81, 0x80}}},
    {{{   -51,   2253,   7027}, 0, {     0,      0}, {0x00, 0x00, 0x81, 0x80}}},
    ...
    {{{  -410,   2253,   7130}, 0, {     0,      0}, {0x8f, 0x00, 0xc7, 0x80}}},
    {{{  -410,   2611,   7130}, 0, {     0,      0}, {0x8f, 0x00, 0xc7, 0x80}}},
};
