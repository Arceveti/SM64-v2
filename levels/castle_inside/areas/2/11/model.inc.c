...
static const Vtx inside_castle_seg7_vertex_070516E8[] = {
    {{{  2080,   2970,   6091}, 0, { 15<<5,  31<<5}, {0xff, 0xff, 0xff, 0x91}}},
    {{{  1569,   2970,   6091}, 0, { 15<<5,      0}, {0xff, 0xff, 0xff, 0x91}}},
    {{{  1569,   2970,   5681}, 0, { 31<<5,      0}, {0xff, 0xff, 0xff, 0x91}}},
    {{{ -2489,   2970,   6091}, 0, { 15<<5,  31<<5}, {0xff, 0xff, 0xff, 0x91}}},
    {{{ -1977,   3379,   6091}, 0, {     0,      0}, {0xff, 0xff, 0xff, 0x91}}},
    {{{ -2489,   3379,   6091}, 0, {     0,  31<<5}, {0xff, 0xff, 0xff, 0x91}}},
    {{{ -1977,   2970,   6091}, 0, { 15<<5,      0}, {0xff, 0xff, 0xff, 0x91}}},
    {{{ -2489,   2970,   5681}, 0, { 31<<5,  31<<5}, {0xff, 0xff, 0xff, 0x91}}},
    {{{ -1977,   2970,   5681}, 0, { 31<<5,      0}, {0xff, 0xff, 0xff, 0x91}}},
    {{{ -1977,   3379,   5681}, 0, { 15<<5,      0}, {0xff, 0xff, 0xff, 0x91}}},
    {{{ -2489,   3379,   5681}, 0, { 15<<5,  31<<5}, {0xff, 0xff, 0xff, 0x91}}},
    {{{  2080,   3379,   6091}, 0, {     0,  31<<5}, {0xff, 0xff, 0xff, 0x91}}},
    {{{  2080,   2970,   5681}, 0, { 31<<5,  31<<5}, {0xff, 0xff, 0xff, 0x91}}},
    {{{  2900,   3021,   5989}, 0, { 31<<5,  31<<5}, {0xff, 0xff, 0xff, 0x91}}},
    {{{  2900,   3277,   5989}, 0, { 31<<5,      0}, {0xff, 0xff, 0xff, 0x91}}},
    {{{  2900,   3277,   5784}, 0, { 15<<5,      0}, {0xff, 0xff, 0xff, 0x91}}},
};
...
static const Vtx inside_castle_seg7_vertex_070517E8[] = {
    ...
    {{{  2080,   2970,   5681}, 0, { 31<<5,  31<<5}, {0xff, 0xff, 0xff, 0x91}}},
    {{{  1569,   2970,   5681}, 0, { 31<<5,      0}, {0xff, 0xff, 0xff, 0x91}}},
    {{{  1569,   3379,   5681}, 0, { 15<<5,      0}, {0xff, 0xff, 0xff, 0x91}}},
    {{{  2080,   3379,   5681}, 0, { 15<<5,  31<<5}, {0xff, 0xff, 0xff, 0x91}}},
    {{{  2900,   3021,   5784}, 0, { 15<<5,  31<<5}, {0xff, 0xff, 0xff, 0x91}}},
    {{{  3105,   3277,   5784}, 0, {     0,      0}, {0xff, 0xff, 0xff, 0x91}}},
    {{{  3105,   3021,   5784}, 0, {     0,  31<<5}, {0xff, 0xff, 0xff, 0x91}}},
    {{{  2900,   3277,   5784}, 0, { 15<<5,      0}, {0xff, 0xff, 0xff, 0x91}}},
    {{{  2900,   3021,   5989}, 0, { 31<<5,  31<<5}, {0xff, 0xff, 0xff, 0x91}}},
    {{{  3105,   3277,   5989}, 0, { 15<<5,      0}, {0xff, 0xff, 0xff, 0x91}}},
    {{{  3105,   3021,   5989}, 0, { 15<<5,  31<<5}, {0xff, 0xff, 0xff, 0x91}}},
    {{{  2900,   3277,   5989}, 0, { 31<<5,      0}, {0xff, 0xff, 0xff, 0x91}}},
};
