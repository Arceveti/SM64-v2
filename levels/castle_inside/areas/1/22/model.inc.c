static const Vtx dl_castle_aquarium_light_vertex_group_1[] = {
    ...
    {{{  3385,    768,  -1631}, 0, {     0,  31<<5}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  3174,    307,  -1280}, 0, { 31<<5,      0}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  2355,    768,  -1741}, 0, {     0,  31<<5}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  2355,    307,  -1280}, 0, {     0,      0}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  3174,    768,  -1741}, 0, { 31<<5,  31<<5}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  3174,    307,  -1689}, 0, { 31<<5,    422}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  3174,    358,  -1741}, 0, { 31<<5,    536}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  2355,    358,  -1741}, 0, {     0,    536}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  2355,    307,  -1689}, 0, {     0,    422}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  3784,    307,   -581}, 0, { 31<<5,      0}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  4109,    768,   -907}, 0, { 31<<5,  31<<5}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  3385,    358,   1171}, 0, {     0,    536}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  3349,    307,   1135}, 0, {     0,    422}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  4073,    307,    410}, 0, { 31<<5,    422}, {0xbb, 0xc7, 0xff, 0x80}}},
};
...
static const Vtx dl_castle_aquarium_light_vertex_group_2[] = {
    ...
    {{{  4109,    768,   -907}, 0, { 31<<5,  31<<5}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  3784,    307,   -581}, 0, { 31<<5,      0}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  4073,    307,   -871}, 0, { 31<<5,    422}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  4109,    358,   -907}, 0, { 31<<5,    536}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  3385,    358,   1171}, 0, {     0,    536}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  4073,    307,    410}, 0, { 31<<5,    422}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  4109,    358,    447}, 0, { 31<<5,    536}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  3784,    307,    121}, 0, { 31<<5,      0}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  4109,    768,    447}, 0, { 31<<5,  31<<5}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  2355,    307,   1229}, 0, {     0,    422}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  2355,    358,   1280}, 0, {     0,    536}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  2355,    768,   1280}, 0, {     0,  31<<5}, {0xbb, 0xc7, 0xff, 0x80}}},
...
static const Vtx dl_castle_aquarium_light_vertex_group_3[] = {
    {{{  4109,    768,    447}, 0, { 31<<5,  31<<5}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  3060,    307,    846}, 0, {     0,      0}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  3385,    768,   1171}, 0, {     0,  31<<5}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  3385,    358,   1171}, 0, {     0,    536}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  3349,    307,   1135}, 0, {     0,    422}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  3174,    307,   1229}, 0, { 31<<5,    422}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  3174,    358,   1280}, 0, { 31<<5,    536}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  2355,    358,   1280}, 0, {     0,    536}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  3174,    307,    819}, 0, { 31<<5,      0}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  2355,    307,   1229}, 0, {     0,    422}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  3174,    768,   1280}, 0, { 31<<5,  31<<5}, {0xbb, 0xc7, 0xff, 0x80}}},
    {{{  2355,    768,   1280}, 0, {     0,  31<<5}, {0xbb, 0xc7, 0xff, 0x80}}},
