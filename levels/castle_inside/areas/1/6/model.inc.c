...
static const Lights1 inside_castle_seg7_lights_sun_carpet = gdSPDefLights1(
    0x5f, 0x5f, 0x5f,
...
static const Vtx inside_castle_seg7_vertex_sun_carpet[] = {
    ...
    {{{ -1024,    -51,    451}, 0, { 31<<5,      0}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{ -1289,    -51,    451}, 0, {     0,      0}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{ -1289,    -51,    717}, 0, {     0,  31<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{ -1023,    -51,    717}, 0, { 31<<5,  31<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  -757,    -51,    451}, 0, {     0,      0}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{ -1289,    -51,    983}, 0, {     0,      0}, {0x00, 0x7f, 0x00, 0xff}}},
};
