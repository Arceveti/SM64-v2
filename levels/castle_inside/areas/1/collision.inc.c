...
const Collision inside_castle_seg7_area_1_collision[] = {
    ...
    SPECIAL_OBJECT_WITH_YAW_AND_PARAM(/*preset*/ special_castle_door_warp,  /*pos*/ -944,     0,  2202, /*yaw*/ 128, /*behParam2*/ 1),
    ...
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_3star_door,        /*pos*/ -2303,    0, -1075, /*yaw*/   0),
    COL_END(),
};
