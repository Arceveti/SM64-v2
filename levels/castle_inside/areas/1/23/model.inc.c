...
static const Vtx dl_castle_aquarium_wall_sign_vertex_group[] = {
...
static const Gfx dl_castle_aquarium_wall_sign_model[] = {
    ...
    gsSPVertex(dl_castle_aquarium_wall_sign_vertex_group, 4, 0),
...
const Gfx dl_castle_aquarium_wall_sign[] = {
    ...
    gsSPDisplayList(dl_castle_aquarium_wall_sign_model),
