...
static const Vtx inside_castle_seg7_vertex_07029678[] = {
    {{{  -512,   1024,   1536}, 0, {     0,      0}, {0xcc, 0xe1, 0x91, 0xff}}},
    {{{  -765,   1741,   1536}, 0, {  7<<5,   -748}, {0xd4, 0x93, 0xd2, 0xff}}},
    {{{  -765,   1741,    922}, 0, {  7<<5,   -748}, {0xdd, 0x87, 0xf3, 0xff}}},
    {{{ -1281,   1741,    922}, 0, { 23<<5,   -748}, {0x23, 0x87, 0xf3, 0xff}}},
    {{{ -1281,   1741,   1536}, 0, { 23<<5,   -748}, {0x2e, 0xbf, 0x9e, 0xff}}},
    {{{ -1536,   1024,   1536}, 0, { 31<<5,      0}, {0x39, 0xe5, 0x93, 0xff}}},
};
...
static const Vtx inside_castle_seg7_vertex_07029718[] = {
    {{{   102,   1024,  -1638}, 0, {   -56,   -192}, {0x2b, 0xee, 0x75, 0xff}}},
    {{{   410,   1024,  -1638}, 0, {  -208,   -192}, {0xc5, 0xd2, 0x65, 0xff}}},
    {{{   155,   1741,  -1024}, 0, {   -80,    128}, {0xf7, 0x93, 0x3e, 0xff}}},
    {{{ -2457,   1024,  -1638}, 0, {  1160,   -192}, {0x25, 0xbc, 0x63, 0xff}}},
    {{{ -2457,   1741,   -768}, 0, {  1160,    264}, {0x48, 0x9c, 0x1d, 0xff}}},
    {{{ -3072,   1024,  -1024}, 0, {  1452,    128}, {0x6b, 0xdb, 0x38, 0xff}}},
    {{{ -2202,   1741,  -1024}, 0, {  1038,    128}, {0x09, 0x8c, 0x31, 0xff}}},
    {{{ -2149,   1024,  -1638}, 0, {  1014,   -192}, {0xd5, 0xee, 0x75, 0xff}}},
    {{{ -1536,   1415,  -1302}, 0, {   720,    -16}, {0xef, 0xf7, 0x7d, 0xff}}},
    {{{  -765,   1741,    922}, 0, {   356,   1150}, {0xdd, 0x87, 0xf3, 0xff}}},
    {{{ -1281,   1741,    922}, 0, {   600,   1150}, {0x23, 0x87, 0xf3, 0xff}}},
    {{{ -2457,   1741,   -253}, 0, {  1160,    528}, {0x33, 0x91, 0xe2, 0xff}}},
    {{{  -512,   1415,  -1302}, 0, {   234,    -16}, {0x1a, 0xf5, 0x7b, 0xff}}},
    {{{   410,   1741,   -768}, 0, {  -208,    264}, {0xb8, 0x9c, 0x1d, 0xff}}},
};

// 0x070297F8 - 0x070298D8
static const Vtx inside_castle_seg7_vertex_070297F8[] = {
    {{{  -512,   1024,   1536}, 0, {   234,   1472}, {0xcc, 0xe1, 0x91, 0xff}}},
    {{{   410,   1741,   -253}, 0, {  -208,    534}, {0xcd, 0x91, 0xe2, 0xff}}},
    {{{  1024,   1024,      0}, 0, {  -496,    668}, {0x8f, 0xd8, 0xd8, 0xff}}},
    {{{ -2457,   1741,   -768}, 0, {  1160,    264}, {0x48, 0x9c, 0x1d, 0xff}}},
    {{{ -2457,   1741,   -253}, 0, {  1160,    534}, {0x33, 0x91, 0xe2, 0xff}}},
    {{{ -3072,   1024,      0}, 0, {  1452,    668}, {0x72, 0xd2, 0xe3, 0xff}}},
    {{{ -3072,   1024,  -1024}, 0, {  1452,    128}, {0x6b, 0xdb, 0x38, 0xff}}},
    {{{ -1536,   1024,   1536}, 0, {   720,   1472}, {0x39, 0xe5, 0x93, 0xff}}},
    {{{ -1281,   1741,    922}, 0, {   600,   1150}, {0x23, 0x87, 0xf3, 0xff}}},
    {{{  1024,   1024,  -1024}, 0, {  -496,    128}, {0x99, 0xe6, 0x44, 0xff}}},
    {{{   410,   1741,   -768}, 0, {  -208,    264}, {0xb8, 0x9c, 0x1d, 0xff}}},
    {{{   410,   1024,  -1638}, 0, {  -208,   -192}, {0xc5, 0xd2, 0x65, 0xff}}},
    {{{   155,   1741,  -1024}, 0, {   -80,    128}, {0xf7, 0x93, 0x3e, 0xff}}},
    {{{  -765,   1741,    922}, 0, {   356,   1150}, {0xdd, 0x87, 0xf3, 0xff}}},
...
static const Vtx inside_castle_seg7_vertex_070298D8[] = {
    {{{ -1536,   1024,  -1024}, 0, {     0,   2288}, {0xdb, 0x1d, 0x75, 0xff}}},
    {{{ -1536,   1415,  -1302}, 0, {     0,  63<<5}, {0xef, 0xf7, 0x7d, 0xff}}},
    {{{ -2149,   1024,  -1638}, 0, {  -644,   1676}, {0xd5, 0xee, 0x75, 0xff}}},
    {{{  -512,   1024,  -1024}, 0, { 31<<5,   2288}, {0x1a, 0x20, 0x77, 0xff}}},
    {{{  -512,   1415,  -1302}, 0, { 31<<5,  63<<5}, {0x1a, 0xf5, 0x7b, 0xff}}},
    {{{   102,   1024,  -1638}, 0, {  1604,   1676}, {0x2b, 0xee, 0x75, 0xff}}},
};

// 0x07029938 - 0x07029978
static const Vtx inside_castle_seg7_vertex_07029938[] = {
    {{{ -1281,   1741,   1536}, 0, {  1336,      0}, {0x2e, 0xbf, 0x9e, 0xff}}},
    {{{  -693,   1536,   1536}, 0, {   552,   7<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{ -1353,   1536,   1536}, 0, {  1432,   7<<5}, {0x00, 0x00, 0x81, 0xff}}},
...
static const Vtx inside_castle_seg7_vertex_07029978[] = {
    ...
    {{{  -693,   1536,   1536}, 0, {   336,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -647,   1408,   1536}, 0, {   240,   7<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{ -1399,   1408,   1536}, 0, {  1740,   7<<5}, {0x00, 0x00, 0x81, 0xff}}},
};

// 0x070299B8 - 0x070299F8
static const Vtx inside_castle_seg7_vertex_070299B8[] = {
    {{{ -1399,   1408,   1536}, 0, {  1536,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -647,   1408,   1536}, 0, {    32,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -602,   1280,   1536}, 0, {   -48,   7<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{ -1444,   1280,   1536}, 0, {  1628,   7<<5}, {0x00, 0x00, 0x81, 0xff}}},
};

// 0x070299F8 - 0x07029A38
static const Vtx inside_castle_seg7_vertex_070299F8[] = {
    {{{ -1444,   1280,   1536}, 0, {  1832,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -602,   1280,   1536}, 0, {   144,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -556,   1152,   1536}, 0, {    64,   7<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{ -1490,   1152,   1536}, 0, {  1920,   7<<5}, {0x00, 0x00, 0x81, 0xff}}},
};

// 0x07029A38 - 0x07029A78
static const Vtx inside_castle_seg7_vertex_07029A38[] = {
    {{{ -1490,   1152,   1536}, 0, {  1716,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -512,   1024,   1536}, 0, {  -232,   7<<5}, {0xcc, 0xe1, 0x91, 0xff}}},
    {{{ -1536,   1024,   1536}, 0, {  1808,   7<<5}, {0x39, 0xe5, 0x93, 0xff}}},
    {{{  -556,   1152,   1536}, 0, {  -144,      0}, {0x00, 0x00, 0x81, 0xff}}},
};

// 0x07029A78 - 0x07029B78
static const Vtx inside_castle_seg7_vertex_07029A78[] = {
    {{{  -870,    768,  -1024}, 0, {  4364,  15<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -512,    512,  -1024}, 0, {159<<5,  31<<5}, {0x30, 0x00, 0x75, 0xff}}},
    {{{  -512,   1024,  -1024}, 0, {159<<5,      0}, {0x1a, 0x20, 0x77, 0xff}}},
    {{{  -870,    512,  -1024}, 0, {  4364,  31<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{ -1177,    768,  -1024}, 0, {  3748,  15<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{ -1536,   1024,  -1024}, 0, { 95<<5,      0}, {0xdb, 0x1d, 0x75, 0xff}}},
    {{{ -1536,    512,  -1024}, 0, { 95<<5,  31<<5}, {0xd0, 0x00, 0x75, 0xff}}},
    {{{ -1177,    512,  -1024}, 0, {  3748,  31<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   102,   1024,  -1638}, 0, {  6304,      0}, {0x2b, 0xee, 0x75, 0xff}}},
    {{{   102,    614,  -1638}, 0, {  6304,    786}, {0x30, 0x00, 0x75, 0xff}}},
    {{{   410,    614,  -1638}, 0, {  6916,    786}, {0xd0, 0x00, 0x75, 0xff}}},
    {{{   410,   1024,  -1638}, 0, {  6916,      0}, {0xc5, 0xd2, 0x65, 0xff}}},
    {{{   662,    614,  -1385}, 0, {  7420,    786}, {0xa7, 0x00, 0x59, 0xff}}},
    {{{  1024,    512,  -1024}, 0, {  8144,  31<<5}, {0x89, 0x00, 0x29, 0xff}}},
    {{{  1024,   1024,  -1024}, 0, {  8144,      0}, {0x99, 0xe6, 0x44, 0xff}}},
...
static const Vtx inside_castle_seg7_vertex_07029B78[] = {
    ...
    {{{   662,    614,  -1385}, 0, {  7420,    786}, {0xa7, 0x00, 0x59, 0xff}}},
    {{{   819,    512,  -1229}, 0, {  7736,  31<<5}, {0xa7, 0x00, 0x59, 0xff}}},
    {{{  1024,    512,  -1024}, 0, {  8144,  31<<5}, {0x89, 0x00, 0x29, 0xff}}},
    {{{  1024,    512,  -1024}, 0, {     0,  31<<5}, {0x89, 0x00, 0x29, 0xff}}},
    {{{  1024,    512,      0}, 0, { 63<<5,  31<<5}, {0x88, 0x00, 0xd7, 0xff}}},
    {{{  1024,   1024,      0}, 0, { 63<<5,      0}, {0x8f, 0xd8, 0xd8, 0xff}}},
    {{{  1024,   1024,  -1024}, 0, {     0,      0}, {0x99, 0xe6, 0x44, 0xff}}},
    {{{  1024,   1024,      0}, 0, { -2080,      0}, {0x8f, 0xd8, 0xd8, 0xff}}},
    {{{  1024,    512,      0}, 0, { -2080,  31<<5}, {0x88, 0x00, 0xd7, 0xff}}},
    {{{  -512,    512,   1536}, 0, { 63<<5,  31<<5}, {0xd7, 0x00, 0x89, 0xff}}},
};
...
static const Vtx inside_castle_seg7_vertex_07029C78[] = {
    {{{  1024,   1024,      0}, 0, { -2080,      0}, {0x8f, 0xd8, 0xd8, 0xff}}},
    {{{  -512,    512,   1536}, 0, { 63<<5,  31<<5}, {0xd7, 0x00, 0x89, 0xff}}},
    {{{  -512,   1024,   1536}, 0, { 63<<5,      0}, {0xcc, 0xe1, 0x91, 0xff}}},
    {{{  -512,    512,   1536}, 0, {     0,  31<<5}, {0xd7, 0x00, 0x89, 0xff}}},
    {{{  -784,    512,   1536}, 0, {   512,  31<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -922,    717,   1536}, 0, {   784,    582}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -512,   1024,   1536}, 0, {     0,      0}, {0xcc, 0xe1, 0x91, 0xff}}},
    {{{ -1536,   1024,   1536}, 0, { 63<<5,      0}, {0x39, 0xe5, 0x93, 0xff}}},
    {{{ -1126,    717,   1536}, 0, {  1196,    582}, {0x00, 0x00, 0x81, 0xff}}},
    {{{ -3072,   1024,  -1024}, 0, {     0,      0}, {0x6b, 0xdb, 0x38, 0xff}}},
    {{{ -2866,    512,  -1229}, 0, {   376,  31<<5}, {0x59, 0x00, 0x59, 0xff}}},
    {{{ -2866,   1024,  -1229}, 0, {   376,      0}, {0x59, 0x00, 0x59, 0xff}}},
    {{{ -1536,    512,   1536}, 0, { 63<<5,  31<<5}, {0x29, 0x00, 0x89, 0xff}}},
    {{{ -1262,    512,   1536}, 0, {  1468,  31<<5}, {0x00, 0x00, 0x81, 0xff}}},
};

// 0x07029D58 - 0x07029E58
static const Vtx inside_castle_seg7_vertex_07029D58[] = {
    {{{ -1536,   1024,   1536}, 0, { -2080,      0}, {0x39, 0xe5, 0x93, 0xff}}},
    {{{ -3072,    512,      0}, 0, { 63<<5,  31<<5}, {0x75, 0x00, 0xd0, 0xff}}},
    {{{ -3072,   1024,      0}, 0, { 63<<5,      0}, {0x72, 0xd2, 0xe3, 0xff}}},
    {{{ -1536,    512,   1536}, 0, { -2080,  31<<5}, {0x29, 0x00, 0x89, 0xff}}},
    {{{ -3072,    512,  -1024}, 0, { 63<<5,  31<<5}, {0x79, 0x00, 0x24, 0xff}}},
    {{{ -3072,   1024,  -1024}, 0, { 63<<5,      0}, {0x6b, 0xdb, 0x38, 0xff}}},
    {{{ -3072,   1024,      0}, 0, {     0,      0}, {0x72, 0xd2, 0xe3, 0xff}}},
    {{{ -3072,    512,      0}, 0, {     0,  31<<5}, {0x75, 0x00, 0xd0, 0xff}}},
    {{{ -2149,   1024,  -1638}, 0, {  1808,      0}, {0xd5, 0xee, 0x75, 0xff}}},
    {{{ -1536,    512,  -1024}, 0, { 95<<5,  31<<5}, {0xd0, 0x00, 0x75, 0xff}}},
    {{{ -1536,   1024,  -1024}, 0, { 95<<5,      0}, {0xdb, 0x1d, 0x75, 0xff}}},
    {{{ -3072,   1024,  -1024}, 0, {     0,      0}, {0x6b, 0xdb, 0x38, 0xff}}},
    {{{ -3072,    512,  -1024}, 0, {     0,  31<<5}, {0x79, 0x00, 0x24, 0xff}}},
    {{{ -2866,    512,  -1229}, 0, {   376,  31<<5}, {0x59, 0x00, 0x59, 0xff}}},
    {{{ -2457,    512,  -1638}, 0, {  1196,  31<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{ -2149,    512,  -1638}, 0, {  1808,  31<<5}, {0xd0, 0x00, 0x75, 0xff}}},
};

// 0x07029E58 - 0x07029EA8
static const Vtx inside_castle_seg7_vertex_07029E58[] = {
    {{{ -2149,   1024,  -1638}, 0, {  1808,      0}, {0xd5, 0xee, 0x75, 0xff}}},
    {{{ -2457,   1024,  -1638}, 0, {  1196,      0}, {0x25, 0xbc, 0x63, 0xff}}},
    {{{ -2457,    512,  -1638}, 0, {  1196,  31<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{ -2149,    512,  -1638}, 0, {  1808,  31<<5}, {0xd0, 0x00, 0x75, 0xff}}},
    {{{ -1536,    512,  -1024}, 0, { 95<<5,  31<<5}, {0xd0, 0x00, 0x75, 0xff}}},
};
...
static const Vtx inside_castle_seg7_vertex_07029EA8[] = {
    {{{  1024,    512,      0}, 0, { -2080,      0}, {0x88, 0x00, 0xd7, 0xff}}},
    {{{  -512,      0,   1536}, 0, { 63<<5,  31<<5}, {0xd0, 0x00, 0x8b, 0xff}}},
    {{{  -512,    512,   1536}, 0, { 63<<5,      0}, {0xd7, 0x00, 0x89, 0xff}}},
    {{{   819,    512,  -1229}, 0, {  1604,      0}, {0xa7, 0x00, 0x59, 0xff}}},
    {{{  1024,    205,  -1024}, 0, { 63<<5,    582}, {0x8b, 0x00, 0x30, 0xff}}},
    {{{  1024,    512,  -1024}, 0, { 63<<5,      0}, {0x89, 0x00, 0x29, 0xff}}},
    {{{   819,    205,  -1229}, 0, {  1604,    582}, {0xa7, 0x00, 0x59, 0xff}}},
    {{{  1024,    205,  -1024}, 0, {     0,    582}, {0x8b, 0x00, 0x30, 0xff}}},
    {{{  1024,    461,   -307}, 0, {  1400,     64}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  1024,    512,  -1024}, 0, {     0,      0}, {0x89, 0x00, 0x29, 0xff}}},
    {{{  1024,    205,   -307}, 0, {  1400,    582}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  1024,    461,   -154}, 0, {  1704,     64}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  1024,    512,      0}, 0, { 63<<5,      0}, {0x88, 0x00, 0xd7, 0xff}}},
    {{{  1024,    205,   -154}, 0, {  1704,    582}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  1024,    205,      0}, 0, { 63<<5,    582}, {0x81, 0x00, 0x00, 0xff}}},
};

// 0x07029F98 - 0x0702A088
static const Vtx inside_castle_seg7_vertex_07029F98[] = {
    {{{ -1536,    512,   1536}, 0, { 63<<5,      0}, {0x29, 0x00, 0x89, 0xff}}},
    {{{ -1262,    512,   1536}, 0, {  1468,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{ -1331,    410,   1536}, 0, {  1604,    176}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  1024,    512,      0}, 0, { -2080,      0}, {0x88, 0x00, 0xd7, 0xff}}},
    {{{  1024,      0,      0}, 0, { -2080,  31<<5}, {0xa7, 0x00, 0xa7, 0xff}}},
    {{{  -512,      0,   1536}, 0, { 63<<5,  31<<5}, {0xd0, 0x00, 0x8b, 0xff}}},
    {{{ -1536,    512,   1536}, 0, { -2080,      0}, {0x29, 0x00, 0x89, 0xff}}},
    {{{ -3072,      0,      0}, 0, { 63<<5,  31<<5}, {0x59, 0x00, 0xa7, 0xff}}},
    {{{ -3072,    512,      0}, 0, { 63<<5,      0}, {0x75, 0x00, 0xd0, 0xff}}},
    {{{ -1536,      0,   1536}, 0, { -2080,  31<<5}, {0x20, 0x00, 0x86, 0xff}}},
    {{{  -512,      0,   1536}, 0, {     0,  31<<5}, {0xd0, 0x00, 0x8b, 0xff}}},
    {{{  -717,      0,   1536}, 0, {   376,  31<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -717,    410,   1536}, 0, {   376,    176}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -512,    512,   1536}, 0, {     0,      0}, {0xd7, 0x00, 0x89, 0xff}}},
    {{{  -784,    512,   1536}, 0, {   512,      0}, {0x00, 0x00, 0x81, 0xff}}},
};

// 0x0702A088 - 0x0702A188
static const Vtx inside_castle_seg7_vertex_0702A088[] = {
    {{{ -3072,    512,  -1024}, 0, {     0,      0}, {0x79, 0x00, 0x24, 0xff}}},
    {{{ -2866,    205,  -1229}, 0, {   376,    582}, {0x59, 0x00, 0x59, 0xff}}},
    {{{ -2866,    512,  -1229}, 0, {   376,      0}, {0x59, 0x00, 0x59, 0xff}}},
    {{{ -1536,    512,   1536}, 0, { 63<<5,      0}, {0x29, 0x00, 0x89, 0xff}}},
    {{{ -1331,    410,   1536}, 0, {  1604,    176}, {0x00, 0x00, 0x81, 0xff}}},
    {{{ -1536,      0,   1536}, 0, { 63<<5,  31<<5}, {0x20, 0x00, 0x86, 0xff}}},
    {{{ -1331,      0,   1536}, 0, {  1604,  31<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{ -3072,    205,      0}, 0, {     0,    582}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{ -3072,    461,   -717}, 0, {  1400,     64}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{ -3072,    512,      0}, 0, {     0,      0}, {0x75, 0x00, 0xd0, 0xff}}},
    {{{ -3072,    205,   -717}, 0, {  1400,    582}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{ -3072,    461,   -870}, 0, {  1704,     64}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{ -3072,    512,  -1024}, 0, { 63<<5,      0}, {0x79, 0x00, 0x24, 0xff}}},
    {{{ -3072,    205,  -1024}, 0, { 63<<5,    582}, {0x7a, 0x00, 0x20, 0xff}}},
    {{{ -3072,    205,  -1024}, 0, {     0,    582}, {0x7a, 0x00, 0x20, 0xff}}},
    {{{ -3072,    205,   -870}, 0, {  1704,    582}, {0x7f, 0x00, 0x00, 0xff}}},
};
...
static const Gfx inside_castle_seg7_dl_0702A548[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, inside_09000000_mural_hills_lower),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
