...
static const Vtx inside_castle_seg7_vertex_lobby_peach_window[] = {
...
static const Gfx inside_castle_seg7_dl_lobby_peach_window_model[] = {
    ...
    gsSPVertex(inside_castle_seg7_vertex_lobby_peach_window, 4, 0),
...
const Gfx dl_castle_lobby_peach_window[] = {
    ...
    gsSPDisplayList(inside_castle_seg7_dl_lobby_peach_window_model),
