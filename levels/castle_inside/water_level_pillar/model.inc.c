...
static const Vtx inside_castle_seg7_vertex_07068920[] = {
    {{{  -154,      0,    154}, 0, {159<<5,   4564}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   154,      0,    154}, 0, {  6612,   4564}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   154,      0,   -154}, 0, {  6612,  95<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  -154,      0,   -154}, 0, {159<<5,  95<<5}, {0x00, 0x7f, 0x00, 0xff}}},
};

// 0x07068960 - 0x07068A60
static const Vtx inside_castle_seg7_vertex_07068960[] = {
    {{{  -154,      0,    154}, 0, { -5140,  -3104}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -154,   -410,    154}, 0, { -5140,  31<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   154,   -410,    154}, 0, { -2080,  31<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -154,      0,   -154}, 0, { 63<<5,      0}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  -154,   -410,    154}, 0, {159<<5, 127<<5}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  -154,      0,    154}, 0, {159<<5,      0}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  -154,   -410,   -154}, 0, { 63<<5, 127<<5}, {0x81, 0x00, 0x00, 0xff}}},
    {{{   154,      0,   -154}, 0, { -2080,  -3104}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -154,   -410,   -154}, 0, { -5140,  31<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -154,      0,   -154}, 0, { -5140,  -3104}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   154,   -410,   -154}, 0, { -2080,  31<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   154,      0,    154}, 0, {159<<5,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   154,   -410,   -154}, 0, { 63<<5, 127<<5}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   154,      0,   -154}, 0, { 63<<5,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   154,   -410,    154}, 0, {159<<5, 127<<5}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   154,      0,    154}, 0, { -2080,  -3104}, {0x00, 0x00, 0x7f, 0xff}}},
};
...
const Gfx inside_castle_seg7_dl_water_level_pillar[] = {
    gsDPPipeSync(),
