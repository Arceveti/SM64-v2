...
extern const GeoLayout bits_geo_sliding_platform[];
extern const GeoLayout bits_geo_twin_sliding_platforms[];
extern const GeoLayout bits_geo_octagonal_platform[];
extern const GeoLayout bits_geo_blue_platform[];
extern const GeoLayout bits_geo_ferris_wheel_axle[];
extern const GeoLayout bits_geo_arrow_platform[];
extern const GeoLayout bits_geo_seesaw_platform[];
extern const GeoLayout bits_geo_tilting_w_platform[];
extern const GeoLayout bits_geo_staircase_0[];
extern const GeoLayout bits_geo_staircase_1[];
...
extern const Collision bits_seg7_collision_sliding_platform[];
extern const Collision bits_seg7_collision_twin_sliding_platforms[];
extern const Collision bits_seg7_collision_rotating_octagonal_platform[];
