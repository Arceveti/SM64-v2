...
extern const GeoLayout bitfs_geo_elevator[];
extern const GeoLayout bitfs_geo_sinking_cage_platform[];
extern const GeoLayout bitfs_geo_sinking_cage_pole[];
extern const GeoLayout bitfs_geo_tilting_square_platform[];
extern const GeoLayout bitfs_geo_tumbling_platform_near[];
extern const GeoLayout bitfs_geo_tumbling_platform_far[];
extern const GeoLayout bitfs_geo_stretching_platforms[];
extern const GeoLayout bitfs_geo_moving_square_platform[];
extern const GeoLayout bitfs_geo_sliding_platform[];
