...
extern const GeoLayout rr_geo_flying_carpet[];
extern const GeoLayout rr_geo_l_swinging_platform[];
extern const GeoLayout rr_geo_rotating_bridge_platform[];
extern const GeoLayout rr_geo_cruiser_wing[];
extern const GeoLayout rr_geo_octagonal_platform[];
extern const GeoLayout rr_geo_sliding_platform[];
extern const GeoLayout rr_geo_pyramid_platform[];
extern const GeoLayout rr_geo_elevator_platform[];
extern const GeoLayout rr_geo_seesaw_platform[];
extern const GeoLayout rr_geo_donut_block[];
extern const GeoLayout rr_geo_l_shaped_platform[];
extern const GeoLayout rr_geo_tricky_triangles_frame_0[];
extern const GeoLayout rr_geo_tricky_triangles_frame_1[];
...
extern const Gfx rr_seg7_dl_donut_block[];
extern const Gfx rr_seg7_dl_donut_block_hole[];
...
extern const Collision rr_seg7_collision_sliding_platform[];
extern const Collision rr_seg7_collision_pyramid_platform[];
extern const Collision rr_seg7_collision_elevator_platform[];
extern const Collision rr_seg7_collision_seesaw_platform[];
extern const Collision rr_seg7_collision_donut_platform[];
extern const Collision rr_seg7_collision_L_shaped_seesaw_platform[];
extern const Collision rr_seg7_collision_tricky_triangles[];
extern const Collision rr_seg7_collision_tricky_triangles_frame_1[];
extern const Collision rr_seg7_collision_tricky_triangles_frame_2[];
extern const Collision rr_seg7_collision_tricky_triangles_frame_3[];
extern const Collision rr_seg7_collision_tricky_triangles_frame_4[];
