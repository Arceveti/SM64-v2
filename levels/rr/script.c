...
static const LevelScript script_func_local_rr_1[] = {
...
static const LevelScript script_func_local_rr_flamethrowers[] = {
...
static const LevelScript script_func_local_rr_stars[] = {
...
const LevelScript level_rr_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_RR_SLIDING_PLATFORM,         rr_geo_sliding_platform),
    LOAD_MODEL_FROM_GEO(MODEL_RR_FLYING_CARPET,            rr_geo_flying_carpet),
    LOAD_MODEL_FROM_GEO(MODEL_RR_OCTAGONAL_PLATFORM,       rr_geo_octagonal_platform),
    LOAD_MODEL_FROM_GEO(MODEL_RR_ROTATING_BRIDGE_PLATFORM, rr_geo_rotating_bridge_platform),
    LOAD_MODEL_FROM_GEO(MODEL_RR_TRIANGLE_PLATFORM,        rr_geo_pyramid_platform),
    LOAD_MODEL_FROM_GEO(MODEL_RR_CRUISER_WING,             rr_geo_cruiser_wing),
    LOAD_MODEL_FROM_GEO(MODEL_RR_SEESAW_PLATFORM,          rr_geo_seesaw_platform),
    LOAD_MODEL_FROM_GEO(MODEL_RR_L_SHAPED_PLATFORM,        rr_geo_l_shaped_platform),
    LOAD_MODEL_FROM_GEO(MODEL_RR_SWINGING_PLATFORM,        rr_geo_l_swinging_platform),
    LOAD_MODEL_FROM_GEO(MODEL_RR_DONUT_PLATFORM,           rr_geo_donut_block),
    LOAD_MODEL_FROM_GEO(MODEL_RR_ELEVATOR_PLATFORM,        rr_geo_elevator_platform),
    LOAD_MODEL_FROM_GEO(MODEL_RR_TRICKY_TRIANGLES,         rr_geo_tricky_triangles_frame_0),
    LOAD_MODEL_FROM_GEO(MODEL_RR_TRICKY_TRIANGLES_FRAME1,  rr_geo_tricky_triangles_frame_1),
    LOAD_MODEL_FROM_GEO(MODEL_RR_TRICKY_TRIANGLES_FRAME2,  rr_geo_tricky_triangles_frame_2),
    LOAD_MODEL_FROM_GEO(MODEL_RR_TRICKY_TRIANGLES_FRAME3,  rr_geo_tricky_triangles_frame_3),
    LOAD_MODEL_FROM_GEO(MODEL_RR_TRICKY_TRIANGLES_FRAME4,  rr_geo_tricky_triangles_frame_4),

    AREA(/*index*/ 1, rr_geo_area_1),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/  2599, -833,  2071, /*angle*/ 0,  90, 0, /*behParam*/ 0x000A0000, /*beh*/ bhvSpinAirborneWarp),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ -7092, 2364,   -64, /*angle*/ 0,  90, 0, /*behParam*/ 0x000B0000, /*beh*/ bhvFadingWarp),
        ...
        JUMP_LINK(script_func_local_rr_1),
        JUMP_LINK(script_func_local_rr_flamethrowers),
        JUMP_LINK(script_func_local_rr_stars),
