...
static const Vtx rr_seg7_vertex_donut_block_hole[] = {
    {{{    61,    144,    317}, 0, ST_B(    32,      0), {0xc7, 0xa2, 0x68, 0xff}}},
    {{{   -61,     20,    317}, 0, ST_B(     0,     32), {0xc7, 0xa2, 0x68, 0xff}}},
    {{{    61,     20,    317}, 0, ST_B(    32,     32), {0xc7, 0xa2, 0x68, 0xff}}},
    {{{   -61,    144,    317}, 0, ST_B(     0,      0), {0xc7, 0xa2, 0x68, 0xff}}},
    {{{    61,     20,   -317}, 0, ST_B(    32,     32), {0xc7, 0xa2, 0x68, 0xff}}},
    {{{   -61,    144,   -317}, 0, ST_B(     0,      0), {0xc7, 0xa2, 0x68, 0xff}}},
    {{{    61,    144,   -317}, 0, ST_B(    32,      0), {0xc7, 0xa2, 0x68, 0xff}}},
    {{{   -61,     20,   -317}, 0, ST_B(     0,     32), {0xc7, 0xa2, 0x68, 0xff}}},
