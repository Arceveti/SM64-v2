...
static const LevelScript script_func_local_sa_fish[] = {
...
static const LevelScript script_func_local_stars[] = {
...
const LevelScript level_sa_entry[] = {
    ...
    AREA(/*index*/ 1, sa_geo_area_1),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ 0, -1536, 0, /*angle*/ 0, 90, 0, /*behParam*/ 0x000A0000, /*beh*/ bhvSwimmingWarp),
        ...
        JUMP_LINK(script_func_local_sa_fish),
        JUMP_LINK(script_func_local_stars),
