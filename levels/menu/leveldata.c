...
static const Vtx vertex_menu_save_button_borders[] = {
    {{{  -160,   -128,      0}, 0, {     0,  31<<5}, {0x00, 0xb6, 0x66, 0xff}}},
    {{{   160,   -128,      0}, 0, { 31<<5,  31<<5}, {0x00, 0xb6, 0x66, 0xff}}},
    {{{  -128,    -80,     32}, 0, {  3<<5,    820}, {0x00, 0xb6, 0x66, 0xff}}},
    {{{   128,    -80,     32}, 0, { 27<<5,    820}, {0x00, 0xb6, 0x66, 0xff}}},
    {{{  -160,   -128,      0}, 0, {     0,  31<<5}, {0xb6, 0x00, 0x66, 0xff}}},
    {{{  -128,    -80,     32}, 0, {  3<<5,    820}, {0xb6, 0x00, 0x66, 0xff}}},
    {{{  -160,    128,      0}, 0, {     0,      0}, {0xb6, 0x00, 0x66, 0xff}}},
    {{{  -128,     80,     32}, 0, {  3<<5,    144}, {0xb6, 0x00, 0x66, 0xff}}},
    {{{  -128,     80,     32}, 0, {  3<<5,    144}, {0x00, 0x4a, 0x66, 0xff}}},
    {{{   128,     80,     32}, 0, { 27<<5,    144}, {0x00, 0x4a, 0x66, 0xff}}},
    {{{   160,    128,      0}, 0, { 31<<5,      0}, {0x00, 0x4a, 0x66, 0xff}}},
    {{{  -160,    128,      0}, 0, {     0,      0}, {0x00, 0x4a, 0x66, 0xff}}},
    {{{   128,     80,     32}, 0, { 27<<5,    144}, {0x4a, 0x00, 0x66, 0xff}}},
    {{{   128,    -80,     32}, 0, { 27<<5,    820}, {0x4a, 0x00, 0x66, 0xff}}},
    {{{   160,   -128,      0}, 0, { 31<<5,  31<<5}, {0x4a, 0x00, 0x66, 0xff}}},
    {{{   160,    128,      0}, 0, { 31<<5,      0}, {0x4a, 0x00, 0x66, 0xff}}},
};

// 0x07003118 - 0x07003158
static const Vtx vertex_menu_save_button_front[] = {
    {{{   128,     80,     32}, 0, { 63<<5,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -128,     80,     32}, 0, {     0,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   128,    -80,     32}, 0, { 63<<5,  31<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -128,    -80,     32}, 0, {     0,  31<<5}, {0x00, 0x00, 0x7f, 0xff}}},
};
...
static const Vtx vertex_menu_save_button_back[] = {
    {{{   160,   -128,      0}, 0, {     0,  31<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -160,   -128,      0}, 0, { 31<<5,  31<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   160,    128,      0}, 0, {     0,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -160,    128,      0}, 0, { 31<<5,      0}, {0x00, 0x00, 0x81, 0xff}}},
};
...
static const Vtx vertex_menu_main_button_group1[] = {
    {{{  -160,   -128,      0}, 0, { 31<<5,      0}, {0xb6, 0x00, 0x66, 0xff}}},
    {{{  -128,    -80,     32}, 0, { 27<<5,    144}, {0xb6, 0x00, 0x66, 0xff}}},
    {{{  -160,    128,      0}, 0, { 31<<5,  31<<5}, {0xb6, 0x00, 0x66, 0xff}}},
    {{{  -144,    102,      0}, 0, {   928,    904}, {0x59, 0x00, 0xa7, 0xff}}},
    {{{  -128,     96,     10}, 0, {   896,  27<<5}, {0x59, 0x00, 0xa7, 0xff}}},
    {{{  -128,    -96,     10}, 0, {   896,     96}, {0x59, 0x00, 0xa7, 0xff}}},
    {{{  -128,     96,     10}, 0, {   896,  27<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   128,    -96,     10}, 0, {    64,     96}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -128,    -96,     10}, 0, {   896,     96}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   128,     96,     10}, 0, {    64,  27<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   128,     96,     10}, 0, {    64,  27<<5}, {0x00, 0xa7, 0xa7, 0xff}}},
    {{{  -128,     96,     10}, 0, {   896,  27<<5}, {0x00, 0xa7, 0xa7, 0xff}}},
    {{{  -144,    102,      0}, 0, {   928,    904}, {0x00, 0xa7, 0xa7, 0xff}}},
    {{{   144,   -102,      0}, 0, {    32,     56}, {0xa7, 0x00, 0xa7, 0xff}}},
    {{{   128,     96,     10}, 0, {    64,  27<<5}, {0xa7, 0x00, 0xa7, 0xff}}},
    {{{   144,    102,      0}, 0, {    32,    904}, {0xa7, 0x00, 0xa7, 0xff}}},
};

// 0x07005D68 - 0x07005E68
static const Vtx vertex_menu_main_button_group2[] = {
    {{{   144,   -102,      0}, 0, {    32,     56}, {0xa7, 0x00, 0xa7, 0xff}}},
    {{{   128,    -96,     10}, 0, {    64,     96}, {0xa7, 0x00, 0xa7, 0xff}}},
    {{{   128,     96,     10}, 0, {    64,  27<<5}, {0xa7, 0x00, 0xa7, 0xff}}},
    {{{   128,     96,     10}, 0, {    64,  27<<5}, {0x00, 0xa7, 0xa7, 0xff}}},
    {{{  -144,    102,      0}, 0, {   926,    904}, {0x00, 0xa7, 0xa7, 0xff}}},
    {{{   144,    102,      0}, 0, {    32,    904}, {0x00, 0xa7, 0xa7, 0xff}}},
    {{{  -144,   -102,      0}, 0, {   926,     56}, {0x00, 0x59, 0xa7, 0xff}}},
    {{{   128,    -96,     10}, 0, {    64,     96}, {0x00, 0x59, 0xa7, 0xff}}},
    {{{   144,   -102,      0}, 0, {    32,     56}, {0x00, 0x59, 0xa7, 0xff}}},
    {{{  -128,    -96,     10}, 0, {   894,     96}, {0x00, 0x59, 0xa7, 0xff}}},
    {{{  -144,    102,      0}, 0, {   926,    904}, {0x59, 0x00, 0xa7, 0xff}}},
    {{{  -128,    -96,     10}, 0, {   894,     96}, {0x59, 0x00, 0xa7, 0xff}}},
    {{{  -144,   -102,      0}, 0, {   926,     56}, {0x59, 0x00, 0xa7, 0xff}}},
    {{{   160,    128,      0}, 0, {     0,  31<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -144,    102,      0}, 0, {   926,    904}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -160,    128,      0}, 0, { 31<<5,  31<<5}, {0x00, 0x00, 0x81, 0xff}}},
};
...
static const Vtx vertex_menu_main_button_group3[] = {
    {{{   160,    128,      0}, 0, {     0,  31<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   144,    102,      0}, 0, {    32,    904}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -144,    102,      0}, 0, {   928,    904}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   144,   -102,      0}, 0, {    32,     54}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   160,   -128,      0}, 0, {     0,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -160,    128,      0}, 0, { 31<<5,  31<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -144,   -102,      0}, 0, {   926,     54}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -160,   -128,      0}, 0, { 31<<5,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   160,   -128,      0}, 0, {     0,      0}, {0x00, 0xb6, 0x66, 0xff}}},
    {{{   128,    -80,     32}, 0, {    96,    144}, {0x00, 0xb6, 0x66, 0xff}}},
    {{{  -128,    -80,     32}, 0, { 27<<5,    144}, {0x00, 0xb6, 0x66, 0xff}}},
    {{{  -128,    -80,     32}, 0, { 27<<5,    144}, {0xb6, 0x00, 0x66, 0xff}}},
    {{{  -128,     80,     32}, 0, { 27<<5,    820}, {0xb6, 0x00, 0x66, 0xff}}},
    {{{  -160,    128,      0}, 0, { 31<<5,  31<<5}, {0xb6, 0x00, 0x66, 0xff}}},
};

// 0x07005F48 - 0x07006038
static const Vtx vertex_menu_main_button_group4[] = {
    {{{  -128,     80,     32}, 0, { 27<<5,    820}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -128,    -80,     32}, 0, { 27<<5,    144}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   128,    -80,     32}, 0, {    96,    144}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -160,   -128,      0}, 0, { 31<<5,      0}, {0x00, 0xb6, 0x66, 0xff}}},
    {{{   160,   -128,      0}, 0, {     0,      0}, {0x00, 0xb6, 0x66, 0xff}}},
    {{{  -128,    -80,     32}, 0, { 27<<5,    144}, {0x00, 0xb6, 0x66, 0xff}}},
    {{{  -128,     80,     32}, 0, { 27<<5,    820}, {0x00, 0x4a, 0x66, 0xff}}},
    {{{   128,     80,     32}, 0, {    96,    820}, {0x00, 0x4a, 0x66, 0xff}}},
    {{{   160,    128,      0}, 0, {     0,  31<<5}, {0x00, 0x4a, 0x66, 0xff}}},
    {{{  -160,    128,      0}, 0, { 31<<5,  31<<5}, {0x00, 0x4a, 0x66, 0xff}}},
    {{{   128,     80,     32}, 0, {    96,    820}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   160,    128,      0}, 0, {     0,  31<<5}, {0x4a, 0x00, 0x66, 0xff}}},
    {{{   128,     80,     32}, 0, {    96,    820}, {0x4a, 0x00, 0x66, 0xff}}},
    {{{   160,   -128,      0}, 0, {     0,      0}, {0x4a, 0x00, 0x66, 0xff}}},
    {{{   128,    -80,     32}, 0, {    96,    144}, {0x4a, 0x00, 0x66, 0xff}}},
};
...
static const Vtx vertex_menu_hand[] = {
    {{{     0,      0,      0}, 0, {     0,  62<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{    32,      0,      0}, 0, { 62<<5,  62<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{    32,     32,      0}, 0, { 62<<5,      0}, {0x00, 0x00, 0x7f, 0xff}}},
...
static const Vtx vertex_menu_course_upper[] = {
    ...
    {{{    32,      0,      0}, 0, {126<<5,  62<<5}, {0x00, 0x00, 0x7f, 0x00}}},
    {{{    32,     32,      0}, 0, {126<<5,      0}, {0x00, 0x00, 0x7f, 0x00}}},
    {{{   -32,     32,      0}, 0, {     0,      0}, {0x00, 0x00, 0x7f, 0x00}}},
};

// 0x0700F1E8 - 0x0700F228
static const Vtx vertex_menu_course_lower[] = {
    {{{   -32,    -32,      0}, 0, {     0,  62<<5}, {0x00, 0x00, 0x7f, 0x00}}},
    {{{    32,    -32,      0}, 0, {126<<5,  62<<5}, {0x00, 0x00, 0x7f, 0x00}}},
    {{{    32,      0,      0}, 0, {126<<5,      0}, {0x00, 0x00, 0x7f, 0x00}}},
