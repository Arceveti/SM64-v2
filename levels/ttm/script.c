...
static const LevelScript script_func_local_ttm_rolling_log[] = {
    OBJECT(/*model*/ MODEL_TTM_ROLLING_LOG,    /*pos*/  4360, -1722,  4000, /*angle*/ 0,  48, 0, /*behParam*/ 0x00000000, /*beh*/ bhvTtmRollingLog),
    RETURN(),
};

static const LevelScript script_func_local_ttm_area_1_objects[] = {
    OBJECT(          /*model*/ MODEL_NONE,               /*pos*/ -1638,  1146, -1742, /*angle*/ 0,   0, 0, /*behParam*/ 0x00010000, /*beh*/ bhvTtmBowlingBallSpawner         ),
    ...
    OBJECT(          /*model*/ MODEL_DL_MONTY_MOLE_HOLE, /*pos*/ -2077, -1024, -1969, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvMontyMoleHole                 ),
    OBJECT(          /*model*/ MODEL_DL_MONTY_MOLE_HOLE, /*pos*/ -2500, -1024, -2157, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvMontyMoleHole                 ),
    OBJECT(          /*model*/ MODEL_DL_MONTY_MOLE_HOLE, /*pos*/ -2048, -1024, -2307, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvMontyMoleHole                 ),
    OBJECT(          /*model*/ MODEL_DL_MONTY_MOLE_HOLE, /*pos*/ -2351, -1024, -2416, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvMontyMoleHole                 ),
    OBJECT(          /*model*/ MODEL_DL_MONTY_MOLE_HOLE, /*pos*/ -2400, -2560, -2185, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvMontyMoleHole                 ),
    OBJECT(          /*model*/ MODEL_DL_MONTY_MOLE_HOLE, /*pos*/ -1435, -2560, -3118, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvMontyMoleHole                 ),
    OBJECT(          /*model*/ MODEL_DL_MONTY_MOLE_HOLE, /*pos*/ -1677, -2560, -3507, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvMontyMoleHole                 ),
    OBJECT(          /*model*/ MODEL_DL_MONTY_MOLE_HOLE, /*pos*/ -1869, -2560, -2704, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvMontyMoleHole                 ),
    OBJECT(          /*model*/ MODEL_DL_MONTY_MOLE_HOLE, /*pos*/ -2525, -2560, -2626, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvMontyMoleHole                 ),
...
static const LevelScript script_func_local_ttm_area_1_stars[] = {
...
static const LevelScript script_func_local_ttm_area_2_smileys[] = {
...
static const LevelScript script_func_local_ttm_area_3_smileys[] = {
    OBJECT(/*model*/ MODEL_TTM_BLUE_SMILEY,   /*pos*/  7867,  -960, -6085, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStaticObject),
...
static const LevelScript script_func_local_ttm_area_4_smileys[] = {
...
// static const LevelScript script_func_local_ttm_area_4_stub[] = {
//     RETURN(),
// };
...
const LevelScript level_ttm_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_TTM_SLIDE_EXIT_PODIUM, ttm_geo_slide_exit_podium),
    LOAD_MODEL_FROM_GEO(MODEL_TTM_ROLLING_LOG,       ttm_geo_rolling_log),
    LOAD_MODEL_FROM_GEO(MODEL_TTM_STAR_CAGE,         ttm_geo_star_cage),
    LOAD_MODEL_FROM_GEO(MODEL_TTM_BLUE_SMILEY,       ttm_geo_blue_smiley),
    LOAD_MODEL_FROM_GEO(MODEL_TTM_YELLOW_SMILEY,     ttm_geo_yellow_smiley),
    LOAD_MODEL_FROM_GEO(MODEL_TTM_STAR_SMILEY,       ttm_geo_star_smiley),
    LOAD_MODEL_FROM_GEO(MODEL_TTM_MOON_SMILEY,       ttm_geo_moon_smiley),
    ...
    AREA(/*index*/ 1, ttm_geo_area_1),
        ...
        JUMP_LINK(script_func_local_ttm_rolling_log),
        JUMP_LINK(script_func_local_ttm_area_1_objects),
        JUMP_LINK(script_func_local_ttm_area_1_stars),
    ...
    AREA(/*index*/ 2, ttm_geo_area_2),
        ...
        WARP_NODE(/*id*/ 0xF0, /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 0x02, /*destNode*/ 0x34, /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ 0xF1, /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 0x02, /*destNode*/ 0x66, /*flags*/ WARP_NO_CHECKPOINT),
        JUMP_LINK(script_func_local_ttm_area_2_smileys),
    ...
    AREA(/*index*/ 3, ttm_geo_area_3),
        WARP_NODE(/*id*/ 0xF0, /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 0x02, /*destNode*/ 0x34, /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ 0xF1, /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 0x02, /*destNode*/ 0x66, /*flags*/ WARP_NO_CHECKPOINT),
        JUMP_LINK(script_func_local_ttm_area_3_smileys),
    ...
    AREA(/*index*/ 4, ttm_geo_area_4),
        ...
        WARP_NODE(/*id*/ 0xF0, /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 0x02, /*destNode*/ 0x34, /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ 0xF1, /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 0x02, /*destNode*/ 0x66, /*flags*/ WARP_NO_CHECKPOINT),
        JUMP_LINK(script_func_local_ttm_area_4_smileys),
        // JUMP_LINK(script_func_local_ttm_area_4_stub),
