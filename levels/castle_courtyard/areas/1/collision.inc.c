...
const Collision castle_courtyard_seg7_collision[] = {
    ...
    COL_VERTEX(    0,  240, -1735),
    COL_VERTEX(  -96,  205, -1735),
    COL_VERTEX(    0,  311, -1781),
    COL_VERTEX(  -72,  285, -1735),
    COL_VERTEX(    0,  311, -1689),
    COL_VERTEX( -128,  350, -1735),
    COL_VERTEX(   48,  358, -1735),
    COL_VERTEX(  128,  350, -1735),
    COL_VERTEX(   72,  285, -1735),
    COL_VERTEX(   96,  205, -1735),
    COL_VERTEX(  -48,  358, -1735),
    COL_VERTEX(    0,  433, -1735),
    COL_VERTEX(  205,  -51, -1893),
    COL_VERTEX( -205,  -51, -1893),
    COL_VERTEX(  102,  205, -1791),
    COL_VERTEX(  205,  -51, -1586),
    COL_VERTEX( -205,  -51, -1586),
    COL_VERTEX(  102,  205, -1689),
    COL_VERTEX( -102,  205, -1689),
    COL_VERTEX( -102,  205, -1791),
    ...
    COL_VERTEX( 2253, -205,   205),
    COL_VERTEX( 2253,    0,   205),
    COL_VERTEX(-1331, -205,   205),
    ...
    COL_VERTEX(  307,    0,   410),
    COL_VERTEX(  -77,  256,   410),
    COL_VERTEX( 3584,  819, -3072),
    COL_VERTEX( 3379,    0, -3072),
    COL_VERTEX( 3584,    0,     0),
    COL_VERTEX( 3072,   20,   717),
    COL_VERTEX( 3072,  819,   717),
    COL_VERTEX( 3072, 2048, -3584),
    COL_VERTEX( 3072,  819, -3584),
    COL_VERTEX( 2662,    0, -3584),
    COL_VERTEX( 1331, -205, -3584),
    COL_VERTEX( 1331,    0, -3584),
    COL_VERTEX( 3072, 2048, -3378),
    COL_VERTEX( 3072,    0, -3173),
    COL_VERTEX( 3574, 2048, -3072),
    COL_VERTEX( 3379, 2048, -3072),
    COL_VERTEX(  614,  102, -2005),
    COL_VERTEX(  614,    0, -2560),
    ...
    COL_VERTEX( -819,    0, -1126),
    COL_VERTEX( -614,  102, -2005),
    COL_VERTEX( -614,  102, -1475),
    COL_VERTEX( -614,    0,  -922),
    COL_VERTEX( -614,    0, -2005),
    COL_VERTEX(  265,  102, -1126),
    COL_VERTEX(  614,    0,  -922),
    COL_VERTEX( -264,    0, -1126),
    COL_VERTEX( -614,    0, -1475),
    COL_VERTEX(  614,  102, -1475),
    COL_VERTEX(  265,    0, -1126),
    COL_VERTEX(  819,    0, -1126),
    COL_VERTEX(  819,    0, -2354),
    COL_VERTEX(  922,    0,     0),
    COL_VERTEX( -922,    0,     0),
    COL_VERTEX(-1229,    0, -1024),
    COL_VERTEX( 1229,    0, -1024),
    COL_VERTEX(  614,    0, -1475),
    COL_VERTEX( -614,    0, -3522),
    COL_VERTEX(-1022,    0, -3522),
    COL_VERTEX(-1331,    0, -2457),
    COL_VERTEX(-1331,    0, -3584),
    COL_VERTEX(  717,    0, -3420),
    COL_VERTEX(  922,    0, -3420),
    COL_VERTEX( 1331,    0, -2457),
    COL_VERTEX( 1024,    0,   102),
    COL_VERTEX( 1741, -102, -2048),
    COL_VERTEX( 1741,    0, -2048),
    COL_VERTEX(-2662, -205, -3584),
    COL_VERTEX(-1331, -102, -2764),
    COL_VERTEX(-1741,    0, -2048),
    COL_VERTEX(-1331, -205,  -717),
    COL_VERTEX(-1331, -102,  -717),
    COL_VERTEX(-1331, -205, -2764),
    COL_VERTEX(-2252, -205,   205),
    COL_VERTEX(-3072,    0,  -614),
    COL_VERTEX(-3072, -205,  -614),
    COL_VERTEX( 1331,  102, -1024),
    COL_VERTEX( 1229,  102,   282),
    COL_VERTEX( 1331, -205,   205),
    COL_VERTEX( 1946, -205, -2149),
    COL_VERTEX( 1946, -102, -1331),
    COL_VERTEX( 1331, -102,  -717),
    COL_VERTEX(-1741, -102, -1433),
    COL_VERTEX(-1331, -102, -1024),
    COL_VERTEX(-1741, -102, -2048),
    COL_VERTEX(-1331, -102, -2459),
    COL_VERTEX(-1946, -102, -2149),
    COL_VERTEX(-1946, -205, -1331),
    COL_VERTEX(-1331,  102,   205),
    COL_VERTEX(-1331,    0, -1024),
    COL_VERTEX(-1946, -102, -1331),
    COL_VERTEX( 2560,    0,   512),
    ...
    COL_VERTEX(-3584,  819, -3072),
    COL_VERTEX(-3584, 2048, -3072),
    COL_VERTEX(-3072,    0, -3378),
    COL_VERTEX(-3378, 2048, -3072),
    COL_VERTEX(-3072,    0, -3173),
    COL_VERTEX(-3072, 2048, -3378),
    COL_VERTEX(-3072,    0, -3584),
    COL_VERTEX(-1331,  819, -3584),
    COL_VERTEX(-2252,    0,   205),
    COL_VERTEX(-3184,   20,    71),
    COL_VERTEX(-3584,   20,    71),
    COL_VERTEX(1229,   102, -1024),
    ...
    COL_VERTEX( 1331, -102, -2764),
    COL_VERTEX( 1331, -205, -2764),
    COL_VERTEX( 1024,    0, -3727),
    COL_VERTEX( 1024,    0, -3522),
    ...
    COL_VERTEX(  717,    0, -3830),
    COL_VERTEX(  614,    0, -3727),
    ...
    COL_VERTEX( 3072,    0, -3584),
    COL_VERTEX( 1331,  819, -3584),
    COL_VERTEX( 3072, -205, -3173),
    COL_VERTEX(  614,  102, -2560),
    COL_VERTEX(  819,  102, -2354),
    COL_VERTEX( -614,  102, -2560),
    COL_VERTEX( -717,    0, -3420),
    COL_VERTEX( -819,  102, -2354),
    COL_VERTEX( -819,  102, -1126),
    COL_VERTEX( -614,  102,  -922),
    COL_VERTEX( -264,  102, -1126),
    COL_VERTEX(  614,  102,  -922),
    COL_VERTEX(  819,  102, -1126),
    COL_VERTEX(  717,    0,     0),
    ...
    COL_VERTEX(-2662,    0, -3584),
    COL_VERTEX(-3072, 2048, -3584),
    COL_VERTEX(-1229,  100,   282),
    COL_VERTEX( 1331,    0, -2458),
    ...
    COL_VERTEX(  162,  -51, -1331),
    COL_VERTEX( -144,  -51, -1331),
    COL_VERTEX( -349,  -51, -1536),
    COL_VERTEX(  367,  -51, -1536),
    COL_VERTEX(  367,  -51, -1946),
    COL_VERTEX( -349,  -51, -1946),
    COL_VERTEX(  162,  -51, -2149),
    COL_VERTEX( -144,  -51, -2149),
    ...
    COL_TRI_STOP(),
    COL_SPECIAL_INIT(19),
    SPECIAL_OBJECT_WITH_YAW(          /*preset*/ special_null_start,       /*pos*/    16,    0,   205, /*yaw*/ 128), // unused, probably an early way to set initial position
    ...
    SPECIAL_OBJECT(                   /*preset*/ special_spiky_tree,       /*pos*/   819,   10,   205),
    SPECIAL_OBJECT(                   /*preset*/ special_spiky_tree,       /*pos*/  -819,   10,   205),
    SPECIAL_OBJECT(                   /*preset*/ special_spiky_tree,       /*pos*/  1681, -214,  -128),
    SPECIAL_OBJECT(                   /*preset*/ special_spiky_tree,       /*pos*/  2382, -214,  -843),
    SPECIAL_OBJECT(                   /*preset*/ special_spiky_tree,       /*pos*/  -819,   10, -3630),
    ...
    SPECIAL_OBJECT(                   /*preset*/ special_spiky_tree,       /*pos*/ -2537, -214,  -760),
