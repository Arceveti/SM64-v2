...
static const LevelScript script_func_local_courtyard_birds[] = {
...
static const LevelScript script_func_local_courtyard_boos[] = {
    OBJECT(/*model*/ MODEL_BOO, /*pos*/ -3217, 100,  -102, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvCourtyardBooTriplet),
    OBJECT(/*model*/ MODEL_BOO, /*pos*/  3317, 100, -1701, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvCourtyardBooTriplet),
    OBJECT(/*model*/ MODEL_BOO, /*pos*/   -71,   0, -1387, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvCourtyardBooTriplet),
    RETURN(),
};
...
const LevelScript level_castle_courtyard_entry[] = {
    ...
    AREA(/*index*/ 1, castle_courtyard_geo_area_1),
        ...
        JUMP_LINK(script_func_local_courtyard_birds),
        JUMP_LINK(script_func_local_courtyard_boos),
