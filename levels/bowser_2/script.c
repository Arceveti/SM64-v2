...
static const LevelScript script_func_local_bowser_2_platform_and_bombs[] = {
    ...
    OBJECT(/*model*/ MODEL_BOWSER_BOMB,            /*pos*/     0, 1329, -3584, /*angle*/ 0, 90, 0, /*behParam*/ 0x00000000, /*beh*/ bhvBowserBomb),
    OBJECT(/*model*/ MODEL_BOWSER_BOMB,            /*pos*/ -3584, 1329,     0, /*angle*/ 0, 90, 0, /*behParam*/ 0x00000000, /*beh*/ bhvBowserBomb),
    RETURN(),
};
...
const LevelScript level_bowser_2_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_BOWSER_2_TILTING_ARENA, bowser_2_geo_tilting_arena),

    AREA(/*index*/ 1, bowser_2_geo_area_1),
        ...
        JUMP_LINK(script_func_local_bowser_2_platform_and_bombs),
