...
static const Gfx hmc_seg7_sub_dl_lake_sky_lights[] = {
    gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_16b, 1, cave_0900B800_light_linear),
    gsDPLoadSync(),
...
const Gfx hmc_seg7_dl_lake_sky_lights[] = {
    gsDPPipeSync(),
    ...
    gsSPDisplayList(hmc_seg7_sub_dl_lake_sky_lights),
