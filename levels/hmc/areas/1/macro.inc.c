...
const MacroObject hmc_seg7_macro_objs[] = {
    ...
    MACRO_OBJECT_WITH_BEH_PARAM(/*preset*/ macro_wooden_signpost,             /*yaw*/   0, /*pos*/  2500,   217,    51, /*behParam*/ DIALOG_071),
    MACRO_OBJECT_WITH_BEH_PARAM(/*preset*/ macro_wooden_signpost,             /*yaw*/   0, /*pos*/  2900,   217,    51, /*behParam*/ DIALOG_062),
    ...
    MACRO_OBJECT_WITH_BEH_PARAM(/*preset*/ macro_wooden_signpost,             /*yaw*/   0, /*pos*/ -3184,     0,   700, /*behParam*/ DIALOG_126),
    ...
    MACRO_OBJECT(               /*preset*/ macro_snufit,                      /*yaw*/   0, /*pos*/  4560,  -620, -1500),
    MACRO_OBJECT(               /*preset*/ macro_snufit,                      /*yaw*/   0, /*pos*/  2439,  -722, -5500),
    MACRO_OBJECT(               /*preset*/ macro_coin_line_horizontal,        /*yaw*/   0, /*pos*/ -6580,  1680, -5780),
    MACRO_OBJECT(               /*preset*/ macro_coin_line_horizontal,        /*yaw*/  90, /*pos*/  2800,   205,   464),
    MACRO_OBJECT(               /*preset*/ macro_coin_line_horizontal,        /*yaw*/  90, /*pos*/  1800,  -410, -7390),
...
#ifdef BONUS_OBJECTS
    MACRO_OBJECT(               /*preset*/ macro_recovery_heart,              /*yaw*/   0, /*pos*/  2000,   256,   464),
    MACRO_OBJECT(               /*preset*/ macro_recovery_heart,              /*yaw*/   0, /*pos*/  6700,  -307, -1600),
    MACRO_OBJECT(               /*preset*/ macro_box_1up,                     /*yaw*/   0, /*pos*/ -5120,  3168, -8000),
#endif
    ...
    MACRO_OBJECT(               /*preset*/ macro_blue_coin_switch,            /*yaw*/   0, /*pos*/  5145,  -768, -2954),
    MACRO_OBJECT(               /*preset*/ macro_hidden_blue_coin,            /*yaw*/   0, /*pos*/  3945, -1024, -2918),
    MACRO_OBJECT(               /*preset*/ macro_hidden_blue_coin,            /*yaw*/   0, /*pos*/  3800, -1024, -4009),
    MACRO_OBJECT(               /*preset*/ macro_hidden_blue_coin,            /*yaw*/   0, /*pos*/  3036,  -859, -4118),
    MACRO_OBJECT(               /*preset*/ macro_hidden_blue_coin,            /*yaw*/   0, /*pos*/  2018,  -922, -4154),
    MACRO_OBJECT(               /*preset*/ macro_hidden_blue_coin,            /*yaw*/   0, /*pos*/  1836,  -922, -4700),
    MACRO_OBJECT(               /*preset*/ macro_hidden_blue_coin,            /*yaw*/   0, /*pos*/  1836,  -722, -4700),
    MACRO_OBJECT(               /*preset*/ macro_hidden_blue_coin,            /*yaw*/   0, /*pos*/  1836,  -522, -4700),
