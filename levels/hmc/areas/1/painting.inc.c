...
static const Lights1 hmc_seg7_lights_cotmc = gdSPDefLights1(
    0x40, 0x40, 0x80,
    0x64, 0x64, 0xff, 0x28, 0x28, 0x28
);

// 0x07024228 - 0x07024268
static const Vtx hmc_seg7_vertex_cotmc[] = {
...
static const Gfx hmc_seg7_painting_dl_cotmc_normal[] = {
    gsDPPipeSync(),
    gsSPLight(&hmc_seg7_lights_cotmc.l, 1),
    gsSPLight(&hmc_seg7_lights_cotmc.a, 2),
    gsSPVertex(hmc_seg7_vertex_cotmc, 4, 0),
