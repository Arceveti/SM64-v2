...
const MacroObject castle_grounds_seg7_macro_objs[] = {
    ...
    MACRO_OBJECT_WITH_BEH_PARAM(/*preset*/ macro_wooden_signpost,     /*yaw*/  90, /*pos*/  1741,    32,  2500, /*behParam*/ DIALOG_065),
    MACRO_OBJECT_WITH_BEH_PARAM(/*preset*/ macro_wooden_signpost,     /*yaw*/   0, /*pos*/ -1566,   260,  3504, /*behParam*/ DIALOG_167),
    ...
    MACRO_OBJECT_WITH_BEH_PARAM(/*preset*/ macro_hidden_1up,          /*yaw*/   0, /*pos*/     0,   512, -1170, /*behParam*/          2),
    ...
    MACRO_OBJECT(               /*preset*/ macro_1up,                 /*yaw*/   0, /*pos*/   440,  3180, -5000                         ),
    MACRO_OBJECT(               /*preset*/ macro_box_wing_cap,        /*yaw*/   0, /*pos*/     0,  3476, -5646                         ),
#ifdef BONUS_OBJECTS
    MACRO_OBJECT(               /*preset*/ macro_box_metal_cap,       /*yaw*/   0, /*pos*/   440,  3476, -5646                         ),
    MACRO_OBJECT(               /*preset*/ macro_box_vanish_cap,      /*yaw*/   0, /*pos*/  -440,  3476, -5646                         ),
#endif
