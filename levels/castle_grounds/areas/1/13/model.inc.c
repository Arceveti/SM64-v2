ALIGNED8 static const Texture castle_grounds_seg7_us_texture_peach_signature[] = {
#include "levels/castle_grounds/5.ia8.inc.c"
};

// 0x0700F2E8
const Gfx castle_grounds_seg7_us_dl_peach_signature[] = {
    gsDPPipeSync(),
    ...
    gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_8b, 1, castle_grounds_seg7_us_texture_peach_signature),
    gsDPLoadSync(),
