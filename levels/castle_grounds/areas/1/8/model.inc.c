...
static const Vtx castle_grounds_seg7_vertex_cannon_grill[] = {
    {{{  2283,     64,   2072}, 0, ST_B(     0,      0), {0xff, 0xff, 0xff, 0xff}}},
    {{{  2485,     64,   2072}, 0, ST_B(     0,     32), {0xff, 0xff, 0xff, 0xff}}},
    {{{  2485,     64,   1849}, 0, ST_B(    32,     32), {0xff, 0xff, 0xff, 0xff}}},
    {{{  2283,     64,   1849}, 0, ST_B(    32,      0), {0xff, 0xff, 0xff, 0xff}}},
};
