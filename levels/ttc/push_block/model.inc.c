...
static const Vtx ttc_seg7_vertex_push_block_front[] = {
    {{{   102,    102,     10}, 0, { 31<<5,     16}, {0x54, 0x2a, 0x54, 0xff}}},
    {{{  -102,   -102,     10}, 0, {     0,  31<<5}, {0xac, 0xd6, 0x54, 0xff}}},
    {{{   102,   -102,     10}, 0, { 31<<5,  31<<5}, {0x33, 0x99, 0x33, 0xff}}},
    {{{  -102,    102,     10}, 0, {     0,     16}, {0xcd, 0x67, 0x33, 0xff}}},
};
