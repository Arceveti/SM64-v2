...
static const Vtx ttc_seg7_vertex_pendulum_arm[] = {
    {{{    19,   -666,     19}, 0, {  3<<5,  47<<5}, {0x38, 0x00, 0x71, 0xff}}},
    {{{   -19,      0,     19}, 0, {     0,      0}, {0xc8, 0x00, 0x71, 0xff}}},
    {{{   -19,   -666,     19}, 0, {     0,  47<<5}, {0x8f, 0x00, 0x38, 0xff}}},
    {{{   -19,   -666,     19}, 0, { 15<<5,  47<<5}, {0x8f, 0x00, 0x38, 0xff}}},
    {{{   -19,      0,     19}, 0, { 15<<5,      0}, {0xc8, 0x00, 0x71, 0xff}}},
    {{{   -19,      0,    -19}, 0, { 11<<5,      0}, {0x8f, 0x00, 0xc8, 0xff}}},
    {{{   -19,   -666,    -19}, 0, { 11<<5,  47<<5}, {0xc8, 0x00, 0x8f, 0xff}}},
    {{{   -19,   -666,    -19}, 0, { 11<<5,  47<<5}, {0xc8, 0x00, 0x8f, 0xff}}},
    {{{    19,      0,    -19}, 0, {  7<<5,      0}, {0x38, 0x00, 0x8f, 0xff}}},
    {{{    19,   -666,    -19}, 0, {  7<<5,  47<<5}, {0x71, 0x00, 0xc8, 0xff}}},
    {{{   -19,      0,    -19}, 0, { 11<<5,      0}, {0x8f, 0x00, 0xc8, 0xff}}},
    {{{    19,      0,     19}, 0, {  3<<5,      0}, {0x71, 0x00, 0x38, 0xff}}},
    {{{    19,   -666,     19}, 0, {  3<<5,  47<<5}, {0x38, 0x00, 0x71, 0xff}}},
    {{{    19,      0,     19}, 0, {  3<<5,      0}, {0x71, 0x00, 0x38, 0xff}}},
};
