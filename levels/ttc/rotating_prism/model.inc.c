...
static const Vtx ttc_seg7_vertex_rotating_prism_base[] = {
    {{{     0,   -230,    200}, 0, ST_B(   -32,      0), {0x29, 0xb8, 0x5f, 0xff}}},
    {{{     0,      0,    200}, 0, ST_B(    32,     24), {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -200,    112,    200}, 0, ST_B(    64,      0), {0xad, 0x00, 0x5f, 0xff}}},
    {{{  -200,    112,   -200}, 0, ST_B(   -32,      0), {0xd7, 0x48, 0xa1, 0xff}}},
    {{{     0,      0,   -200}, 0, ST_B(    32,     24), {0x00, 0x00, 0x81, 0xff}}},
    {{{     0,   -230,   -200}, 0, ST_B(    64,      0), {0xd7, 0xb8, 0xa1, 0xff}}},
    {{{     0,   -230,   -200}, 0, ST_B(   -32,      0), {0xd7, 0xb8, 0xa1, 0xff}}},
    {{{   200,    112,   -200}, 0, ST_B(    64,      0), {0x53, 0x00, 0xa0, 0xff}}},
    {{{   200,    112,   -200}, 0, ST_B(   -32,      0), {0x53, 0x00, 0xa0, 0xff}}},
    {{{  -200,    112,   -200}, 0, ST_B(    64,      0), {0xd7, 0x48, 0xa1, 0xff}}},
    {{{   200,    112,    200}, 0, ST_B(   -32,      0), {0x29, 0x47, 0x60, 0xff}}},
    {{{     0,   -230,    200}, 0, ST_B(    64,      0), {0x29, 0xb8, 0x5f, 0xff}}},
    {{{  -200,    112,    200}, 0, ST_B(   -32,      0), {0xad, 0x00, 0x5f, 0xff}}},
    {{{   200,    112,    200}, 0, ST_B(    64,      0), {0x29, 0x47, 0x60, 0xff}}},
};

// 0x0700EE60 - 0x0700EF20
static const Vtx ttc_seg7_vertex_rotating_prism_lateral_sides[] = {
    {{{   200,    112,    200}, 0, ST_B(    32,      0), {0x29, 0x47, 0x60, 0xff}}},
    {{{  -200,    112,   -200}, 0, ST_B(     0,     32), {0xd7, 0x48, 0xa1, 0xff}}},
    {{{  -200,    112,    200}, 0, ST_B(    32,     32), {0xad, 0x00, 0x5f, 0xff}}},
    {{{   200,    112,   -200}, 0, ST_B(     0,      0), {0x53, 0x00, 0xa0, 0xff}}},
    {{{  -200,    112,    200}, 0, ST_B(    32,      0), {0xad, 0x00, 0x5f, 0xff}}},
    {{{  -200,    112,   -200}, 0, ST_B(     0,      0), {0xd7, 0x48, 0xa1, 0xff}}},
    {{{     0,   -230,   -200}, 0, ST_B(     0,     32), {0xd7, 0xb8, 0xa1, 0xff}}},
    {{{     0,   -230,    200}, 0, ST_B(    32,     32), {0x29, 0xb8, 0x5f, 0xff}}},
    {{{     0,   -230,    200}, 0, ST_B(    32,      0), {0x29, 0xb8, 0x5f, 0xff}}},
    {{{     0,   -230,   -200}, 0, ST_B(     0,      0), {0xd7, 0xb8, 0xa1, 0xff}}},
    {{{   200,    112,   -200}, 0, ST_B(     0,     32), {0x53, 0x00, 0xa0, 0xff}}},
    {{{   200,    112,    200}, 0, ST_B(    32,     32), {0x29, 0x47, 0x60, 0xff}}},
};
