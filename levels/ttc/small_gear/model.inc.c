...
static const Vtx ttc_seg7_vertex_small_gear[] = {
    {{{   102,      0,   -102}, 0, ST_B(    32,      0), {0xff, 0xff, 0xff, 0xff}}},
    {{{  -102,      0,   -102}, 0, ST_B(     0,      0), {0xff, 0xff, 0xff, 0xff}}},
    {{{  -102,      0,    102}, 0, ST_B(     0,     32), {0xff, 0xff, 0xff, 0xff}}},
    {{{   102,      0,    102}, 0, ST_B(    32,     32), {0xff, 0xff, 0xff, 0xff}}},
};
