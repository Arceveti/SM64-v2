...
const Collision ttc_seg7_collision_level[] = {
    ...
    COL_VERTEX( 2253, -8192, -2252),
    COL_VERTEX(-2252, -8192,  2253),
    COL_VERTEX( 2253, -8192,  2253),
    COL_VERTEX(-2252, -8192, -2252),
    COL_VERTEX( 1024,  5089,   424),
    COL_VERTEX( 1536,  5089,   424),
    COL_VERTEX( 1536,  5396,  -424),
    COL_VERTEX( 1024,  5396,  -424),
    COL_VERTEX( 1386,  5089,   786),
    COL_VERTEX( 1386,  5396,  -786),
    COL_VERTEX(  424,  4782,  1024),
    COL_VERTEX(  786,  4782,  1386),
    COL_VERTEX(  424,  4782,  1536),
    COL_VERTEX(  786,  6011, -1385),
    COL_VERTEX(  424,  6011, -1024),
    COL_VERTEX(  364,  3860,  -175),
    COL_VERTEX(  876,  3860,  -175),
    COL_VERTEX(  364,  3707, -1024),
    COL_VERTEX(  876,  3860, -1024),
    COL_VERTEX( -424,  4475,  1024),
    COL_VERTEX( -786,  4475,  1386),
    COL_VERTEX(  726,  3860, -1385),
    COL_VERTEX(  364,  3860, -1024),
    COL_VERTEX( -424,  6011, -1536),
    COL_VERTEX( -424,  6011, -1024),
    COL_VERTEX( -424,  3860, -1536),
    COL_VERTEX( -424,  3860, -1024),
    COL_VERTEX(-1385,  4014,   786),
    COL_VERTEX(-1536,  4168,   424),
    COL_VERTEX(-1024,  3860,  -424),
    COL_VERTEX(-1385,  3860,  -786),
    COL_VERTEX( 1386,  5243,  -786),
    COL_VERTEX(  424,  6011, -1536),
    COL_VERTEX(  726,  3707, -1385),
    COL_VERTEX( -424,  4475,  1536),
    COL_VERTEX( -424,  3707, -1024),
    COL_VERTEX(-1024,  6011,  -424),
    COL_VERTEX(  364,  3860, -1536),
    COL_VERTEX( -786,  6011, -1385),
    COL_VERTEX(-1385,  5857,  -786),
    COL_VERTEX(-1024,  4168,   424),
    COL_VERTEX( -786,  3860, -1385),
    COL_VERTEX(-1536,  3860,  -424),
    COL_VERTEX( 1024,  5243,  -424),
    COL_VERTEX( 1024,  4936,   424),
    COL_VERTEX(  424,  4628,  1024),
    COL_VERTEX(  424,  5857, -1024),
    COL_VERTEX( -424,  5857, -1024),
    COL_VERTEX( -424,  4321,  1024),
    COL_VERTEX(-1024,  5857,  -424),
    COL_VERTEX(-1024,  3707,  -424),
    COL_VERTEX(-1024,  4014,   424),
    COL_VERTEX( 1536,  3072,  1407),
    COL_VERTEX( 1024,  3072,  1407),
    COL_VERTEX(  864,  2919,  2080),
    COL_VERTEX(  760,  2919,  1672),
    COL_VERTEX(  760,  3072,  1672),
    COL_VERTEX( -547,  3072,  1672),
    COL_VERTEX(-1568,  3072,   650),
    COL_VERTEX( -864,  2919,  2080),
    COL_VERTEX(-2080,  2919,   864),
    ...
    COL_VERTEX( 2080, -2088,  -427),
    COL_VERTEX( 1821, -2088,  -687),
    COL_VERTEX( 1495, -2088,  -361),
    COL_VERTEX( 2080, -2242,  -427),
    ...
    COL_VERTEX( -864, -1453, -2080),
    COL_VERTEX( -539, -1453, -1758),
    COL_VERTEX( -581,  1056,  -911),
    COL_VERTEX( -689,  1056, -1019),
    COL_VERTEX( -800,  1056,  -911),
    COL_VERTEX( -689,  1056,  -802),
    ...
    COL_VERTEX( -790,  -840,  1573),
    COL_VERTEX(-1080,  -840,  1863),
    ...
    COL_VERTEX(-2080,  -992,  -864),
    COL_VERTEX(-1646,  -992,  -717),
    COL_VERTEX(-1671, -1607,   692),
    COL_VERTEX(-1671, -1453,   657),
    COL_VERTEX(-1671, -1453,   692),
    COL_VERTEX(-2080, -1453,   864),
    COL_VERTEX(-1935, -1146, -1006),
    COL_VERTEX(-1646, -1146,  -717),
    COL_VERTEX(-2080, -1146,  -864),
    ...
    COL_VERTEX(-2080, -1607,   864),
    COL_VERTEX( -162, -2692,  2080),
    COL_VERTEX( -162, -2692,  1682),
    COL_VERTEX( -162, -2846,  2080),
    COL_VERTEX( -696, -2692,  1682),
    COL_VERTEX( -864, -2692,  2080),
    COL_VERTEX(-1211, -2692,  1732),
    COL_VERTEX( -928, -2692,  1449),
    COL_VERTEX( -928, -2846,  1449),
    COL_VERTEX(-1593, -3492,  1349),
    COL_VERTEX(-1833, -3492,   614),
    COL_VERTEX(-1346, -3670,  1102),
    COL_VERTEX(-1346, -3492,  1102),
    COL_VERTEX(-1833, -3670,   614),
    COL_VERTEX(-2080, -3516,   864),
    ...
    COL_VERTEX(-2080, -4003,  -864),
    COL_VERTEX(-1876, -4156,  -656),
    COL_VERTEX( -896, -4003, -1634),
    COL_VERTEX(-1103, -4003, -1839),
    COL_VERTEX(-1363,  1075,   145),
    COL_VERTEX(-1363,  1229,   145),
    COL_VERTEX(-1478,  1229,   378),
    COL_VERTEX(-1647,  1075,   -72),
    COL_VERTEX(-1824,  1075,   285),
    COL_VERTEX(-1495,  1075,   637),
    COL_VERTEX(-1411,  1229,   883),
    COL_VERTEX(-1722,  1229,  1062),
    COL_VERTEX(-1850,  1075,   684),
    COL_VERTEX(-1722,  1075,  1062),
    COL_VERTEX(-1478,  1075,   378),
    COL_VERTEX(-1495,  1229,   637),
    COL_VERTEX(  395, -4407,  -611),
    COL_VERTEX(  876,  3707,  -175),
    COL_VERTEX(  364,  3707,  -175),
    COL_VERTEX(  876,  3707, -1024),
    COL_VERTEX(-1385,  6011,  -786),
    COL_VERTEX( -786,  4321,  1386),
    COL_VERTEX(-1385,  4168,   786),
    COL_VERTEX( 1536,  4936,   424),
    COL_VERTEX( 1536,  5243,  -424),
    COL_VERTEX( 1386,  4936,   786),
    COL_VERTEX(  786,  4628,  1386),
    COL_VERTEX(  786,  5857, -1385),
    COL_VERTEX(  424,  5857, -1536),
    COL_VERTEX(  424,  4628,  1536),
    COL_VERTEX( -424,  5857, -1536),
    COL_VERTEX(  364,  3707, -1536),
    COL_VERTEX( -424,  4321,  1536),
    COL_VERTEX( -786,  5857, -1385),
    COL_VERTEX( -424,  3707, -1536),
    COL_VERTEX( -786,  3707, -1385),
    COL_VERTEX(-1536,  4014,   424),
    COL_VERTEX(-1385,  3707,  -786),
    COL_VERTEX(-1536,  3707,  -424),
    COL_VERTEX( 1024,  2919,  1407),
    COL_VERTEX( 1536,  2919,  1407),
    COL_VERTEX(  864,  3072,  2080),
    COL_VERTEX( -547,  2919,  1672),
    COL_VERTEX( -864,  3072,  2080),
    COL_VERTEX(-2080,  3072,   864),
    ...
    COL_VERTEX( 2080,   -19,   864),
    COL_VERTEX( 2080,   -19,  -864),
    COL_VERTEX( 1075,  -173,  -145),
    COL_VERTEX( 2080,  -173,  -864),
    COL_VERTEX( 2080,  -173,   864),
    ...
    COL_VERTEX( -666,  -224, -1030),
    COL_VERTEX(-1244,  -224, -1030),
    COL_VERTEX(-1339,  -224, -1126),
    ...
    COL_VERTEX( 2080, -2088,   -58),
    COL_VERTEX( 2080, -2242,   -58),
    ...
    COL_VERTEX( -864, -1607, -2080),
    COL_VERTEX( -689,   901, -1019),
    COL_VERTEX( -800,   901,  -911),
    ...
    COL_VERTEX(-1080,  -840,  1283),
    COL_VERTEX( -790,  -992,  1573),
    COL_VERTEX(-1080,  -992,  1863),
    COL_VERTEX(-1369,  -840,  1573),
    ...
    COL_VERTEX( -864, -2846,  2080),
    COL_VERTEX(-1211, -2846,  1732),
    COL_VERTEX(-1593, -3670,  1349),
    COL_VERTEX(-2080, -3492,   864),
    COL_VERTEX(-2080, -3670,   864),
    COL_VERTEX(-2080, -3670,   572),
    COL_VERTEX(-2080, -4156,  -571),
    COL_VERTEX(-1876, -4003,  -656),
    COL_VERTEX(-2080, -4156,  -864),
    COL_VERTEX(-1647,  1229,   -72),
    COL_VERTEX(-1824,  1229,   285),
    COL_VERTEX(-1411,  1075,   883),
    COL_VERTEX(-1850,  1229,   684),
    COL_VERTEX(  171, -4407, -1056),
    COL_VERTEX(   64, -4407,  -944),
    ...
    COL_VERTEX( 2208,  6897,  1920),
    COL_VERTEX( 2208,  7051,  1920),
    COL_VERTEX( 1920,  7051,  2208),
    COL_VERTEX( 2498,  6897,  2208),
    COL_VERTEX( 2208,  7051,  2498),
    COL_VERTEX( 2208,  6897,  2498),
    COL_VERTEX( 1920,  6897,  2208),
    COL_VERTEX( 1671,  3860,   749),
    COL_VERTEX( 2080,  3707,   749),
    COL_VERTEX( 2080,  3860,   749),
    COL_VERTEX( 2080,  3707,   339),
    COL_VERTEX( 2080,  3860,   339),
    COL_VERTEX( 1671,  3707,   339),
    COL_VERTEX( 1671,  3860,   339),
    COL_VERTEX( 1671,  3707,   749),
    COL_VERTEX( 1270,  2939,   800),
    COL_VERTEX( 1270,  3159,   800),
    COL_VERTEX( 1270,  3159,   840),
    COL_VERTEX(  926,  3518,   336),
    COL_VERTEX(  926,  3298,   336),
    COL_VERTEX(  926,  3518,   378),
    COL_VERTEX(  999,  2939,   800),
    COL_VERTEX(  655,  3298,   336),
    ...
    COL_VERTEX( -205,  4321,   512),
    COL_VERTEX( -512,  4321,  -205),
    COL_VERTEX(  611,  3318,  2080),
    COL_VERTEX(  611,  3277,  2080),
    COL_VERTEX(  611,  3277,  1672),
    COL_VERTEX(  611,  3318,  1713),
    COL_VERTEX(  611,  3943,  1672),
    COL_VERTEX( -617,  3943,  2080),
    COL_VERTEX( -617,  3943,  1672),
    COL_VERTEX( -576,  3318,  1713),
    COL_VERTEX( -576,  3318,  2080),
    COL_VERTEX( -576,  3902,  1713),
    COL_VERTEX(  864,  1351,  1672),
    COL_VERTEX(  864,  1351,  2080),
    COL_VERTEX(  453,  1351,  1672),
    COL_VERTEX(  864,  1197,  2080),
    ...
    COL_VERTEX(-1218,  -173,   -56),
    COL_VERTEX(-1211,  -173,   -64),
    COL_VERTEX(  105, -4684,  -901),
    COL_VERTEX(   64, -4684,  -944),
    COL_VERTEX(  105, -4976,  -901),
    COL_VERTEX(  171, -4546, -1056),
    ...
    COL_VERTEX(  999,  3159,   800),
    COL_VERTEX( 1270,  2939,   840),
    COL_VERTEX(  999,  2939,   840),
    COL_VERTEX(  926,  3298,   378),
    COL_VERTEX(  655,  3518,   336),
    COL_VERTEX(  655,  3298,   378),
    COL_VERTEX(  999,  3159,   840),
    COL_VERTEX(  655,  3518,   378),
    COL_VERTEX( -617,  3277,  2080),
    COL_VERTEX( -617,  3277,  1672),
    COL_VERTEX(  611,  3902,  1713),
    COL_VERTEX( -576,  3902,  2080),
    COL_VERTEX(  453,  1351,  2080),
    COL_VERTEX(  864,  1197,  1672),
    COL_VERTEX(  453,  1197,  1672),
    COL_VERTEX(  453,  1197,  2080),
    COL_VERTEX(-1073,  2626,  -420),
    COL_VERTEX(-1797,  2063, -1144),
    COL_VERTEX(-1797,  2626, -1144),
    COL_VERTEX(-1073,  2370, -1144),
    COL_VERTEX( -768,  2114,  -782),
    ...
    COL_VERTEX( 1699,  -960, -1243),
    COL_VERTEX( 1376,  -960,  -896),
    ...
    COL_VERTEX(  864, -5365,  2080),
    COL_VERTEX(  859, -4976,   800),
    COL_VERTEX( 1472, -5211,  1472),
    COL_VERTEX(  468, -4976,   468),
    COL_VERTEX(  -64, -5365,  2080),
    COL_VERTEX(  468, -4822,   468),
    COL_VERTEX(  864, -5211,  2080),
    COL_VERTEX( 2080, -4822,   864),
    COL_VERTEX( 2080, -4822,  -864),
    ...
    COL_VERTEX( 2080,  5284,   864),
    COL_VERTEX( 2080,  7475,   864),
    COL_VERTEX( 2080,  7475,  -864),
    ...
    COL_VERTEX(  864,  7475,  2080),
    COL_VERTEX( -602,  8192,  1457),
    COL_VERTEX( -864,  5284,  2080),
    COL_VERTEX( -864,  7475,  2080),
    ...
    COL_VERTEX(-2080,  7475,  -864),
    COL_VERTEX(-2080,  5284,  -864),
    COL_VERTEX( 1920,  6191,  2208),
    COL_VERTEX( 2208,  6191,  1920),
    COL_VERTEX( 1629,  6037,  1920),
    COL_VERTEX( 1629,  6191,  1920),
    COL_VERTEX( 1920,  6037,  2208),
    COL_VERTEX( 2208,  6037,  1920),
    COL_VERTEX( 1920,  6037,  1629),
    COL_VERTEX( 1920,  6191,  1629),
    COL_VERTEX(  864,  5284,  2080),
    COL_VERTEX( 2080,  5919,   864),
    COL_VERTEX( 1080,  5284,  1864),
    COL_VERTEX( 2866,  5284,  2080),
    COL_VERTEX( 2080,  5284,  2866),
    COL_VERTEX( 1864,  5284,  1080),
    COL_VERTEX( 2080,  5919,  3301),
    COL_VERTEX( 1430,  5284,  1152),
    COL_VERTEX(  864,  5919,  2080),
    COL_VERTEX( 3301,  5919,  2080),
    COL_VERTEX( 3301,  7475,  2080),
    COL_VERTEX(  864,  5239,  2080),
    COL_VERTEX( 1080,  5239,  1864),
    COL_VERTEX( 1152,  5284,  1430),
    COL_VERTEX(  864,  1915,  2080),
    COL_VERTEX( 2080,  1915,   864),
    COL_VERTEX( 2080,  1915,  -864),
    COL_VERTEX( -864,  1915,  2080),
    COL_VERTEX(  864,  1915, -2080),
    COL_VERTEX(-2080,  1915,   864),
    ...
    COL_VERTEX(-2080, -3104,  -864),
    COL_VERTEX(-1876, -4022,  -656),
    COL_VERTEX( 2080, -8192,   864),
    COL_VERTEX(  864, -8192,  2080),
    COL_VERTEX( 2080, -8192,  -864),
    COL_VERTEX( -864, -8192,  2080),
    COL_VERTEX(  864, -8192, -2080),
    COL_VERTEX(-2080, -8192,   864),
    COL_VERTEX( -864, -8192, -2080),
    COL_VERTEX(-2080, -8192,  -864),
    COL_VERTEX( 2080,  7475,  3301),
    COL_VERTEX( 2080,  5239,   864),
    COL_VERTEX( 1864,  5239,  1080),
    ...
    COL_VERTEX( -896, -4822, -1634),
    COL_VERTEX( -896, -4022, -1634),
