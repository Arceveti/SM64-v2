...
static const Gfx bitdw_seg7_sub_dl_quartz_crystal[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bitdw_seg7_texture_quartz_crystal_env),
    gsDPLoadSync(),
...
const Gfx bitdw_seg7_dl_quartz_crystal[] = {
    gsDPPipeSync(),
    ...
    gsSPDisplayList(bitdw_seg7_sub_dl_quartz_crystal),
