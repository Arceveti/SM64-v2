...
static const LevelScript script_func_local_ddd_fish[] = {
    OBJECT(/*model*/ MODEL_SUSHI,        /*pos*/ -3072,  -270,   0, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvSushiShark),
    OBJECT(/*model*/ MODEL_SUSHI,        /*pos*/ -3072, -4270,   0, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvSushiShark),
    OBJECT(/*model*/ MODEL_NONE,         /*pos*/ -3072,  -130,   0, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvFewBlueFishSpawner),
    OBJECT(/*model*/ MODEL_NONE,         /*pos*/ -3072, -4270,   0, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvManyBlueFishSpawner),
    OBJECT(/*model*/ MODEL_NONE,         /*pos*/ -3072, -2000,   0, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvBubSpawner),
    OBJECT(/*model*/ MODEL_NONE,         /*pos*/ -3072, -3000,   0, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvBubSpawner),
    OBJECT(/*model*/ MODEL_DL_WHIRLPOOL, /*pos*/ -3175, -4915, 102, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvWhirlpool),
    RETURN(),
};

static const LevelScript script_func_local_ddd_stars[] = {
...
static const LevelScript script_func_local_ddd_area_2_poles_and_sub[] = {
...
static const LevelScript script_func_local_ddd_area_2_jet_stream[] = {
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ 3404, -3319, -489, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvJetStream),
    RETURN(),
};

static const LevelScript script_func_local_ddd_area_2_stars[] = {
...
const LevelScript level_ddd_entry[] = {
    ...
    AREA(/*index*/ 1, ddd_geo_area_1),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ -3072, 3000, 0, /*angle*/ 0, 7, 0, /*behParam*/ 0x000A0000, /*beh*/ bhvSpinAirborneWarp),
        ...
        JUMP_LINK(script_func_local_ddd_fish),
        JUMP_LINK(script_func_local_ddd_stars),
    ...
    AREA(/*index*/ 2, ddd_geo_area_2),
        WHIRLPOOL(/*unk2*/ 0, /*unk3*/ 0, /*pos*/ 3355, -3575, -512, /*strength*/ -30),
        WHIRLPOOL(/*unk2*/ 1, /*unk3*/ 2, /*pos*/ 3917, -2040, -6042, /*strength*/ 50),
        WARP_NODE(/*id*/ 0xF0, /*destLevel*/ LEVEL_CASTLE,         /*destArea*/ 0x03, /*destNode*/ 0x35, /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ 0xF1, /*destLevel*/ LEVEL_CASTLE,         /*destArea*/ 0x03, /*destNode*/ 0x67, /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ 0xF3, /*destLevel*/ LEVEL_CASTLE_GROUNDS, /*destArea*/ 0x01, /*destNode*/ 0x1E, /*flags*/ WARP_NO_CHECKPOINT),
        JUMP_LINK(script_func_local_ddd_area_2_poles_and_sub),
        JUMP_LINK(script_func_local_ddd_area_2_jet_stream),
        JUMP_LINK(script_func_local_ddd_area_2_stars),
