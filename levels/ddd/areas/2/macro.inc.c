...
const MacroObject ddd_seg7_area_2_macro_objs[] = {
    ...
    MACRO_OBJECT(               /*preset*/ macro_red_coin,                    /*yaw*/   0, /*pos*/  2100,  1024, -1600                         ),
    ...
    MACRO_OBJECT(               /*preset*/ macro_seaweed_bundle,              /*yaw*/   0, /*pos*/  3000, -4096,  4430                         ),
    MACRO_OBJECT(               /*preset*/ macro_coin_ring_horizontal,        /*yaw*/   0, /*pos*/  4876, -4087,  4430                         ),
    MACRO_OBJECT(               /*preset*/ macro_coin_line_vertical,          /*yaw*/   0, /*pos*/  3892, -4032, -3830                         ),
    MACRO_OBJECT(               /*preset*/ macro_coin_line_horizontal,        /*yaw*/  90, /*pos*/  3923,   110,  5953                         ),
    MACRO_OBJECT(               /*preset*/ macro_fire_spitter,                /*yaw*/   0, /*pos*/   938,   154,  4107                         ),
