...
const MacroObject ddd_seg7_area_1_macro_objs[] = {
    ...
    MACRO_OBJECT(               /*preset*/ macro_yellow_coin_2,        /*yaw*/   0, /*pos*/ -2180, -5120,  1720                ),
    MACRO_OBJECT(               /*preset*/ macro_yellow_coin_2,        /*yaw*/   0, /*pos*/ -1460, -5120,  1300                ),
    MACRO_OBJECT(               /*preset*/ macro_yellow_coin_2,        /*yaw*/   0, /*pos*/ -1320, -5120,   840                ),
    MACRO_OBJECT_END(),
};
