...
static const Gfx wmotr_seg7_dl_07008EF0[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, wmotr_seg7_texture_green_pole),
    gsDPLoadSync(),
...
static const Gfx wmotr_seg7_dl_07009148[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, wmotr_seg7_texture_pink_surface_edge),
    gsDPLoadSync(),
...
static const Gfx wmotr_seg7_dl_070092A0[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, wmotr_seg7_texture_pink_surface),
    gsDPLoadSync(),
...
static const Gfx wmotr_seg7_dl_07009458[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, wmotr_seg7_texture_cloud_surface),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
static const Vtx wmotr_seg7_vertex_0700F048[] = {
    ...
    {{{   342,   -641,   4824}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   577,   -982,   4828}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  4113,  -2764,   4879}, 0, {     0,    -89}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3991,  -2170,   4877}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3595,  -2279,   4872}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    ...
    {{{   133,  -1475,   4821}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -350,  -1475,   4814}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   577,   -982,   4828}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   342,   -641,   4824}, 0, {     0,    -96}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   249,  -1289,   4823}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   -68,  -1027,   4818}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
};

// 0x0700F138 - 0x0700F228
static const Vtx wmotr_seg7_vertex_0700F138[] = {
    {{{  2492,   -809,   4856}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  2068,   -264,   4849}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  2011,   -673,   4849}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  1013,   -770,   4834}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   882,   -379,   4832}, 0, {     0,    -92}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   342,   -641,   4824}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  1509,   -672,   4841}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  1469,   -262,   4841}, 0, {     0,    -80}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   882,   -379,   4832}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  1013,   -770,   4834}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  2011,   -673,   4849}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  2068,   -264,   4849}, 0, {     0,    -80}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  1509,   -672,   4841}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  1469,   -262,   4841}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
...
static const Vtx wmotr_seg7_vertex_0700F228[] = {
    ...
    {{{  3819,  -1678,   4875}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  2887,  -1069,   4861}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3153,   -754,   4865}, 0, {     0,    -92}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  2665,   -432,   4858}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  2492,   -809,   4856}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3187,  -1389,   4866}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3519,  -1145,   4870}, 0, {     0,    -89}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3153,   -754,   4865}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  2887,  -1069,   4861}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3445,  -1847,   4869}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3819,  -1678,   4875}, 0, {     0,    -74}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3519,  -1145,   4870}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3187,  -1389,   4866}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
};

// 0x0700F318 - 0x0700F408
static const Vtx wmotr_seg7_vertex_0700F318[] = {
    {{{ -3829,   1198,   1098}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -4251,   1217,    578}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -4064,    921,    798}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3595,  -2279,   4872}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3819,  -1678,   4875}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3445,  -1847,   4869}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -791,  -1495,   4743}, 0, {     0,   -107}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -899,   -927,   4631}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -1059,  -1495,   4413}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -1142,  -1056,   4326}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -4064,    921,    798}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -4251,   1217,    578}, 0, {     0,    -70}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -4209,    607,    607}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -4419,    856,    358}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
...
static const Vtx wmotr_seg7_vertex_0700F408[] = {
    ...
    {{{ -2894,   1522,   2263}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -3561,   1403,   1436}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -3652,   1793,   1338}, 0, {     0,    -77}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -3968,   1552,    940}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -3829,   1198,   1098}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -3240,   1516,   1836}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -3652,   1793,   1338}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -3561,   1403,   1436}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    ...
    {{{ -3277,   1926,   1806}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -3240,   1516,   1836}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -2876,   1932,   2300}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
};
...
static const Vtx wmotr_seg7_vertex_0700F508[] = {
    ...
    {{{ -2450,   1794,   2820}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -2522,   1402,   2717}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -1880,    812,   3486}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -1707,   1109,   3711}, 0, {     0,    -74}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -2167,   1154,   3145}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -2041,   1509,   3314}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -1623,    344,   3785}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -1421,    591,   4044}, 0, {     0,    -60}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -1880,    812,   3486}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -1142,  -1056,   4326}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -1023,   -461,   4495}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -1257,   -625,   4201}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -1707,   1109,   3711}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
};
...
static const Vtx wmotr_seg7_vertex_0700F5F8[] = {
    ...
    {{{ -1421,    591,   4044}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -1623,    344,   3785}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -1257,   -625,   4201}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -1023,   -461,   4495}, 0, {     0,    -52}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -1415,   -129,   4024}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -1194,     73,   4305}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -1142,  -1056,   4326}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -899,   -927,   4631}, 0, {     0,    -52}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -1023,   -461,   4495}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{    87,   2403,   1061}, 0, {     0,   -112}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   156,   2111,    638}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   110,   1811,    922}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
};

// 0x0700F6D8 - 0x0700F7C8
static const Vtx wmotr_seg7_vertex_0700F6D8[] = {
    {{{  -469,  -1463,   4481}, 0, {     0,    -42}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -464,   -663,   4450}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -399,   -695,   4047}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -404,  -1463,   4077}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   138,   1576,    749}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   110,   1811,    922}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   156,   2111,    638}, 0, {     0,   -323}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   216,   1608,    269}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    ...
    {{{  -185,   2547,   2738}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
};

// 0x0700F7C8 - 0x0700F8B8
static const Vtx wmotr_seg7_vertex_0700F7C8[] = {
    {{{   -15,   2190,   1691}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{    87,   2403,   1061}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{    57,   2033,   1244}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{    -1,   2594,   1609}, 0, {     0,    -89}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   -88,   2223,   2140}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   -90,   2635,   2155}, 0, {     0,    -87}, {0xff, 0xff, 0xff, 0xff}}},
    {{{    -1,   2594,   1609}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   -15,   2190,   1691}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -165,   2151,   2614}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -185,   2547,   2738}, 0, {     0,    -91}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   -88,   2223,   2140}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   -90,   2635,   2155}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -364,    677,   3835}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -392,   1387,   4007}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -333,   1201,   3644}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
};
...
static const Vtx wmotr_seg7_vertex_0700F8B8[] = {
    {{{  -234,   1932,   3037}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -185,   2547,   2738}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -165,   2151,   2614}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -292,   1588,   3392}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -343,   1852,   3705}, 0, {     0,    -86}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -273,   2270,   3274}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -234,   1932,   3037}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -333,   1201,   3644}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -392,   1387,   4007}, 0, {     0,    -83}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -292,   1588,   3392}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -343,   1852,   3705}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -364,    677,   3835}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
...
static const Vtx wmotr_seg7_vertex_0700F998[] = {
    ...
    {{{  4122,   1558,     18}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3773,   1540,   -195}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -385,     68,   3961}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -450,    134,   4360}, 0, {     0,    -52}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -427,    791,   4224}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -364,    677,   3835}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -399,   -695,   4047}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -464,   -663,   4450}, 0, {     0,    -43}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -385,     68,   3961}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -450,    134,   4360}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -2463,   4636,  -4017}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -2769,   4841,  -4205}, 0, {     0,   -356}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -2890,   4474,  -4279}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -2516,   4474,  -4050}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
};

// 0x0700FA88 - 0x0700FB78
static const Vtx wmotr_seg7_vertex_0700FA88[] = {
    {{{ -1119,   5845,  -3194}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -1896,   5830,  -3670}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -1707,   5484,  -3554}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  4122,     63,     18}, 0, {     0,    -35}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3773,   1540,   -195}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    ...
    {{{ -2769,   4841,  -4205}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -2463,   4636,  -4017}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -1707,   5484,  -3554}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -1896,   5830,  -3670}, 0, {     0,    -63}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -2422,   5355,  -3993}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -2175,   5061,  -3841}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
...
static const Vtx wmotr_seg7_vertex_0700FB78[] = {
    ...
    {{{   969,   6085,  -1913}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -494,   6051,  -2811}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -556,   6456,  -2849}, 0, {     0,    -59}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -1249,   6228,  -3273}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{ -1119,   5845,  -3194}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   277,   6125,  -2337}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   272,   6535,  -2341}, 0, {     0,    -50}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -556,   6456,  -2849}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -494,   6051,  -2811}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   969,   6085,  -1913}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   272,   6535,  -2341}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   277,   6125,  -2337}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
...
static const Vtx wmotr_seg7_vertex_0700FC68[] = {
    ...
    {{{  3090,   4990,   -613}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  1772,   6248,  -1421}, 0, {     0,    -64}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  1025,   6492,  -1879}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   969,   6085,  -1913}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  2276,   5407,  -1112}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  2499,   5728,   -976}, 0, {     0,    -64}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  1772,   6248,  -1421}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  1631,   5869,  -1507}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  2817,   4733,   -781}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3090,   4990,   -613}, 0, {     0,    -56}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  2499,   5728,   -976}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  2276,   5407,  -1112}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  2817,   4733,   -781}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
};

// 0x0700FD58 - 0x0700FE48
static const Vtx wmotr_seg7_vertex_0700FD58[] = {
    {{{  4293,     55,    379}, 0, {     0,     56}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  4252,    586,    376}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    ...
    {{{  3574,   4157,   -317}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3265,   3961,   -506}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3713,   2323,   -231}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  4059,   2386,    -19}, 0, {     0,    -51}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3557,   3145,   -327}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3891,   3270,   -122}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3773,   1540,   -195}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  4122,   1558,     18}, 0, {     0,    -46}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  4059,   2386,    -19}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3713,   2323,   -231}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
};

// 0x0700FE48 - 0x0700FF38
static const Vtx wmotr_seg7_vertex_0700FE48[] = {
    {{{  1583,   2187,    157}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  1058,   2349,    114}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  1313,   2025,    135}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  4252,    586,    376}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3847,    519,    343}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3883,     55,    346}, 0, {   990,     77}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  1103,   1811,    118}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   759,   2043,     90}, 0, {     0,   -142}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   609,   1697,     78}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   998,   1569,    110}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  1313,   2025,    135}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  1058,   2349,    114}, 0, {     0,   -141}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  1103,   1811,    118}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   759,   2043,     90}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  1425,   2570,    144}, 0, {     0,   -128}, {0xff, 0xff, 0xff, 0xff}}},
};
...
static const Vtx wmotr_seg7_vertex_0700FF38[] = {
    ...
    {{{  2706,   2184,    249}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  1911,   2269,    184}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  1861,   2679,    180}, 0, {     0,   -112}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  1583,   2187,    157}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  1425,   2570,    144}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  2310,   2269,    216}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  2353,   2679,    220}, 0, {     0,    -96}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  1911,   2269,    184}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  1861,   2679,    180}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  2706,   2184,    249}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  2848,   2573,    260}, 0, {     0,    -96}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  2353,   2679,    220}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  2310,   2269,    216}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
};

// 0x07010028 - 0x07010118
static const Vtx wmotr_seg7_vertex_07010028[] = {
    {{{  3729,    992,    333}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3911,   1596,    347}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3552,   1397,    318}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3279,   2341,    295}, 0, {     0,   -112}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  2848,   2573,    260}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  2706,   2184,    249}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3321,   1739,    299}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3279,   2341,    295}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3038,   2006,    276}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3633,   2006,    324}, 0, {     0,    -96}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3552,   1397,    318}, 0, {   990,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3911,   1596,    347}, 0, {     0,    -83}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3321,   1739,    299}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3633,   2006,    324}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
...
static const Vtx wmotr_seg7_vertex_07010118[] = {
    ...
    {{{  4252,    586,    376}, 0, {     0,    -64}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  4116,   1125,    364}, 0, {     0,    224}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  3729,    992,    333}, 0, {   990,    224}, {0xff, 0xff, 0xff, 0xff}}},
};

// 0x07010158 - 0x07010608
static const Gfx wmotr_seg7_sub_dl_rainbows[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, wmotr_seg7_texture_rainbow),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, CALC_LRS(32, 8), CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
const Gfx wmotr_seg7_dl_rainbows[] = {
    gsDPPipeSync(),
    ...
    gsSPDisplayList(wmotr_seg7_sub_dl_rainbows),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_OFF),
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADE, G_CC_SHADE),
