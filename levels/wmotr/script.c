...
static const LevelScript script_func_local_wmotr_poles[] = {
...
static const LevelScript script_func_local_wmotr_stars[] = {
...
const LevelScript level_wmotr_entry[] = {
    ...
    AREA(/*index*/ 1, wmotr_geo_area_1),
        ...
        JUMP_LINK(script_func_local_wmotr_poles),
        JUMP_LINK(script_func_local_wmotr_stars),
