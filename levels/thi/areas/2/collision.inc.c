...
const Collision thi_seg7_area_2_collision[] = {
    ...
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_level_geo_03, /*pos*/   -40,  -768, -4494, /*yaw*/   0),
    SPECIAL_OBJECT(         /*preset*/ special_bubble_tree,  /*pos*/  1444,  -154,   676             ),
    COL_WATER_BOX_INIT(3),
    COL_WATER_BOX(0, -2457, -2457, -1535, 1874, -922),
    COL_WATER_BOX(1, -1381,  1352,  2089, 2458, -922),
    COL_WATER_BOX(2,  -307,  -768,  307,  -154, 1204),
    COL_END(),
};
