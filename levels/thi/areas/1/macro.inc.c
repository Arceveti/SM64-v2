...
const MacroObject thi_seg7_area_1_macro_objs[] = {
    ...
    MACRO_OBJECT(               /*preset*/ macro_coin_line_horizontal, /*yaw*/   0, /*pos*/   870,  -500,  2828                         ),
    MACRO_OBJECT(               /*preset*/ macro_coin_line_horizontal, /*yaw*/  90, /*pos*/   -64, -1638, -4944                         ),
    MACRO_OBJECT(               /*preset*/ macro_coin_line_horizontal, /*yaw*/   0, /*pos*/  5711, -1677, -2944                         ),
#ifdef FIX_IMPOSSIBLE_COINS
    MACRO_OBJECT(               /*preset*/ macro_coin_line_horizontal, /*yaw*/   0, /*pos*/ -4911,  -160, -1433                         ),
#else
    MACRO_OBJECT(               /*preset*/ macro_coin_line_horizontal, /*yaw*/   0, /*pos*/ -4911,  -395, -1433                         ),
#endif
    MACRO_OBJECT(               /*preset*/ macro_coin_line_horizontal, /*yaw*/  90, /*pos*/   200,  2233,   432                         ),
    ...
    MACRO_OBJECT(               /*preset*/ macro_huge_goomba,          /*yaw*/   0, /*pos*/ -3622,  -512,  3100                         ),
    MACRO_OBJECT(               /*preset*/ macro_huge_goomba,          /*yaw*/   0, /*pos*/ -3177,  1255, -2366                         ),
    MACRO_OBJECT(               /*preset*/ macro_huge_goomba,          /*yaw*/   0, /*pos*/ -3180,  -512,  2080                         ),
    ...
    MACRO_OBJECT(               /*preset*/ macro_chuckya,              /*yaw*/   0, /*pos*/ -1800,  2233,  -320                         ),
    ...
    MACRO_OBJECT(               /*preset*/ macro_butterfly_triplet,    /*yaw*/   0, /*pos*/ -3111,  -512,  2400                         ),
