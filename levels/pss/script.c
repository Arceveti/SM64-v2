...
const LevelScript level_pss_entry[] = {
    ...
    #define LANTERN_LIGHT(x, y, z, yaw) PUPPYLIGHT_NODE(255,  85,   0, 255, (x), (y), (z), LANTERN_SIZE, LANTERN_SIZE, LANTERN_SIZE, (yaw), 0, (PUPPYLIGHT_SHAPE_CYLINDER | PUPPYLIGHT_DIRECTIONAL), -1)
        LANTERN_LIGHT( 2920,  6460, -5170, 0x8000),
        LANTERN_LIGHT( 2920,  6460, -6092, 0x0000),
        LANTERN_LIGHT(-3600,  4960, -6092, 0x0000),
        LANTERN_LIGHT(-5720,  4740, -5448, 0x2000),
        LANTERN_LIGHT(-6660,  4380, -3100, 0x4000),
        LANTERN_LIGHT(-6660,  3970,     0, 0x4000),
        LANTERN_LIGHT(-5076,  3535,  2390, 0x7000),
        LANTERN_LIGHT(  552, -1880, -5330, 0x7000),
        LANTERN_LIGHT(-4560, -3300, -3300, 0x6800),
        LANTERN_LIGHT(-5900, -3900,   900, 0xC000),
        LANTERN_LIGHT(-6820, -3900,   900, 0x4000),
        LANTERN_LIGHT(-5900, -4032,  2300, 0xC000),
        LANTERN_LIGHT(-6820, -4032,  2300, 0x4000),
        LANTERN_LIGHT(-5900, -4164,  3700, 0xC000),
        LANTERN_LIGHT(-6820, -4164,  3700, 0x4000),
    #undef LANTERN_SIZE
    #undef LANTERN_LIGHT
#endif
    END_AREA(),
