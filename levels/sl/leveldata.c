...
#include "levels/sl/cracked_ice/model.inc.c"
#include "levels/sl/ice_shard/model.inc.c" // Used in the unused behavior when ground pounding the cracked ice show in the above model.
...
#include "levels/sl/cracked_ice/collision.inc.c"
