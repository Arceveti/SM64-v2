...
const MacroObject sl_seg7_area_1_macro_objs[] = {
...
#ifdef BONUS_OBJECTS
    MACRO_OBJECT(               /*preset*/ macro_recovery_heart,       /*yaw*/   0, /*pos*/  4000,   864, -3000                         ),
#endif
    MACRO_OBJECT(               /*preset*/ macro_yellow_coin,          /*yaw*/   0, /*pos*/ -1520,  1040,   940                         ),
    MACRO_OBJECT(               /*preset*/ macro_yellow_coin,          /*yaw*/   0, /*pos*/ -1340,  1280,  1024                         ),
    ...
    MACRO_OBJECT(               /*preset*/ macro_red_coin,             /*yaw*/   0, /*pos*/  -528,  1050, -5329                         ),
