...
struct MacroPreset MacroObjectPresets[] = {
    ...
    {bhvBreakableBoxSmall,              MODEL_BREAKABLE_BOX_SMALL,          0}, // macro_breakable_box_small
    ...
    {bhvThwomp,                         MODEL_THWOMP,                       0}, // macro_thwomp - unused (was thwomp2)
    ...
    {bhvBubSpawner,                     MODEL_NONE,                         0}, // macro_chirp_chirp
