...
/* activeFlags */
#define ACTIVE_FLAG_DEACTIVATED            0x00      // 0x0000
...
/* gTTCSpeedSetting */
#define TTC_SPEED_SLOW    0x00
#define TTC_SPEED_FAST    0x01
#define TTC_SPEED_RANDOM  0x02
#define TTC_SPEED_STOPPED 0x03
...
/* Blue Coin Switch */
    ...
    #define BLUE_COIN_SWITCH_ACT_EXTENDING 3

/* Moving Blue Coin */
    /* oAction */
    #define MOV_BCOIN_ACT_STILL        0
    #define MOV_BCOIN_ACT_MOVING       1
    #define MOV_BCOIN_ACT_SLOWING_DOWN 2
    #define MOV_BCOIN_ACT_STOPPED      3
    #define MOV_BCOIN_ACT_FLICKERING   4
...
/* Cheep Cheep Spawner */
    /* oAction */
    #define BUB_SPAWNER_ACT_SPAWN_BUBS  0
    #define BUB_SPAWNER_ACT_IDLE        1
    #define BUB_SPAWNER_ACT_REMOVE_BUBS 2
    #define BUB_SPAWNER_ACT_RESET       3

/* Cheep Cheep */
    /* oAction */
    #define BUB_ACT_INIT                     0
    #define BUB_ACT_SWIMMING_TOWARDS_MARIO   1
    #define BUB_ACT_SWIMMING_AWAY_FROM_MARIO 2

/* Small Breakable Box */
    /* oAction */
    #define BREAKABLE_BOX_SMALL_ACT_MOVE    0
    #define BREAKABLE_BOX_SMALL_ACT_RESPAWN 101
...
/* Exclamation Box */
    ...
    #define EXCLAMATION_BOX_ACT_EXPLODE          4
    #define EXCLAMATION_BOX_ACT_WAIT_FOR_RESPAWN 5
...
/* Camera Lakitu */
    ...
    #define CAMERA_LAKITU_INTRO_ACT_SHOW_DIALOG      2
...
/* HMC Controllable Platform */
    ...
    #define DIRECTION_STATE_STOPPED      0
    #define DIRECTION_STATE_SOUTH        1
    #define DIRECTION_STATE_NORTH        2
    #define DIRECTION_STATE_EAST         3
    #define DIRECTION_STATE_WEST         4
    #define DIRECTION_STATE_HIT_WALL     5
    #define DIRECTION_STATE_DISAPPEARING 6

    #define MOVE_DIRECTION_NORTH         1
    #define MOVE_DIRECTION_SOUTH         2
    #define MOVE_DIRECTION_WEST          3
    #define MOVE_DIRECTION_EAST          4
...
/* Openable Grill Door */
    /* oAction */
    #define OEPNABLE_GRILL_SPAWN                    0
    #define OEPNABLE_GRILL_IDLE_CLOSED              1
    #define OEPNABLE_GRILL_OPENING                  2
    #define OEPNABLE_GRILL_IDLE_OPEN                3
...
/* Water Bomb Cannon */
    /* oAction */
    #define WATER_BOMB_CANNON_ACT_HIDDEN 0
    #define WATER_BOMB_CANNON_ACT_ACTIVE 1
    #define WATER_BOMB_CANNON_ACT_HIDE   2
...
/* King Bobomb */
    /* oAction */
    #define KING_BOBOMB_ACT_INACTIVE        0
    #define KING_BOBOMB_ACT_ACTIVATE        1
    #define KING_BOBOMB_ACT_ACTIVE          2
    #define KING_BOBOMB_ACT_GRABBED_MARIO   3
    #define KING_BOBOMB_ACT_BEEN_THROWN     4
    #define KING_BOBOMB_ACT_RETURN_HOME     5
    #define KING_BOBOMB_ACT_HIT_GROUND      6
    #define KING_BOBOMB_ACT_DEATH           7
