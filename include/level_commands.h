...
#define VAR_CURR_SAVE_FILE_NUM  0x0
#define VAR_CURR_COURSE_NUM     0x1
#define VAR_CURR_ACT_NUM        0x2
#define VAR_CURR_LEVEL_NUM      0x3
#define VAR_CURR_AREA_INDEX     0x4

#define WARP_CHECKPOINT         0x80
#define WARP_NO_CHECKPOINT      0x00

#define WHIRLPOOL_COND_ALWAYS               0x0
#define WHIRLPOOL_COND_BOWSER2_NOT_BEATEN   0x1
#define WHIRLPOOL_COND_BOWSER2_BEATEN       0x2
#define WHIRLPOOL_COND_AT_LEAST_SECOND_STAR 0x3
