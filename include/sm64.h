...
#define GROUND_STEP_LEFT_GROUND                 0x00
#define GROUND_STEP_NONE                        0x01
#define GROUND_STEP_HIT_WALL                    0x02
#define GROUND_STEP_HIT_WALL_STOP_QSTEPS        0x02
#define GROUND_STEP_HIT_WALL_CONTINUE_QSTEPS    0x03
#define GROUND_STEP_DEATH                       0x04

#define AIR_STEP_CHECK_LEDGE_GRAB               0x01
#define AIR_STEP_CHECK_HANG                     0x02

#define AIR_STEP_NONE                           0x00
#define AIR_STEP_LANDED                         0x01
#define AIR_STEP_HIT_WALL                       0x02
#define AIR_STEP_GRABBED_LEDGE                  0x03
...
#define WATER_STEP_HIT_CEILING                  0x02
#define WATER_STEP_CANCELLED                    0x03
#define WATER_STEP_HIT_WALL                     0x04
...
#define ACT_SLIDE_KICK_SLIDE_STOP      0x0C000225 // (0x025 | ACT_FLAG_STATIONARY | ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
...
#define ACT_BACKFLIP_LAND_STOP         0x0C00022F // (0x02F | ACT_FLAG_STATIONARY | ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
...
#define ACT_AIR_THROW_LAND             0x8C000A36 // (0x036 | ACT_FLAG_STATIONARY | ACT_FLAG_AIR | ACT_FLAG_THROWING | ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
#define ACT_TWIRL_LAND                 0x1C800238 // (0x038 | ACT_FLAG_STATIONARY | ACT_FLAG_ATTACKING | ACT_FLAG_PAUSE_EXIT | ACT_FLAG_SWIMMING_OR_FLYING)
#define ACT_LAVA_BOOST_LAND            0x0C000239 // (0x039 | ACT_FLAG_STATIONARY | ACT_FLAG_ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
#define ACT_TRIPLE_JUMP_LAND_STOP      0x0C00023A // (0x03A | ACT_FLAG_STATIONARY | ACT_FLAG_ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
#define ACT_LONG_JUMP_LAND_STOP        0x0C00023B // (0x03B | ACT_FLAG_STATIONARY | ACT_FLAG_ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
#define ACT_GROUND_POUND_LAND          0x0C80023C // (0x03C | ACT_FLAG_STATIONARY | ACT_FLAG_ATTACKING | ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
...
#define ACT_WALKING                    0x0C000440 // (0x040 | ACT_FLAG_MOVING | ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
#define ACT_HOLD_WALKING               0x08000442 // (0x042 | ACT_FLAG_MOVING | ACT_FLAG_PAUSE_EXIT)
#define ACT_TURNING_AROUND             0x0C000443 // (0x043 | ACT_FLAG_MOVING | ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
#define ACT_FINISH_TURNING_AROUND      0x0C000444 // (0x044 | ACT_FLAG_MOVING | ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
#define ACT_BRAKING                    0x0C000445 // (0x045 | ACT_FLAG_MOVING | ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
#define ACT_RIDING_SHELL_GROUND        0x28810446 // (0x046 | ACT_FLAG_MOVING | ACT_FLAG_RIDING_SHELL | ACT_FLAG_ATTACKING | ACT_FLAG_WATER_OR_TEXT | ACT_FLAG_PAUSE_EXIT)
#define ACT_HOLD_HEAVY_WALKING         0x08000447 // (0x047 | ACT_FLAG_MOVING | ACT_FLAG_PAUSE_EXIT)
#define ACT_CRAWLING                   0x0C008448 // (0x048 | ACT_FLAG_MOVING | ACT_FLAG_SHORT_HITBOX | ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
#define ACT_BURNING_GROUND             0x00020449 // (0x049 | ACT_FLAG_MOVING | ACT_FLAG_INVULNERABLE)
#define ACT_DECELERATING               0x0C00044A // (0x04A | ACT_FLAG_MOVING | ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
#define ACT_HOLD_DECELERATING          0x0800044B // (0x04B | ACT_FLAG_MOVING | ACT_FLAG_PAUSE_EXIT)
...
#define ACT_MOVE_PUNCHING              0x08800457 // (0x057 | ACT_FLAG_MOVING | ACT_FLAG_ATTACKING | ACT_FLAG_PAUSE_EXIT)
#define ACT_CROUCH_SLIDE               0x0C808459 // (0x059 | ACT_FLAG_MOVING | ACT_FLAG_SHORT_HITBOX | ACT_FLAG_ATTACKING | ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
...
#define ACT_JUMP_LAND                  0x0C000470 // (0x070 | ACT_FLAG_MOVING | ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
#define ACT_FREEFALL_LAND              0x0C000471 // (0x071 | ACT_FLAG_MOVING | ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
#define ACT_DOUBLE_JUMP_LAND           0x0C000472 // (0x072 | ACT_FLAG_MOVING | ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
#define ACT_SIDE_FLIP_LAND             0x0C000473 // (0x073 | ACT_FLAG_MOVING | ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
#define ACT_HOLD_JUMP_LAND             0x08000474 // (0x074 | ACT_FLAG_MOVING | ACT_FLAG_PAUSE_EXIT)
#define ACT_HOLD_FREEFALL_LAND         0x08000475 // (0x075 | ACT_FLAG_MOVING | ACT_FLAG_PAUSE_EXIT)
...
#define ACT_TRIPLE_JUMP_LAND           0x0C000478 // (0x078 | ACT_FLAG_MOVING | ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
#define ACT_LONG_JUMP_LAND             0x0C000479 // (0x079 | ACT_FLAG_MOVING | ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
#define ACT_BACKFLIP_LAND              0x0C00047A // (0x07A | ACT_FLAG_MOVING | ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
...
#define ACT_GROUND_POUND_JUMP          0x01000884 // (0x084 | ACT_FLAG_AIR | ACT_FLAG_ALLOW_VERTICAL_WIND_ACTION | ACT_FLAG_CONTROL_JUMP_HEIGHT)
...
#define ACT_WALL_SLIDE                 0x0100088B // (0x08B | ACT_FLAG_AIR | ACT_FLAG_ALLOW_VERTICAL_WIND_ACTION)
...
#define ACT_WATER_ACTION_END           0x380022C2 // (0x0C2 | ACT_FLAG_STATIONARY | ACT_FLAG_SWIMMING | ACT_FLAG_PAUSE_EXIT | ACT_FLAG_SWIMMING_OR_FLYING | ACT_FLAG_WATER_OR_TEXT)
#define ACT_HOLD_WATER_ACTION_END      0x380022C3 // (0x0C3 | ACT_FLAG_STATIONARY | ACT_FLAG_SWIMMING | ACT_FLAG_PAUSE_EXIT | ACT_FLAG_SWIMMING_OR_FLYING | ACT_FLAG_WATER_OR_TEXT)
...
#define ACT_WATER_GROUND_POUND_LAND    0x388022C9 // (0x0C9 | ACT_FLAG_STATIONARY | ACT_FLAG_SWIMMING | ACT_FLAG_PAUSE_EXIT | ACT_FLAG_SWIMMING_OR_FLYING | ACT_FLAG_WATER_OR_TEXT | ACT_FLAG_ATTACKING)
#define ACT_WATER_GROUND_POUND         0x388024CF // (0x0CF | ACT_FLAG_MOVING | ACT_FLAG_SWIMMING | ACT_FLAG_PAUSE_EXIT | ACT_FLAG_SWIMMING_OR_FLYING | ACT_FLAG_WATER_OR_TEXT | ACT_FLAG_ATTACKING)
#define ACT_BREASTSTROKE               0x380024D0 // (0x0D0 | ACT_FLAG_MOVING | ACT_FLAG_SWIMMING | ACT_FLAG_PAUSE_EXIT | ACT_FLAG_SWIMMING_OR_FLYING | ACT_FLAG_WATER_OR_TEXT)
#define ACT_SWIMMING_END               0x380024D1 // (0x0D1 | ACT_FLAG_MOVING | ACT_FLAG_SWIMMING | ACT_FLAG_PAUSE_EXIT | ACT_FLAG_SWIMMING_OR_FLYING | ACT_FLAG_WATER_OR_TEXT)
#define ACT_FLUTTER_KICK               0x380024D2 // (0x0D2 | ACT_FLAG_MOVING | ACT_FLAG_SWIMMING | ACT_FLAG_PAUSE_EXIT | ACT_FLAG_SWIMMING_OR_FLYING | ACT_FLAG_WATER_OR_TEXT)
#define ACT_HOLD_BREASTSTROKE          0x380024D3 // (0x0D3 | ACT_FLAG_MOVING | ACT_FLAG_SWIMMING | ACT_FLAG_PAUSE_EXIT | ACT_FLAG_SWIMMING_OR_FLYING | ACT_FLAG_WATER_OR_TEXT)
#define ACT_HOLD_SWIMMING_END          0x380024D4 // (0x0D4 | ACT_FLAG_MOVING | ACT_FLAG_SWIMMING | ACT_FLAG_PAUSE_EXIT | ACT_FLAG_SWIMMING_OR_FLYING | ACT_FLAG_WATER_OR_TEXT)
#define ACT_HOLD_FLUTTER_KICK          0x380024D5 // (0x0D5 | ACT_FLAG_MOVING | ACT_FLAG_SWIMMING | ACT_FLAG_PAUSE_EXIT | ACT_FLAG_SWIMMING_OR_FLYING | ACT_FLAG_WATER_OR_TEXT)
#define ACT_WATER_SHELL_SWIMMING       0x380024D6 // (0x0D6 | ACT_FLAG_MOVING | ACT_FLAG_SWIMMING | ACT_FLAG_PAUSE_EXIT | ACT_FLAG_SWIMMING_OR_FLYING | ACT_FLAG_WATER_OR_TEXT)
#define ACT_WATER_THROW                0x380024E0 // (0x0E0 | ACT_FLAG_MOVING | ACT_FLAG_SWIMMING | ACT_FLAG_PAUSE_EXIT | ACT_FLAG_SWIMMING_OR_FLYING | ACT_FLAG_WATER_OR_TEXT)
#define ACT_WATER_PUNCH                0x380024E1 // (0x0E1 | ACT_FLAG_MOVING | ACT_FLAG_SWIMMING | ACT_FLAG_PAUSE_EXIT | ACT_FLAG_SWIMMING_OR_FLYING | ACT_FLAG_WATER_OR_TEXT)
#define ACT_WATER_PLUNGE               0x380022E2 // (0x0E2 | ACT_FLAG_STATIONARY | ACT_FLAG_SWIMMING | ACT_FLAG_PAUSE_EXIT | ACT_FLAG_SWIMMING_OR_FLYING | ACT_FLAG_WATER_OR_TEXT)
...
#define ACT_METAL_WATER_STANDING       0x0C0042F0 // (0x0F0 | ACT_FLAG_STATIONARY | ACT_FLAG_METAL_WATER | ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
#define ACT_HOLD_METAL_WATER_STANDING  0x080042F1 // (0x0F1 | ACT_FLAG_STATIONARY | ACT_FLAG_METAL_WATER | ACT_FLAG_PAUSE_EXIT)
#define ACT_METAL_WATER_WALKING        0x0C0044F2 // (0x0F2 | ACT_FLAG_MOVING | ACT_FLAG_METAL_WATER | ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
...
#define ACT_METAL_WATER_FALL_LAND      0x0C0042F6 // (0x0F6 | ACT_FLAG_STATIONARY | ACT_FLAG_METAL_WATER | ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
#define ACT_HOLD_METAL_WATER_FALL_LAND 0x080042F7 // (0x0F7 | ACT_FLAG_STATIONARY | ACT_FLAG_METAL_WATER | ACT_FLAG_PAUSE_EXIT)
...
#define ACT_METAL_WATER_JUMP_LAND      0x0C0044FA // (0x0FA | ACT_FLAG_MOVING | ACT_FLAG_METAL_WATER | ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
#define ACT_HOLD_METAL_WATER_JUMP_LAND 0x080044FB // (0x0FB | ACT_FLAG_MOVING | ACT_FLAG_METAL_WATER | ACT_FLAG_PAUSE_EXIT)
...
#define ACT_DEBUG_FREE_MOVE            0x0C00130F // (0x10F | ACT_FLAG_STATIONARY | ACT_FLAG_INTANGIBLE | ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
...
#define ACT_PULLING_DOOR               0x08001320 // (0x120 | ACT_FLAG_STATIONARY | ACT_FLAG_INTANGIBLE | ACT_FLAG_PAUSE_EXIT)
#define ACT_PUSHING_DOOR               0x08001321 // (0x121 | ACT_FLAG_STATIONARY | ACT_FLAG_INTANGIBLE | ACT_FLAG_PAUSE_EXIT)
#define ACT_WARP_DOOR_SPAWN            0x08001322 // (0x122 | ACT_FLAG_STATIONARY | ACT_FLAG_INTANGIBLE | ACT_FLAG_PAUSE_EXIT)
...
#define ACT_HEAD_STUCK_IN_GROUND       0x0802033A // (0x13A | ACT_FLAG_STATIONARY | ACT_FLAG_INVULNERABLE | ACT_FLAG_PAUSE_EXIT)
#define ACT_BUTT_STUCK_IN_GROUND       0x0802033B // (0x13B | ACT_FLAG_STATIONARY | ACT_FLAG_INVULNERABLE | ACT_FLAG_PAUSE_EXIT)
#define ACT_FEET_STUCK_IN_GROUND       0x0802033C // (0x13C | ACT_FLAG_STATIONARY | ACT_FLAG_INVULNERABLE | ACT_FLAG_PAUSE_EXIT)
...
#define ACT_GRAB_POLE_SLOW             0x08100341 // (0x141 | ACT_FLAG_STATIONARY | ACT_FLAG_ON_POLE | ACT_FLAG_PAUSE_EXIT)
#define ACT_GRAB_POLE_FAST             0x08100342 // (0x142 | ACT_FLAG_STATIONARY | ACT_FLAG_ON_POLE | ACT_FLAG_PAUSE_EXIT)
#define ACT_CLIMBING_POLE              0x08100343 // (0x143 | ACT_FLAG_STATIONARY | ACT_FLAG_ON_POLE | ACT_FLAG_PAUSE_EXIT)
#define ACT_TOP_OF_POLE_TRANSITION     0x08100344 // (0x144 | ACT_FLAG_STATIONARY | ACT_FLAG_ON_POLE | ACT_FLAG_PAUSE_EXIT)
#define ACT_TOP_OF_POLE                0x08100345 // (0x145 | ACT_FLAG_STATIONARY | ACT_FLAG_ON_POLE | ACT_FLAG_PAUSE_EXIT)
...
#define ACT_LEDGE_CLIMB_SLOW_1         0x0800054C // (0x14C | ACT_FLAG_MOVING | ACT_FLAG_PAUSE_EXIT)
#define ACT_LEDGE_CLIMB_SLOW_2         0x0800054D // (0x14D | ACT_FLAG_MOVING | ACT_FLAG_PAUSE_EXIT)
#define ACT_LEDGE_CLIMB_DOWN           0x0800054E // (0x14E | ACT_FLAG_MOVING | ACT_FLAG_PAUSE_EXIT)
#define ACT_LEDGE_CLIMB_FAST           0x0800054F // (0x14F | ACT_FLAG_MOVING | ACT_FLAG_PAUSE_EXIT)
#define ACT_GRABBED                    0x00020370 // (0x170 | ACT_FLAG_STATIONARY | ACT_FLAG_INVULNERABLE)
#define ACT_IN_CANNON                  0x08001371 // (0x171 | ACT_FLAG_STATIONARY | ACT_FLAG_INTANGIBLE | ACT_FLAG_PAUSE_EXIT)
...
#define ACT_PUNCHING                   0x08800380 // (0x180 | ACT_FLAG_STATIONARY | ACT_FLAG_ATTACKING | ACT_FLAG_PAUSE_EXIT)
#define ACT_PICKING_UP                 0x08000383 // (0x183 | ACT_FLAG_STATIONARY | ACT_FLAG_PAUSE_EXIT)
...
#define ACT_PLACING_DOWN               0x08000387 // (0x187 | ACT_FLAG_STATIONARY | ACT_FLAG_PAUSE_EXIT)
#define ACT_THROWING                   0x88000588 // (0x188 | ACT_FLAG_MOVING | ACT_FLAG_THROWING | ACT_FLAG_PAUSE_EXIT)
#define ACT_HEAVY_THROW                0x88000589 // (0x189 | ACT_FLAG_MOVING | ACT_FLAG_THROWING | ACT_FLAG_PAUSE_EXIT)
#define ACT_PICKING_UP_BOWSER          0x08000390 // (0x190 | ACT_FLAG_STATIONARY | ACT_FLAG_PAUSE_EXIT)
#define ACT_HOLDING_BOWSER             0x08000391 // (0x191 | ACT_FLAG_STATIONARY | ACT_FLAG_PAUSE_EXIT)
#define ACT_RELEASING_BOWSER           0x08000392 // (0x192 | ACT_FLAG_STATIONARY | ACT_FLAG_PAUSE_EXIT)
