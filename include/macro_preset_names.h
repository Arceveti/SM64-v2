...
enum MacroPresets {
    ...
    macro_fish_group_3,
    macro_fish_group,
    macro_beta_fish_splash_spawner,
    ...
    macro_homing_amp,
    macro_circling_amp,
    macro_unknown_40, // bhvCarrySomething1, MODEL_UNKNOWN_7D
    macro_beta_trampoline_top,
    ...
    macro_water_level_breakable_box,
    macro_box_wing_cap,
    macro_box_metal_cap,
