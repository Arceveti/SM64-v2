...
// 0x0605A2C0
static const Vtx bomb_seg6_vertex_left_side[] = {
    {{{     0,    120,      0}, 0, { 31<<5,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -120,   -120,      0}, 0, {     0,  63<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{     0,   -120,      0}, 0, { 31<<5,  63<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -120,    120,      0}, 0, {     0,      0}, {0xff, 0xff, 0xff, 0xff}}},
};

// 0x0605A300
static const Vtx bomb_seg6_vertex_right_side[] = {
    {{{   120,    120,      0}, 0, { 31<<5,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{     0,   -120,      0}, 0, {     0,  63<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   120,   -120,      0}, 0, { 31<<5,  63<<5}, {0xff, 0xff, 0xff, 0xff}}},
...
static const Vtx bomb_seg6_vertex_spike_1[] = {
    ...
    {{{    -9,     37,      0}, 0, {   972,    960}, {0x8a, 0x2e, 0xfd, 0xff}}},
    {{{     0,     60,      0}, 0, {   434,    -16}, {0xf7, 0x7e, 0xf7, 0xff}}},
    {{{    10,     37,      0}, 0, {   -16,    960}, {0x74, 0x32, 0xfd, 0xff}}},
    {{{     0,     37,     -8}, 0, {   960,    960}, {0xfd, 0x29, 0x89, 0xff}}},
...
static const Vtx bomb_seg6_vertex_spike_2[] = {
    ...
    {{{    -9,    -36,      0}, 0, {   916,    960}, {0x8a, 0xd2, 0xfd, 0xff}}},
    {{{     0,    -59,      0}, 0, {   486,      0}, {0xf7, 0x82, 0xf7, 0xff}}},
    {{{    10,    -36,      0}, 0, {     0,    960}, {0x74, 0xce, 0xfd, 0xff}}},
    {{{     0,    -36,      9}, 0, {   960,    952}, {0xfd, 0xd2, 0x76, 0xff}}},
...
static const Vtx bomb_seg6_vertex_spike_3[] = {
    ...
    {{{    10,      0,     37}, 0, {   960,    980}, {0x74, 0xf9, 0x32, 0xff}}},
    {{{     0,      0,     60}, 0, {   428,    -16}, {0xf8, 0xee, 0x7d, 0xff}}},
    ...
    {{{    37,      0,     -9}, 0, {   960,    972}, {0x2e, 0xf9, 0x8a, 0xff}}},
    {{{    60,      0,      0}, 0, {   400,    -16}, {0x7d, 0xee, 0xf8, 0xff}}},
    {{{    37,     10,      0}, 0, {     0,    960}, {0x32, 0x74, 0xfd, 0xff}}},
    {{{    37,      0,     10}, 0, {   978,    960}, {0x32, 0xf9, 0x74, 0xff}}},
...
static const Vtx bomb_seg6_vertex_spike_5[] = {
    ...
    {{{    -9,      0,    -36}, 0, {    16,    960}, {0x8a, 0xf9, 0xd2, 0xff}}},
    ...
    {{{    -9,      0,    -36}, 0, {   952,    960}, {0x8a, 0xf9, 0xd2, 0xff}}},
};
...
const Gfx bomb_seg6_sub_dl_sphere[] = {
    ...
    gsSPVertex(bomb_seg6_vertex_left_side, 4, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  3,  1, 0x0),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bomb_seg6_texture_right_side),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 64 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPVertex(bomb_seg6_vertex_right_side, 4, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  3,  1, 0x0),
    gsSPEndDisplayList(),
};
