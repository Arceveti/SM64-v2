...
static const Vtx mushroom_1up_seg3_vertex_64x64[] = {
    {{{    32,     32,      0}, 0, ST_B(    32,      0), {0xff, 0xff, 0xff, 0xff}}},
    {{{   -32,     32,      0}, 0, ST_B(     0,      0), {0xff, 0xff, 0xff, 0xff}}},
    {{{   -32,    -32,      0}, 0, ST_B(     0,     64), {0xff, 0xff, 0xff, 0xff}}},
    {{{    32,    -32,      0}, 0, ST_B(    32,     64), {0xff, 0xff, 0xff, 0xff}}},
};
