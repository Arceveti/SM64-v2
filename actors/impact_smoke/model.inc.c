...
// 0x0605AA28
ALIGNED8 static const Texture impact_smoke_seg6_texture_0[] = {
#include "actors/impact_smoke/impact_smoke_0.ia16.inc.c"
};

// 0x0605CA28
ALIGNED8 static const Texture impact_smoke_seg6_texture_1[] = {
#include "actors/impact_smoke/impact_smoke_1.ia16.inc.c"
};

// 0x0605EA28
ALIGNED8 static const Texture impact_smoke_seg6_texture_2[] = {
#include "actors/impact_smoke/impact_smoke_2.ia16.inc.c"
};

// 0x06060A28
ALIGNED8 static const Texture impact_smoke_seg6_texture_3[] = {
...
static const Vtx impact_smoke_seg6_vertex_06062A28[] = {
    ...
    {{{  -150,    300,      0}, 0, ST_B(     0,      0), {0x28, 0x19, 0x14, 0xff}}},
    {{{  -150,      0,      0}, 0, ST_B(     0,     32), {0x28, 0x19, 0x14, 0xff}}},
    {{{   150,      0,      0}, 0, ST_B(    64,     32), {0x28, 0x19, 0x14, 0xff}}},
    {{{   150,    150,      0}, 0, ST_B(    64,      0), {0x28, 0x19, 0x14, 0xff}}},
    {{{  -150,    150,      0}, 0, ST_B(     0,      0), {0x28, 0x19, 0x14, 0xff}}},
};
