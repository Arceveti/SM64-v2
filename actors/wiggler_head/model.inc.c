...
// 0x0500E0E8
static const Vtx wiggler_seg5_vertex_nose[] = {
    {{{     0,     15,      0}, 0, ST_B(32-0.5,      0), {0xff, 0xff, 0xff, 0xff}}},
    {{{   -15,    -15,      0}, 0, ST_B(  -0.5,     64), {0xff, 0xff, 0xff, 0xff}}},
    {{{     0,    -15,      0}, 0, ST_B(32-0.5,     64), {0xff, 0xff, 0xff, 0xff}}},
    {{{   -15,     15,      0}, 0, ST_B(  -0.5,      0), {0xff, 0xff, 0xff, 0xff}}},
    {{{    15,     15,      0}, 0, ST_B(32+0.5,      0), {0xff, 0xff, 0xff, 0xff}}},
    {{{     0,    -15,      0}, 0, ST_B(   0.5,     64), {0xff, 0xff, 0xff, 0xff}}},
    {{{    15,    -15,      0}, 0, ST_B(32+0.5,     64), {0xff, 0xff, 0xff, 0xff}}},
    {{{     0,     15,      0}, 0, ST_B(   0.5,      0), {0xff, 0xff, 0xff, 0xff}}},
};
...
const Gfx wiggler_seg5_sub_dl_nose[] = {
    ...
    gsSPVertex(wiggler_seg5_vertex_nose, 8, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  3,  1, 0x0),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, wiggler_seg5_texture_nose_right_side),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, CALC_LRS(32, 64), CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
const Gfx wiggler_seg5_dl_nose[] = {
    gsDPPipeSync(),
...
// 0x0500E250
static const Vtx wiggler_seg5_vertex_frown[] = {
    {{{    58,     87,      0}, 0, ST_B(    16,     32), {0xff, 0xff, 0xff, 0xff}}},
    {{{    84,     50,     23}, 0, ST_B(    32,      0), {0xff, 0xff, 0xff, 0xff}}},
    {{{    88,     54,      0}, 0, ST_B(    16,      0), {0xff, 0xff, 0xff, 0xff}}},
    {{{    54,     83,    -21}, 0, ST_B(     0,     32), {0xff, 0xff, 0xff, 0xff}}},
    {{{    84,     50,    -21}, 0, ST_B(     0,      0), {0xff, 0xff, 0xff, 0xff}}},
    {{{    54,     83,     23}, 0, ST_B(    32,     32), {0xff, 0xff, 0xff, 0xff}}},
};
...
const Gfx wiggler_seg5_sub_dl_frown[] = {
    ...
    gsSPVertex(wiggler_seg5_vertex_frown, 6, 0),
...
const Gfx wiggler_seg5_dl_frown[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_DECALRGBA, G_CC_DECALRGBA),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
// 0x0500E368
static const Vtx wiggler_seg5_vertex_eyes[] = {
    {{{    58,    -82,      0}, 0, ST_B(    32,      0), {0xff, 0xff, 0xff, 0xff}}},
    {{{    88,    -35,    -43}, 0, ST_B(     0,     32), {0xff, 0xff, 0xff, 0xff}}},
    {{{    94,    -40,      0}, 0, ST_B(    32,     32), {0xff, 0xff, 0xff, 0xff}}},
    {{{    51,    -77,    -43}, 0, ST_B(     0,      0), {0xff, 0xff, 0xff, 0xff}}},
    {{{    94,    -40,      0}, 0, ST_B(     0,     32), {0xff, 0xff, 0xff, 0xff}}},
    {{{    51,    -77,     44}, 0, ST_B(    32,      0), {0xff, 0xff, 0xff, 0xff}}},
    {{{    58,    -82,      0}, 0, ST_B(     0,      0), {0xff, 0xff, 0xff, 0xff}}},
    {{{    88,    -35,     44}, 0, ST_B(    32,     32), {0xff, 0xff, 0xff, 0xff}}},
};
...
const Gfx wiggler_seg5_sub_dl_eyes[] = {
    ...
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPVertex(wiggler_seg5_vertex_eyes, 8, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  3,  1, 0x0),
    gsSP2Triangles( 4,  5,  6, 0x0,  4,  7,  5, 0x0),
    gsSPEndDisplayList(),
};
...
const Gfx wiggler_seg5_dl_eyes[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_DECALRGBA, G_CC_DECALRGBA),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
// 0x0500E4A0
static const Vtx wiggler_seg5_vertex_flower[] = {
    {{{   -77,    -98,      2}, 0, ST_B(    32,     32), {0xff, 0xff, 0xff, 0xff}}},
    {{{     8,    -83,     94}, 0, ST_B(     0,      0), {0xff, 0xff, 0xff, 0xff}}},
    {{{   -74,    -53,     79}, 0, ST_B(     0,     32), {0xff, 0xff, 0xff, 0xff}}},
    {{{     6,   -128,     16}, 0, ST_B(    32,      0), {0xff, 0xff, 0xff, 0xff}}},
};
...
const Gfx wiggler_seg5_sub_dl_flower[] = {
    ...
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPVertex(wiggler_seg5_vertex_flower, 4, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  3,  1, 0x0),
    gsSPEndDisplayList(),
};

// 0x0500E518 - 0x0500E588
const Gfx wiggler_seg5_dl_flower[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_DECALRGBA, G_CC_DECALRGBA),
...
// 0x0500E588
static const Vtx wiggler_seg5_vertex_head_sphere[] = {
    {{{     0,     26,      0}, 0, ST_B(32-0.5,      0), {0xff, 0xff, 0xff, 0xff}}},
    {{{   -26,    -26,      0}, 0, ST_B(  -0.5,     64), {0xff, 0xff, 0xff, 0xff}}},
    {{{     0,    -26,      0}, 0, ST_B(32-0.5,     64), {0xff, 0xff, 0xff, 0xff}}},
    {{{   -26,     26,      0}, 0, ST_B(  -0.5,      0), {0xff, 0xff, 0xff, 0xff}}},
    {{{    26,     26,      0}, 0, ST_B(32+0.5,      0), {0xff, 0xff, 0xff, 0xff}}},
    {{{     0,    -26,      0}, 0, ST_B(   0.5,     64), {0xff, 0xff, 0xff, 0xff}}},
    {{{    26,    -26,      0}, 0, ST_B(32+0.5,     64), {0xff, 0xff, 0xff, 0xff}}},
    {{{     0,     26,      0}, 0, ST_B(   0.5,      0), {0xff, 0xff, 0xff, 0xff}}},
};
...
const Gfx wiggler_seg5_sub_dl_head[] = {
    ...
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, CALC_LRS(32, 64), CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPVertex(wiggler_seg5_vertex_head_sphere, 8, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  3,  1, 0x0),
