...
// 0x06010108
ALIGNED8 static const Texture scuttlebug_seg6_texture_eye[] = {
#include "actors/scuttlebug/scuttlebug_eye.rgba16.inc.c"
};

// 0x06010908
ALIGNED8 static const Texture scuttlebug_seg6_texture_left_side[] = {
#include "actors/scuttlebug/scuttlebug_left_side.rgba16.inc.c"
};

// 0x06011908
ALIGNED8 static const Texture scuttlebug_seg6_texture_right_side[] = {
#include "actors/scuttlebug/scuttlebug_right_side.rgba16.inc.c"
};

// 0x06012908
ALIGNED8 static const Texture scuttlebug_seg6_texture_iris[] = {
#include "actors/scuttlebug/scuttlebug_iris.rgba16.inc.c"
};

// 0x06013108
ALIGNED8 static const Texture scuttlebug_seg6_texture_leg[] = {
...
const Gfx scuttlebug_seg6_dl_body[] = {
    gsDPPipeSync(),
    ...
    gsSPDisplayList(scuttlebug_seg6_sub_dl_body),
...
const Gfx scuttlebug_seg6_dl_06013AB0[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, scuttlebug_seg6_texture_eye),
    gsDPLoadSync(),
...
const Gfx scuttlebug_seg6_dl_06013C80[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, scuttlebug_seg6_texture_iris),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
static const Vtx scuttlebug_seg6_vertex_06013E28[] = {
    {{{  -112,     85,    293}, 0, {     0,      0}, {0x7e, 0x06, 0x0b, 0xff}}},
    {{{  -120,    128,    192}, 0, {     0,      0}, {0x34, 0x64, 0xc8, 0xff}}},
    {{{  -120,    102,    301}, 0, {     0,      0}, {0xc9, 0x62, 0x3a, 0xff}}},
    {{{  -128,    -84,    293}, 0, {     0,      0}, {0x82, 0xfa, 0x0b, 0xff}}},
    {{{  -120,   -128,    192}, 0, {     0,      0}, {0xc7, 0x9e, 0xc8, 0xff}}},
    {{{  -120,   -102,    301}, 0, {     0,      0}, {0x32, 0x9c, 0x3b, 0xff}}},
    {{{  -102,    -88,    200}, 0, {     0,      0}, {0x7e, 0xf9, 0xf3, 0xff}}},
    {{{  -112,    -84,    293}, 0, {     0,      0}, {0x7d, 0x10, 0x0c, 0xff}}},
    {{{  -120,    -29,    351}, 0, {     0,      0}, {0xf4, 0x3d, 0x6e, 0xff}}},
    {{{  -136,    -88,    200}, 0, {     0,      0}, {0x83, 0x10, 0xf4, 0xff}}},
    {{{  -120,    -58,    167}, 0, {     0,      0}, {0xfe, 0x1f, 0x85, 0xff}}},
    {{{  -120,    -50,    205}, 0, {     0,      0}, {0x2f, 0x75, 0x04, 0xff}}},
    {{{  -120,    -67,    284}, 0, {     0,      0}, {0xc9, 0x72, 0xf9, 0xff}}},
    {{{  -120,     68,    284}, 0, {     0,      0}, {0x32, 0x8c, 0xf8, 0xff}}},
    {{{  -102,     89,    200}, 0, {     0,      0}, {0x7c, 0xee, 0xf3, 0xff}}},
...
static const Vtx scuttlebug_seg6_vertex_06013F28[] = {
    ...
    {{{  -120,    128,    192}, 0, {     0,      0}, {0x34, 0x64, 0xc8, 0xff}}},
    {{{  -136,     89,    200}, 0, {     0,      0}, {0x82, 0x06, 0xf4, 0xff}}},
    {{{  -120,    102,    301}, 0, {     0,      0}, {0xc9, 0x62, 0x3a, 0xff}}},
    {{{  -112,     85,    293}, 0, {     0,      0}, {0x7e, 0x06, 0x0b, 0xff}}},
    {{{  -120,     30,    351}, 0, {     0,      0}, {0xf4, 0xc3, 0x6e, 0xff}}},
...
static const Vtx scuttlebug_seg6_vertex_06014110[] = {
    ...
    {{{   192,     19,      0}, 0, {    28,    892}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   192,    -19,      0}, 0, { 31<<5,    958}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   -16,    -26,      0}, 0, {   982,  -4136}, {0xff, 0xff, 0xff, 0xff}}},
};

// 0x06014150 - 0x06014188
const Gfx scuttlebug_seg6_dl_06014150[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, scuttlebug_seg6_texture_leg),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
static const Vtx scuttlebug_seg6_vertex_060141F8[] = {
    ...
    {{{   200,     20,      2}, 0, {    32,    944}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   201,    -17,     -2}, 0, { 31<<5,  31<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{    -5,    -22,     -4}, 0, { 31<<5,  -4192}, {0xff, 0xff, 0xff, 0xff}}},
};
