...
static const Vtx blue_coin_switch_seg8_vertex_08000C18[] = {
    {{{    26,      0,     26}, 0, { 31<<5,  15<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{    26,     26,     26}, 0, { 31<<5,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   -26,     26,     26}, 0, {     0,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   -26,      0,     26}, 0, {     0,  15<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   -26,      0,    -26}, 0, { 31<<5,  15<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{    26,     26,    -26}, 0, {     0,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{    26,      0,    -26}, 0, {     0,  15<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   -26,     26,    -26}, 0, { 31<<5,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   -26,      0,     26}, 0, { 31<<5,  15<<5}, {0x81, 0x00, 0x00, 0xff}}},
    {{{   -26,     26,    -26}, 0, {     0,      0}, {0x81, 0x00, 0x00, 0xff}}},
    {{{   -26,      0,    -26}, 0, {     0,  15<<5}, {0x81, 0x00, 0x00, 0xff}}},
    {{{   -26,     26,     26}, 0, { 31<<5,      0}, {0x81, 0x00, 0x00, 0xff}}},
    {{{    26,      0,    -26}, 0, { 31<<5,  15<<5}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{    26,     26,    -26}, 0, { 31<<5,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{    26,     26,     26}, 0, {     0,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{    26,      0,     26}, 0, {     0,  15<<5}, {0x7f, 0x00, 0x00, 0xff}}},
};

// 0x08000D18
static const Vtx blue_coin_switch_seg8_vertex_08000D18[] = {
    {{{    26,     26,    -26}, 0, { 31<<5,      0}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   -26,     26,     26}, 0, {     0,  31<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{    26,     26,     26}, 0, { 31<<5,  31<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   -26,     26,    -26}, 0, {     0,      0}, {0x00, 0x7f, 0x00, 0xff}}},
};
