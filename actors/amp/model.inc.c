...
static const Vtx dAmpEyeVertices[] = {
    ...
    {{{   -27,    -72,    164}, 0, { 31<<5,  31<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{    68,    -72,    158}, 0, { 31<<5,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   -27,     72,    164}, 0, {     0,  31<<5}, {0xff, 0xff, 0xff, 0xff}}},
};
...
static const Vtx dAmpMouthVertices[] = {
    {{{   -32,     72,    164}, 0, {     0,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -128,    -72,    121}, 0, { 31<<5,  31<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   -32,    -72,    164}, 0, { 31<<5,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -128,     72,    121}, 0, {     0,  31<<5}, {0xff, 0xff, 0xff, 0xff}}},
};
...
static const Vtx dAmpBodyVertices[] = {
    {{{   -40,    -40,      0}, 0, {     0,  31<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{    40,     40,      0}, 0, { 31<<5,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   -40,     40,      0}, 0, {     0,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{    40,    -40,      0}, 0, { 31<<5,  31<<5}, {0xff, 0xff, 0xff, 0xff}}},
};
