...
static const Vtx seaweed_seg6_vertex_06009E10[] = {
    {{{   232,      2,    -77}, 0, ST_B(     0,      0), {0x00, 0x7f, 0x00, 0xff}}},
    {{{    -1,      2,     77}, 0, ST_B(    32,     32), {0x00, 0x7f, 0x00, 0xff}}},
    {{{   232,      2,     77}, 0, ST_B(    32,      0), {0x00, 0x7f, 0x00, 0xff}}},
    {{{    -1,      2,    -77}, 0, ST_B(     0,     32), {0x00, 0x7f, 0x00, 0xff}}},
};
...
static const Vtx seaweed_seg6_vertex_06009F08[] = {
    {{{   311,      2,    -77}, 0, ST_B(     0,      0), {0x00, 0x7f, 0x00, 0xff}}},
    {{{    -1,      2,    -77}, 0, ST_B(     0,     32), {0x00, 0x7f, 0x00, 0xff}}},
    {{{    -1,      2,     77}, 0, ST_B(    32,     32), {0x00, 0x7f, 0x00, 0xff}}},
    {{{   311,      2,     77}, 0, ST_B(    32,      0), {0x00, 0x7f, 0x00, 0xff}}},
};
...
static const Vtx seaweed_seg6_vertex_0600A000[] = {
    {{{   314,      2,    -77}, 0, ST_B(     0,      0), {0x00, 0x7f, 0x00, 0xff}}},
    {{{    -1,      2,     77}, 0, ST_B(    32,     32), {0x00, 0x7f, 0x00, 0xff}}},
    {{{   314,      2,     77}, 0, ST_B(    32,      0), {0x00, 0x7f, 0x00, 0xff}}},
    {{{    -1,      2,    -77}, 0, ST_B(     0,     32), {0x00, 0x7f, 0x00, 0xff}}},
};
...
static const Vtx seaweed_seg6_vertex_0600A0F8[] = {
    {{{   236,      2,    -77}, 0, ST_B(     0,      0), {0x00, 0x7f, 0x00, 0xff}}},
    {{{     0,      2,     77}, 0, ST_B(    32,     32), {0x00, 0x7f, 0x00, 0xff}}},
    {{{   236,      2,     77}, 0, ST_B(    32,      0), {0x00, 0x7f, 0x00, 0xff}}},
    {{{     0,      2,    -77}, 0, ST_B(     0,     32), {0x00, 0x7f, 0x00, 0xff}}},
};
