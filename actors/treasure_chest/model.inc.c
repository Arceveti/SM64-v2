...
static const Vtx treasure_chest_seg6_vertex_060167A8[] = {
    {{{    20,    102,     87}, 0, ST_B(    32,      0), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   -20,     72,     87}, 0, ST_B(     0,     32), {0x00, 0x00, 0x7f, 0xff}}},
    {{{    20,     72,     87}, 0, ST_B(    32,     32), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   -20,    102,     87}, 0, ST_B(     0,      0), {0x00, 0x00, 0x7f, 0xff}}},
};

// 0x060167E8
static const Vtx treasure_chest_seg6_vertex_060167E8[] = {
    {{{    20,     72,     77}, 0, ST_B(    32,     32), {0x00, 0x81, 0x00, 0xff}}},
    {{{   -20,     72,     87}, 0, ST_B(     0,      0), {0x00, 0x81, 0x00, 0xff}}},
    {{{   -20,     72,     77}, 0, ST_B(     0,     32), {0x00, 0x81, 0x00, 0xff}}},
    {{{     0,    102,     77}, 0, ST_B(    16,     32), {0x00, 0x7f, 0x00, 0xff}}},
    {{{    20,    102,     87}, 0, ST_B(     0,      0), {0x00, 0x7f, 0x00, 0xff}}},
    {{{    20,    102,     77}, 0, ST_B(     0,     32), {0x00, 0x7f, 0x00, 0xff}}},
    {{{   -20,    102,     87}, 0, ST_B(    32,      0), {0x00, 0x7f, 0x00, 0xff}}},
    {{{   -20,    102,     77}, 0, ST_B(    32,     32), {0x00, 0x7f, 0x00, 0xff}}},
    {{{   -20,     72,     77}, 0, ST_B(     0,     32), {0x81, 0x00, 0x00, 0xff}}},
    {{{   -20,    102,     87}, 0, ST_B(    32,      0), {0x81, 0x00, 0x00, 0xff}}},
    {{{   -20,    102,     77}, 0, ST_B(     0,      0), {0x81, 0x00, 0x00, 0xff}}},
    {{{   -20,     72,     87}, 0, ST_B(    32,     32), {0x81, 0x00, 0x00, 0xff}}},
    {{{    20,     72,     87}, 0, ST_B(    32,      0), {0x00, 0x81, 0x00, 0xff}}},
    {{{    20,    102,     77}, 0, ST_B(    32,      0), {0x7f, 0x00, 0x00, 0xff}}},
    {{{    20,     72,     87}, 0, ST_B(     0,     32), {0x7f, 0x00, 0x00, 0xff}}},
    {{{    20,     72,     77}, 0, ST_B(    32,     32), {0x7f, 0x00, 0x00, 0xff}}},
};

// 0x060168E8
static const Vtx treasure_chest_seg6_vertex_060168E8[] = {
    {{{    20,    102,     77}, 0, ST_B(    32,      0), {0x7f, 0x00, 0x00, 0xff}}},
    {{{    20,    102,     87}, 0, ST_B(     0,      0), {0x7f, 0x00, 0x00, 0xff}}},
    {{{    20,     72,     87}, 0, ST_B(     0,     32), {0x7f, 0x00, 0x00, 0xff}}},
};
