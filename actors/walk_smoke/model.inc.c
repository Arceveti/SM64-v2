...
static const Vtx smoke_seg4_vertex_64x64_raised[] = {
    {{{   -32,      0,      0}, 0, ST_B(     0,     32), {0xff, 0xff, 0xff, 0x64}}},
    {{{    32,      0,      0}, 0, ST_B(    32,     32), {0xff, 0xff, 0xff, 0x64}}},
    {{{    32,     64,      0}, 0, ST_B(    32,      0), {0xff, 0xff, 0xff, 0x64}}},
    {{{   -32,     64,      0}, 0, ST_B(     0,      0), {0xff, 0xff, 0xff, 0x64}}},
};
