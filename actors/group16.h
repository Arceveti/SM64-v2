...
extern const Gfx chilly_chief_seg6_sub_dl_small_body[];
extern const Gfx chilly_chief_seg6_dl_small_body[];
extern const Gfx chilly_chief_seg6_sub_dl_big_body[];
extern const Gfx chilly_chief_seg6_dl_big_body[];
