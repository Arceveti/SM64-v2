...
static const Vtx mario_wings_half_1_dl_vertex[] = {
    {{{  -106,    212,      0}, 0, ST_B(     0,      0), {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -106,      0,      0}, 0, ST_B(     0,     64), {0x00, 0x00, 0x7f, 0xff}}},
    {{{     0,      0,      0}, 0, ST_B(    32,     64), {0x00, 0x00, 0x7f, 0xff}}},
    {{{     0,    212,      0}, 0, ST_B(    32,      0), {0x00, 0x00, 0x7f, 0xff}}},
};

// 0x0401C980
static const Vtx mario_wings_half_2_dl_vertex[] = {
    {{{     0,      0,      0}, 0, ST_B(     0,     64), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   106,    212,      0}, 0, ST_B(    32,      0), {0x00, 0x00, 0x7f, 0xff}}},
    {{{     0,    212,      0}, 0, ST_B(     0,      0), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   106,      0,      0}, 0, ST_B(    32,     64), {0x00, 0x00, 0x7f, 0xff}}},
};
