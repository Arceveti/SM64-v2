...
//     {{{   199,    247,    -55}, 0, { 31<<5,      0}, {0x59, 0xed, 0x58, 0xff}}},
//     {{{   131,    274,     20}, 0, {     0,      0}, {0x59, 0xed, 0x58, 0xff}}},
//     {{{    69,     71,     38}, 0, {     0,  63<<5}, {0x59, 0xed, 0x58, 0xff}}},
//     {{{   199,    247,    -55}, 0, { 31<<5,      0}, {0x58, 0xee, 0x58, 0xff}}},
//     {{{    69,     71,     38}, 0, {     0,  63<<5}, {0x58, 0xee, 0x58, 0xff}}},
//     {{{   138,     44,    -37}, 0, { 31<<5,  63<<5}, {0x58, 0xee, 0x58, 0xff}}},
//     {{{  -137,     44,    -37}, 0, { 31<<5,  63<<5}, {0xa8, 0xee, 0x58, 0xff}}},
//     {{{   -68,     71,     38}, 0, {     0,  63<<5}, {0xa8, 0xee, 0x58, 0xff}}},
//     {{{  -198,    247,    -55}, 0, { 31<<5,      0}, {0xa8, 0xee, 0x58, 0xff}}},
//     {{{   -68,     71,     38}, 0, {     0,  63<<5}, {0xa7, 0xed, 0x58, 0xff}}},
//     {{{  -130,    274,     20}, 0, {     0,      0}, {0xa7, 0xed, 0x58, 0xff}}},
//     {{{  -198,    247,    -55}, 0, { 31<<5,      0}, {0xa7, 0xed, 0x58, 0xff}}},
// };

// // 0x0401C5F8
// static const Vtx mario_wings_half_2_unused_dl_vertex[] = {
//     {{{   268,    219,   -132}, 0, { 31<<5,      0}, {0x59, 0xed, 0x57, 0xff}}},
//     {{{   199,    247,    -55}, 0, {     0,      0}, {0x59, 0xed, 0x57, 0xff}}},
//     {{{   138,     44,    -37}, 0, {     0,  63<<5}, {0x59, 0xed, 0x57, 0xff}}},
//     {{{   207,     16,   -114}, 0, { 31<<5,  63<<5}, {0x59, 0xed, 0x57, 0xff}}},
//     {{{  -206,     16,   -114}, 0, { 31<<5,  63<<5}, {0xa7, 0xed, 0x57, 0xff}}},
//     {{{  -137,     44,    -37}, 0, {     0,  63<<5}, {0xa7, 0xed, 0x57, 0xff}}},
//     {{{  -267,    219,   -132}, 0, { 31<<5,      0}, {0xa7, 0xed, 0x57, 0xff}}},
...
static const Vtx mario_wings_half_1_dl_vertex[] = {
    {{{  -106,    212,      0}, 0, {     0,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -106,      0,      0}, 0, {     0,  63<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{     0,      0,      0}, 0, { 31<<5,  63<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{     0,    212,      0}, 0, { 31<<5,      0}, {0x00, 0x00, 0x7f, 0xff}}},
};

// 0x0401C980
static const Vtx mario_wings_half_2_dl_vertex[] = {
    {{{     0,      0,      0}, 0, {     0,  63<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   106,    212,      0}, 0, { 31<<5,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{     0,    212,      0}, 0, {     0,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   106,      0,      0}, 0, { 31<<5,  63<<5}, {0x00, 0x00, 0x7f, 0xff}}},
};
