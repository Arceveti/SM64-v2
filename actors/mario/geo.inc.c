...
const GeoLayout mario_geo_face_and_wings[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         ...
         GEO_OPEN_NODE(),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_cap_on_eyes_front),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_cap_on_eyes_half_closed),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_cap_on_eyes_closed),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_cap_on_eyes_right), // unused
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_cap_on_eyes_left), // unused
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_cap_on_eyes_up), // unused
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_cap_on_eyes_down), // unused
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_cap_on_eyes_dead),
         GEO_CLOSE_NODE(),
         GEO_SWITCH_CASE(0, geo_switch_mario_eyes),
         GEO_OPEN_NODE(),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_cap_off_eyes_front),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_cap_off_eyes_half_closed),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_cap_off_eyes_closed),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_cap_off_eyes_right), // unused
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_cap_off_eyes_left), // unused
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_cap_off_eyes_up), // unused
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_cap_off_eyes_down), // unused
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_cap_off_eyes_dead),
         GEO_CLOSE_NODE(),
      GEO_CLOSE_NODE(),
      GEO_TRANSLATE_ROTATE(LAYER_FORCE, 142, -51, -126, 22, -40, -135),
      GEO_OPEN_NODE(),
         GEO_ASM(0, geo_mario_rotate_wing_cap_wings),
         GEO_ROTATION_NODE(LAYER_FORCE, 0, 0, 0),
         GEO_OPEN_NODE(),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_ALPHA, mario_cap_wings), // left
         GEO_CLOSE_NODE(),
      GEO_CLOSE_NODE(),
      GEO_TRANSLATE_ROTATE(LAYER_FORCE, 142, -51, 126, -22, 40, -135),
      GEO_OPEN_NODE(),
         ...
         GEO_ROTATION_NODE(LAYER_FORCE, 0, 0, 0),
         GEO_OPEN_NODE(),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_ALPHA, mario_cap_wings), // right
         GEO_CLOSE_NODE(),
      GEO_CLOSE_NODE(),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
...
const GeoLayout mario_geo_left_hand[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         ...
         GEO_OPEN_NODE(),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_left_hand_closed),
         GEO_CLOSE_NODE(),
      GEO_CLOSE_NODE(),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_left_hand_open),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_left_hand_closed),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_left_hand_closed),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_left_hand_closed),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
...
const GeoLayout mario_geo_right_hand[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         ...
         GEO_SCALE(LAYER_FORCE, 65536),
         GEO_OPEN_NODE(),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_right_hand_closed),
         GEO_CLOSE_NODE(),
         GEO_HELD_OBJECT(0x00, 0, 0, 0, geo_switch_mario_hand_grab_pos),
      GEO_CLOSE_NODE(),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_right_hand_open),
      GEO_OPEN_NODE(),
         GEO_HELD_OBJECT(0x00, 0, 0, 0, geo_switch_mario_hand_grab_pos),
      GEO_CLOSE_NODE(),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_right_hand_peace), // here we go hand
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_right_hand_cap),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_right_hand_cap),
      GEO_OPEN_NODE(),
         GEO_DISPLAY_LIST(LAYER_SILHOUETTE_ALPHA, mario_right_hand_cap_wings),
      GEO_CLOSE_NODE(),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
};
...
const GeoLayout mario_geo_body[] = {
   ...
   GEO_OPEN_NODE(),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, mario_butt), // starts sharing solid color with mario_torso (blue)
      GEO_OPEN_NODE(),
         GEO_ASM(0, geo_move_mario_part_from_parent),
         GEO_ASM(0, geo_mario_tilt_torso),
         GEO_ROTATION_NODE(LAYER_FORCE, 0, 0, 0),
         GEO_OPEN_NODE(),
            GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 68, 0, 0, mario_torso),
            GEO_OPEN_NODE(),
               ...
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, mario_left_arm), // starts sharing solid color with mario_left_forearm (red)
                  GEO_OPEN_NODE(),
                     GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 65, 0, 0, mario_left_forearm_shared_dl),
                     GEO_OPEN_NODE(),
                        GEO_BRANCH(1, mario_geo_left_hand), // stops sharing because hand has its solid color (white)
                     GEO_CLOSE_NODE(),
                  GEO_CLOSE_NODE(),
               GEO_CLOSE_NODE(),
               GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 68, -10, -79, NULL),
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, mario_right_arm), // starts sharing solid color of his dl with mario_right_forearm (red)
                  GEO_OPEN_NODE(),
                     GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 65, 0, 0, mario_right_forearm_shared_dl),
                     GEO_OPEN_NODE(),
         ...
         GEO_OPEN_NODE(),
            GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, mario_left_thigh), // starts sharing solid color of his dl with mario_left_leg (blue)
            GEO_OPEN_NODE(),
               GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 89, 0, 0, mario_left_leg_shared_dl),
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 67, 0, 0, mario_left_foot), // stops sharing because foot has its solid color (brown)
               GEO_CLOSE_NODE(),
            GEO_CLOSE_NODE(),
         GEO_CLOSE_NODE(),
         GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 13, -8, -42, NULL),
         GEO_OPEN_NODE(),
            GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, mario_right_thigh), // starts sharing solid color of his dl with mario_left_leg (blue)
            GEO_OPEN_NODE(),
               GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 89, 0, 0, mario_right_leg_shared_dl),
               GEO_OPEN_NODE(),
                  ...
                  GEO_OPEN_NODE(),
                     ...
                     GEO_SCALE(LAYER_FORCE, 65536),
                     GEO_OPEN_NODE(),
                        GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_right_foot), // stops sharing because foot has its solid color (brown)
                     GEO_CLOSE_NODE(),
                  GEO_CLOSE_NODE(),
               GEO_CLOSE_NODE(),
            GEO_CLOSE_NODE(),
...
const GeoLayout mario_geo_medium_poly_left_hand[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         ...
         GEO_SCALE(LAYER_FORCE, 65536),
         GEO_OPEN_NODE(),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_medium_poly_left_hand_closed),
         GEO_CLOSE_NODE(),
      GEO_CLOSE_NODE(),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_left_hand_open),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_medium_poly_left_hand_closed),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_medium_poly_left_hand_closed),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_medium_poly_left_hand_closed),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
...
const GeoLayout mario_geo_medium_poly_right_hand[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         ...
         GEO_SCALE(LAYER_FORCE, 65536),
         GEO_OPEN_NODE(),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_medium_poly_right_hand_closed),
         GEO_CLOSE_NODE(),
         GEO_HELD_OBJECT(0x00, 0, 0, 0, geo_switch_mario_hand_grab_pos),
      GEO_CLOSE_NODE(),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_right_hand_open),
...
const GeoLayout mario_geo_medium_poly_body[] = {
   GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, NULL),
   GEO_OPEN_NODE(),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, mario_medium_poly_butt), // starts sharing solid color with mario_torso (blue)
      GEO_OPEN_NODE(),
         GEO_ASM(0, geo_move_mario_part_from_parent),
         GEO_ASM(0, geo_mario_tilt_torso),
         GEO_ROTATION_NODE(LAYER_FORCE, 0, 0, 0),
         GEO_OPEN_NODE(),
            GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 68, 0, 0, mario_medium_poly_torso),
            GEO_OPEN_NODE(),
               GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 87, 0, 0, NULL),
               GEO_OPEN_NODE(),
               ...
               GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 67, -10, 79, NULL),
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, mario_medium_poly_left_arm), // starts sharing solid color with mario_left_forearm (red)
                  GEO_OPEN_NODE(),
                     GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 65, 0, 0, mario_medium_poly_left_forearm_shared_dl),
                     GEO_OPEN_NODE(),
               ...
               GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 68, -10, -79, NULL),
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, mario_medium_poly_right_arm), // starts sharing solid color of his dl with mario_right_forearm (red)
                  GEO_OPEN_NODE(),
                     GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 65, 0, 0, mario_medium_poly_right_forearm_shared_dl),
                     GEO_OPEN_NODE(),
         ...
         GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 13, -8, 42, NULL),
         GEO_OPEN_NODE(),
            GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, mario_medium_poly_left_thigh), // starts sharing solid color of his dl with mario_left_leg (blue)
            GEO_OPEN_NODE(),
               GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 89, 0, 0, mario_medium_poly_left_leg_shared_dl),
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 67, 0, 0, mario_medium_poly_left_foot), // stops sharing because foot has its solid color (brown)
               GEO_CLOSE_NODE(),
            GEO_CLOSE_NODE(),
         GEO_CLOSE_NODE(),
         GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 13, -8, -42, NULL),
         GEO_OPEN_NODE(),
            GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, mario_medium_poly_right_thigh), // starts sharing solid color of his dl with mario_left_leg (blue)
            GEO_OPEN_NODE(),
               GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 89, 0, 0, mario_medium_poly_right_leg_shared_dl),
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 67, 0, 0, NULL),
                  GEO_OPEN_NODE(),
                     GEO_ASM(2, geo_mario_hand_foot_scaler),
                     GEO_SCALE(LAYER_FORCE, 65536),
                     GEO_OPEN_NODE(),
                        GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_medium_poly_right_foot), // stops sharing because foot has its solid color (brown)
                     GEO_CLOSE_NODE(),
                  GEO_CLOSE_NODE(),
               GEO_CLOSE_NODE(),
            GEO_CLOSE_NODE(),
...
const GeoLayout mario_geo_low_poly_face_and_wings[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         GEO_SWITCH_CASE(0, geo_switch_mario_eyes),
         GEO_OPEN_NODE(),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_low_poly_cap_on_eyes_front),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_low_poly_cap_on_eyes_half_closed),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_low_poly_cap_on_eyes_closed),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_low_poly_cap_on_eyes_right), // unused
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_low_poly_cap_on_eyes_left), // unused
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_low_poly_cap_on_eyes_up), // unused
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_low_poly_cap_on_eyes_down), // unused
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_low_poly_cap_on_eyes_dead),
         GEO_CLOSE_NODE(),
         GEO_SWITCH_CASE(0, geo_switch_mario_eyes),
         GEO_OPEN_NODE(),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_low_poly_cap_off_eyes_front),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_low_poly_cap_off_eyes_half_closed),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_low_poly_cap_off_eyes_closed),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_low_poly_cap_off_eyes_right), // unused
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_low_poly_cap_off_eyes_left), // unused
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_low_poly_cap_off_eyes_up), // unused
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_low_poly_cap_off_eyes_down), // unused
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_low_poly_cap_off_eyes_dead),
         GEO_CLOSE_NODE(),
      GEO_CLOSE_NODE(),
      GEO_TRANSLATE_ROTATE(LAYER_FORCE, 142, -51, -126, 22, -40, -135),
      GEO_OPEN_NODE(),
...
const GeoLayout mario_geo_low_poly_left_hand[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         ...
         GEO_SCALE(LAYER_FORCE, 65536),
         GEO_OPEN_NODE(),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_low_poly_left_hand_closed),
         GEO_CLOSE_NODE(),
      GEO_CLOSE_NODE(),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_left_hand_open),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_low_poly_left_hand_closed),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_low_poly_left_hand_closed),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_low_poly_left_hand_closed),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
...
const GeoLayout mario_geo_low_poly_right_hand[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         ...
         GEO_SCALE(LAYER_FORCE, 65536),
         GEO_OPEN_NODE(),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_low_poly_right_hand_closed),
         GEO_CLOSE_NODE(),
         GEO_HELD_OBJECT(0x00, 0, 0, 0, geo_switch_mario_hand_grab_pos),
      GEO_CLOSE_NODE(),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_right_hand_open),
...
const GeoLayout mario_geo_low_poly_body[] = {
   GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, NULL),
   GEO_OPEN_NODE(),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, mario_low_poly_butt), // starts sharing solid color with mario_torso (blue)
      GEO_OPEN_NODE(),
         GEO_ASM(0, geo_move_mario_part_from_parent),
         GEO_ASM(0, geo_mario_tilt_torso),
         GEO_ROTATION_NODE(LAYER_FORCE, 0, 0, 0),
         GEO_OPEN_NODE(),
            GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 68, 0, 0, mario_low_poly_torso),
            GEO_OPEN_NODE(),
               GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 87, 0, 0, NULL),
               GEO_OPEN_NODE(),
               ...
               GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 67, -10, 79, NULL),
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, mario_low_poly_left_arm), // starts sharing solid color with mario_left_forearm (red)
                  GEO_OPEN_NODE(),
                     GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 65, 0, 0, mario_low_poly_left_forearm_shared_dl),
                     GEO_OPEN_NODE(),
               ...
               GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 68, -10, -79, NULL),
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, mario_low_poly_right_arm), // starts sharing solid color of his dl with mario_right_forearm (red)
                  GEO_OPEN_NODE(),
                     GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 65, 0, 0, mario_low_poly_right_forearm_shared_dl),
                     GEO_OPEN_NODE(),
         ...
         GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 13, -8, 42, NULL),
         GEO_OPEN_NODE(),
            GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, mario_low_poly_left_thigh), // starts sharing solid color of his dl with mario_left_leg (blue)
            GEO_OPEN_NODE(),
               GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 89, 0, 0, mario_low_poly_left_leg_shared_dl),
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 67, 0, 0, mario_low_poly_left_foot), // stops sharing because foot has its solid color (brown)
               GEO_CLOSE_NODE(),
            GEO_CLOSE_NODE(),
         GEO_CLOSE_NODE(),
         GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 13, -8, -42, NULL),
         GEO_OPEN_NODE(),
            GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, mario_low_poly_right_thigh), // starts sharing solid color of his dl with mario_left_leg (blue)
            GEO_OPEN_NODE(),
               GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 89, 0, 0, mario_low_poly_right_leg_shared_dl),
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 67, 0, 0, NULL),
                  GEO_OPEN_NODE(),
                     GEO_ASM(2, geo_mario_hand_foot_scaler),
                     GEO_SCALE(LAYER_FORCE, 65536),
                     GEO_OPEN_NODE(),
                        GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_low_poly_right_foot), // stops sharing because foot has its solid color (brown)
                     GEO_CLOSE_NODE(),
                  GEO_CLOSE_NODE(),
               GEO_CLOSE_NODE(),
            GEO_CLOSE_NODE(),
...
const GeoLayout mario_metal_geo_face_and_wings[] = {
   ...
   GEO_OPEN_NODE(),
      GEO_SWITCH_CASE(0, geo_switch_mario_cap_on_off),
      GEO_OPEN_NODE(),
         GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_metal_cap_on_shared_dl),
         GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_metal_cap_off_shared_dl),
      GEO_CLOSE_NODE(),
      GEO_TRANSLATE_ROTATE(LAYER_FORCE, 142, -51, -126, 22, -40, -135),
      GEO_OPEN_NODE(),
         GEO_ASM(0, geo_mario_rotate_wing_cap_wings),
         GEO_ROTATION_NODE(LAYER_FORCE, 0, 0, 0),
         GEO_OPEN_NODE(),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_ALPHA, mario_metal_cap_wings), // left
         GEO_CLOSE_NODE(),
      GEO_CLOSE_NODE(),
      GEO_TRANSLATE_ROTATE(LAYER_FORCE, 142, -51, 126, -22, 40, -135),
      GEO_OPEN_NODE(),
         ...
         GEO_ROTATION_NODE(LAYER_FORCE, 0, 0, 0),
         GEO_OPEN_NODE(),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_ALPHA, mario_metal_cap_wings), // right
         GEO_CLOSE_NODE(),
      GEO_CLOSE_NODE(),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
...
const GeoLayout mario_metal_geo_left_hand[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         ...
         GEO_SCALE(LAYER_FORCE, 65536),
         GEO_OPEN_NODE(),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_left_hand_closed_shared_dl),
         GEO_CLOSE_NODE(),
      GEO_CLOSE_NODE(),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_left_hand_open_shared_dl),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_left_hand_closed_shared_dl),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_left_hand_closed_shared_dl),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_left_hand_closed_shared_dl),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
...
const GeoLayout mario_metal_geo_right_hand[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         ...
         GEO_SCALE(LAYER_FORCE, 65536),
         GEO_OPEN_NODE(),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_metal_right_hand_closed),
         GEO_CLOSE_NODE(),
         GEO_HELD_OBJECT(0x00, 0, 0, 0, geo_switch_mario_hand_grab_pos),
      GEO_CLOSE_NODE(),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_metal_right_hand_open),
      GEO_OPEN_NODE(),
         GEO_HELD_OBJECT(0x00, 0, 0, 0, geo_switch_mario_hand_grab_pos),
      GEO_CLOSE_NODE(),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_right_hand_peace_shared_dl), // here we go hand
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_metal_right_hand_cap_shared_dl),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_metal_right_hand_cap_shared_dl),
      GEO_OPEN_NODE(),
         GEO_DISPLAY_LIST(LAYER_SILHOUETTE_ALPHA, mario_metal_right_hand_cap_shared_dl_wings),
      GEO_CLOSE_NODE(),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
};
...
const GeoLayout mario_metal_geo_body[] = {
   GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, NULL),
   GEO_OPEN_NODE(),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, mario_metal_butt), // starts sharing metal texture with the dls below
      GEO_OPEN_NODE(),
         GEO_ASM(0, geo_move_mario_part_from_parent),
         GEO_ASM(0, geo_mario_tilt_torso),
         GEO_ROTATION_NODE(LAYER_FORCE, 0, 0, 0),
         GEO_OPEN_NODE(),
            GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 68, 0, 0, mario_metal_torso_shared_dl),
            GEO_OPEN_NODE(),
               GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 87, 0, 0, NULL),
               GEO_OPEN_NODE(),
               ...
               GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 67, -10, 79, NULL),
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, mario_left_arm_shared_dl),
                  GEO_OPEN_NODE(),
                     GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 65, 0, 0, mario_left_forearm_shared_dl),
                     GEO_OPEN_NODE(),
               ...
               GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 68, -10, -79, NULL),
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, mario_right_arm_shared_dl),
                  GEO_OPEN_NODE(),
                     GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 65, 0, 0, mario_right_forearm_shared_dl),
                     GEO_OPEN_NODE(),
         ...
         GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 13, -8, 42, NULL),
         GEO_OPEN_NODE(),
            GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, mario_metal_left_thigh), // starts sharing metal texture with the dls below
            GEO_OPEN_NODE(),
               GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 89, 0, 0, mario_left_leg_shared_dl),
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 67, 0, 0, mario_left_foot_shared_dl),
               GEO_CLOSE_NODE(),
            GEO_CLOSE_NODE(),
         GEO_CLOSE_NODE(),
         GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 13, -8, -42, NULL),
         GEO_OPEN_NODE(),
            GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, mario_right_thigh_shared_dl),
            GEO_OPEN_NODE(),
               GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 89, 0, 0, mario_right_leg_shared_dl),
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 67, 0, 0, NULL),
                  GEO_OPEN_NODE(),
                     ...
                     GEO_SCALE(LAYER_FORCE, 65536),
                     GEO_OPEN_NODE(),
                        GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_metal_right_foot),
                     GEO_CLOSE_NODE(),
                  GEO_CLOSE_NODE(),
               GEO_CLOSE_NODE(),
            GEO_CLOSE_NODE(),
...
const GeoLayout mario_metal_geo_medium_poly_left_hand[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         ...
         GEO_SCALE(LAYER_FORCE, 65536),
         GEO_OPEN_NODE(),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_medium_poly_left_hand_closed_shared_dl),
         GEO_CLOSE_NODE(),
      GEO_CLOSE_NODE(),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_left_hand_open_shared_dl),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_medium_poly_left_hand_closed_shared_dl),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_medium_poly_left_hand_closed_shared_dl),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_medium_poly_left_hand_closed_shared_dl),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
...
const GeoLayout mario_metal_geo_medium_poly_right_hand[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         ...
         GEO_SCALE(LAYER_FORCE, 65536),
         GEO_OPEN_NODE(),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_metal_medium_poly_right_hand_closed),
         GEO_CLOSE_NODE(),
         GEO_HELD_OBJECT(0x00, 0, 0, 0, geo_switch_mario_hand_grab_pos),
      GEO_CLOSE_NODE(),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_metal_right_hand_open),
...
const GeoLayout mario_metal_geo_medium_poly_body[] = {
   GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, NULL),
   GEO_OPEN_NODE(),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, mario_metal_medium_poly_butt),
      GEO_OPEN_NODE(),
         GEO_ASM(0, geo_move_mario_part_from_parent),
         GEO_ASM(0, geo_mario_tilt_torso),
         GEO_ROTATION_NODE(LAYER_FORCE, 0, 0, 0),
         GEO_OPEN_NODE(),
            GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 68, 0, 0, mario_metal_medium_poly_torso),
            GEO_OPEN_NODE(),
               GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 87, 0, 0, NULL),
               GEO_OPEN_NODE(),
               ...
               GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 67, -10, 79, NULL),
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, mario_medium_poly_left_arm_shared_dl),
                  GEO_OPEN_NODE(),
                     GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 65, 0, 0, mario_medium_poly_left_forearm_shared_dl),
                     GEO_OPEN_NODE(),
               ...
               GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 68, -10, -79, NULL),
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, mario_medium_poly_right_arm_shared_dl),
                  GEO_OPEN_NODE(),
                     GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 65, 0, 0, mario_medium_poly_right_forearm_shared_dl),
                     GEO_OPEN_NODE(),
         ...
         GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 13, -8, 42, NULL),
         GEO_OPEN_NODE(),
            GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, mario_metal_medium_poly_left_thigh),
            GEO_OPEN_NODE(),
               GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 89, 0, 0, mario_medium_poly_left_leg_shared_dl),
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 67, 0, 0, mario_medium_poly_left_foot_shared_dl),
               GEO_CLOSE_NODE(),
            GEO_CLOSE_NODE(),
         GEO_CLOSE_NODE(),
         GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 13, -8, -42, NULL),
         GEO_OPEN_NODE(),
            GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, mario_medium_poly_right_thigh_shared_dl),
            GEO_OPEN_NODE(),
               GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 89, 0, 0, mario_medium_poly_right_leg_shared_dl),
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 67, 0, 0, NULL),
                  GEO_OPEN_NODE(),
                     ...
                     GEO_SCALE(LAYER_FORCE, 65536),
                     GEO_OPEN_NODE(),
                        GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_metal_medium_poly_right_foot),
                     GEO_CLOSE_NODE(),
                  GEO_CLOSE_NODE(),
               GEO_CLOSE_NODE(),
            GEO_CLOSE_NODE(),
...
const GeoLayout mario_metal_geo_low_poly_face_and_wings[] = {
   ...
   GEO_OPEN_NODE(),
      GEO_SWITCH_CASE(0, geo_switch_mario_cap_on_off),
      GEO_OPEN_NODE(),
         GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_metal_low_poly_cap_on),
         GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_metal_low_poly_cap_off),
      GEO_CLOSE_NODE(),
      GEO_TRANSLATE_ROTATE(LAYER_FORCE, 142, -51, -126, 22, -40, -135),
      GEO_OPEN_NODE(),
         GEO_ASM(0, geo_mario_rotate_wing_cap_wings),
         GEO_ROTATION_NODE(LAYER_FORCE, 0, 0, 0),
         GEO_OPEN_NODE(),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_ALPHA, mario_metal_cap_wings),
         GEO_CLOSE_NODE(),
      GEO_CLOSE_NODE(),
      GEO_TRANSLATE_ROTATE(LAYER_FORCE, 142, -51, 126, -22, 40, -135),
      GEO_OPEN_NODE(),
...
const GeoLayout mario_metal_geo_low_poly_left_hand[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         ...
         GEO_SCALE(LAYER_FORCE, 65536),
         GEO_OPEN_NODE(),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_low_poly_left_hand_closed_shared_dl),
         GEO_CLOSE_NODE(),
      GEO_CLOSE_NODE(),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_left_hand_open_shared_dl),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_low_poly_left_hand_closed_shared_dl),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_low_poly_left_hand_closed_shared_dl),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_low_poly_left_hand_closed_shared_dl),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
...
const GeoLayout mario_metal_geo_low_poly_right_hand[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         ...
         GEO_SCALE(LAYER_FORCE, 65536),
         GEO_OPEN_NODE(),
            GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_metal_low_poly_right_hand_closed),
         GEO_CLOSE_NODE(),
         GEO_HELD_OBJECT(0x00, 0, 0, 0, geo_switch_mario_hand_grab_pos),
      GEO_CLOSE_NODE(),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 60, 0, 0, mario_metal_right_hand_open),
...
const GeoLayout mario_metal_geo_low_poly_body[] = {
   GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, NULL),
   GEO_OPEN_NODE(),
      GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, mario_metal_low_poly_butt),
      GEO_OPEN_NODE(),
         GEO_ASM(0, geo_move_mario_part_from_parent),
         GEO_ASM(0, geo_mario_tilt_torso),
         GEO_ROTATION_NODE(LAYER_FORCE, 0, 0, 0),
         GEO_OPEN_NODE(),
            GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 68, 0, 0, mario_metal_low_poly_torso),
            GEO_OPEN_NODE(),
               GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 87, 0, 0, NULL),
               GEO_OPEN_NODE(),
               ...
               GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 67, -10, 79, NULL),
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, mario_low_poly_left_arm_shared_dl),
                  GEO_OPEN_NODE(),
                     GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 65, 0, 0, mario_low_poly_left_forearm_shared_dl),
                     GEO_OPEN_NODE(),
               ...
               GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 68, -10, -79, NULL),
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, mario_low_poly_right_arm_shared_dl),
                  GEO_OPEN_NODE(),
                     GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 65, 0, 0, mario_low_poly_right_forearm_shared_dl),
                     GEO_OPEN_NODE(),
         ...
         GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 13, -8, 42, NULL),
         GEO_OPEN_NODE(),
            GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, mario_metal_low_poly_left_thigh),
            GEO_OPEN_NODE(),
               GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 89, 0, 0, mario_low_poly_left_leg_shared_dl),
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 67, 0, 0, mario_low_poly_left_foot_shared_dl),
               GEO_CLOSE_NODE(),
            GEO_CLOSE_NODE(),
         GEO_CLOSE_NODE(),
         GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 13, -8, -42, NULL),
         GEO_OPEN_NODE(),
            GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 0, 0, 0, mario_low_poly_right_thigh_shared_dl),
            GEO_OPEN_NODE(),
               GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 89, 0, 0, mario_low_poly_right_leg_shared_dl),
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_SILHOUETTE_OPAQUE, 67, 0, 0, NULL),
                  GEO_OPEN_NODE(),
                     ...
                     GEO_SCALE(LAYER_FORCE, 65536),
                     GEO_OPEN_NODE(),
                        GEO_DISPLAY_LIST(LAYER_SILHOUETTE_OPAQUE, mario_metal_low_poly_right_foot),
                     GEO_CLOSE_NODE(),
                  GEO_CLOSE_NODE(),
               GEO_CLOSE_NODE(),
            GEO_CLOSE_NODE(),
...
const GeoLayout mario_geo[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         ...
         GEO_ASM(0, geo_vanish_mario_set_alpha),
