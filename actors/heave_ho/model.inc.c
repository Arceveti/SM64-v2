...
static const Vtx heave_ho_seg5_vertex_05012440[] = {
    {{{   438,     63,   -205}, 0, ST_B(     0,     32), {0x10, 0x83, 0x00, 0xff}}},
    {{{   438,     63,    206}, 0, ST_B(    32,     32), {0x10, 0x83, 0x00, 0xff}}},
    {{{   146,     25,    206}, 0, ST_B(    32,      0), {0x10, 0x83, 0x00, 0xff}}},
    {{{   146,     25,   -205}, 0, ST_B(     0,      0), {0x10, 0x83, 0x00, 0xff}}},
};
...
static const Vtx heave_ho_seg5_vertex_05012770[] = {
    {{{    30,    155,      0}, 0, ST_B(     0,     32), {0x00, 0x00, 0x7f, 0xff}}},
    {{{    30,   -153,      0}, 0, ST_B(    32,     32), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   214,    155,      0}, 0, ST_B(     0,      0), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   214,   -153,      0}, 0, ST_B(    32,      0), {0x00, 0x00, 0x7f, 0xff}}},
};
