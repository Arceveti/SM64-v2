                        ...
                        GEO_OPEN_NODE(),
                           ...
                           GEO_OPEN_NODE(),
                              ...
                              GEO_OPEN_NODE(),
                                 ...
                                 GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OCCLUDE_SILHOUETTE_OPAQUE, 0, 100, 0, 180, 270, 0, mario_cap_seg3_dl_03022F48),
                              GEO_CLOSE_NODE(),
                           GEO_CLOSE_NODE(),
                           ...
                           GEO_OPEN_NODE(),
                              ...
                              GEO_OPEN_NODE(),
                                 GEO_ASM(0, geo_offset_klepto_held_object),
                                 GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_TRANSPARENT, 0, 100, 0, 180, 270, 0, transparent_star_seg3_dl),
                              GEO_CLOSE_NODE(),
                           GEO_CLOSE_NODE(),
                        GEO_CLOSE_NODE(),
                     GEO_CLOSE_NODE(),
