...
static const Vtx yellow_sphere_seg6_vertex_0601EB48[] = {
    {{{   -77,    -77,      0}, 0, ST_B(     0,     32), {0xff, 0xff, 0xff, 0xff}}},
    {{{    77,    -77,      0}, 0, ST_B(    32,     32), {0xff, 0xff, 0xff, 0xff}}},
    {{{    77,     77,      0}, 0, ST_B(    32,      0), {0xff, 0xff, 0xff, 0xff}}},
    {{{   -77,     77,      0}, 0, ST_B(     0,      0), {0xff, 0xff, 0xff, 0xff}}},
};
