...
static const Vtx exclamation_box_seg8_vertex_08018E28[] = {
    {{{   -26,      0,    -26}, 0, { 31<<5,  31<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   -26,     51,    -26}, 0, { 31<<5,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{    26,     51,    -26}, 0, {     0,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   -26,      0,     26}, 0, {     0,  31<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{    26,      0,     26}, 0, { 31<<5,  31<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{    26,     51,     26}, 0, { 31<<5,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   -26,     51,     26}, 0, {     0,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{    26,     51,    -26}, 0, { 31<<5,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{    26,      0,     26}, 0, {     0,  31<<5}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{    26,      0,    -26}, 0, { 31<<5,  31<<5}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{    26,     51,     26}, 0, {     0,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   -26,      0,    -26}, 0, {     0,  31<<5}, {0x81, 0x00, 0x00, 0xff}}},
    {{{   -26,      0,     26}, 0, { 31<<5,  31<<5}, {0x81, 0x00, 0x00, 0xff}}},
    {{{   -26,     51,     26}, 0, { 31<<5,      0}, {0x81, 0x00, 0x00, 0xff}}},
    {{{   -26,     51,    -26}, 0, {     0,      0}, {0x81, 0x00, 0x00, 0xff}}},
    {{{    26,      0,    -26}, 0, {     0,  31<<5}, {0x00, 0x00, 0x81, 0xff}}},
};

// 0x08018F28
static const Vtx exclamation_box_seg8_vertex_08018F28[] = {
    {{{    26,      0,    -26}, 0, { 31<<5,  63<<5}, {0x00, 0x81, 0x00, 0xff}}},
    {{{    26,      0,     26}, 0, { 31<<5,      0}, {0x00, 0x81, 0x00, 0xff}}},
    {{{   -26,      0,     26}, 0, {     0,      0}, {0x00, 0x81, 0x00, 0xff}}},
    {{{   -26,      0,    -26}, 0, {     0,  63<<5}, {0x00, 0x81, 0x00, 0xff}}},
    {{{   -26,     51,    -26}, 0, {     0,      0}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   -26,     51,     26}, 0, {     0,  63<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{    26,     51,     26}, 0, { 31<<5,  63<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{    26,     51,    -26}, 0, { 31<<5,      0}, {0x00, 0x7f, 0x00, 0xff}}},
};
...
static const Vtx exclamation_box_seg8_vertex_080191A0[] = {
    {{{   -26,     51,     26}, 0, {     0,  31<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{    26,     51,     26}, 0, { 63<<5,  31<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{    26,     51,    -26}, 0, { 63<<5,      0}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   -26,     51,    -26}, 0, {     0,      0}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   -26,      0,     26}, 0, {     0,      0}, {0x00, 0x81, 0x00, 0xff}}},
    {{{   -26,      0,    -26}, 0, {     0,  31<<5}, {0x00, 0x81, 0x00, 0xff}}},
    {{{    26,      0,    -26}, 0, { 63<<5,  31<<5}, {0x00, 0x81, 0x00, 0xff}}},
    {{{    26,      0,     26}, 0, { 63<<5,      0}, {0x00, 0x81, 0x00, 0xff}}},
};
