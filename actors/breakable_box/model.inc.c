...
static const Vtx breakable_box_seg8_vertex_08012A90[] = {
    {{{  -100,      0,   -100}, 0, { 31<<5,      0}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  -100,      0,    100}, 0, { 31<<5,  31<<5}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  -100,    200,    100}, 0, {     0,  31<<5}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  -100,      0,    100}, 0, {     0,  31<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   100,      0,    100}, 0, { 31<<5,  31<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   100,    200,    100}, 0, { 31<<5,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -100,    200,    100}, 0, {     0,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   100,      0,   -100}, 0, { 31<<5,      0}, {0x00, 0x81, 0x00, 0xff}}},
    {{{   100,      0,    100}, 0, {     0,      0}, {0x00, 0x81, 0x00, 0xff}}},
    {{{  -100,      0,    100}, 0, {     0,  31<<5}, {0x00, 0x81, 0x00, 0xff}}},
    {{{  -100,      0,   -100}, 0, { 31<<5,  31<<5}, {0x00, 0x81, 0x00, 0xff}}},
    {{{   100,    200,   -100}, 0, {     0,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   100,    200,    100}, 0, {     0,  31<<5}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   100,      0,    100}, 0, { 31<<5,  31<<5}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   100,      0,   -100}, 0, { 31<<5,      0}, {0x7f, 0x00, 0x00, 0xff}}},
};

// 0x08012B80
static const Vtx breakable_box_seg8_vertex_08012B80[] = {
    {{{  -100,    200,    100}, 0, {     0,      0}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   100,    200,   -100}, 0, { 31<<5,  31<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  -100,    200,   -100}, 0, { 31<<5,      0}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   100,    200,    100}, 0, {     0,  31<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   100,    200,   -100}, 0, {     0,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   100,      0,   -100}, 0, {     0,  31<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -100,      0,   -100}, 0, { 31<<5,  31<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -100,    200,   -100}, 0, { 31<<5,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -100,      0,   -100}, 0, { 31<<5,      0}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  -100,    200,    100}, 0, {     0,  31<<5}, {0x81, 0x00, 0x00, 0xff}}},
