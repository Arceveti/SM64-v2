...
const GeoLayout peach_geo_000098[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         GEO_ANIMATED_PART(LAYER_NO_SILHOUETTE, 0, 0, 0, peach_seg5_dl_05007230),
         GEO_OPEN_NODE(),
            GEO_ANIMATED_PART(LAYER_NO_SILHOUETTE, 78, 0, 0, peach_seg5_dl_05006A18),
            GEO_OPEN_NODE(),
               GEO_ANIMATED_PART(LAYER_NO_SILHOUETTE, 132, 0, 0, NULL),
               GEO_OPEN_NODE(),
                  GEO_SWITCH_CASE(8, geo_switch_peach_eyes),
                  GEO_OPEN_NODE(),
                     GEO_DISPLAY_LIST(LAYER_NO_SILHOUETTE, peach_seg5_dl_05005CE0),
                     GEO_DISPLAY_LIST(LAYER_NO_SILHOUETTE, peach_seg5_dl_05005D38),
                     GEO_DISPLAY_LIST(LAYER_NO_SILHOUETTE, peach_seg5_dl_05005D90),
                     GEO_DISPLAY_LIST(LAYER_NO_SILHOUETTE, peach_seg5_dl_05005DE8),
                     GEO_DISPLAY_LIST(LAYER_NO_SILHOUETTE, peach_seg5_dl_05005E40),
                     GEO_DISPLAY_LIST(LAYER_NO_SILHOUETTE, peach_seg5_dl_05005E98),
                     GEO_DISPLAY_LIST(LAYER_NO_SILHOUETTE, peach_seg5_dl_05005EF0),
                     GEO_DISPLAY_LIST(LAYER_NO_SILHOUETTE, peach_seg5_dl_05005F48),
                  GEO_CLOSE_NODE(),
                  GEO_ANIMATED_PART(LAYER_NO_SILHOUETTE, 38, -78, 0, NULL),
                  GEO_OPEN_NODE(),
                     GEO_ANIMATED_PART(LAYER_NO_SILHOUETTE, 0, 0, 0, peach_seg5_dl_05007AB8),
                  GEO_CLOSE_NODE(),
               GEO_CLOSE_NODE(),
               GEO_ANIMATED_PART(LAYER_NO_SILHOUETTE, 132, 0, 0, peach_seg5_dl_05009148),
               GEO_ANIMATED_PART(LAYER_NO_SILHOUETTE, 132, 0, 0, peach_seg5_dl_05008F20),
               GEO_ANIMATED_PART(LAYER_NO_SILHOUETTE, 63, 0, 84, NULL),
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_NO_SILHOUETTE, 0, 0, 0, peach_seg5_dl_05007E58),
                  GEO_OPEN_NODE(),
                     GEO_ANIMATED_PART(LAYER_NO_SILHOUETTE, 104, 0, 0, peach_seg5_dl_050087A8),
                     GEO_OPEN_NODE(),
                        GEO_ANIMATED_PART(LAYER_NO_SILHOUETTE, 87, 0, 0, peach_seg5_dl_05009500),
                     GEO_CLOSE_NODE(),
                  GEO_CLOSE_NODE(),
                  GEO_ANIMATED_PART(LAYER_NO_SILHOUETTE, 0, 0, 0, peach_seg5_dl_05008560),
               GEO_CLOSE_NODE(),
               GEO_ANIMATED_PART(LAYER_NO_SILHOUETTE, 63, 0, -84, NULL),
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_NO_SILHOUETTE, 0, 0, 0, peach_seg5_dl_05008228),
                  GEO_OPEN_NODE(),
                     GEO_ANIMATED_PART(LAYER_NO_SILHOUETTE, 104, 0, 0, peach_seg5_dl_05008CF8),
                     GEO_OPEN_NODE(),
                        GEO_ANIMATED_PART(LAYER_NO_SILHOUETTE, 87, 0, 0, peach_seg5_dl_05009940),
                     GEO_CLOSE_NODE(),
                  GEO_CLOSE_NODE(),
                  GEO_ANIMATED_PART(LAYER_NO_SILHOUETTE, 0, 0, 0, peach_seg5_dl_05008AB0),
               GEO_CLOSE_NODE(),
            GEO_CLOSE_NODE(),
            GEO_ANIMATED_PART(LAYER_NO_SILHOUETTE, 78, 0, 0, peach_seg5_dl_050060E0),
            GEO_ANIMATED_PART(LAYER_NO_SILHOUETTE, -23, -1, 0, NULL),
            GEO_OPEN_NODE(),
               GEO_ANIMATED_PART(LAYER_NO_SILHOUETTE, 0, 0, 0, peach_seg5_dl_0500A0A8),
            GEO_CLOSE_NODE(),
         GEO_CLOSE_NODE(),
      GEO_CLOSE_NODE(),
   GEO_CLOSE_NODE(),
