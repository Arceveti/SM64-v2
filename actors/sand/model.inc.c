...
// 0x0302BA90
static const Vtx sand_seg3_vertex_16x16[] = {
    {{{    -8,     -8,      0}, 0, {     0,  15<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{     8,     -8,      0}, 0, { 15<<5,  15<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{     8,      8,      0}, 0, { 15<<5,      0}, {0xff, 0xff, 0xff, 0xff}}},
...
const Gfx sand_seg3_dl_particle[] = {
    ...
    gsSPVertex(sand_seg3_vertex_16x16, 4, 0),
