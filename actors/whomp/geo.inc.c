                     ...
                     GEO_OPEN_NODE(),
                        ...
                        GEO_OPEN_NODE(),
                           ...
                           GEO_OPEN_NODE(),
                              GEO_BILLBOARD(),
                              GEO_OPEN_NODE(),
                                 GEO_DISPLAY_LIST(LAYER_ALPHA, whomp_seg6_dl_hand_1),
                              GEO_CLOSE_NODE(),
                           GEO_CLOSE_NODE(),
                        GEO_CLOSE_NODE(),
                     GEO_CLOSE_NODE(),
                     ...
                     GEO_OPEN_NODE(),
                        ...
                        GEO_OPEN_NODE(),
                           ...
                           GEO_OPEN_NODE(),
                              GEO_BILLBOARD(),
                              GEO_OPEN_NODE(),
                                 GEO_DISPLAY_LIST(LAYER_ALPHA, whomp_seg6_dl_hand_2),
                              GEO_CLOSE_NODE(),
                           GEO_CLOSE_NODE(),
                        GEO_CLOSE_NODE(),
                     GEO_CLOSE_NODE(),
