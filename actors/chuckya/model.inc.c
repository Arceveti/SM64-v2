...
// 0x08006778
ALIGNED8 static const Texture chuckya_seg8_texture_eyes[] = {
#include "actors/chuckya/chuckya_eyes.rgba16.inc.c"
};

// 0x08007778
ALIGNED8 static const Texture chuckya_seg8_texture_hand_antenna[] = {
#include "actors/chuckya/chuckya_hand_antenna.rgba16.inc.c"
};

// 0x08007F78
ALIGNED8 static const Texture chuckya_seg8_texture_body_arm_left_side[] = {
#include "actors/chuckya/chuckya_body_arm_left_side.rgba16.inc.c"
};

// 0x08008F78
ALIGNED8 static const Texture chuckya_seg8_texture_body_arm_right_side[] = {
...
const Gfx chuckya_seg8_dl_0800A3F0[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, chuckya_seg8_texture_hand_antenna),
    gsDPLoadSync(),
...
static const Vtx chuckya_seg8_vertex_0800A680[] = {
    {{{    32,    237,      0}, 0, { 15<<5,   1024}, {0x40, 0x65, 0x28, 0xff}}},
    {{{    26,    198,    109}, 0, {  1008,    928}, {0x40, 0x65, 0x28, 0xff}}},
    {{{   196,    134,      0}, 0, { 15<<5,    -64}, {0x40, 0x65, 0x28, 0xff}}},
    {{{   163,    112,    109}, 0, {  1008,     16}, {0x40, 0x65, 0x28, 0xff}}},
    {{{   196,    134,      0}, 0, { 15<<5,    -64}, {0x40, 0x65, 0xd7, 0xff}}},
    {{{    26,    198,   -109}, 0, {   -48,    928}, {0x40, 0x65, 0xd7, 0xff}}},
    {{{    32,    237,      0}, 0, { 15<<5,   1024}, {0x40, 0x65, 0xd7, 0xff}}},
    {{{   163,    112,   -109}, 0, {   -48,     16}, {0x40, 0x65, 0xd7, 0xff}}},
};

// 0x0800A700 - 0x0800A758
const Gfx chuckya_seg8_dl_0800A700[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, chuckya_seg8_texture_eyes),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
static const Vtx chuckya_seg8_vertex_0800A7E0[] = {
    {{{    87,     42,    -42}, 0, {     0,      0}, {0xb8, 0x49, 0xb7, 0xff}}},
    {{{    87,      0,    -58}, 0, {     0,      0}, {0xb8, 0x00, 0x98, 0xff}}},
    {{{     3,      0,      0}, 0, {     0,      0}, {0x82, 0x00, 0x00, 0xff}}},
    {{{    87,     58,      0}, 0, {     0,      0}, {0xb8, 0x67, 0x00, 0xff}}},
    {{{    87,    -42,    -42}, 0, {     0,      0}, {0xb8, 0xb6, 0xb7, 0xff}}},
    {{{    87,    -42,     42}, 0, {     0,      0}, {0xb8, 0xb6, 0x49, 0xff}}},
    {{{    87,      0,     59}, 0, {     0,      0}, {0xb8, 0x00, 0x67, 0xff}}},
    {{{    87,     42,     42}, 0, {     0,      0}, {0xb7, 0x49, 0x48, 0xff}}},
    {{{    87,    -59,      0}, 0, {     0,      0}, {0xb9, 0x98, 0x00, 0xff}}},
};
...
static const Vtx chuckya_seg8_vertex_0800A908[] = {
    {{{    -9,      0,      0}, 0, {     0,      0}, {0x82, 0xfd, 0x00, 0xff}}},
    {{{    80,     26,      0}, 0, {     0,      0}, {0xdf, 0x7a, 0x00, 0xff}}},
    {{{    80,      0,    -32}, 0, {     0,      0}, {0xd4, 0xff, 0x8a, 0xff}}},
    {{{    80,    -26,      0}, 0, {     0,      0}, {0xde, 0x86, 0x00, 0xff}}},
    {{{    80,      0,     32}, 0, {     0,      0}, {0xd4, 0xff, 0x76, 0xff}}},
};
