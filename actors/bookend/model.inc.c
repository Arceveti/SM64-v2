...
static const Vtx bookend_seg5_vertex_05001878[] = {
    {{{   -10,      0,    109}, 0, ST_B(     0,     32), {0x83, 0xed, 0x00, 0xff}}},
    {{{    -4,    -39,   -109}, 0, ST_B(    16,      0), {0x83, 0xed, 0x00, 0xff}}},
    {{{    -4,    -39,    109}, 0, ST_B(    16,     32), {0x83, 0xed, 0x00, 0xff}}},
    {{{   -10,      0,   -109}, 0, ST_B(     0,      0), {0x83, 0xed, 0x00, 0xff}}},
};

// 0x050018B8
static const Vtx bookend_seg5_vertex_050018B8[] = {
    {{{    -4,    -39,   -109}, 0, ST_B(    16,      0), {0x00, 0x81, 0x00, 0xff}}},
    {{{   185,    -39,    109}, 0, ST_B(     0,     32), {0x00, 0x81, 0x00, 0xff}}},
    {{{    -4,    -39,    109}, 0, ST_B(    16,     32), {0x00, 0x81, 0x00, 0xff}}},
    {{{   185,    -39,   -109}, 0, ST_B(     0,      0), {0x00, 0x81, 0x00, 0xff}}},
};
...
static const Vtx bookend_seg5_vertex_05001A60[] = {
    {{{    -4,    -39,   -109}, 0, ST_B(     0,     32), {0x00, 0x81, 0x00, 0xff}}},
    {{{   185,    -39,    109}, 0, ST_B(    32,      0), {0x00, 0x81, 0x00, 0xff}}},
    {{{    -4,    -39,    109}, 0, ST_B(     0,      0), {0x00, 0x81, 0x00, 0xff}}},
    {{{   185,    -39,   -109}, 0, ST_B(    32,     32), {0x00, 0x81, 0x00, 0xff}}},
};
...
static const Vtx bookend_seg5_vertex_05001BC8[] = {
    {{{   -10,      0,    102}, 0, ST_B(     0,     32), {0x00, 0x7f, 0x00, 0xff}}},
    {{{   160,      0,   -102}, 0, ST_B(    16,      0), {0x00, 0x7f, 0x00, 0xff}}},
    {{{   -10,      0,   -102}, 0, ST_B(     0,      0), {0x00, 0x7f, 0x00, 0xff}}},
    {{{   160,      0,    102}, 0, ST_B(    16,     32), {0x00, 0x7f, 0x00, 0xff}}},
};

// 0x05001C08
static const Vtx bookend_seg5_vertex_05001C08[] = {
    {{{   160,      0,    102}, 0, ST_B(     0,      0), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   -10,      0,    102}, 0, ST_B(     0,     32), {0x00, 0x00, 0x7f, 0xff}}},
    {{{    -4,    -38,    102}, 0, ST_B(    16,     32), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   170,    -38,    102}, 0, ST_B(    16,      0), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   160,      0,   -102}, 0, ST_B(     0,      0), {0x79, 0x23, 0x00, 0xff}}},
    {{{   160,      0,    102}, 0, ST_B(     0,     32), {0x79, 0x23, 0x00, 0xff}}},
    {{{   170,    -38,    102}, 0, ST_B(    16,     32), {0x79, 0x23, 0x00, 0xff}}},
    {{{   170,    -38,   -102}, 0, ST_B(    16,      0), {0x79, 0x23, 0x00, 0xff}}},
    {{{   -10,      0,   -102}, 0, ST_B(     0,      0), {0x00, 0x00, 0x81, 0xff}}},
    {{{   160,      0,   -102}, 0, ST_B(     0,     32), {0x00, 0x00, 0x81, 0xff}}},
    {{{   170,    -38,   -102}, 0, ST_B(    16,     32), {0x00, 0x00, 0x81, 0xff}}},
    {{{    -4,    -38,   -102}, 0, ST_B(    16,      0), {0x00, 0x00, 0x81, 0xff}}},
};
...
static const Vtx bookend_seg5_vertex_05002028[] = {
    {{{   157,     -1,    -48}, 0, {     0,    358}, {0x83, 0xee, 0x00, 0xff}}},
    {{{   151,     39,    -72}, 0, { 15<<5,    624}, {0x83, 0xee, 0x00, 0xff}}},
    {{{   157,     -1,    -99}, 0, {   372,  -1002}, {0x83, 0xee, 0x00, 0xff}}},
    {{{   157,     -1,      0}, 0, {   106,    390}, {0x83, 0xee, 0x00, 0xff}}},
    {{{   151,     39,    -24}, 0, {   464,    640}, {0x83, 0xee, 0x00, 0xff}}},
    {{{   157,     -1,    -48}, 0, {   464,   -944}, {0x83, 0xee, 0x00, 0xff}}},
    {{{   157,     -1,     51}, 0, {   -56,    352}, {0x83, 0xee, 0x00, 0xff}}},
    {{{   151,     39,     26}, 0, { 15<<5,    570}, {0x83, 0xee, 0x00, 0xff}}},
    {{{   157,     -1,      0}, 0, {   448,   -975}, {0x83, 0xee, 0x00, 0xff}}},
    {{{   157,     -1,    102}, 0, {    64,    304}, {0x83, 0xee, 0x00, 0xff}}},
    {{{   151,     39,     78}, 0, {   496,    590}, {0x83, 0xee, 0x00, 0xff}}},
    {{{   157,     -1,     51}, 0, {   464,   -960}, {0x83, 0xee, 0x00, 0xff}}},
};
...
static const Vtx bookend_seg5_vertex_050021C8[] = {
    {{{   157,     -1,    102}, 0, {    32,    400}, {0x83, 0xee, 0x00, 0xff}}},
    {{{   151,     39,     77}, 0, {   426,    768}, {0x83, 0xee, 0x00, 0xff}}},
    {{{   157,     -1,     51}, 0, {   416,   -720}, {0x83, 0xee, 0x00, 0xff}}},
    {{{   157,     -1,     51}, 0, {   -40,    392}, {0x83, 0xee, 0x00, 0xff}}},
    {{{   151,     39,     26}, 0, {   457,    852}, {0x83, 0xee, 0x00, 0xff}}},
    {{{   157,     -1,      0}, 0, {   363,   -564}, {0x83, 0xee, 0x00, 0xff}}},
    {{{   157,     -1,      0}, 0, {     0,    360}, {0x83, 0xee, 0x00, 0xff}}},
    {{{   151,     39,    -26}, 0, { 15<<5,    906}, {0x83, 0xee, 0x00, 0xff}}},
    {{{   157,     -1,    -51}, 0, {   372,   -928}, {0x83, 0xee, 0x00, 0xff}}},
    {{{   157,     -1,    -51}, 0, {    16,    240}, {0x83, 0xee, 0x00, 0xff}}},
