...
static const Vtx tree_seg3_vertex_bubbly_left_side[] = {
    {{{  -358,     -9,      0}, 0, {  -800,  63<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{     0,     -9,      0}, 0, { 31<<5,  63<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{     0,    800,      0}, 0, { 31<<5,   -704}, {0xff, 0xff, 0xff, 0xff}}},
};

// 0x0302FE58
static const Vtx tree_seg3_vertex_bubbly_right_side[] = {
    {{{     0,     -9,      0}, 0, {     0,  63<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   358,     -9,      0}, 0, { 55<<5,  63<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{     0,    800,      0}, 0, {     0,   -704}, {0xff, 0xff, 0xff, 0xff}}},
};
...
static const Vtx tree_seg3_vertex_spiky[] = {
    {{{   128,    512,      0}, 0, { 31<<5,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -128,    512,      0}, 0, {     0,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -128,      0,      0}, 0, {     0,  63<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   128,      0,      0}, 0, { 31<<5,  63<<5}, {0x00, 0x00, 0x7f, 0xff}}},
};
...
static const Vtx tree_seg3_vertex_palm[] = {
    {{{   170,    512,      0}, 0, { 31<<5,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -170,    512,      0}, 0, {     0,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -170,      0,      0}, 0, {     0,  63<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   170,      0,      0}, 0, { 31<<5,  63<<5}, {0x00, 0x00, 0x7f, 0xff}}},
};
