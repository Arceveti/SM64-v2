   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         ...
         GEO_OPEN_NODE(),
            ...
            GEO_OPEN_NODE(),
               GEO_ANIMATED_PART(LAYER_OCCLUDE_SILHOUETTE_OPAQUE, 132, 0, 0, lakitu_seg6_dl_cameraman_frown),
               GEO_OPEN_NODE(),
                  GEO_SWITCH_CASE(2, geo_switch_anim_state),
                  GEO_OPEN_NODE(),
                     GEO_DISPLAY_LIST(LAYER_OCCLUDE_SILHOUETTE_ALPHA, lakitu_seg6_dl_cameraman_eyes_open),
                     GEO_DISPLAY_LIST(LAYER_OCCLUDE_SILHOUETTE_ALPHA, lakitu_seg6_dl_cameraman_eyes_closed),
                  GEO_CLOSE_NODE(),
               GEO_CLOSE_NODE(),
               ...
               GEO_OPEN_NODE(),
                  ...
                  GEO_OPEN_NODE(),
                     ...
                     GEO_OPEN_NODE(),
                        GEO_ANIMATED_PART(LAYER_OCCLUDE_SILHOUETTE_OPAQUE, 0, 0, 0, lakitu_seg6_dl_cameraman_black_string_2),
                        GEO_OPEN_NODE(),
                           GEO_ANIMATED_PART(LAYER_OCCLUDE_SILHOUETTE_OPAQUE, 191, 0, 0, lakitu_seg6_dl_camera),
                        GEO_CLOSE_NODE(),
                        GEO_ANIMATED_PART(LAYER_OCCLUDE_SILHOUETTE_OPAQUE, 0, 0, 0, lakitu_seg6_dl_cameraman_black_string_1),
                     GEO_CLOSE_NODE(),
                  GEO_CLOSE_NODE(),
