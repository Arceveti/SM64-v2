...
static const Vtx mist_seg3_vertex_03000040[] = {
    {{{   -25,    -25,      0}, 0, ST_B(     0,     32), {0x22, 0x1a, 0x1c, 0xff}}},
    {{{    25,    -25,      0}, 0, ST_B(    32,     32), {0x22, 0x1a, 0x1c, 0xff}}},
    {{{    25,     25,      0}, 0, ST_B(    32,      0), {0x22, 0x1a, 0x1c, 0xff}}},
    {{{   -25,     25,      0}, 0, ST_B(     0,      0), {0x22, 0x1a, 0x1c, 0xff}}},
};
