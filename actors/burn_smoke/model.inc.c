...
static const Vtx dBurnSmokeVertices[] = {
    {{{   -50,    -50,      0}, 0, ST_B(     0,     32), {0x14, 0x0a, 0x0a, 0xff}}},
    {{{    50,    -50,      0}, 0, ST_B(    32,     32), {0x14, 0x0a, 0x0a, 0xff}}},
    {{{    50,     50,      0}, 0, ST_B(    32,      0), {0x14, 0x0a, 0x0a, 0xff}}},
    {{{   -50,     50,      0}, 0, ST_B(     0,      0), {0x14, 0x0a, 0x0a, 0xff}}},
};
