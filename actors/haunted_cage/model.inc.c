...
static const Vtx haunted_cage_seg5_vertex_0500EF88[] = {
    {{{    26,      0,     44}, 0, ST_B(   128,     16), {0x21, 0x00, 0x7a, 0xff}}},
    {{{     0,     10,     51}, 0, ST_B(    96,      0), {0x21, 0x00, 0x7a, 0xff}}},
    {{{     0,      0,     51}, 0, ST_B(    96,     16), {0x21, 0x00, 0x7a, 0xff}}},
    {{{    26,     10,     44}, 0, ST_B(   128,      0), {0x21, 0x00, 0x7a, 0xff}}},
    {{{    44,      0,     26}, 0, ST_B(   160,     16), {0x59, 0x00, 0x59, 0xff}}},
    {{{    26,     10,     44}, 0, ST_B(   128,      0), {0x59, 0x00, 0x59, 0xff}}},
    {{{    26,      0,     44}, 0, ST_B(   128,     16), {0x59, 0x00, 0x59, 0xff}}},
    {{{    44,     10,     26}, 0, ST_B(   160,      0), {0x59, 0x00, 0x59, 0xff}}},
};
