...
static const Vtx book_seg5_vertex_05002D70[] = {
    {{{   -10,     31,    -51}, 0, ST_B(    32,      0), {0x00, 0x7f, 0x00, 0xff}}},
    {{{    10,     31,      0}, 0, ST_B(     0,     32), {0x00, 0x7f, 0x00, 0xff}}},
    {{{    10,     31,    -51}, 0, ST_B(     0,      0), {0x00, 0x7f, 0x00, 0xff}}},
    {{{   -10,     31,      0}, 0, ST_B(    16,     32), {0x00, 0x7f, 0x00, 0xff}}},
    {{{    10,    -31,    -51}, 0, ST_B(     0,     32), {0x00, 0x81, 0x00, 0xff}}},
    {{{    10,    -31,      0}, 0, ST_B(     0,      0), {0x00, 0x81, 0x00, 0xff}}},
    {{{   -10,    -31,      0}, 0, ST_B(    16,      0), {0x00, 0x81, 0x00, 0xff}}},
    {{{   -10,    -31,    -51}, 0, ST_B(    32,     32), {0x00, 0x81, 0x00, 0xff}}},
    {{{    10,    -31,    -51}, 0, ST_B(     0,     32), {0x00, 0x00, 0x81, 0xff}}},
    {{{   -10,     31,    -51}, 0, ST_B(    32,      0), {0x00, 0x00, 0x81, 0xff}}},
    {{{    10,     31,    -51}, 0, ST_B(     0,      0), {0x00, 0x00, 0x81, 0xff}}},
    {{{   -10,    -31,    -51}, 0, ST_B(    32,     32), {0x00, 0x00, 0x81, 0xff}}},
};

// 0x05002E30
static const Vtx book_seg5_vertex_05002E30[] = {
    {{{    10,     31,      0}, 0, ST_B(    32,      0), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   -10,     31,      0}, 0, ST_B(     0,      0), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   -10,    -31,      0}, 0, ST_B(     0,     32), {0x00, 0x00, 0x7f, 0xff}}},
    {{{    10,    -31,      0}, 0, ST_B(    32,     32), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   -10,    -31,    -51}, 0, ST_B(    32,     32), {0x81, 0x00, 0x00, 0xff}}},
    {{{   -10,     31,      0}, 0, ST_B(     0,      0), {0x81, 0x00, 0x00, 0xff}}},
    {{{   -10,     31,    -51}, 0, ST_B(    32,      0), {0x81, 0x00, 0x00, 0xff}}},
    {{{   -10,    -31,      0}, 0, ST_B(     0,     32), {0x81, 0x00, 0x00, 0xff}}},
    {{{    10,     31,    -51}, 0, ST_B(    32,      0), {0x7f, 0x00, 0x00, 0xff}}},
    {{{    10,     31,      0}, 0, ST_B(     0,      0), {0x7f, 0x00, 0x00, 0xff}}},
    {{{    10,    -31,      0}, 0, ST_B(     0,     32), {0x7f, 0x00, 0x00, 0xff}}},
    {{{    10,    -31,    -51}, 0, ST_B(    32,     32), {0x7f, 0x00, 0x00, 0xff}}},
};
