...
static const Vtx book_seg5_vertex_05002D70[] = {
    {{{   -10,     31,    -51}, 0, { 31<<5,      0}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{    10,     31,      0}, 0, {     0,  31<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{    10,     31,    -51}, 0, {     0,      0}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   -10,     31,      0}, 0, { 15<<5,  31<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{    10,    -31,    -51}, 0, {     0,  31<<5}, {0x00, 0x81, 0x00, 0xff}}},
    {{{    10,    -31,      0}, 0, {     0,      0}, {0x00, 0x81, 0x00, 0xff}}},
    {{{   -10,    -31,      0}, 0, { 15<<5,      0}, {0x00, 0x81, 0x00, 0xff}}},
    {{{   -10,    -31,    -51}, 0, { 31<<5,  31<<5}, {0x00, 0x81, 0x00, 0xff}}},
    {{{    10,    -31,    -51}, 0, {     0,  31<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   -10,     31,    -51}, 0, { 31<<5,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{    10,     31,    -51}, 0, {     0,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   -10,    -31,    -51}, 0, { 31<<5,  31<<5}, {0x00, 0x00, 0x81, 0xff}}},
};

// 0x05002E30
static const Vtx book_seg5_vertex_05002E30[] = {
    {{{    10,     31,      0}, 0, { 31<<5,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   -10,     31,      0}, 0, {     0,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   -10,    -31,      0}, 0, {     0,  31<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{    10,    -31,      0}, 0, { 31<<5,  31<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   -10,    -31,    -51}, 0, { 31<<5,  31<<5}, {0x81, 0x00, 0x00, 0xff}}},
    {{{   -10,     31,      0}, 0, {     0,      0}, {0x81, 0x00, 0x00, 0xff}}},
    {{{   -10,     31,    -51}, 0, { 31<<5,      0}, {0x81, 0x00, 0x00, 0xff}}},
    {{{   -10,    -31,      0}, 0, {     0,  31<<5}, {0x81, 0x00, 0x00, 0xff}}},
    {{{    10,     31,    -51}, 0, { 31<<5,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{    10,     31,      0}, 0, {     0,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{    10,    -31,      0}, 0, {     0,  31<<5}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{    10,    -31,    -51}, 0, { 31<<5,  31<<5}, {0x7f, 0x00, 0x00, 0xff}}},
};
