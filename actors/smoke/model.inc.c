...
static const Vtx smoke_seg5_vertex_05007280[] = {
    {{{    26,     26,      0}, 0, ST_B(    32,      0), {0xff, 0xff, 0xff, 0xb4}}},
    {{{   -26,     26,      0}, 0, ST_B(     0,      0), {0xff, 0xff, 0xff, 0xb4}}},
    {{{   -26,    -26,      0}, 0, ST_B(     0,     32), {0xff, 0xff, 0xff, 0xb4}}},
    {{{    26,    -26,      0}, 0, ST_B(    32,     32), {0xff, 0xff, 0xff, 0xb4}}},
};
