...
static const Vtx yellow_sphere_seg5_vertex_05000000[] = {
    {{{   -50,    -50,      0}, 0, ST_B(     0,     32), {0xb5, 0x20, 0x40, 0xff}}},
    {{{    50,    -50,      0}, 0, ST_B(    32,     32), {0xb5, 0x20, 0x40, 0xff}}},
    {{{    50,     50,      0}, 0, ST_B(    32,      0), {0xb5, 0x20, 0x40, 0xff}}},
    {{{   -50,     50,      0}, 0, ST_B(     0,      0), {0xb5, 0x20, 0x40, 0xff}}},
};
