...
static const Vtx door_seg3_vertex_03013910[] = {
    {{{   -16,      0,    -60}, 0, ST_B(     0,      0), {0x81, 0x00, 0x00, 0xff}}},
    {{{   -16,      0,     60}, 0, ST_B(    32,      0), {0x81, 0x00, 0x00, 0xff}}},
    {{{   -16,   1024,     60}, 0, ST_B(    32,     64), {0x81, 0x00, 0x00, 0xff}}},
    {{{   -16,   1024,    -60}, 0, ST_B(    32,     64), {0x00, 0x7f, 0x00, 0xff}}},
    {{{   -16,   1024,     60}, 0, ST_B(     0,     64), {0x00, 0x7f, 0x00, 0xff}}},
    {{{   600,   1024,     60}, 0, ST_B(     0,      0), {0x00, 0x7f, 0x00, 0xff}}},
    {{{   600,   1024,    -60}, 0, ST_B(    32,      0), {0x00, 0x7f, 0x00, 0xff}}},
    {{{   600,      0,    -60}, 0, ST_B(     0,      0), {0x00, 0x81, 0x00, 0xff}}},
    {{{   -16,      0,     60}, 0, ST_B(    32,     64), {0x00, 0x81, 0x00, 0xff}}},
    {{{   -16,      0,    -60}, 0, ST_B(     0,     64), {0x00, 0x81, 0x00, 0xff}}},
    {{{   600,      0,     60}, 0, ST_B(    32,      0), {0x00, 0x81, 0x00, 0xff}}},
    {{{   600,      0,     60}, 0, ST_B(     0,      0), {0x7f, 0x00, 0x00, 0xff}}},
    {{{   600,      0,    -60}, 0, ST_B(    32,      0), {0x7f, 0x00, 0x00, 0xff}}},
    {{{   600,   1024,    -60}, 0, ST_B(    32,     64), {0x7f, 0x00, 0x00, 0xff}}},
    {{{   600,   1024,     60}, 0, ST_B(     0,     64), {0x7f, 0x00, 0x00, 0xff}}},
    {{{   -16,   1024,    -60}, 0, ST_B(     0,     64), {0x81, 0x00, 0x00, 0xff}}},
};

// 0x03013A10
static const Vtx door_seg3_vertex_03013A10[] = {
    {{{   600,      0,    -60}, 0, ST_B(    32,     56), {0x00, 0x00, 0x81, 0xff}}},
    {{{   -16,      0,    -60}, 0, ST_B(     0,     56), {0x00, 0x00, 0x81, 0xff}}},
    {{{   -16,   1024,    -60}, 0, ST_B(     0,      5), {0x00, 0x00, 0x81, 0xff}}},
    {{{   600,   1024,    -60}, 0, ST_B(    32,      5), {0x00, 0x00, 0x81, 0xff}}},
    {{{   -16,      0,     60}, 0, ST_B(     0,     56), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   600,      0,     60}, 0, ST_B(    32,     56), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   600,   1024,     60}, 0, ST_B(    32,      5), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   -16,   1024,     60}, 0, ST_B(     0,      5), {0x00, 0x00, 0x7f, 0xff}}},
};

// 0x03013A90
static const Vtx door_seg3_vertex_03013A90[] = {
    {{{   512,    512,    102}, 0, ST_B(     0,      0), {0xff, 0x7e, 0x01, 0xff}}},
    {{{   456,    432,    160}, 0, ST_B(     0,      0), {0xa6, 0x1f, 0x53, 0xff}}},
    {{{   512,    488,    160}, 0, ST_B(     0,      0), {0x16, 0x49, 0x65, 0xff}}},
    {{{   512,    372,    160}, 0, ST_B(     0,      0), {0xe7, 0xba, 0x66, 0xff}}},
    {{{   572,    432,    160}, 0, ST_B(     0,      0), {0x5a, 0xe3, 0x53, 0xff}}},
    {{{   596,    432,    102}, 0, ST_B(     0,      0), {0x7e, 0x01, 0x01, 0xff}}},
    {{{   512,    348,    102}, 0, ST_B(     0,      0), {0xff, 0x82, 0x01, 0xff}}},
    {{{   432,    432,    102}, 0, ST_B(     0,      0), {0x82, 0x01, 0x01, 0xff}}},
    {{{   512,    488,     44}, 0, ST_B(     0,      0), {0xda, 0x70, 0xd4, 0xff}}},
    {{{   456,    432,     44}, 0, ST_B(     0,      0), {0x8f, 0xde, 0xd4, 0xff}}},
    {{{   512,    372,     44}, 0, ST_B(     0,      0), {0x24, 0x90, 0xd3, 0xff}}},
    {{{   572,    432,     44}, 0, ST_B(     0,      0), {0x6f, 0x28, 0xd3, 0xff}}},
};

// 0x03013B50
static const Vtx door_seg3_vertex_03013B50[] = {
    {{{   512,    488,   -156}, 0, ST_B(     0,      0), {0xe8, 0x48, 0x9b, 0xff}}},
    {{{   512,    372,   -156}, 0, ST_B(     0,      0), {0x17, 0xb9, 0x9a, 0xff}}},
    {{{   456,    432,   -156}, 0, ST_B(     0,      0), {0xa5, 0xe4, 0xae, 0xff}}},
    {{{   432,    432,   -102}, 0, ST_B(     0,      0), {0x82, 0x01, 0xff, 0xff}}},
    {{{   512,    512,   -102}, 0, ST_B(     0,      0), {0xff, 0x7e, 0xff, 0xff}}},
    {{{   572,    432,   -156}, 0, ST_B(     0,      0), {0x59, 0x20, 0xac, 0xff}}},
    {{{   512,    348,   -102}, 0, ST_B(     0,      0), {0xff, 0x82, 0xff, 0xff}}},
    {{{   596,    432,   -102}, 0, ST_B(     0,      0), {0x7e, 0x01, 0xff, 0xff}}},
    {{{   572,    432,    -40}, 0, ST_B(     0,      0), {0x70, 0xdc, 0x2d, 0xff}}},
    {{{   512,    372,    -40}, 0, ST_B(     0,      0), {0xd8, 0x91, 0x2d, 0xff}}},
    {{{   456,    432,    -40}, 0, ST_B(     0,      0), {0x90, 0x26, 0x2c, 0xff}}},
    {{{   512,    488,    -40}, 0, ST_B(     0,      0), {0x22, 0x71, 0x2c, 0xff}}},
};
...
static const Vtx door_seg3_vertex_03013FA0[] = {
    {{{   496,    468,   -154}, 0, ST_B(     0,      0), {0x00, 0x00, 0x81, 0xff}}},
    {{{   544,    416,   -154}, 0, ST_B(     0,      0), {0x00, 0x00, 0x81, 0xff}}},
    {{{   496,    357,   -154}, 0, ST_B(     0,      0), {0x00, 0x00, 0x81, 0xff}}},
    {{{   437,    416,   -154}, 0, ST_B(     0,      0), {0x00, 0x00, 0x81, 0xff}}},
    {{{   496,    468,    154}, 0, ST_B(     0,      0), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   496,    357,    154}, 0, ST_B(     0,      0), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   544,    416,    154}, 0, ST_B(     0,      0), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   437,    416,    154}, 0, ST_B(     0,      0), {0x00, 0x00, 0x7f, 0xff}}},
};
...
static const Vtx door_seg3_vertex_03014140[] = {
    {{{   441,    850,     64}, 0, ST_B(    32,      0), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   144,    850,     64}, 0, ST_B(     0,      0), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   144,    550,     64}, 0, ST_B(     0,     32), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   441,    550,     64}, 0, ST_B(    32,     32), {0x00, 0x00, 0x7f, 0xff}}},
};

// 0x03014180
static const Vtx door_seg3_vertex_03014180[] = {
    {{{   441,    850,     60}, 0, ST_B(    32,      0), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   144,    850,     60}, 0, ST_B(     0,      0), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   144,    550,     60}, 0, ST_B(     0,     32), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   441,    550,     60}, 0, ST_B(    32,     32), {0x00, 0x00, 0x7f, 0xff}}},
};
...
static const Vtx door_seg3_vertex_03014370[] = {
    {{{   600,    912,     60}, 0, ST_B(    16,      0), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   410,    544,     60}, 0, ST_B(     0,     32), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   600,    544,     60}, 0, ST_B(    16,     32), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   410,    912,     60}, 0, ST_B(     0,      0), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   600,    544,    -60}, 0, ST_B(    16,     32), {0x00, 0x00, 0x81, 0xff}}},
    {{{   410,    544,    -60}, 0, ST_B(     0,     32), {0x00, 0x00, 0x81, 0xff}}},
    {{{   410,    912,    -60}, 0, ST_B(     0,      0), {0x00, 0x00, 0x81, 0xff}}},
    {{{   600,    912,    -60}, 0, ST_B(    16,      0), {0x00, 0x00, 0x81, 0xff}}},
};

// 0x030143F0 - lock
static const Vtx door_seg3_vertex_030143F0[] = {
    {{{   600,    912,     64}, 0, ST_B(    16,      0), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   410,    544,     64}, 0, ST_B(     0,     32), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   600,    544,     64}, 0, ST_B(    16,     32), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   410,    912,     64}, 0, ST_B(     0,      0), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   600,    544,    -64}, 0, ST_B(    16,     32), {0x00, 0x00, 0x81, 0xff}}},
    {{{   410,    544,    -64}, 0, ST_B(     0,     32), {0x00, 0x00, 0x81, 0xff}}},
    {{{   410,    912,    -64}, 0, ST_B(     0,      0), {0x00, 0x00, 0x81, 0xff}}},
    {{{   600,    912,    -64}, 0, ST_B(    16,      0), {0x00, 0x00, 0x81, 0xff}}},
};
...
static const Vtx door_seg3_vertex_03014558[] = {
    {{{   -16,   1024,    -60}, 0, ST_B(     0,      4), {0x81, 0x00, 0x00, 0xff}}},
    {{{   -16,      0,    -60}, 0, ST_B(     0,     30), {0x81, 0x00, 0x00, 0xff}}},
    {{{   -16,      0,     60}, 0, ST_B(    32,     30), {0x81, 0x00, 0x00, 0xff}}},
    {{{   -16,      0,    -60}, 0, ST_B(    32,      4), {0x00, 0x81, 0x00, 0xff}}},
    {{{   600,      0,    -60}, 0, ST_B(    32,     28), {0x00, 0x81, 0x00, 0xff}}},
    {{{   600,      0,     60}, 0, ST_B(     0,     28), {0x00, 0x81, 0x00, 0xff}}},
    {{{   -16,      0,     60}, 0, ST_B(     0,      4), {0x00, 0x81, 0x00, 0xff}}},
    {{{   -16,   1024,     60}, 0, ST_B(     0,      4), {0x00, 0x7f, 0x00, 0xff}}},
    {{{   600,   1024,    -60}, 0, ST_B(    32,     28), {0x00, 0x7f, 0x00, 0xff}}},
    {{{   -16,   1024,    -60}, 0, ST_B(    32,      4), {0x00, 0x7f, 0x00, 0xff}}},
    {{{   600,   1024,     60}, 0, ST_B(     0,     28), {0x00, 0x7f, 0x00, 0xff}}},
    {{{   600,   1024,     60}, 0, ST_B(    32,      4), {0x7f, 0x00, 0x00, 0xff}}},
    {{{   600,      0,     60}, 0, ST_B(    32,     30), {0x7f, 0x00, 0x00, 0xff}}},
    {{{   600,      0,    -60}, 0, ST_B(     0,     30), {0x7f, 0x00, 0x00, 0xff}}},
    {{{   600,   1024,    -60}, 0, ST_B(     0,      4), {0x7f, 0x00, 0x00, 0xff}}},
    {{{   -16,   1024,     60}, 0, ST_B(    32,      4), {0x81, 0x00, 0x00, 0xff}}},
};

// 0x03014658
static const Vtx door_seg3_vertex_03014658[] = {
    {{{   -16,      0,     60}, 0, ST_B(    32,     64), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   600,   1024,     60}, 0, ST_B(     0,      0), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   -16,   1024,     60}, 0, ST_B(    32,      0), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   600,      0,     60}, 0, ST_B(     0,     64), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   600,      0,    -60}, 0, ST_B(     0,     64), {0x00, 0x00, 0x81, 0xff}}},
    {{{   -16,      0,    -60}, 0, ST_B(    32,     64), {0x00, 0x00, 0x81, 0xff}}},
    {{{   -16,   1024,    -60}, 0, ST_B(    32,      0), {0x00, 0x00, 0x81, 0xff}}},
    {{{   600,   1024,    -60}, 0, ST_B(     0,      0), {0x00, 0x00, 0x81, 0xff}}},
};

// 0x030146D8
static const Vtx door_seg3_vertex_030146D8[] = {
    {{{   496,    468,   -154}, 0, ST_B(     0,      0), {0xe8, 0x47, 0x9a, 0xff}}},
    {{{   416,    416,    -99}, 0, ST_B(     0,      0), {0x82, 0x00, 0x00, 0xff}}},
    {{{   496,    496,    -99}, 0, ST_B(     0,      0), {0x00, 0x7e, 0x00, 0xff}}},
    {{{   496,    468,    154}, 0, ST_B(     0,      0), {0x18, 0x47, 0x66, 0xff}}},
    {{{   496,    357,    154}, 0, ST_B(     0,      0), {0xe9, 0xb8, 0x65, 0xff}}},
    {{{   544,    416,    154}, 0, ST_B(     0,      0), {0x5b, 0xe2, 0x53, 0xff}}},
    {{{   437,    416,    154}, 0, ST_B(     0,      0), {0xa5, 0x1d, 0x53, 0xff}}},
    {{{   496,    496,     99}, 0, ST_B(     0,      0), {0x00, 0x7e, 0x00, 0xff}}},
    {{{   569,    416,     99}, 0, ST_B(     0,      0), {0x7e, 0x00, 0x00, 0xff}}},
    {{{   496,    334,     99}, 0, ST_B(     0,      0), {0x00, 0x82, 0x00, 0xff}}},
    {{{   416,    416,     99}, 0, ST_B(     0,      0), {0x82, 0x00, 0x00, 0xff}}},
    {{{   496,    468,     44}, 0, ST_B(     0,      0), {0xdb, 0x6f, 0xd1, 0xff}}},
    {{{   437,    416,     44}, 0, ST_B(     0,      0), {0x91, 0xdb, 0xd2, 0xff}}},
    {{{   496,    357,     44}, 0, ST_B(     0,      0), {0x26, 0x91, 0xd2, 0xff}}},
    {{{   544,    416,     44}, 0, ST_B(     0,      0), {0x70, 0x24, 0xd2, 0xff}}},
};

// 0x030147C8
static const Vtx door_seg3_vertex_030147C8[] = {
    {{{   496,    496,    -99}, 0, ST_B(     0,      0), {0x00, 0x7e, 0x00, 0xff}}},
    {{{   437,    416,    -44}, 0, ST_B(     0,      0), {0x90, 0x24, 0x2e, 0xff}}},
    {{{   496,    468,    -44}, 0, ST_B(     0,      0), {0x26, 0x6f, 0x2f, 0xff}}},
    {{{   496,    468,   -154}, 0, ST_B(     0,      0), {0xe8, 0x47, 0x9a, 0xff}}},
    {{{   544,    416,   -154}, 0, ST_B(     0,      0), {0x5b, 0x1d, 0xae, 0xff}}},
    {{{   496,    357,   -154}, 0, ST_B(     0,      0), {0x18, 0xb9, 0x9b, 0xff}}},
    {{{   437,    416,   -154}, 0, ST_B(     0,      0), {0xa6, 0xe2, 0xad, 0xff}}},
    {{{   416,    416,    -99}, 0, ST_B(     0,      0), {0x82, 0x00, 0x00, 0xff}}},
    {{{   569,    416,    -99}, 0, ST_B(     0,      0), {0x7e, 0x00, 0x00, 0xff}}},
    {{{   496,    334,    -99}, 0, ST_B(     0,      0), {0x00, 0x82, 0x00, 0xff}}},
    {{{   496,    357,    -44}, 0, ST_B(     0,      0), {0xdb, 0x90, 0x2e, 0xff}}},
    {{{   544,    416,    -44}, 0, ST_B(     0,      0), {0x70, 0xdb, 0x2e, 0xff}}},
};
