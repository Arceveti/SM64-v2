...
static const Vtx door_seg3_vertex_03013910[] = {
    ...
    {{{   -16,      0,     60}, 0, { 31<<5,      0}, {0x81, 0x00, 0x00, 0xff}}},
    {{{   -16,   1024,     60}, 0, { 31<<5,  63<<5}, {0x81, 0x00, 0x00, 0xff}}},
    {{{   -16,   1024,    -60}, 0, { 31<<5,  63<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   -16,   1024,     60}, 0, {     0,  63<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   600,   1024,     60}, 0, {     0,      0}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   600,   1024,    -60}, 0, { 31<<5,      0}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   600,      0,    -60}, 0, {     0,      0}, {0x00, 0x81, 0x00, 0xff}}},
    {{{   -16,      0,     60}, 0, { 31<<5,  63<<5}, {0x00, 0x81, 0x00, 0xff}}},
    {{{   -16,      0,    -60}, 0, {     0,  63<<5}, {0x00, 0x81, 0x00, 0xff}}},
    {{{   600,      0,     60}, 0, { 31<<5,      0}, {0x00, 0x81, 0x00, 0xff}}},
    {{{   600,      0,     60}, 0, {     0,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   600,      0,    -60}, 0, { 31<<5,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   600,   1024,    -60}, 0, { 31<<5,  63<<5}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   600,   1024,     60}, 0, {     0,  63<<5}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   -16,   1024,    -60}, 0, {     0,  63<<5}, {0x81, 0x00, 0x00, 0xff}}},
};
