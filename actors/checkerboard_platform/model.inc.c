...
static const Vtx checkerboard_platform_seg8_vertex_sides[] = {
    {{{  -256,    -26,    154}, 0, ST_B(    48,     16), {0x81, 0x00, 0x00, 0xff}}},
    {{{  -256,     26,    154}, 0, ST_B(    48,      0), {0x81, 0x00, 0x00, 0xff}}},
    {{{  -256,     26,   -154}, 0, ST_B(     0,      0), {0x81, 0x00, 0x00, 0xff}}},
    {{{  -256,    -26,   -154}, 0, ST_B(     0,     16), {0x81, 0x00, 0x00, 0xff}}},
    {{{   256,    -26,   -154}, 0, ST_B(    48,     16), {0x7f, 0x00, 0x00, 0xff}}},
    {{{   256,     26,    154}, 0, ST_B(     0,      0), {0x7f, 0x00, 0x00, 0xff}}},
    {{{   256,    -26,    154}, 0, ST_B(     0,     16), {0x7f, 0x00, 0x00, 0xff}}},
    {{{   256,     26,   -154}, 0, ST_B(    48,      0), {0x7f, 0x00, 0x00, 0xff}}},
};

// 0x0800D4C0
static const Vtx checkerboard_platform_seg8_vertex_surface[] = {
    {{{   256,    -26,    154}, 0, ST_B(    80,     32), {0x00, 0x81, 0x00, 0xff}}},
    {{{  -256,    -26,   -154}, 0, ST_B(     0,    -16), {0x00, 0x81, 0x00, 0xff}}},
    {{{   256,    -26,   -154}, 0, ST_B(    80,    -16), {0x00, 0x81, 0x00, 0xff}}},
    {{{   256,     26,   -154}, 0, ST_B(    80,    -16), {0x00, 0x7f, 0x00, 0xff}}},
    {{{  -256,     26,    154}, 0, ST_B(     0,     32), {0x00, 0x7f, 0x00, 0xff}}},
    {{{   256,     26,    154}, 0, ST_B(    80,     32), {0x00, 0x7f, 0x00, 0xff}}},
    {{{  -256,     26,   -154}, 0, ST_B(     0,    -16), {0x00, 0x7f, 0x00, 0xff}}},
    {{{  -256,    -26,   -154}, 0, ST_B(    80,     16), {0x00, 0x00, 0x81, 0xff}}},
    {{{  -256,     26,   -154}, 0, ST_B(    80,      0), {0x00, 0x00, 0x81, 0xff}}},
    {{{   256,     26,   -154}, 0, ST_B(     0,      0), {0x00, 0x00, 0x81, 0xff}}},
    {{{   256,    -26,   -154}, 0, ST_B(     0,     16), {0x00, 0x00, 0x81, 0xff}}},
    {{{   256,    -26,    154}, 0, ST_B(    80,     16), {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -256,     26,    154}, 0, ST_B(     0,      0), {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -256,    -26,    154}, 0, ST_B(     0,     16), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   256,     26,    154}, 0, ST_B(    80,      0), {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -256,    -26,    154}, 0, ST_B(     0,     32), {0x00, 0x81, 0x00, 0xff}}},
};
