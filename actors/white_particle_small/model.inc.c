...
static const Vtx white_particle_small_vertex[] = {
    {{{    -4,      0,      0}, 0, {     0,  30<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{     4,      0,      0}, 0, { 30<<5,  30<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{     4,      8,      0}, 0, { 30<<5,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{    -4,      8,      0}, 0, {     0,      0}, {0xff, 0xff, 0xff, 0xff}}},
};

// 0x04032740
static const Vtx white_particle_small_unused_vertex[] = {
    {{{    -4,      0,      0}, 0, {     0,  30<<5}, {0xff, 0x00, 0x00, 0xff}}},
    {{{     4,      0,      0}, 0, { 30<<5,  30<<5}, {0xff, 0x00, 0x00, 0xff}}},
    {{{     4,      8,      0}, 0, { 30<<5,      0}, {0xff, 0x00, 0x00, 0xff}}},
