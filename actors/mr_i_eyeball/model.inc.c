...
static const Vtx mr_i_eyeball_seg6_vertex_06000000[] = {
    {{{  -100,      0,      0}, 0, {     0,  63<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{     0,      0,      0}, 0, { 31<<5,  63<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{     0,    200,      0}, 0, { 31<<5,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -100,    200,      0}, 0, {     0,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{     0,      0,      0}, 0, {     0,  63<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   100,      0,      0}, 0, { 31<<5,  63<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   100,    200,      0}, 0, { 31<<5,      0}, {0xff, 0xff, 0xff, 0xff}}},
