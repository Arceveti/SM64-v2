...
static const Vtx skeeter_seg6_vertex_06000990[] = {
    {{{   -45,     45,      0}, 0, ST_B(     0,      0), {0x00, 0xff, 0xd4, 0xff}}},
    {{{   -45,    -45,      0}, 0, ST_B(     0,     32), {0x00, 0xff, 0xd4, 0xff}}},
    {{{    45,    -45,      0}, 0, ST_B(    32,     32), {0x00, 0xff, 0xd4, 0xff}}},
    {{{    45,     45,      0}, 0, ST_B(    32,      0), {0x00, 0xff, 0xd4, 0xff}}},
};
...
static const Vtx skeeter_seg6_vertex_06000A78[] = {
    {{{   -16,     16,      0}, 0, ST_B(     0,      0), {0xff, 0x55, 0x00, 0xff}}},
    {{{   -16,    -16,      0}, 0, ST_B(     0,     32), {0xff, 0x55, 0x00, 0xff}}},
    {{{    16,    -16,      0}, 0, ST_B(    32,     32), {0xff, 0x55, 0x00, 0xff}}},
    {{{    16,     16,      0}, 0, ST_B(    32,      0), {0xff, 0x55, 0x00, 0xff}}},
};
...
static const Vtx skeeter_seg6_vertex_06000B60[] = {
    {{{   -18,     18,      0}, 0, ST_B(     0,      0), {0xff, 0xff, 0xff, 0xff}}},
    {{{   -18,    -18,      0}, 0, ST_B(     0,     32), {0xff, 0xff, 0xff, 0xff}}},
    {{{    18,    -18,      0}, 0, ST_B(    32,     32), {0xff, 0xff, 0xff, 0xff}}},
    {{{    18,     18,      0}, 0, ST_B(    32,      0), {0xff, 0xff, 0xff, 0xff}}},
};
