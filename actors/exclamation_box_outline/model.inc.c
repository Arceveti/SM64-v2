...
static const Vtx exclamation_box_outline_seg8_vertex_outline_0[] = {
    {{{   -26,     51,     26}, 0, { 31<<5,  31<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{    26,     51,     26}, 0, { 31<<5,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{    26,     51,    -26}, 0, {     0,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   -26,     51,    -26}, 0, {     0,  31<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{    26,      0,     26}, 0, { 31<<5,  31<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   -26,     51,     26}, 0, {     0,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   -26,      0,     26}, 0, {     0,  31<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{    26,      0,    -26}, 0, { 31<<5,  31<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{    26,     51,    -26}, 0, { 31<<5,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{    26,     51,     26}, 0, {     0,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{    26,      0,     26}, 0, {     0,  31<<5}, {0xff, 0xff, 0xff, 0xff}}},
...
static const Vtx exclamation_box_outline_seg8_vertex_outline_1[] = {
    ...
    {{{   -26,      0,     26}, 0, {     0,  31<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   -26,      0,    -26}, 0, { 31<<5,  31<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{    26,      0,    -26}, 0, { 31<<5,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{    26,      0,     26}, 0, {     0,      0}, {0xff, 0xff, 0xff, 0xff}}},
};
