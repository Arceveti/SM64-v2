...
// 0x08024D18
static const Vtx exclamation_box_outline_seg8_vertex_shade[] = {
    {{{    26,      0,    -26}, 0, ST_B(     0,      0), {0x7f, 0x00, 0x00, 0x50}}},
    {{{    26,     51,     26}, 0, ST_B(     0,      0), {0x7f, 0x00, 0x00, 0x50}}},
    {{{    26,      0,     26}, 0, ST_B(     0,      0), {0x7f, 0x00, 0x00, 0x50}}},
    {{{    26,      0,     26}, 0, ST_B(     0,      0), {0x00, 0x81, 0x00, 0x50}}},
    {{{   -26,      0,     26}, 0, ST_B(     0,      0), {0x00, 0x81, 0x00, 0x50}}},
    {{{   -26,      0,    -26}, 0, ST_B(     0,      0), {0x00, 0x81, 0x00, 0x50}}},
    {{{    26,      0,    -26}, 0, ST_B(     0,      0), {0x00, 0x81, 0x00, 0x50}}},
    {{{    26,      0,     26}, 0, ST_B(     0,      0), {0x00, 0x00, 0x7f, 0x50}}},
    {{{    26,     51,     26}, 0, ST_B(     0,      0), {0x00, 0x00, 0x7f, 0x50}}},
    {{{   -26,     51,     26}, 0, ST_B(     0,      0), {0x00, 0x00, 0x7f, 0x50}}},
    {{{   -26,      0,     26}, 0, ST_B(     0,      0), {0x00, 0x00, 0x7f, 0x50}}},
    {{{   -26,      0,     26}, 0, ST_B(     0,      0), {0x81, 0x00, 0x00, 0x50}}},
    {{{   -26,     51,     26}, 0, ST_B(     0,      0), {0x81, 0x00, 0x00, 0x50}}},
    {{{   -26,     51,    -26}, 0, ST_B(     0,      0), {0x81, 0x00, 0x00, 0x50}}},
    {{{   -26,      0,    -26}, 0, ST_B(     0,      0), {0x81, 0x00, 0x00, 0x50}}},
    {{{   -26,      0,    -26}, 0, ST_B(     0,      0), {0x00, 0x00, 0x81, 0x50}}},
    {{{   -26,     51,    -26}, 0, ST_B(     0,      0), {0x00, 0x00, 0x81, 0x50}}},
    {{{    26,     51,    -26}, 0, ST_B(     0,      0), {0x00, 0x00, 0x81, 0x50}}},
    {{{    26,      0,    -26}, 0, ST_B(     0,      0), {0x00, 0x00, 0x81, 0x50}}},
    {{{    26,      0,    -26}, 0, ST_B(     0,      0), {0x7f, 0x00, 0x00, 0x50}}},
    {{{    26,     51,    -26}, 0, ST_B(     0,      0), {0x7f, 0x00, 0x00, 0x50}}},
    {{{    26,     51,     26}, 0, ST_B(     0,      0), {0x7f, 0x00, 0x00, 0x50}}},
    {{{   -26,     51,     26}, 0, ST_B(     0,      0), {0x00, 0x7f, 0x00, 0x50}}},
    {{{    26,     51,     26}, 0, ST_B(     0,      0), {0x00, 0x7f, 0x00, 0x50}}},
    {{{    26,     51,    -26}, 0, ST_B(     0,      0), {0x00, 0x7f, 0x00, 0x50}}},
    {{{   -26,     51,    -26}, 0, ST_B(     0,      0), {0x00, 0x7f, 0x00, 0x50}}},
};
...
const Gfx exclamation_box_outline_seg8_sub_dl_shade[] = {
    gsSPVertex(exclamation_box_outline_seg8_vertex_shade, 26, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSP2Triangles( 3,  5,  6, 0x0,  7,  8,  9, 0x0),
    gsSP2Triangles( 7,  9, 10, 0x0, 11, 12, 13, 0x0),
    gsSP2Triangles(11, 13, 14, 0x0, 15, 16, 17, 0x0),
    gsSP2Triangles(15, 17, 18, 0x0, 19, 20, 21, 0x0),
...
// 0x08025008
static const Vtx exclamation_box_outline_seg8_vertex_outline[] = {
...
const Gfx exclamation_box_outline_seg8_sub_dl_outline[] = {
    ...
    gsSPVertex(exclamation_box_outline_seg8_vertex_outline, 22, 0),
...
static const Vtx exclamation_box_outline_seg8_vertex_exclamation_point[] = {
    {{{   -22,     48,      0}, 0, ST_B(    -6,      0), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   -22,      4,      0}, 0, ST_B(    -6,     32), {0x00, 0x00, 0x7f, 0xff}}},
    {{{    23,      4,      0}, 0, ST_B(    20,     32), {0x00, 0x00, 0x7f, 0xff}}},
    {{{    23,     48,      0}, 0, ST_B(    20,      0), {0x00, 0x00, 0x7f, 0xff}}},
};
