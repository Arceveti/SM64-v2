...
static const Vtx eyerok_seg5_vertex_0500B558[] = {
    {{{   350,    200,   -200}, 0, {     0,    -16}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   350,      0,   -200}, 0, {     0,  31<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{     0,      0,   -200}, 0, { 53<<5,  31<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   350,      0,      0}, 0, {     0,  31<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   350,    200,      0}, 0, {     0,    -16}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{     0,    200,      0}, 0, { 53<<5,    -16}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{     0,      0,      0}, 0, { 53<<5,  31<<5}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   350,    200,   -200}, 0, {     0,    -16}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   350,      0,      0}, 0, { 31<<5,  31<<5}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   350,      0,   -200}, 0, { 31<<5,    -16}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   350,    200,      0}, 0, {     0,  31<<5}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   350,    200,   -200}, 0, {     0,    -16}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{     0,    200,   -200}, 0, { 53<<5,    -16}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   350,    200,      0}, 0, {     0,  31<<5}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{     0,    200,      0}, 0, { 53<<5,  31<<5}, {0x00, 0x7f, 0x00, 0xff}}},
};

// 0x0500B648
static const Vtx eyerok_seg5_vertex_0500B648[] = {
    {{{   350,      0,   -200}, 0, {     0,    -16}, {0x00, 0x81, 0x00, 0xff}}},
    {{{   350,      0,      0}, 0, {     0,  31<<5}, {0x00, 0x81, 0x00, 0xff}}},
    {{{     0,      0,      0}, 0, { 53<<5,  31<<5}, {0x00, 0x81, 0x00, 0xff}}},
    {{{     0,    200,   -200}, 0, { 53<<5,    -16}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   350,    200,   -200}, 0, {     0,    -16}, {0x00, 0x00, 0x81, 0xff}}},
    {{{     0,      0,   -200}, 0, { 53<<5,  31<<5}, {0x00, 0x00, 0x81, 0xff}}},
    {{{     0,      0,   -200}, 0, { 53<<5,    -16}, {0x00, 0x81, 0x00, 0xff}}},
};
...
static const Vtx eyerok_seg5_vertex_eye[] = {
    {{{   212,    365,     64}, 0, { 31<<5,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   212,    365,   -256}, 0, {     0,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   -73,    192,   -256}, 0, {     0,  31<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   -73,    192,     64}, 0, { 31<<5,  31<<5}, {0xff, 0xff, 0xff, 0xff}}},
};
