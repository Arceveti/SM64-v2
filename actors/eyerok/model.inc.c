...
static const Vtx eyerok_seg5_vertex_0500BA48[] = {
    {{{  -200,    200,   -100}, 0, ST_B(   -32,    -16), {0x81, 0x00, 0x00, 0xff}}},
    {{{  -200,   -200,   -100}, 0, ST_B(    32,    -16), {0x81, 0x00, 0x00, 0xff}}},
    {{{  -200,    200,    200}, 0, ST_B(   -32,     32), {0x81, 0x00, 0x00, 0xff}}},
    {{{  -200,   -200,   -100}, 0, ST_B(   180,     32), {0x00, 0x00, 0x81, 0xff}}},
    {{{  -200,    200,   -100}, 0, ST_B(   180,    -32), {0x00, 0x00, 0x81, 0xff}}},
    {{{   200,   -200,   -100}, 0, ST_B(   117,     32), {0x00, 0x00, 0x81, 0xff}}},
    {{{   200,    200,   -100}, 0, ST_B(   117,    -32), {0x00, 0x00, 0x81, 0xff}}},
    {{{   200,   -200,    200}, 0, ST_B(   117,     32), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   200,    200,    200}, 0, ST_B(   117,    -32), {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -200,   -200,    200}, 0, ST_B(   180,     32), {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -200,    200,    200}, 0, ST_B(   180,    -32), {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -200,   -200,   -100}, 0, ST_B(   180,    -16), {0x00, 0x81, 0x00, 0xff}}},
    {{{   200,   -200,   -100}, 0, ST_B(   117,    -16), {0x00, 0x81, 0x00, 0xff}}},
    {{{  -200,   -200,    200}, 0, ST_B(   180,     32), {0x00, 0x81, 0x00, 0xff}}},
    {{{   200,   -200,    200}, 0, ST_B(   117,     32), {0x00, 0x81, 0x00, 0xff}}},
};

// 0x0500BB38
static const Vtx eyerok_seg5_vertex_0500BB38[] = {
    {{{   200,    200,   -100}, 0, ST_B(     0,    -16), {0x7f, 0x00, 0x00, 0xff}}},
    {{{   200,    200,    200}, 0, ST_B(     0,     32), {0x7f, 0x00, 0x00, 0xff}}},
    {{{   200,   -200,    200}, 0, ST_B(    64,     32), {0x7f, 0x00, 0x00, 0xff}}},
    {{{  -200,   -200,   -100}, 0, ST_B(    32,    -16), {0x81, 0x00, 0x00, 0xff}}},
    {{{  -200,   -200,    200}, 0, ST_B(    32,     32), {0x81, 0x00, 0x00, 0xff}}},
    {{{  -200,    200,    200}, 0, ST_B(   -32,     32), {0x81, 0x00, 0x00, 0xff}}},
    {{{   200,    200,   -100}, 0, ST_B(   117,    -16), {0x00, 0x7f, 0x00, 0xff}}},
    {{{  -200,    200,   -100}, 0, ST_B(   180,    -16), {0x00, 0x7f, 0x00, 0xff}}},
    {{{   200,    200,    200}, 0, ST_B(   117,     32), {0x00, 0x7f, 0x00, 0xff}}},
    {{{  -200,    200,    200}, 0, ST_B(   180,     32), {0x00, 0x7f, 0x00, 0xff}}},
    {{{   200,   -200,   -100}, 0, ST_B(    64,    -16), {0x7f, 0x00, 0x00, 0xff}}},
};
...
static const Vtx eyerok_seg5_vertex_0500BF88[] = {
    {{{     0,      0,    100}, 0, ST_B(     0,    -32), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   400,      0,    100}, 0, ST_B(     0,     32), {0x00, 0x00, 0x7f, 0xff}}},
    {{{     0,    200,    100}, 0, ST_B(    32,    -32), {0x00, 0x00, 0x7f, 0xff}}},
    {{{     0,      0,   -100}, 0, ST_B(     0,    -32), {0x00, 0x81, 0x00, 0xff}}},
    {{{   400,      0,   -100}, 0, ST_B(     0,     32), {0x00, 0x81, 0x00, 0xff}}},
    {{{     0,      0,    100}, 0, ST_B(    32,    -32), {0x00, 0x81, 0x00, 0xff}}},
    {{{   400,      0,    100}, 0, ST_B(    32,     32), {0x00, 0x81, 0x00, 0xff}}},
    {{{     0,    200,    100}, 0, ST_B(    32,    -32), {0x00, 0x7f, 0x00, 0xff}}},
    {{{   400,    200,    100}, 0, ST_B(    32,     32), {0x00, 0x7f, 0x00, 0xff}}},
    {{{     0,    200,   -100}, 0, ST_B(     0,    -32), {0x00, 0x7f, 0x00, 0xff}}},
    {{{   400,    200,   -100}, 0, ST_B(     0,     32), {0x00, 0x7f, 0x00, 0xff}}},
    {{{   400,      0,   -100}, 0, ST_B(     0,     32), {0x00, 0x00, 0x81, 0xff}}},
    {{{     0,      0,   -100}, 0, ST_B(     0,    -32), {0x00, 0x00, 0x81, 0xff}}},
    {{{   400,    200,   -100}, 0, ST_B(    32,     32), {0x00, 0x00, 0x81, 0xff}}},
    {{{     0,    200,   -100}, 0, ST_B(    32,    -32), {0x00, 0x00, 0x81, 0xff}}},
    {{{   400,    200,    100}, 0, ST_B(    32,     32), {0x00, 0x00, 0x7f, 0xff}}},
};
...
static const Vtx eyerok_seg5_vertex_0500C188[] = {
    {{{   400,      0,   -100}, 0, ST_B(    32,      0), {0x00, 0x81, 0x00, 0xff}}},
    {{{   400,      0,    100}, 0, ST_B(    32,     32), {0x00, 0x81, 0x00, 0xff}}},
    {{{     0,      0,    100}, 0, ST_B(   -32,     32), {0x00, 0x81, 0x00, 0xff}}},
    {{{     0,    200,    100}, 0, ST_B(   -32,     32), {0x00, 0x7f, 0x00, 0xff}}},
    {{{   400,    200,    100}, 0, ST_B(    32,     32), {0x00, 0x7f, 0x00, 0xff}}},
    {{{     0,    200,   -100}, 0, ST_B(   -32,      0), {0x00, 0x7f, 0x00, 0xff}}},
    {{{   400,    200,   -100}, 0, ST_B(    32,      0), {0x00, 0x7f, 0x00, 0xff}}},
    {{{     0,      0,   -100}, 0, ST_B(    32,      0), {0x81, 0x00, 0x00, 0xff}}},
    {{{     0,      0,    100}, 0, ST_B(     0,      0), {0x81, 0x00, 0x00, 0xff}}},
    {{{     0,    200,   -100}, 0, ST_B(    32,    -32), {0x81, 0x00, 0x00, 0xff}}},
    {{{     0,    200,    100}, 0, ST_B(     0,    -32), {0x81, 0x00, 0x00, 0xff}}},
    {{{   400,      0,   -100}, 0, ST_B(    32,      0), {0x00, 0x00, 0x81, 0xff}}},
    {{{     0,      0,   -100}, 0, ST_B(   -32,      0), {0x00, 0x00, 0x81, 0xff}}},
    {{{   400,    200,   -100}, 0, ST_B(    32,     32), {0x00, 0x00, 0x81, 0xff}}},
    {{{     0,    200,   -100}, 0, ST_B(   -32,     32), {0x00, 0x00, 0x81, 0xff}}},
};
...
static const Vtx eyerok_seg5_vertex_0500C278[] = {
    {{{   400,      0,    100}, 0, ST_B(     0,      0), {0x00, 0x00, 0x7f, 0xff}}},
    {{{   400,    200,    100}, 0, ST_B(     0,     32), {0x00, 0x00, 0x7f, 0xff}}},
    {{{     0,    200,    100}, 0, ST_B(    64,     32), {0x00, 0x00, 0x7f, 0xff}}},
    {{{     0,      0,   -100}, 0, ST_B(   -32,      0), {0x00, 0x81, 0x00, 0xff}}},
    {{{   400,      0,   -100}, 0, ST_B(    32,      0), {0x00, 0x81, 0x00, 0xff}}},
    {{{     0,      0,    100}, 0, ST_B(   -32,     32), {0x00, 0x81, 0x00, 0xff}}},
    {{{     0,      0,    100}, 0, ST_B(    64,      0), {0x00, 0x00, 0x7f, 0xff}}},
};
