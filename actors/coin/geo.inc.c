...
const GeoLayout yellow_coin_geo[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         GEO_SWITCH_CASE(8, geo_switch_anim_state),
         GEO_OPEN_NODE(),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_yellow_front),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_yellow_front),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_yellow_tilt_right),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_yellow_tilt_right),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_yellow_side),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_yellow_side),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_yellow_tilt_left),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_yellow_tilt_left),
         GEO_CLOSE_NODE(),
      GEO_CLOSE_NODE(),
   GEO_CLOSE_NODE(),
...
const GeoLayout blue_coin_geo[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         GEO_SWITCH_CASE(8, geo_switch_anim_state),
         GEO_OPEN_NODE(),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_blue_front),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_blue_front),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_blue_tilt_right),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_blue_tilt_right),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_blue_side),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_blue_side),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_blue_tilt_left),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_blue_tilt_left),
         GEO_CLOSE_NODE(),
      GEO_CLOSE_NODE(),
   GEO_CLOSE_NODE(),
...
const GeoLayout red_coin_geo[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         GEO_SWITCH_CASE(8, geo_switch_anim_state),
         GEO_OPEN_NODE(),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_red_front),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_red_front),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_red_tilt_right),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_red_tilt_right),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_red_side),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_red_side),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_red_tilt_left),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_red_tilt_left),
         GEO_CLOSE_NODE(),
      GEO_CLOSE_NODE(),
   GEO_CLOSE_NODE(),
...
const GeoLayout secret_coin_geo[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         GEO_SWITCH_CASE(8, geo_switch_anim_state),
         GEO_OPEN_NODE(),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_secret_0),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_secret_22_5),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_secret_45),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_secret_67_5),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_secret_90),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_secret_67_5_r),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_secret_45_r),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_secret_22_5_r),
         GEO_CLOSE_NODE(),
      GEO_CLOSE_NODE(),
      GEO_RENDER_RANGE(3072, 32767),
      GEO_OPEN_NODE(),
         GEO_SWITCH_CASE(8, geo_switch_anim_state),
         GEO_OPEN_NODE(),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_secret_front),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_secret_front),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_secret_tilt_right),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_secret_tilt_right),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_secret_side),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_secret_side),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_secret_tilt_left),
            GEO_DISPLAY_LIST(LAYER_ALPHA, coin_seg3_dl_secret_tilt_left),
         GEO_CLOSE_NODE(),
      GEO_CLOSE_NODE(),
   GEO_CLOSE_NODE(),
