...
static const Vtx coin_seg3_vertex_yellow_far[] = {
    {{{   -32,      0,      0}, 0, {     0,  63<<5}, {0xff, 0xff, 0x00, 0xff}}},
    {{{    32,      0,      0}, 0, { 63<<5,  63<<5}, {0xff, 0xff, 0x00, 0xff}}},
    {{{    32,     64,      0}, 0, { 63<<5,      0}, {0xff, 0xff, 0x00, 0xff}}},
...
static const Vtx coin_seg3_vertex_blue_far[] = {
    {{{   -48,      0,      0}, 0, {     0,  63<<5}, {0x80, 0x80, 0xff, 0xff}}},
    {{{    48,      0,      0}, 0, { 63<<5,  63<<5}, {0x80, 0x80, 0xff, 0xff}}},
    {{{    48,     96,      0}, 0, { 63<<5,      0}, {0x80, 0x80, 0xff, 0xff}}},
    {{{   -48,     96,      0}, 0, {     0,      0}, {0x80, 0x80, 0xff, 0xff}}},
};

// RED FAR
// 0x03005740
static const Vtx coin_seg3_vertex_red_far[] = {
    {{{   -36,      0,      0}, 0, {     0,  63<<5}, {0xff, 0x00, 0x00, 0xff}}},
    {{{    36,      0,      0}, 0, { 63<<5,  63<<5}, {0xff, 0x00, 0x00, 0xff}}},
    {{{    36,     72,      0}, 0, { 63<<5,      0}, {0xff, 0x00, 0x00, 0xff}}},
    {{{   -36,     72,      0}, 0, {     0,      0}, {0xff, 0x00, 0x00, 0xff}}},
};

// SECRET FAR
// 0x03005740
static const Vtx coin_seg3_vertex_secret_far[] = {
    {{{   -36,      0,      0}, 0, {     0,  63<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{    36,      0,      0}, 0, { 63<<5,  63<<5}, {0xff, 0xff, 0xff, 0xff}}},
    {{{    36,     72,      0}, 0, { 63<<5,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   -36,     72,      0}, 0, {     0,      0}, {0xff, 0xff, 0xff, 0xff}}},
};
