...
static const Vtx piranha_plant_seg6_vertex_060153F8[] = {
    {{{     0,      1,   -224}, 0, ST_B(     0,     64), {0x00, 0x7f, 0x00, 0xff}}},
    {{{   519,      1,    211}, 0, ST_B(    32,      1), {0x00, 0x7f, 0x00, 0xff}}},
    {{{   519,      1,   -224}, 0, ST_B(     0,      1), {0x00, 0x7f, 0x00, 0xff}}},
    {{{     0,      1,    211}, 0, ST_B(    32,     64), {0x00, 0x7f, 0x00, 0xff}}},
};
...
static const Vtx piranha_plant_seg6_vertex_060154F0[] = {
    {{{   519,      1,   -224}, 0, ST_B(    32,      0), {0x00, 0x82, 0x00, 0xff}}},
    {{{   519,      1,    211}, 0, ST_B(     0,      0), {0x00, 0x82, 0x00, 0xff}}},
    {{{     0,      1,    211}, 0, ST_B(     0,     64), {0x00, 0x82, 0x00, 0xff}}},
    {{{     0,      1,   -224}, 0, ST_B(    32,     64), {0x00, 0x82, 0x00, 0xff}}},
};
