...
// 0x0302BDC8
static const Vtx dirt_seg3_vertex_dirt_particle[] = {
    {{{  -101,    -60,      0}, 0, {  -128,    464}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   102,    -60,      0}, 0, {   600,    464}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{     0,     92,      0}, 0, {   234,    -80}, {0x00, 0x00, 0x7f, 0xff}}},
};

// 0x0302BDF8
ALIGNED8 static const Texture dirt_seg3_texture_dirt_particle[] = {
#include "actors/dirt/dirt_particle.rgba16.inc.c"
};

// 0x0302BFF8 - 0x0302C028
const Gfx dirt_seg3_sub_dl_dirt_particle[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, dirt_seg3_texture_dirt_particle),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, CALC_LRS(16, 16), CALC_DXT(16, G_IM_SIZ_16b_BYTES)),
    gsSPVertex(dirt_seg3_vertex_dirt_particle, 3, 0),
